...
#using hashed-1\zm_powerup_fire_sale.gsc;
...
function init_clientfields()
{
	...
	clientfield::register("scriptmover", "" + #"safe_fx", 1, 1, "int");	clientfield::register("scriptmover", "" + #"flare_fx", 1, 2, "int");
	...
	clientfield::register("scriptmover", "" + #"car_fx", 1, 1, "int");	clientfield::register("world", "" + #"hash_1166237b92466ac9", 1, 1, "int");
	clientfield::register("world", "" + #"fireworks_fx", 1, 2, "counter");	clientfield::register("world", "" + #"crash_fx", 1, 1, "int");	clientfield::register("world", "" + #"hash_4f672a8a7ae530e5", 1, 1, "int");
}
...
function function_ec9e5cf2()
{
	...
	zm_sq::start(#"hash_2a94ed57942ab290");
	zm_sq::start(#"hash_1b2ce27a742dce1");
	zm_sq::start(#"hash_6ec9bcc25b22e601");
	zm_sq::start(#"hash_520fa96bf5c8055");
...
function function_977835f8()
{
	...
	foreach(var_86a2fb89 in var_d66b8108)
	{
		...
		{
			arrayremovevalue(var_d66b8108, s_valve, 1);
		}
	}
...
function function_76351c42()
{
	...
	{
		s_result = undefined;
		s_result = level waittill(#"hash_e66663be8ba322f");
...
function function_143dcc81(var_5ea5c94d)
{
	...
	foreach(spot in a_spots)
	{
		...
		{
			s_result = undefined;
			s_result = var_3adcbaed waittill(#"damage");
...
function function_5daf1bb7()
{
	...
	var_fcec724a = struct::get(#"floaters_fx");	playrumbleonposition("grenade_rumble", var_fcec724a.origin);
	level waittill(#"start_of_round");
...
function function_c0174de(var_f02fb354, var_e531b8b8)
{
	...
	{
		s_result.e_who zm_audio::create_and_play_dialog(#"hash_5afc9e48d1d21f89", #"pick_up");
	}
	...
	if(!var_a276c861)
	{
		while(level flag::get(#"hash_2aaea7cd22f44712") == 0)
		{
			...
			else
			{
				...
				foreach(var_96d7c567 in level.var_d3587a62)
				{
					var_96d7c567.var_6f7cfe6d clientfield::set("" + #"safe_fx", 0);					var_96d7c567.var_d6249c56 = undefined;
				}
				function_b8048aaf();
			}
		}
...
function function_ae4e9016()
{
	...
	self.var_6f7cfe6d clientfield::set("" + #"safe_fx", 1);	level.var_f39ad20a++;
...
function function_75bdcb53(var_3bac6db4)
{
	...
	var_3bac6db4 clientfield::set("" + #"car_fx", 1);	while(n_start_round + 3 > level.round_number && !level flag::get(#"hash_3799c8bb28e2f2f"))
	{
		/#
			if(getdvarint(#"hash_7919e37cd5d57659", 0))
			{
	...
	var_3bac6db4 clientfield::set("" + #"car_fx", 0);	var_3bac6db4 unlink();
	veh_car delete();
	/#
		if(getdvarint(#"hash_7919e37cd5d57659", 0))
		{
...
function function_23c7360a()
{
	...
	level clientfield::set("" + #"crash_fx", 1);	wait(0.5);
...
function function_73bdaf30()
{
	...
	if(isdefined(var_e9e88745))
	{
		...
		if(isdefined(level.ai[#"axis"]))
		{
			...
			var_cd02461b = array::filter(var_dce7716b, 0, &cschashed-2\script_27ba6748d83412fd::function_6c856fde);
	...
	foreach(struct in var_425fb862)
	{
		...
		{
			var_f4e690cf = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(#"hash_332fbe57f2dd01f0");
...
function function_62c5099d()
{
	...
	level.var_d241eaa9 = struct::get_array(#"s_launcher");	foreach(var_e5da245 in level.var_d241eaa9)
	{
		var_e5da245.var_f0bbde5 = struct::get(s_launcher.target);
...
function function_acfd770e()
{
	...
	while(true)
	{
		...
		if(zm_utility::can_use(e_player) && isdefined(e_player.var_a4bb6a54))
		{
			...
			var_a4bb6a54.s_launcher = struct;
			playsoundatposition(#"hash_1cedcfe708cf2627", var_a4bb6a54.s_launcher.origin);
...
function function_9fa09d36(var_a4bb6a54)
{
	...
	var_45f93277.var_e5da245 = var_a4bb6a54.s_launcher;
...
function fireworks_fx(str_color)
{
	switch(str_color)
	{
		case "red":
		{
			level clientfield::increment("" + #"fireworks_fx", 1);			break;
		}
		case "green":
		{
			level clientfield::increment("" + #"fireworks_fx", 2);			break;
		}
		case "blue":
		{
			level clientfield::increment("" + #"fireworks_fx", 3);			break;
		}
	}
}
...
function function_a7669bbf(var_a276c861)
{
	...
	cschashed-2\script_709bf7c56eb65adf::register_melee_weapon_for_level(#"hash_6a9069969e6fa287");
...
function function_41ee4286()
{
	...
	while(true)
	{
		...
		if(isdefined(var_6bfbf04e.var_32d36a7f))
		{
			...
			if(var_6bfbf04e.var_32d36a7f == s_piano.script_int)
			{
