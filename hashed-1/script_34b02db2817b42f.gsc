...
#namespace cschashed-2\script_27a4aedb3d2a899b;
...
function preload()
{
	...
	level.var_74170866.var_22355173.a_e_doors = getentarray(level.var_74170866.s_cabinet.target, "targetname");
	...
	level.var_74170866.var_1e20c0e5.var_b9989e12 = hash(level.var_74170866.s_fireplace.script_noteworthy);
...
private function function_b60df00d()
{
	...
	var_22355173 = level.var_74170866.s_cabinet;
...
function function_4b4ede()
{
	...
	while(true)
	{
		...
		if(s_notify cschashed-3\script_e2bef0652b31f68::function_69320b44("zm_aat_plasmatic_burst"))
		{
...
private function function_9d66ea6f(var_2e1f34dd, e_player)
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mod_phase", 3, e_player);
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2z_ammo", 1, e_player);
	function_87e09347();
	if(zm_utility::is_classic())
	{
		level.var_74170866.e_player cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_z_ammo_pickup", 0);
...
{
	var_3b901e6a = level.var_74170866.s_fireplace;
...
private function function_b9a31cb(var_2e1f34dd, e_player)
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2z_ammo", 2, e_player);
...
private function function_cba90c3c()
{
	...
	if(zm_utility::is_classic())
	{
		...
		level.var_74170866.e_player cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_z_craft", 0);
	}
	function_fa74521f();
}
