...
#namespace cschashed-1\script_3c362258ff800237;
...
function fail(reason = undefined, var_eeb30248 = undefined)
{
	...
	cschashed-1\script_3d5821d793ed4c6::set_game_state(1);
	cschashed-1\script_3d5821d793ed4c6::function_58292c4a(reason, var_eeb30248);
...
function function_361e2cb0()
{
	...
	cschashed-1\script_3d5821d793ed4c6::set_game_state(2);
...
function function_18b797ec()
{
	...
	cschashed-1\script_3d5821d793ed4c6::set_game_state(3);
	wait(3);
	level notify(#"hash_4c09c9d01060d7ad");
	level notify(#"end_game");
}
...
private function reset_round()
{
	...
	cschashed-1\script_3d5821d793ed4c6::set_game_state(0);
...
private function function_10801ad3()
{
	foreach(player in getplayers())
	{
		...
		player.var_42a4759e.var_8c5bddf5 = player cschashed-1\script_3d5821d793ed4c6::function_3f8a4145(0);
	}
}
...
private function function_bcd35efc()
{
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d5821d793ed4c6::function_d37a769(player.var_42a4759e.var_8c5bddf5);
		...
		{
			player takeallweapons();
			player cschashed-2\script_709bf7c56eb65adf::give_start_weapon(1);
			player cschashed-2\script_709bf7c56eb65adf::init_player_offhand_weapons();
		}
		...
		player cschashed-1\script_3d5821d793ed4c6::function_7f999aa0(player.var_42a4759e.var_8c5bddf5);
...
function function_74872db6()
{
	...
	cschashed-1\script_3d5821d793ed4c6::set_game_state(0);
	cschashed-1\script_3d5821d793ed4c6::function_8cdbf9f0();
	cschashed-1\script_3d5821d793ed4c6::function_96e10d88(0);
	clientfield::set_world_uimodel("ZMHudGlobal.trials.roundNumber", level.round_number);
	cschashed-1\script_3d5821d793ed4c6::function_eaa44cea();
