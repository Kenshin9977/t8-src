...
#namespace cschashed-1\script_5fb8da2731850d9e;
...
{
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_4deb3ae7a73c87f3") || (isdefined(level.var_15747fb1) && level.var_15747fb1))
	{
		return;
	}
...
function dog_init()
{
	...
	if(self.entity_type != #"zombie_wolf")
	{
		self.a.nodeath = 1;
	}
...
function dog_death()
{
	...
	self stoploopsound();
	if(self.entity_type != #"zombie_wolf" && (!(isdefined(self.a.nodeath) && self.a.nodeath)))
	{
	...
	if(self.entity_type != #"zombie_wolf" && isdefined(self.a.nodeath))
	{
