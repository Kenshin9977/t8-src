...
#namespace cschashed-3\script_3599c70c9d1abde8;
...
function function_ccbee20()
{
	...
	if(isarray(a_s_spawn_locs))
	{
		...
		while(i < a_s_spawn_locs.size)
		{
			...
			{
				if(a_s_spawn_locs[i].var_39512f0e === "power_on3" && namespace_59ff1d6c::function_901b751c("zmPowerState") == 2 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_29004a67830922b6") == 0)
				{
					i++;
				}
				else
...
private function werewolftargetservice(entity)
{
	...
	if(entity ai::has_behavior_attribute("patrol") && entity ai::get_behavior_attribute("patrol"))
	{
		...
		cschashed-1\script_5a012bbb9342dbdf::stop_patrol(entity);
	}
	...
	/#
		...
		foreach(werewolf in werewolves)
		{
			...
			foreach(node in nearest_nodes)
			{
				...
				{
					var_71c80ceb = cschashed-1\script_5a012bbb9342dbdf::function_35eac38d(node);
					cschashed-1\script_5a012bbb9342dbdf::start_patrol(werewolf, var_71c80ceb.path, var_71c80ceb.loops, undefined, undefined);
					break;
				}
			}
		}
...
private function function_e79ce40a()
{
	/#
		...
		if(isdefined(spawners))
		{
			...
			{
				if(spawner.entity_type === #"hash_39ab6066fc0ba2b8" && isdefined(spawner.script_noteworthy))
				{
					adddebugcommand("");
					break;
				}
