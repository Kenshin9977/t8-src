...
function init_clientfields()
{
	...
	clientfield::register("scriptmover", "" + #"wormhole_fx", 1, 2, "int", &wormhole_fx, 0, 0);	clientfield::register("toplayer", "player_stargate_fx", 1, 1, "int", &player_stargate_fx, 0, 1);
...
function fasttravel_end_fx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	if(newval)
	{
		self thread function_4ffb2e90(localclientnum);
	}
}

/*
	Name: function_4ffb2e90
	Namespace: cschashed-2\script_27ba6748d83412fd
	Checksum: 0xEA1B324
	Offset: 0xF08
	Size: 0x12C
	...
	Flags: None
*/
function function_4ffb2e90(localclientnum, var_b8763ebc = "fasttravel_end")
{
	level endon(#"end_game");
	self endon(#"bled_out", #"disconnect");
	if(self != function_5c10bd79(localclientnum))
