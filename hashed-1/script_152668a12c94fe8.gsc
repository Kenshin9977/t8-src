...
#namespace cschashed-1\script_5d65ba89fe134c5c;
...
function function_ca35fa36()
{
	...
	zm_utility::function_fef4b36a(var_f79ff5ec);
	level.var_752f8086 thread cschashed-1\script_4c9e3a985ae04008::function_16ccd69f();
	level.var_2bcfd0bb thread cschashed-1\script_4c9e3a985ae04008::function_16ccd69f();
...
function function_7f933d39()
{
	...
	{
		s_portal cschashed-1\script_4c9e3a985ae04008::portal_init();
	}
	level.s_portal_power.b_active = 1;
	level.var_2bcfd0bb.b_active = 1;
	level.s_portal_power.e_model show();
	level.var_2bcfd0bb.e_model show();
	level.s_portal_power thread cschashed-1\script_4c9e3a985ae04008::portal_activate();
	level.var_2bcfd0bb thread cschashed-1\script_4c9e3a985ae04008::portal_activate();
	level.var_752f8086.n_dest = level.var_2bcfd0bb.var_7b89ada3;
	level.var_2bcfd0bb.n_dest = level.var_752f8086.var_7b89ada3;
}
...
function function_c87db3f7(var_f79ff5ec)
{
	...
	level.var_752f8086 thread cschashed-1\script_4c9e3a985ae04008::function_978923cd();
	level.var_2bcfd0bb thread cschashed-1\script_4c9e3a985ae04008::function_978923cd();
...
function intro_zombie_dog(n_round_number)
{
	...
	{
		var_b88c4823 = cschashed-1\script_5fb8da2731850d9e::function_62db7b1c(1, undefined);
...
function intro_nova_crawler(n_round_number)
{
	...
	while(n_spawn_count < 3)
	{
		var_b88c4823 = cschashed-3\script_318816742cac11da::function_dd836251();
		if(isdefined(var_b88c4823))
		{
			n_spawn_count++;
		}
	...
	level notify(#"crawlers_spawned");	zm_utility::function_9b7bc715(#"nova_crawler", 0);
}
