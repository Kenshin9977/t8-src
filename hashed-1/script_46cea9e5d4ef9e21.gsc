...
#namespace cschashed-3\script_675455e5e6c0c5ad;
...
function function_fb0bd6b9()
{
	...
	var_5554a9f4 thread function_562067d3();
...
private function function_15aa00e7()
{
	...
	if(!(isdefined(level.var_19fe84f5) && level.var_19fe84f5))
	{
		...
		{
			level.var_19fe84f5 = cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_citadel_stairs");
		}
		else if(zm_zonemgr::get_players_in_zone("zone_citadel_basement") > 0)
		{
			level.var_19fe84f5 = cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_citadel_basement");
		}
		else if(zm_zonemgr::get_players_in_zone("zone_citadel") > 0)
		{
			level.var_19fe84f5 = cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_citadel");
		}
	}
}
...
private function function_f50cec70()
{
	...
	level.var_988ed695++;
	namespace_891c9bac::function_3c173d37(s_result.e_grabber.origin, 512);
	s_result.e_grabber namespace_891c9bac::function_a2bd5a0c(#"hash_6ae96725c891addc", 0, 1, 9999);
}
