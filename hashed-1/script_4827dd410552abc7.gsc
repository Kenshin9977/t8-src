...
#namespace cschashed-1\script_6c1449411a084293;
...
event main(eventstruct)
{
	...
	var_14ef8b33 = getent("phys_fieldTarget_BackLeft", "targetname");
	var_14ef8b33 linkto(target1);
	col1 = getent("col_fieldTarget_BackLeft", "targetname");
	col1 linkto(target1);
	target2 = getent("fieldTarget_FrontLeft", "targetname");
	var_57bec48 = getent("phys_fieldTarget_FrontLeft", "targetname");
	var_57bec48 linkto(target2);
	col2 = getent("col_fieldTarget_FrontLeft", "targetname");
	col2 linkto(target2);
	target3 = getent("fieldTarget_Middle", "targetname");
	var_13b288bd = getent("phys_fieldTarget_Middle", "targetname");
	var_13b288bd linkto(target3);
	col3 = getent("col_fieldTarget_Middle", "targetname");
	col3 linkto(target3);
	target4 = getent("fieldTarget_BackRight", "targetname");
	var_e2112573 = getent("phys_fieldTarget_BackRight", "targetname");
	var_e2112573 linkto(target4);
	col4 = getent("col_fieldTarget_BackRight", "targetname");
	col4 linkto(target4);
	target5 = getent("fieldTarget_FrontRight", "targetname");
	var_f052c1f6 = getent("phys_fieldTarget_FrontRight", "targetname");
	var_f052c1f6 linkto(target5);
	...
	var_dead1eab = getent("phys_trailerTarget_Window", "targetname");
	var_dead1eab linkto(target7);
	var_15af6c19 = getent("col_trailerTarget_Window", "targetname");
	var_15af6c19 linkto(target7);
	target8 = getent("alleyTarget_Cover", "targetname");
	var_93b808c2 = getent("phys_alleyTarget_Cover", "targetname");
	var_93b808c2 linkto(target8);
	var_37b018e6 = getent("mantle_alleyTarget_Cover", "targetname");
	var_37b018e6 linkto(target8);
	var_217983ad = getent("col_alleyTarget_Cover", "targetname");
	var_217983ad linkto(target8);
	target9 = getent("alleyTarget_Path", "targetname");
	var_baf75740 = getent("phys_alleyTarget_Path", "targetname");
	var_baf75740 linkto(target9);
	var_8f08c796 = getent("mantle_alleyTarget_Path", "targetname");
	var_8f08c796 linkto(target9);
	var_eabe9600 = getent("col_alleyTarget_Path", "targetname");
	var_eabe9600 linkto(target9);
	target10 = getent("centerTarget_Sandbags", "targetname");
	var_489b3277 = getent("phys_centerTarget_Sandbags", "targetname");
	var_489b3277 linkto(target10);
	var_14f08938 = getent("mantle_centerTarget_Sandbags", "targetname");
	var_14f08938 linkto(target10);
	var_9af375c9 = getent("col_centerTarget_Sandbags", "targetname");
	var_9af375c9 linkto(target10);
	target11 = getent("towerTarget_Front", "targetname");
	var_ac389853 = getent("col_towerTarget_Front", "targetname");
	var_ac389853 linkto(target11);
	target12 = getent("towerTarget_Back", "targetname");
	var_757caadc = getent("col_towerTarget_Back", "targetname");
	var_757caadc linkto(target12);
	target13 = getent("centerTarget_Path", "targetname");
	var_6fdb00fa = getent("phys_centerTarget_Path", "targetname");
	var_6fdb00fa linkto(target13);
	var_88cad178 = getent("col_centerTarget_Path", "targetname");
	var_88cad178 linkto(target13);
	...
	var_2c25182e = getent("col_steelBuildingTarget_Slide1", "targetname");
	var_2c25182e linkto(target16);
	target17 = getent("steelBuildingTarget_PopUp", "targetname");
	var_3faebf41 = getent("col_steelBuildingTarget_PopUp", "targetname");
	var_3faebf41 linkto(target17);
	target18 = getent("target_alleyWindow1", "targetname");
	var_bb14176b = getent("phys_target_alleyWindow1", "targetname");
	var_bb14176b linkto(target18);
	var_8c05165 = getent("col_target_alleyWindow1", "targetname");
	var_8c05165 linkto(target18);
	target19 = getent("target_alleyWindow2", "targetname");
	var_c8d3b2f6 = getent("phys_target_alleyWindow2", "targetname");
	var_c8d3b2f6 linkto(target19);
	var_1af0f5c6 = getent("col_target_alleyWindow2", "targetname");
	var_1af0f5c6 linkto(target19);
	target20 = getent("target_alleyWindow3", "targetname");
	registerwheelhouse_target3_ambient = getent("phys_target_alleyWindow3", "targetname");
	registerwheelhouse_target3_ambient linkto(target20);
