...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_4746da5c54386c3d", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_2e2a518(n_timer, var_f97d1a30)
{
	...
	while(true)
	{
		...
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_1a444a987e075837", array(self));
