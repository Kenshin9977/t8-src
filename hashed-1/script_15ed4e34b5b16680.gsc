...
function function_ba542258(mode)
{
	...
	self thread namespace_d82263d5::vo_clearstartsupersprint();
...
/*
	...
	Flags: None
*/
function function_4b892700(s_veh)
{
...
function function_4bae19cf(str_targetname, str_team, var_be674792 = 1, b_missiles = 1, var_edf46d6e = [])
{
	...
	chopper.var_a2a6e327 = var_edf46d6e[#"shoot_spread"];	chopper.n_speed = var_edf46d6e[#"speed"];
...
function function_64dd0b39(var_fec7078b)
{
	...
	e_player thread namespace_73e1c3e3::magic_explosion(self.origin);
...
function function_52d196f2(n_difficulty = 2)
{
	...
	var_edf46d6e[#"shoot_spread"] = var_ed621a12[n_difficulty];	var_edf46d6e[#"speed"] = var_c52588b6[n_difficulty];
	...
	e_player namespace_73e1c3e3::objcounter_init(#"hash_1b6372a0a5dc0fef", n_count, n_total, 1, 1);
...
function function_4674d2e7()
{
	...
	while(true)
	{
		...
		if(var_1c5e8282 < 4)
		{
			namespace_73e1c3e3::get_player() thread namespace_73e1c3e3::magic_explosion(self.origin);
			wait(0.1);
			self delete();
		}
		waitframe(1);
...
function function_56e0d37e(var_764a1fa0)
{
	...
	{
		e_enemy = namespace_64a487a9::function_7e8fcca2(nd_enemy);
		if(isalive(e_enemy))
		{
