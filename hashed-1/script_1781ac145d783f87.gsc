...
function function_135e7d64(e_player)
{
	...
	var_59aa5add = level flag::get(var_d4c288fb.model + "_placed");
...
function function_51817689()
{
	...
	while(true)
	{
		...
		if(isplayer(e_player) && isactor(ai_victim))
		{
			...
			var_1e137cec = ai_victim.entity_type;
...
function function_5ca13573()
{
	...
	while(true)
	{
		...
		if(cschashed-1\script_4a4eacd716becef3::function_a57b8fca(var_6aa0de02.weapon, 0))
		{
...
function function_3ce07a2b()
{
	...
	while(true)
	{
		...
		if(cschashed-1\script_4a4eacd716becef3::function_a57b8fca(var_be17187b.weapon, 0) && e_attacker.var_c9d375dc.b_charged)
		{
			str_player_zone = var_be17187b.attacker.zone_name;
