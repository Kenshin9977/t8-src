...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_5b4dc34d166627cb", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_ed49e96e, var_ea5e88ac, str_return, var_c728f1dd, var_aed178c2)
{
	...
	level.var_2bb6b2ba = [];
	level.var_9fc7133d = cschashed-1\script_3c362258ff800237::function_5769f26a(var_c728f1dd);
	self.n_defend_time = cschashed-1\script_3c362258ff800237::function_5769f26a(var_aed178c2);
...
private function function_452ec7b3()
{
	...
	{
		level.var_c8b84806 = [];
		var_6f13f276 = self.var_247c8132;
		...
		foreach(player in getplayers())
		{
			player thread function_209fb197(self, self.var_a7d4f51b, self.str_return, level.var_9fc7133d);
...
private function start_timer(n_timeout, str_return)
{
	if(!level.var_f995ece6 zm_trial_timer::is_open(self))
	{
		...
		self cschashed-1\script_3d5821d793ed4c6::start_timer(n_timeout);
...
/*
	...
	Flags: Linked, Private
*/
private function function_209fb197(challenge, var_2d5ebf67, var_530e040f, timeout)
{
...
private function function_ff66b979()
{
	...
	foreach(player in getplayers())
	{
		...
		player thread function_209fb197(player.var_356935bb.challenge, player.var_356935bb.var_2d5ebf67, player.var_356935bb.var_530e040f, timeout);
		player thread damage_watcher();
	}
}
