...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"friendly_fire", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_9e0a2a85 = 1)
{
	...
	{
		var_9e0a2a85 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_9e0a2a85);
	}
	level.var_3c2226ce = cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_3f8f02e8109b6e93");
	cschashed-3\script_12282e6b2cc91b42::function_928be07c(var_9e0a2a85);
...
{
	cschashed-3\script_12282e6b2cc91b42::function_928be07c(level.var_3c2226ce);
...
private function on_player_damage(params)
{
	...
	{
		cschashed-1\script_3c362258ff800237::fail(#"hash_6e2a00b7d2d6e510", array(params.eattacker));
		return;
	}
	...
	{
		cschashed-1\script_3c362258ff800237::fail(#"hash_6e2a00b7d2d6e510", array(params.einflictor.activated_by_player));
		return;
	}
}
