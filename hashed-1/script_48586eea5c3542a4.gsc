...
function function_a0367a9()
{
	...
	self endon(#"death");
	self endon(#"disconnect");
	self endon(#"bells_complete");	wait(12);
...
{
	level flag::wait_till(#"hash_1e9939091ee8cb9b");
	if(isdefined(level.var_dc2e3646))
	{
		/#
			iprintlnbold("" + "");
		#/
		level.var_dc2e3646 zm_utility::giveachievement_wrapper("zm_orange_secret", 0);
	}
}

/*
	Name: function_3d30725f
	Namespace: namespace_e9563b61
	Checksum: 0x3213E359
	Offset: 0x1008
	Size: 0x1206
