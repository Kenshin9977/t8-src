...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"timed_round", &function_d1de6a85, &function_9e7b3f4d);}
...
{
	n_time_limit = cschashed-1\script_3c362258ff800237::function_5769f26a(n_time);
	var_399c992a = cschashed-1\script_3c362258ff800237::function_5769f26a(var_52b8b3a2);
...
private function function_8b87e57c(var_6325d314, n_grace, n_time_limit)
{
	...
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d5821d793ed4c6::start_timer(n_time_limit);
	}
	wait(n_time_limit);
	foreach(player in getplayers())
	{
