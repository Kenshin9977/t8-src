...
{
	self notify(#"remote_control");	self endon(#"hash_3e23eda36b75f2f9", #"disconnect", #"death", #"hash_67b8b8174869f4a2");
	while(true)
	{
...
function gadget_vision_pulse_on(slot, weapon)
{
	...
	self notify(#"vision_pulse_on");	self flagsys::set(#"gadget_vision_pulse_on");
...
{
	self notify(#"vision_pulse_off");	self.var_87b1ba00 = 0;
	if(!spottedenemy)
	{
	...
	self notify(#"remote_control");	if(isdefined(self._pulse_ent))
	{
		self._pulse_ent delete();
	}
	if(immediate)
