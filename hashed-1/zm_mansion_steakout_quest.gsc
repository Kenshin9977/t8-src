...
#namespace cschashed-1\script_6c494cd6189bb8dc;
...
function init()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_d8383812("ee_asf_altar", 8000, #"a_skeet_fink_charge", &function_123eb361, &function_9bb74431, 1);
	function_c739f755();
...
function function_ff75fde6(var_a276c861)
{
	...
	cschashed-2\script_709bf7c56eb65adf::register_melee_weapon_for_level(#"hash_19a4271a5452dc0b");
...
function function_abf0bf8c()
{
	...
	while(true)
	{
		...
		if(isplayer(var_be17187b.attacker) && !cschashed-2\script_709bf7c56eb65adf::is_offhand_weapon(var_be17187b.weapon))
		{
...
function function_15c82a8a(var_a276c861)
{
	if(level flag::get(#"hash_6df692c4073d421b"))
	{
		...
		if(!var_a276c861)
		{
			...
			cschashed-2\script_624a704d0f6bf28d::function_3f808d3d("ee_asf_altar");
			if(zm_utility::is_trials())
			{
...
function function_9bb74431(var_f0e6c7a2, ent)
{
	...
	{
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("ee_asf_altar");
...
function function_ed59d8e4()
{
	...
	cschashed-2\script_257d7bea5de94cbf::function_cf4e3354(var_d9d51621, getweapon(#"hash_4aa70c9036cc210e"));
}
...
function function_2879cfed(var_a276c861)
{
	if(level flag::get(#"hash_6df692c4073d421b"))
	{
		...
		cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"zblueprint_mansion_a_skeet_fink", &function_36194a5f);
	}
}
