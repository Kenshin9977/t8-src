...
#namespace cschashed-1\script_6a0e50bc15d725a9;
...
function __init__()
{
	...
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_119644e9a557f4e9", 0.5, 1);
...
function function_68871817(e_attacker)
{
	if(isdefined(self))
	{
		...
		{
			self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_119644e9a557f4e9");
...
private function function_1b33fb6d(var_155e1cdd)
{
	...
	while(true)
	{
		...
		{
			if(self function_635f9c02(var_155e1cdd) || (namespace_fcd611c3::is_active() && !self cschashed-3\script_45657e86e8f90414::function_26f124d8()))
			{
				break;
			}
			waitframe(1);
...
function function_d1a7390b(var_f2a06582)
{
	...
	while(true)
	{
		...
		if(isdefined(a_trace[#"entity"]) || isdefined(var_4ff501e0))
		{
			...
			{
				foreach(var_afe32345 in level.var_c7626f2a)
				{
