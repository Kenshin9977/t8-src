...
#namespace cschashed-3\script_20422991283c1b8;
...
function preload()
{
	...
	clientfield::register("world", "" + #"lava_init", 24000, 1, "int");	clientfield::register("world", "" + #"lava_control", 24000, 2, "int");	clientfield::register("world", "" + #"hash_72b5b0359ca48427", 24000, 1, "int");
	clientfield::register("world", "" + #"hash_5e69ee96304ec40b", 24000, 1, "int");
	clientfield::register("vehicle", "" + #"lantern_fx", 24000, 2, "int");
	clientfield::register("vehicle", "" + #"lantern_explode_fx", 24000, 1, "counter");	clientfield::register("toplayer", "" + #"hash_78b8d89d34b32241", 24000, 2, "int");
	clientfield::register("scriptmover", "" + #"hash_54e24ec6e84ad6e6", 24000, 1, "int");
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_1", 24000, "sc_lantern_1", &function_36eb3c96, &function_defd8c26, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_2", 24000, "sc_lantern_2", &function_36eb3c96, &function_defd8c26, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_3", 24000, "sc_lantern_3", &function_36eb3c96, &function_defd8c26, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_4", 24000, "sc_lantern_4", &function_36eb3c96, &function_defd8c26, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_end", 24000, "sc_lantern_end", &function_36eb3c96, &function_f578fb22, 1);
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 10);
...
function function_d9d65ea6()
{
	...
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"surrounded");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"oh", #"shit");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"general", #"attacked");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"zipline", #"activate");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"flinger", #"react");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"hash_20b463357f4ae8f");
	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"electric_zombie");	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"935_zombie");	waitframe(1);
	cschashed-3\script_e2bef0652b31f68::function_df67a12d(#"german_zombie");}
...
function function_f1749965()
{
	...
	cschashed-3\script_e2bef0652b31f68::function_2ba419ee(0, 29);
...
function lava_control()
{
	...
	{
		setlightingstate(1);
		level clientfield::set("" + #"lava_control", 1);		foreach(var_59bd23de in level.var_eb7fcc70)
		{
			var_59bd23de show();
			var_59bd23de solid();
		}
	...
	{
		setlightingstate(0);
		level clientfield::set("" + #"lava_control", 0);		foreach(var_59bd23de in level.var_eb7fcc70)
		{
			var_59bd23de hide();
			var_59bd23de notsolid();
		}
...
function spawn_guide()
{
	...
	var_a41818b5 val::set(#"hash_3509fda15e89663b", "takedamage", 0);
...
function function_a340f5a2()
{
	...
	/#
		iprintlnbold("");
	#/
	level.var_5d5b7e8e.var_a41818b5 clientfield::increment("" + #"lantern_explode_fx", 1);	level thread lui::screen_flash(0.2, 0.5, 1, 0.8, "white");
	wait(0.2);
	cschashed-1\script_4f00f8c9cdfa5084::function_70f4c8c3("sunken_path_blocker");
	lava_control();
	...
	{
		var_a84febff flag::set("pap_waiting_for_user");
		var_a84febff cschashed-3\script_f459be361894751::function_e3921120(0);
	}
	wait(2);
...
{
	level endon(#"end_game");
	namespace_3263198e::function_fd24e47f(#"hash_519ab3eee65867f8");
	level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_519ab3eee65867f8");
}
...
function function_25c6ed8d()
{
	...
	foreach(e_player in getplayers())
	{
		...
		{
			e_player thread cschashed-1\script_1edaf4333ed0bece::fling_player(vol_fling);
	...
	self waittill(#"zip");
	self setspeed(7);
	self waittill(#"hash_23d1ae8124c172d6");
	self setspeed(5);
...
{
	cschashed-2\script_624a704d0f6bf28d::function_2a94055d(self.var_5f9f040);
...
{
	level endon(#"end_game");
	cschashed-3\script_e2bef0652b31f68::function_314447b(1);
	wait(n_time);
	cschashed-3\script_e2bef0652b31f68::function_314447b(0);
}
...
function function_9be0a8a6(str_id)
{
	...
	level thread namespace_3263198e::function_fd24e47f(#"hash_6f4de6a856d64c98");
	function_95557832();
	s_sc = struct::get(str_id, "script_noteworthy");
	var_3b901e6a.var_7944be4a = 0;
	var_3b901e6a.var_5f9f040 = hash(str_id);
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(var_3b901e6a.var_5f9f040);
	/#
		iprintlnbold("");
	#/
}
...
function function_3c3bee91()
{
	level.var_5d5b7e8e.var_a41818b5 setspeedimmediate(0);
	function_95557832();
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(#"sc_lantern_end");
	level thread namespace_3263198e::function_fd24e47f(#"hash_6f4de6a856d64c98");
	/#
		iprintlnbold("");
	#/
	...
	wait(15);
	namespace_3263198e::function_fd24e47f(#"hash_5aba3394c65e8f8c");
	wait(5);
	cschashed-2\script_624a704d0f6bf28d::function_2a94055d(#"sc_lantern_end");
	cschashed-3\script_e2bef0652b31f68::function_314447b(1);
	...
	wait(1);
	level namespace_3263198e::function_fd24e47f(#"hash_66817621c4ce4596");
	wait(1);
...
{
	playsoundatposition(#"evt_last_stand", (0, 0, 0));	wait(1);
...
{
	level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_7f649ba02c11110c");
}
