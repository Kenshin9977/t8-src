...
function function_f7dbfdf9(player, unitrigger)
{
	if(isdefined(player))
	{
		player notify(#"hash_7fd32c9551894e64");
...
function function_d95a600f(player, unitrigger)
{
	if(isdefined(player))
	{
		player notify(#"hash_424834e6dee13bc3");
...
function function_f665fde0(trig)
{
	...
	if(zm_utility::function_166646a6() == 1 && isdefined(trig.target4))
	{
...
private function function_356e77bd()
{
	...
	{
		event = undefined;
		event = self waittill(#"hash_396aa901be0c0eaf");
		player = event.player;
...
private function function_8109ae21(player)
{
	...
	if(blueprints.size < 1 || !array::contains(blueprints, self.blueprint))
	{
		...
		if(zm_utility::function_166646a6() == 1 && isdefined(self.var_c2f40a58) && (isdefined(self.var_c2f40a58.is_visible) && self.var_c2f40a58.is_visible))
		{
