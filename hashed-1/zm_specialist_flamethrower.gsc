...
#namespace cschashed-1\script_3a10f19f96036e97;
...
function __init__()
{
	...
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_18829d56b3fbd75b");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_18829e56b3fbd90e");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_18829f56b3fbdac1");
	...
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_6ff4731de876ab68", 0.6, 1);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_6a420a16118789e1", 0.6, 3);
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_18829d56b3fbd75b", 16, 6);
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_18829e56b3fbd90e", 16, 6);
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_18829f56b3fbdac1", 16, 6);
...
function function_f63feeb6(einflictor, eattacker, idamage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	if(isplayer(einflictor) && meansofdeath === "MOD_BURNED" && (!(isdefined(self.is_on_fire) && self.is_on_fire)))
	{
		...
		self cschashed-3\script_d67878983e3d7c::burn(weapon.name, eattacker, weapon, var_bb6709b6);
	}
...
private function function_d8ee4d6a(eattacker)
{
	...
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_6ff4731de876ab68");
		wait(1);
	}
	...
	else if(self.var_6f84b820 == #"basic" || self.var_6f84b820 == #"enhanced")
	{
		...
		{
			self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_6a420a16118789e1");
			wait(3);
		}
	}
...
private function function_e296efef(var_1c041bd9, e_player)
{
	...
	{
		var_bb6709b6 = zm_equipment::function_379f6b5d(16);
		self cschashed-3\script_d67878983e3d7c::burn(var_1c041bd9.name, e_player, var_1c041bd9, var_bb6709b6);
	}
}
