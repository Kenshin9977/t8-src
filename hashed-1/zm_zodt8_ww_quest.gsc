...
#using hashed-2\zm_zod_wonderweapon_quest.gsc;
...
function init()
{
	...
	foreach(var_d6524d4e in level.var_a066b028)
	{
		s_chest chest_init();
		cschashed-2\script_624a704d0f6bf28d::function_d8383812(var_d6524d4e.script_noteworthy, 1, var_d6524d4e, &function_62f0c1c, &function_32edfed);
	}
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_541a4d5c476468f4"))
	{
		...
		level.var_1cf75f1d = getweapon(#"hash_5b8d1ff4b772bd85");
		...
		level.var_3a67ac0e = array(#"hash_10d96c6e67b7604d", #"hash_42571afbd6335f8a", #"hash_64e29f1c46b77c4e", #"hash_7559073102f844ad", #"hash_303a3e9981fd0d91");
		...
		var_35da56ee = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(#"hash_6f259b259997271a");
		if(isdefined(var_35da56ee))
		{
			var_35da56ee.var_99577dd3.var_62a98b13 = #"hash_4223e614aaaeb5be";
			var_35da56ee.var_670f9944.var_62a98b13 = #"hash_7197969b05db907a";
	...
	clientfield::register("scriptmover", "" + #"clue_fx", 1, 1, "int");	clientfield::register("scriptmover", "" + #"despawn_fx", 1, 1, "int");	clientfield::register("scriptmover", "" + #"hash_1c8f8a5e03b36070", 1, 1, "int");
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_2c93a769()
{
	...
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"hash_6f259b259997271a", &function_8498110e);
...
/*
	...
	Flags: Linked, Private
*/
private function function_e4b33b89(var_a276c861)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_64809180(var_a276c861, var_19e802fa)
{
	if(!var_a276c861)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f7b0a02a()
{
	...
	if(self.archetype == #"stoker")
	{
		...
		if(waitresult._notify == #"hash_4651621237a54fc7")
		{
			if(!isdefined(level.var_86d6efbf))
			{
				level.var_86d6efbf = util::spawn_model(#"hash_4b3c37611d7d5118", self.origin + (0, 0, 32), self.angles);
...
/*
	...
	Flags: Linked, Private
*/
private function function_a20e6e5d()
{
	...
	if(isdefined(player))
	{
		...
		player util::delay(0.5, "death", &zm_audio::create_and_play_dialog, #"hash_5a2c12d3bcc84513", #"pick_up");
	}
	level.var_85a8dbba delete();
	level.var_86d6efbf delete();
	level flag::set(#"hash_1562cc6d96b2bc4");
...
/*
	...
	Flags: Linked, Private
*/
private function function_ca409b53()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_fee02008(var_a276c861)
{
	level endon(#"end_game");
	if(!var_a276c861)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_bb332956(var_a276c861, var_19e802fa)
{
	if(!var_a276c861)
	{
		zm_unitrigger::unregister_unitrigger(level.var_f9f50915.s_unitrigger);
	}
	level.var_f9f50915.var_31919730 thread scene::play(#"hash_69a846d6b117080b", "open", level.var_f9f50915.var_31919730);
...
/*
	...
	Flags: Linked, Private
*/
private function function_aed5650e(var_a276c861)
{
	level endon(#"end_game");
	if(!var_a276c861)
	{
		...
		{
			function_887ad605();
			cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(level.var_f9f50915.script_noteworthy);
			level waittill(#"hash_17332cf9062484a6");
			cschashed-2\script_624a704d0f6bf28d::function_2a94055d(level.var_f9f50915.script_noteworthy);
			wait(1);
			level.var_f9f50915.var_31919730 stoploopsound(1);
			level.var_f9f50915.var_31919730 thread scene::play(#"hash_69a846d6b117080b", "close", level.var_f9f50915.var_31919730);
			wait(3);
...
/*
	...
	Flags: Linked, Private
*/
private function function_8a5e22a9(var_a276c861, var_19e802fa)
{
	if(var_19e802fa)
	{
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d(level.var_f9f50915.script_noteworthy);
...
/*
	...
	Flags: Linked, Private
*/
private function function_887ad605()
{
	a_e_players = getplayers();
...
/*
	...
	Flags: Linked, Private
*/
private function function_62f0c1c(s_struct, ai_killed)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_32edfed(s_struct, ai_killed)
{
	level.n_kill_count++;
...
/*
	...
	Flags: Linked, Private
*/
private function function_fb4f668c(var_a276c861)
{
	level endon(#"end_game");
	if(!var_a276c861)
	{
		array::run_all(util::get_active_players(), &forcestreambundle, #"hash_475742bf38e2ed65");
...
/*
	...
	Flags: Linked, Private
*/
private function function_d332dd57(var_a276c861, var_19e802fa)
{
	scene::add_scene_func(#"hash_475742bf38e2ed65", &spawn_tricannon);
	scene::add_scene_func(#"hash_475742bf38e2ed65", &function_d3351bf7, "done");
	level scene::play(level.var_f3abf34a.target, "targetname");
	scene::remove_scene_func(#"hash_475742bf38e2ed65", &spawn_tricannon);
	level flag::set(#"hash_35ab49975b4cc894");
	array::run_all(util::get_active_players(), &function_66b6e720, #"hash_475742bf38e2ed65");
}
...
function function_d3351bf7(a_ents)
{
	...
	scene::remove_scene_func(#"hash_475742bf38e2ed65", &function_d3351bf7, "done");
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_a8fff4b0()
{
	level endon(#"end_game");
	self.var_31919730 thread scene::play(#"hash_69a846d6b117080b", "close", self.var_31919730);
	wait(3);
	...
	if(level.var_3a67ac0e[level.var_2e2dab8d] == #"hash_42571afbd6335f8a")
	{
		var_5792d83f setscale(2);
	}
	var_5792d83f rotate(vectorscale((0, 1, 0), 22));
	var_5792d83f clientfield::set("" + #"clue_fx", 1);	self.var_31919730 thread scene::play(#"hash_69a846d6b117080b", "open", self.var_31919730);
...
/*
	...
	Flags: Linked, Private
*/
private function spawn_tricannon(a_ents)
{
	if(self.targetname !== #"hash_d57edbfd2d86a0c")
	{
		...
		var_c238080c clientfield::set("" + #"despawn_fx", 1);		var_c238080c waittill(#"hash_10720ca9d0a02cc2");
...
/*
	...
	Flags: Linked, Private
*/
private function function_10d4ff8d(e_player)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e0fe80db()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_557328cc(waitresult)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e796525(e_player)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_707a3db7()
{
...
function function_8498110e(e_player)
{
	...
	s_unitrigger = var_38cf61e4 zm_unitrigger::create(&function_86710c92, 64, &function_ae6c3cf2, 1);
	zm_unitrigger::unitrigger_force_per_player_triggers(s_unitrigger, 1);
	namespace_cb42c6c0::function_d67bafb5(s_unitrigger, "lockdown_stub_type_crafting_tables");
	level thread cschashed-1\script_6d85b093d74cdfdd::function_ca244624(#"hash_6f259b259997271a");
}
...
/*
	...
	Flags: Linked, Private
*/
private function registerblinkingshouldshowpain(e_player)
{
	...
	if(e_player zm_utility::is_player_looking_at(self.origin, 0.5, 0) && isdefined(e_player.var_b6ddf07f) && e_player.var_b6ddf07f != "" && isdefined(var_9102824b))
	{
		...
		switch(e_player.var_b6ddf07f)
		{
			case "decay":
			{
				if(var_9102824b.name == #"hash_95dd69e40d99560" || var_9102824b.name == #"hash_337a0bfc51449d31")
				{
			...
			case "plasma":
			{
				if(var_9102824b.name == #"hash_539f784146391d2" || var_9102824b.name == #"hash_34415d7a97a7d783")
				{
					if(zm_utility::is_standard())
					{
						if(function_8b1a219a())
			...
			case "purity":
			{
				if(var_9102824b.name == #"hash_5004e2171c2be97d" || var_9102824b.name == #"hash_3b5823adc79b4e56")
				{
					if(zm_utility::is_standard())
					{
						if(function_8b1a219a())
			...
			case "radiance":
			{
				if(var_9102824b.name == #"hash_7d7f0dbb00201240" || var_9102824b.name == #"hash_2909dcf2d0d6eed1")
				{
					if(zm_utility::is_standard())
					{
						if(function_8b1a219a())
...
/*
	...
	Flags: Linked, Private
*/
private function function_9b8016f1(var_9102824b)
{
...
function function_ae6c3cf2()
{
	...
	while(true)
	{
		...
		var_c713c910 = user function_8f59b576();
		if(!isdefined(var_c713c910))
		{
			continue;
		}
		n_cost = function_9b8016f1(var_c713c910);
...
/*
	...
	Flags: Linked, Private
*/
private function function_e00eae6(e_player)
{
	var_9102824b = e_player function_8f59b576();
	if(isdefined(var_9102824b))
	{
		...
		switch(e_player.var_b6ddf07f)
		{
			case "decay":
			{
				var_be9badbc = #"hash_95dd69e40d99560";
				var_73d97896 = 2;
				break;
			}
			case "plasma":
			{
				var_be9badbc = #"hash_539f784146391d2";
				var_73d97896 = 3;
				break;
			}
			case "purity":
			{
				var_be9badbc = #"hash_5004e2171c2be97d";
				var_73d97896 = 1;
				break;
			}
			case "radiance":
			{
				var_be9badbc = #"hash_7d7f0dbb00201240";
				var_73d97896 = 4;
				break;
			}
			default:
			{
				/#
					assert(0, "");
				#/
				var_be9badbc = #"hash_5b8d1ff4b772bd85";
				break;
			}
		}
		if(function_81d8403b(var_9102824b))
...
/*
	...
	Flags: Linked, Private
*/
private function function_f4a7fd49(params)
{
	level endon(#"end_game");
		...
		if(is_tricannon(params.weapon))
		{
			if(level.var_ab242e52 < 4 && randomint(100) <= 50)
			{
				...
				switch(self.var_62e81e47)
				{
					case 1:
					{
						level function_4facba35(#"hash_39628a4f9a104108", self.origin, self getcentroid());
						break;
					}
					case 3:
					{
						level function_4facba35(#"hash_3d003a8f09e60fc7", self.origin, self getcentroid());
						break;
					}
					case 2:
					{
						level function_4facba35(#"hash_7233c98a09139934", self.origin, self getcentroid());
						break;
					}
					case 4:
					{
						level function_4facba35(#"hash_6eb25b39d1ebb59f", self.origin, self getcentroid());
						break;
					}
					default:
					{
...
/*
	...
	Flags: Linked, Private
*/
private function function_4facba35(var_ab02aaca, v_origin, v_spawn)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_3ef485b1(t_trig)
{
	level endon(#"end_game");
...
/*
	...
	Flags: Linked, Private
*/
private function function_74df2b21(t_trig)
{
	level endon(#"end_game");
...
{
	e_player zm_audio::create_and_play_dialog(#"hash_6c69dcee8b5d90b5", #"decay");
	e_player.var_b6ddf07f = #"decay";
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_zodt8_conc_catalyst", 1, e_player);
}
...
{
	e_player zm_audio::create_and_play_dialog(#"hash_6c69dcee8b5d90b5", #"plasma");
	e_player.var_b6ddf07f = #"plasma";
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_zodt8_conc_catalyst", 2, e_player);
}
...
{
	e_player zm_audio::create_and_play_dialog(#"hash_6c69dcee8b5d90b5", #"purity");
	e_player.var_b6ddf07f = #"purity";
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_zodt8_conc_catalyst", 4, e_player);
}
...
{
	e_player zm_audio::create_and_play_dialog(#"hash_6c69dcee8b5d90b5", #"radiance");
	e_player.var_b6ddf07f = #"radiance";
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_zodt8_conc_catalyst", 3, e_player);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_58269323()
{
	self.var_b6ddf07f = "";
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_zodt8_conc_catalyst", 0, self);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_d37acf8a()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_8f59b576()
{
	a_weapons = self getweaponslistprimaries();
	foreach(weapon in a_weapons)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function is_tricannon(weapon)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_81d8403b(weapon)
{
	if(isdefined(weapon) && isdefined(weapon.name))
	{
		switch(weapon.name)
