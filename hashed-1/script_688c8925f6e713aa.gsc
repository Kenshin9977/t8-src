...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_3ad93d68c19802af", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	if(!round_reset)
	{
		...
		if(var_696c3b4.size)
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_6a7d01641de1f5c3", var_696c3b4);
		}
	}
	foreach(player in getplayers())
	{
...
private function function_7bc122af()
{
	...
	while(true)
	{
		...
		var_1a3ca504 = self cschashed-2\script_709bf7c56eb65adf::get_player_lethal_grenade();
		...
		if(self.var_53531c80 != var_94020d2)
		{
			...
			self cschashed-1\script_3d5821d793ed4c6::function_63060af4(self.var_53531c80);
		}
		waitframe(1);
	}
}
