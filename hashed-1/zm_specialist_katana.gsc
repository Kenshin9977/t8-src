...
#namespace cschashed-2\script_784bc1aee23dbf1f;
...
function __init__()
{
	...
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_6627879099b8a337");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_6627889099b8a4ea");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_6627899099b8a69d");
...
function function_119af40d(var_c1ed7977)
{
	...
	while(true)
	{
		...
		if(s_result.weapon == var_c1ed7977)
		{
			self playsound(#"wpn_katana_dash");			self thread flagsys::set_for_time(1, "katana_dash");
			self.var_5605c31e = 1;
