...
function function_88dec965(var_5ea5c94d)
{
	...
	if(!var_5ea5c94d)
	{
		foreach(var_1c4cfc0f in level.var_79260935.var_9720ddfa)
		{
			s_keycard zm_unitrigger::create("", 64);
			var_1c4cfc0f thread function_d332685();
		}
...
function function_ee2edc25()
{
	...
	var_88f6f50a = [];
	var_7ab3d884 = [];
	foreach(var_1c4cfc0f in var_9720ddfa)
	{
	...
	foreach(var_1c4cfc0f in level.var_79260935.var_9720ddfa)
	{
		var_1c4cfc0f.var_cd0e32a2 = getent(s_keycard.target, "targetname");
	}
	var_5731429e = [];
	var_5731429e = arraycombine(var_88f6f50a, var_7ab3d884, 1, 0);
	foreach(var_1c4cfc0f in var_5731429e)
	{
...
function function_d332685()
{
	...
	if(level.var_79260935.var_f4c36022 === 0 && level.var_79260935.n_keys_placed === 0)
	{
		...
		level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_1", 1);
	}
	else if(!isdefined(level.var_79260935.var_30df7623) || level.var_79260935.n_keys_placed == 0)
	{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_2", 1);
...
function function_61298be5()
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_1", 0);
	level.var_79260935.var_f4c36022--;
	level.var_79260935.n_keys_placed++;
	wait(0.5);
	self.var_b6aa4c4f cschashed-3\script_e2bef0652b31f68::function_dc4ab629(-8, 1.5);
...
function function_2ec6a1aa()
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_2", 0);
	level.var_79260935.var_f4c36022--;
	level.var_79260935.n_keys_placed++;
	wait(0.5);
	self.var_a56fa9da cschashed-3\script_e2bef0652b31f68::function_dc4ab629(-8, 1.5);
...
function function_3aa0b188(var_5ea5c94d, ended_early)
{
	if(var_5ea5c94d || ended_early)
	{
		foreach(var_1c4cfc0f in level.var_79260935.var_9720ddfa)
		{
			if(isdefined(var_1c4cfc0f.var_cd0e32a2))
			{
				var_1c4cfc0f.var_cd0e32a2 delete();
...
function function_6c5a5d32()
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_1", 2);
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_2", 2);
...
function function_3590cb58()
{
	...
	while(true)
	{
		...
		if(level flag::get(#"hash_475c24f631fab267"))
		{
			...
			wait(1);
			self.var_896127a6 cschashed-3\script_e2bef0652b31f68::function_dc4ab629(-8, 1.5);
			...
			else
			{
				level flag::set(#"hash_50f159e379843d0c");
				level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_keycard_2", 0);
				level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_phase_num", 2);
				level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_handle_final", 1);
				return;
			}
		}
...
{
	var_cb24ec97 = cschashed-3\script_e2bef0652b31f68::function_9258efe1("human_infusion");
...
function function_1f269398()
{
	...
	{
		level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_4b68766a3d07f0da", 0);
	}
	...
	if(level.var_98138d6b > 1)
	{
		level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_4b68766a3d07f0da", 1);
	}
	level flag::set(#"hash_4aab4794a755ce9d");
}
...
function function_b53212e5()
{
	...
	foreach(alarm in var_408fc16d)
	{
		...
		alarm.var_29c7dbd6 playloopsound(#"evt_vault_alarm");		wait(0.05);
	}
	wait(60);
	foreach(alarm in var_408fc16d)
	{
...
function function_7c831be0(e_player)
{
	...
	if(level.var_98138d6b > 1)
	{
		level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_7809b2dff89ac8d0");
	}
}
