...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"give_reward", &function_d1de6a85, &function_9e7b3f4d);
	level.var_ee7ca64 = [];
}
...
private function function_e7254828()
{
	...
	foreach(player in getplayers())
	{
		...
		if(cschashed-1\script_3c362258ff800237::function_ba9853db() == 0)
		{
