...
#using hashed-1\zm_game_timer.gsc;
...
#namespace cschashed-1\script_3d5821d793ed4c6;
...
function function_3f8a4145(var_26f4f16d)
{
	...
	{
		var_e8cdc6a = self.var_c27f1e90[slot];
		...
		if(var_bf4e9328 && !var_d84249cb)
		{
			...
			self notify(var_e8cdc6a + "_stop", {#hash_fe7072f6:1, #hash_613b7621:!var_d84249cb});
			/#
...
function function_d37a769(var_806e2de0)
{
	...
	for(slot = 0; slot < 4; slot++)
	{
		...
		var_e8cdc6a = self.var_c27f1e90[slot];
		if(var_806e2de0.var_149ec45c[slot] || (self zm_perks::function_e56d8ef4(var_e8cdc6a) && !namespace_5f71460c::is_active(1)))
		{
			if(isdefined(var_806e2de0.var_c4193958) && isdefined(var_806e2de0.var_c4193958[slot]))
			{
				var_e8cdc6a = var_806e2de0.var_c4193958[slot];
...
/*
	...
	Flags: Linked
*/
function function_dc9ab223(var_77d3cd77 = 1, var_1d9fd2ff = 0)
{
	if(b_locked)
	{
		foreach(weapon in cschashed-2\script_709bf7c56eb65adf::function_5a5a742a("lethal_grenade"))
		{
...
function function_d0348c2c(var_69cbd99d = 0)
{
	...
	{
		if(!isdefined(level.var_87e6a031) || !self namespace_2ba51478::function_393977df("lethal_grenade", level.var_87e6a031) && (!isdefined(level.var_fefd572b) || !self cschashed-2\script_709bf7c56eb65adf::function_393977df("lethal_grenade", level.var_fefd572b)))
		{
...
function function_bf710271(var_ef2d79a9 = 1, var_88ebd569 = 1, var_fdb73f9e = 1, var_af33418e = 1, var_3bd29f5e = 1)
{
	...
	{
		if(cschashed-2\script_709bf7c56eb65adf::function_2ff6913(weapon))
		{
			continue;
		}
