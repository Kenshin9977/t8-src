...
event main(eventstruct)
{
	...
	{
		level cschashed-3\script_3487c470617b596f::init();
	}
...
function function_7c4ef26b(predictedspawn)
{
	...
	if(level.var_cd9d597c == 0)
	{
		self cschashed-3\script_3487c470617b596f::function_c9ff0dce();
		return;
	}
	if(self.team == #"allies")
	{
...
function function_9d65db70(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration)
{
	if(level.var_cd9d597c == 0)
	{
		self cschashed-3\script_3487c470617b596f::function_72ba0df6(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration);
		return;
	}
	if(self.team == #"allies")
	{
...
function function_ba542258(mode)
{
	...
	if(level.var_cd9d597c == 0)
	{
		level cschashed-3\script_3487c470617b596f::setup();
	}
	else
	{
		level.var_20361ed4 = -1;
...
function function_b89106ad(gamedifficulty)
{
	...
	if(gamedifficulty == 0)
	{
		cschashed-3\script_3487c470617b596f::function_9b9525e9();
	}
	else
	{
		function_72e84e64();
...
function setup_beacons()
{
	...
	{
		level waittill(#"beacon_destroyed");		if(level.var_8eac6c9c.size > 0)
		{
	...
	while(true)
	{
		...
		if(isdefined(var_326df4eb))
		{
			...
			if(dt >= 1.75)
			{
				...
				level notify(#"beacon_destroyed");				e_player = getplayers()[0];
