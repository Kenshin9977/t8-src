...
#namespace cschashed-3\script_12282e6b2cc91b42;
...
/*
	...
	Flags: Linked
*/
function function_928be07c(n_friendly_fire)
{
	if(isdefined(n_friendly_fire))
	{
		var_7df0eb2d = n_friendly_fire;
		level.friendlyfire = n_friendly_fire;
		setgametypesetting(#"hash_3f8f02e8109b6e93", n_friendly_fire);
		setdvar(#"ui_friendlyfire", n_friendly_fire);
	}
	else
	{
...
function function_318d417b(e_player)
{
	...
	self thread zm_perks::function_9c5d6cd6(e_player, e_player.var_62fef0f1, n_slot);
...
private function function_74b79f63()
{
	...
	if(!function_901b751c(#"zmshieldisenabled"))
	{
		...
		{
			cschashed-1\script_6d85b093d74cdfdd::function_ca244624(hash(var_b772a844));
		}
	}
