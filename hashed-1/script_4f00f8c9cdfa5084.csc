...
function init()
{
	...
	clientfield::register("scriptmover", "" + #"dynamite_explosion_fx", 24000, 1, "counter", &function_dfa13c3a, 0, 0);	clientfield::register("actor", "" + #"hash_6adfdd12c9656e1c", 24000, 1, "int", &function_ee32b1b8, 0, 0);
