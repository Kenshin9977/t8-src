...
{
	level.var_6f6736a8 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_c4da4541);
	if(isdefined(var_93a137cd))
	{
		self.var_93a137cd = cschashed-1\script_3c362258ff800237::function_5769f26a(var_93a137cd);
	}
	...
	{
		cschashed-1\script_3d5821d793ed4c6::function_c2cd0cba(level.var_6f6736a8);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(isdefined(self.var_93a137cd) && self.var_93a137cd)
	{
		if(!round_reset && level.var_41d5077e < level.var_6f6736a8)
		{
			...
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_11dba2735866a0f6");
			}
			else
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_aaf7fedbbd0fd9");
			}
		}
	...
	else
	{
		...
		if(!round_reset && var_ef7fbb73.size)
		{
			if(zm_utility::function_166646a6() === 1)
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_11dba2735866a0f6", var_ef7fbb73);
			}
			else
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_aaf7fedbbd0fd9", var_ef7fbb73);
			}
		}
	}
...
/*
	...
	Flags: Private
*/
private function function_c3996268()
{
...
/*
	...
	Flags: Private
*/
private function function_34835ec7()
{
	level endon(#"hash_7646638df88a3656", #"end_game");
	while(true)
	{
...
/*
	...
	Flags: Private
*/
private function function_a14072bf()
{
	...
	while(true)
	{
		self cschashed-1\script_3d5821d793ed4c6::function_2190356a(self.var_41d5077e);
		...
		if(self.var_41d5077e === level.var_6f6736a8)
		{
			...
			self cschashed-1\script_3d5821d793ed4c6::function_63060af4(1);
			return;
		}
	}
}
...
/*
	...
	Flags: Private
*/
private function function_c33c2895()
{
	level endon(#"hash_7646638df88a3656");
	cschashed-1\script_3d5821d793ed4c6::function_2976fa44(level.var_6f6736a8);
	while(true)
	{
		cschashed-1\script_3d5821d793ed4c6::function_dace284(level.var_41d5077e);
