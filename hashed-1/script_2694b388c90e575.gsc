...
#namespace cschashed-1\script_5e109f38777fc309;
...
{
	system::register(#"hash_69bcbdf2d5bc14d5", &__init__, &__main__, undefined);
}
...
function __init__()
{
	...
	weaponobjects::function_e6400478(#"hash_23882a5729dceca", &function_38eaed4c, 0);
	weaponobjects::function_e6400478(#"hash_1b5092cccdb3d65b", &function_38eaed4c, 0);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_716657b9842cfd1b", 0.6, 1);
	if(!isdefined(level.var_214f6204))
	{
		object = new throttle();
		[[ object ]]->__constructor();
		level.var_214f6204 = object;
...
function function_efefda46(willbekilled, einflictor, eattacker, idamage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	var_3845b34a = getweapon(#"hash_23882a5729dceca");
	var_474adcfd = getweapon(#"hash_1b5092cccdb3d65b");
	...
	if(weapon == var_4f57eb04 || weapon == var_ab3c01bc)
	{
...
*/
private function function_eaa9c593()
{
	...
	while(true)
	{
		...
		if(wpn_cur == getweapon(#"hash_25a13b6f6232a985") || wpn_cur == getweapon(#"hash_4c157b1aeefae09e"))
		{
			self thread function_d72c4a61();
		}
		else if(wpn_prev == getweapon(#"hash_25a13b6f6232a985") || wpn_prev == getweapon(#"hash_4c157b1aeefae09e"))
		{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d72c4a61()
{
	self notify(#"hash_20e403096a8af3b7");
	...
	while(true)
	{
		...
		if(s_result.weapon == getweapon(#"hash_25a13b6f6232a985") || s_result.weapon == getweapon(#"hash_4c157b1aeefae09e"))
		{
...
function wait_for_grenade_explode(n_fuse_timer, ai_target, e_attacker)
{
	...
	if(isdefined(ai_target))
	{
		...
		else if(isdefined(level.no_gib_in_wolf_area) && (isdefined(ai_target [[level.no_gib_in_wolf_area]]()) && ai_target [[level.no_gib_in_wolf_area]]()))
		{
			ai_target.no_gib = 1;
		}
...
function function_482c54d5(watcher, owner)
{
	...
	s_result = undefined;
	s_result = self waittill_timeout(5, #"stationary", #"hash_14fd7b6a20ac8f44");
	waitframe(1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_bf2a4486(var_f846fec1, owner, weapon)
{
	self delete();
	...
	var_f846fec1 waittill_timeout(5, #"hash_39da21c99d3cf743");
...
/*
	...
	Flags: Linked, Private
*/
private function function_7b25328b(e_player)
{
	...
	if(isdefined(w_current) && (w_current === getweapon(#"hash_1b5092cccdb3d65b") || w_current === getweapon(#"hash_4c157b1aeefae09e")))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_aa1b44dc(e_grenade)
{
	self endon(#"death");
	e_grenade endon(#"death");
	s_result = undefined;
	s_result = self waittill_timeout(5, #"grenade_stuck");
...
/*
	...
	Flags: Linked, Private
*/
private function function_5f305489(var_f846fec1)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c74dfed4(weapon)
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_19b9fb04()
{
...
function function_89bde454(weapon)
{
	var_e97d8c2c = getweapon(#"hash_617dcc39334959ce");
	var_4f57eb04 = getweapon(#"hash_19c157f2230454ad");
	var_44dea58e = getweapon(#"hash_cb1cdb5b47f0226");
	var_25836e3e = getweapon(#"hash_25a13b6f6232a985");
	var_e6343dc3 = getweapon(#"hash_4c157b1aeefae09e");
	var_3845b34a = getweapon(#"hash_23882a5729dceca");
	var_5749016f = getweapon(#"hash_1b5092cccdb3d65b");
	var_e30eba14 = array(var_e97d8c2c, var_4f57eb04, var_44dea58e, var_25836e3e, var_e6343dc3, var_3845b34a, var_5749016f);
	if(isinarray(var_e30eba14, weapon))
	{
		foreach(var_4f57eb04 in var_e30eba14)
		{
			if(self hasweapon(var_4f57eb04, 1))
			{
				return var_4f57eb04;
			}
		}
...
function function_bd27d397(oldweapondata, newweapondata)
{
	...
	var_3845b34a = getweapon(#"hash_23882a5729dceca");
	var_5749016f = getweapon(#"hash_1b5092cccdb3d65b");
	if(oldweapondata[#"weapon"] === var_e97d8c2c || oldweapondata[#"weapon"] === var_4f57eb04 || oldweapondata[#"weapon"] === var_44dea58e || oldweapondata[#"weapon"] === var_25836e3e || oldweapondata[#"weapon"] === var_e6343dc3 || oldweapondata[#"weapon"] === var_3845b34a || oldweapondata[#"weapon"] === var_5749016f && (newweapondata[#"weapon"] === var_e97d8c2c || newweapondata[#"weapon"] === var_4f57eb04 || newweapondata[#"weapon"] === var_44dea58e || newweapondata[#"weapon"] === var_25836e3e || newweapondata[#"weapon"] === var_e6343dc3 || newweapondata[#"weapon"] === var_3845b34a || newweapondata[#"weapon"] === var_5749016f))
	{
		weapondata = [];
		...
		else if(oldweapondata[#"weapon"] === var_e6343dc3 || newweapondata[#"weapon"] === var_e6343dc3)
		{
			weapondata[#"weapon"] = var_e6343dc3;
		}
		else if(oldweapondata[#"weapon"] === var_3845b34a || newweapondata[#"weapon"] === var_3845b34a)
		{
			weapondata[#"weapon"] = var_3845b34a;
		}
		else if(oldweapondata[#"weapon"] === var_25836e3e || newweapondata[#"weapon"] === var_25836e3e)
		{
			weapondata[#"weapon"] = var_25836e3e;
		}
		else if(oldweapondata[#"weapon"] === var_44dea58e || newweapondata[#"weapon"] === var_44dea58e)
		{
		...
		{
			weapondata[#"weapon"] = var_4f57eb04;
		}
...
/*
	...
	Flags: Linked, Private
*/
private function function_b1abe6ab(t_damage, weapon)
{
	self endon(#"disconnect");
...
/*
	...
	Flags: Linked, Private
*/
private function function_209c8c45(eattacker, weapon)
{
	v_pos = self.origin;
...
/*
	...
	Flags: Linked, Private
*/
private function function_dc3470c5(shitloc, vpoint, eattacker, weapon)
{
	self endon(#"death");
	wait(0.5);
	if(self.var_6f84b820 == #"miniboss" || self.var_6f84b820 == #"boss")
...
/*
	...
	Flags: Linked, Private
*/
private function function_78f754f7(eattacker, weapon)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_ba9e077b(eattacker, v_hit_pos, n_damage, weapon)
{
	self endon(#"death");
	self.var_d3bcc6f9 = 1;
...
/*
	...
	Flags: Linked, Private
*/
private function function_6901bb20(v_hit_pos)
{
	self endon(#"death");
	if(isdefined(self.var_cde645df) && self.var_cde645df)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_faa2e2e5(eattacker, weapon)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_20905835()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_7f95d262(eattacker, weapon)
{
	self endon(#"death");
	if(self.var_6f84b820 !== #"basic" && self.var_6f84b820 !== #"enhanced")
	{
	...
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_716657b9842cfd1b");
		wait(1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_c95282e3()
{
...
function function_e33adfe0(player)
{
	...
	if(!level flag::get(#"hash_634424410f574c1c"))
	{
		...
		if(player hasweapon(getweapon(#"hash_cb1cdb5b47f0226")))
		{
			if(function_8b1a219a())
			{
		...
		if(player hasweapon(getweapon(#"hash_23882a5729dceca")))
		{
			if(function_8b1a219a())
			{
		...
		if(player hasweapon(getweapon(#"hash_1b5092cccdb3d65b")))
		{
			if(function_8b1a219a())
			{
...
function function_b1347a6()
{
	...
	while(true)
	{
		...
		if(!level flag::get(#"hash_72c4671390c83158") && !level flag::get(#"hash_634424410f574c1c"))
		{
			...
			else if(e_player hasweapon(getweapon(#"hash_23882a5729dceca")))
			{
				var_fc074136 = #"hash_23882a5729dceca";
				var_87cbf0eb = 0;
				var_da887cb9 = getweapon(#"hash_23882a5729dceca");
			}
			else if(e_player hasweapon(getweapon(#"hash_1b5092cccdb3d65b")))
			{
				var_fc074136 = #"hash_1b5092cccdb3d65b";
				var_87cbf0eb = 1;
				var_da887cb9 = getweapon(#"hash_1b5092cccdb3d65b");
			}
		...
		{
			if(zm_utility::is_player_valid(e_player) && !e_player zm_utility::is_drinking() && !cschashed-2\script_709bf7c56eb65adf::is_placeable_mine(e_player.currentweapon) && !zm_equipment::is_equipment(e_player.currentweapon) && e_player.currentweapon.name != "none")
			{
				...
				if(e_player hasweapon(getweapon(#"hash_25a13b6f6232a985")))
				{
					e_player givemaxammo(getweapon(#"hash_25a13b6f6232a985"));
				}
				else if(e_player hasweapon(getweapon(#"hash_4c157b1aeefae09e")))
				{
					e_player givemaxammo(getweapon(#"hash_4c157b1aeefae09e"));
				}
				else if(isdefined(var_13202c94.worldgun))
				{
					var_f2fae71a = var_13202c94.worldgun.item;
				}
				else
				{
					var_f2fae71a = getweapon(#"hash_25a13b6f6232a985");
				}
				e_player giveweapon(var_f2fae71a);
				e_player switchtoweapon(var_f2fae71a);
				if(isdefined(e_player.register06_dust_))
				{
					e_player setweaponammostock(var_f2fae71a, math::clamp(e_player.var_452feb6c, 0, var_f2fae71a.maxammo));
					e_player.register06_dust_ = undefined;
				}
...
function blundergat_upgrade_station_inject(var_f2528cbc, e_player)
{
	...
	if(var_f2528cbc == #"hash_19c157f2230454ad" || var_f2528cbc == #"hash_23882a5729dceca")
	{
		self.worldgun = zm_utility::spawn_weapon_model(getweapon(#"hash_25a13b6f6232a985"), undefined, self.v_weapon_origin, self.v_weapon_angles);
	}
	else
	{
