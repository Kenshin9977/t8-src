...
#namespace cschashed-1\script_4a4eacd716becef3;
...
function __init__()
{
	...
	level.var_c9d375dc.is_upgraded_zhield_zword = getweapon(#"hash_upgraded_zhield_zword");
	level.var_70f7eb75 = level.var_c9d375dc.is_upgraded_zhield_zword;
	...
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_237b6756a81881cb", 100, 5);
...
function function_65a59ce0(w_current, var_5738ae72 = 0)
{
	if(var_5738ae72)
	{
		if(w_current == level.var_c9d375dc.is_upgraded_zhield_zword)
		{
			return 1;
		}
	...
	if(w_current == level.var_c9d375dc.melee_weapon || w_current == level.var_c9d375dc.is_upgraded_zhield_zword)
	{
		return 1;
	}
...
{
	var_710873d9 = getweapon(#"hash_upgraded_zhield_zword");
	if(!player hasweapon(var_710873d9) && (isdefined(player.var_5ba94c1e) && player.var_5ba94c1e))
	{
		...
		self.cost = self cschashed-1\script_6d85b093d74cdfdd::function_ceac3bf9(player);
	}
	...
	else if(player hasweapon(var_710873d9))
	{
		...
		{
			self.cost = self cschashed-1\script_6d85b093d74cdfdd::function_ceac3bf9(player, 1);
...
function function_22d79d55(player)
{
	...
	if(player cschashed-1\script_6d85b093d74cdfdd::function_2d53738e(var_710873d9))
	{
	...
	{
		var_f66d1847 = self.stub cschashed-1\script_6d85b093d74cdfdd::function_ceac3bf9(player, 1);
		if(isdefined(var_f66d1847) && var_f66d1847 > 0)
		{
			if(player zm_score::can_player_purchase(var_f66d1847))
			{
				player thread cschashed-1\script_6d85b093d74cdfdd::function_fccf9f0d();
	...
	{
		var_f66d1847 = self.stub cschashed-1\script_6d85b093d74cdfdd::function_ceac3bf9(player);
		if(isdefined(var_f66d1847) && var_f66d1847 > 0)
		{
			if(player zm_score::can_player_purchase(var_f66d1847))
			{
...
function function_2a9a30bb(death, inflictor, attacker, damage, flags, mod, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	if(!(isdefined(attacker.var_c9d375dc.var_276d45bf) && attacker.var_c9d375dc.b_charged))
	{
		return;
	}
	...
	self cschashed-3\script_d67878983e3d7c::burn(#"hash_237b6756a81881cb", attacker, weapon, var_bb6709b6);
...
function function_646d73c3()
{
	...
	var_6e14b651 thread function_693527ec(#"katar");
...
function function_4e59dd4b()
{
	...
	while(true)
	{
		...
		{
			if(isdefined(self.something))
			{
				if(!isdefined(self.something))
				{
					self.something = [];
				}
				else if(!isarray(self.something))
				{
					self.something = array(self.something);
				}
				if(!isinarray(self.something, ai_killed.entity_type))
				{
					self.something[self.something.size] = ai_killed.entity_type;
				}
				if(self.something.size >= 4)
				{
					self flag::set(#"hash_1d380d2c916018c9");
				}
			}
...
function function_a11cc995(s_params)
{
	...
	if(function_ed81d8f5(s_params.weapon) && e_attacker.var_c9d375dc.b_charged)
	{
		if(isdefined(e_attacker.var_2f4d7df0))
		{
			...
			if(!isinarray(e_attacker.var_2f4d7df0, self.entity_type))
			{
				e_attacker.var_2f4d7df0[e_attacker.var_2f4d7df0.size] = self.entity_type;
			}
