...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_7bbed35c8208ca10", &function_d1de6a85, &function_9e7b3f4d);
}
...
*/
private function function_d1de6a85(var_66fe7443, var_ec90b685)
{
	if(isdefined(var_ec90b685))
	{
		self.var_ec90b685 = 1;
		callback::on_ai_killed(&function_8e0401ab);
		level.var_a58dc99e = cschashed-1\script_3c362258ff800237::function_5769f26a(var_66fe7443);
	}
	else
	{
		var_620e7dea = cschashed-1\script_3c362258ff800237::function_5769f26a(var_66fe7443) / 100;
...
{
	s_challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_7bbed35c8208ca10");
	if(var_a32bbdd)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_8e0401ab(params)
{
