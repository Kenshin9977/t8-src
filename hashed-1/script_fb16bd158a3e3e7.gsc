...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_576586e9331e76d2", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d805557c(weapon)
{
	...
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_576586e9331e76d2");
...
private function function_e14e7b75(weapon)
{
	...
	if(var_9caacad5 || var_b3340a9)
	{
		...
		{
			self cschashed-1\script_3d5821d793ed4c6::function_88805385(1);
		}
	}
	if(isdefined(weapon.isheroweapon) && weapon.isheroweapon && var_9caacad5 && var_b3340a9)
	{
		self cschashed-1\script_3d5821d793ed4c6::function_9bf8e274();
	}
}
...
private function function_d1de6a85(var_e097dc07, var_f5300808)
{
	...
	{
		var_f5300808 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_f5300808);
	}
	...
	switch(var_e097dc07)
	{
		...
		case "melee":
		{
			...
			level cschashed-1\script_3c362258ff800237::function_cdcce681(1);
			break;
		}
		case "bowie_knife":
		{
...
private function function_9e7b3f4d(round_reset)
{
	...
	foreach(player in getplayers())
	{
		foreach(weapon in player getweaponslist(1))
		{
			...
			if(cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(weapon))
			{
				player cschashed-1\script_3d5821d793ed4c6::function_88805385(0);
			}
		}
...
function function_f0e03d3(var_f5300808)
{
	...
	self thread function_6a8979c9();
	self cschashed-1\script_3d5821d793ed4c6::function_7dbb1712(1);
}
...
{
	s_challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_576586e9331e76d2");
