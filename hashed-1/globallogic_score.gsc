...
private function function_b78294bf(victim, weapon, attackerweapon, var_67660cb2, time, meansofdeath)
{
	...
	{
		if(!isdefined(var_67660cb2.var_6d794427) || ![[var_67660cb2.kill_callback]](self, victim, weapon, attackerweapon, meansofdeath))
		{
			return;
		}
	}
...
function function_5829abe3(attacker, weapon, var_651b6171)
{
	...
	{
		attacker cschashed-2\script_158d50d476435605::function_896ac347(weapon, #"showstopper", 1);
	}
	scoreevents = function_3cbc4c6c(weapon.var_2e4a8800);
...
function function_a458dbe1(var_b03e560d, callback)
{
	...
	level.var_f19c99e1[var_b03e560d].kill_callback = callback;
}
