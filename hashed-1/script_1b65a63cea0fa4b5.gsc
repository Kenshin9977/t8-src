...
function __init__()
{
	...
	bgb::register(#"hash_a303f67afd6f4a8", "activated", 1, undefined, undefined, &validation, &activation);
	bgb::function_72469efe(#"hash_a303f67afd6f4a8", 1);
	bgb::function_8a5d8cfb(#"hash_a303f67afd6f4a8", 1);
	bgb::function_1fee6b3(#"hash_a303f67afd6f4a8", 15);
...
function activation()
{
	...
	wait(0.2);
	self val::reset(#"hash_a303f67afd6f4a8", "freezecontrols");
...
function get_best_spawnpoint(e_player)
{
	...
	foreach(var_e15a68a8 in level.zones[var_8666ff27].a_loc_types[#"wait_location"])
	{
		if(zm_utility::check_point_in_enabled_zone(var_e15a68a8.origin, 1))
		{
			...
			var_65500f70[var_65500f70.size] = var_e15a68a8;
			if(!isdefined(var_ed38ae06))
			{
				var_ed38ae06 = [];
			}
	...
	{
		var_65500f70 = [[level.var_eeb98313]](var_65500f70);
	}
