...
function __init__()
{
	...
	clientfield::register("allplayers", "" + #"hash_58757f4a64fedf21", 1, 2, "int", &function_8a2b203b, 0, 1);
	...
	level._effect[#"hash_1bc13dc98b3bbcc2"] = #"hash_2d151fbde925d3e";
	level._effect[#"hash_5a722d93fee71051"] = #"hash_7a37d99aaa7057cf";
	level._effect[#"hash_14c97eee2542c63e"] = #"hash_5a45cca38c2dd6c8";
	level._effect[#"hash_14c272ee253c932c"] = #"hash_5a4cd8a38c3409da";
...
function function_618e1db4(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	{
		var_27aa6343 = level._effect[#"hash_14c97eee2542c63e"];
		var_a1f103c8 = level._effect[#"hash_14c272ee253c932c"];
	}
	if(zm_utility::function_f8796df3(localclientnum))
	{
		if(viewmodelhastag(localclientnum, "tag_barrels_fx"))
		{
			self.var_ba9dc1e7 = playviewmodelfx(localclientnum, var_27aa6343, "tag_barrels_fx");
		}
	}
	else
	{
		self.var_ba9dc1e7 = util::playfxontag(localclientnum, var_a1f103c8, self, "tag_barrels_fx");
	}
}
...
function function_467afa20(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(newval)
	{
		if(zm_utility::function_f8796df3(localclientnum))
		{
			...
			{
				self.var_16956fb5 = playviewmodelfx(localclientnum, var_a3229167, "tag_blade_fx");
			}
		}
		else
		{
			...
			self.var_16956fb5 = util::playfxontag(localclientnum, var_2f34467b, self, "tag_blade_fx");
		}
	}
...
function function_8a2b203b(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(zm_utility::function_f8796df3(localclientnum))
	{
		...
		{
			self.var_bf403388[#"hash_178410fd941062ac"] = playviewmodelfx(localclientnum, var_43a627a8, "tag_blade_fx");
		}
		...
		{
			self.var_bf403388[#"r"] = playviewmodelfx(localclientnum, var_2b01a8ab, "tag_gem_right3_fx");
			self.var_bf403388[#"l"] = playviewmodelfx(localclientnum, var_2b01a8ab, "tag_gem_left3_fx");
		}
	}
	else if(isdefined(var_c10d7c76))
	{
		self.var_bf403388[#"hash_178b1cfd941695be"] = util::playfxontag(localclientnum, var_c10d7c76, self, "tag_blade_fx");
		if(var_515e20e6)
		{
		...
		{
			self.var_d16b03db = util::playfxontag(localclientnum, level._effect[#"hash_1bc13dc98b3bbcc2"], self, "tag_barrels_fx");
		}
	}
}
