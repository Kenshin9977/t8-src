...
function function_41827934(arc_source, arc_target)
{
	...
	if(isdefined(arc_source))
	{
		if(!isdefined(arc_source.45c9a4f55b11e032_entrance_))
		{
			arc_source.45c9a4f55b11e032_entrance_ = [];
		}
		arc_source.45c9a4f55b11e032_entrance_[arc_source.45c9a4f55b11e032_entrance_.size] = arc_target;
	}
}
...
{
	if(isdefined(self.45c9a4f55b11e032_entrance_))
	{
		foreach(target in self.45c9a4f55b11e032_entrance_)
		{
