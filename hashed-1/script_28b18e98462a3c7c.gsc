...
#namespace cschashed-1\script_4c9e3a985ae04008;
...
function function_24167ed8()
{
	...
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"hash_33a1f55aa9d0ac8e", &function_5702b2e7);
}
...
function function_5702b2e7(e_player)
{
	...
	if(var_4b912983.blueprint.name == #"hash_ef185e110c83ded")
	{
		...
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_whiteteleporter_phase_num", 1);
	}
	else
	{
...
function function_e0a8fc52()
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("teleporter_pad_1", 1);
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("teleporter_pad_2", 1);
...
function function_a09d62f1()
{
	...
	while(true)
	{
		...
		if(level.var_868c98df > 0 && !self.b_placed)
		{
			...
			{
				e_user thread cschashed-3\script_e2bef0652b31f68::function_51b752a9(#"hash_7832a05d73569401");
			}
			level.var_868c98df--;
			self.b_active = 1;
			self.b_placed = 1;
		...
		switch(level.var_868c98df)
		{
			case 0:
			{
				cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("teleporter_pad_1", 0);
				cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("teleporter_pad_2", 0);
				break;
			}
			case 1:
			{
