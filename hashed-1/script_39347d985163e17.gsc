...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_27f8093e2c3d8f82", &function_d1de6a85, &function_9e7b3f4d);
}
...
{
	var_264ee2f5 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_264ee2f5);
...
private function function_9e7b3f4d(round_reset)
{
	...
	{
		player cschashed-1\script_3d5821d793ed4c6::function_dc0859e();
		if(!round_reset)
		{
...
private function function_68af83a9(s_event)
{
	...
	if(!cschashed-2\script_709bf7c56eb65adf::function_2ff6913(w_root) && isarray(level.var_388587c6) && !isinarray(level.var_388587c6, w_root.name))
	{
...
function function_cec06121(var_264ee2f5)
{
	...
	foreach(player in getplayers())
	{
		player cschashed-1\script_3d5821d793ed4c6::function_bf710271();
	}
...
function is_active()
{
	s_challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_27f8093e2c3d8f82");
