...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_10949a7065d076ef", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(n_max_zombies, var_2ec39966, str_zone1, str_zone2, var_588808b1, var_91e2fb66, var_84245fe9, var_a7a5a6ef)
{
	...
	{
		n_max_zombies = cschashed-1\script_3c362258ff800237::function_5769f26a(n_max_zombies);
	}
	wait(5);
...
private function function_65e6d40c(a_str_zones, n_max_zombies = 0)
{
	...
	while(true)
	{
		...
		foreach(ai in a_ai_enemies)
		{
			...
			if(n_max_zombies > 0)
			{
				cschashed-1\script_3d5821d793ed4c6::function_dace284(var_d1d851f3, 1);
				cschashed-1\script_3d5821d793ed4c6::function_2976fa44(n_max_zombies + 1);
			}
			if(var_d1d851f3 > n_max_zombies)
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_622e72c9731cca58");
				return;
			}
		}
		wait(0.5);
