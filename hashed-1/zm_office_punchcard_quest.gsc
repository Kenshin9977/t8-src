...
#namespace cschashed-2\script_62e2e15ec08cf4e2;
...
function function_88d1bd71()
{
	...
	level.var_9c56a77 = struct::get("fix_server_spark_fx", "targetname");
	...
	registerrobot_name_3sprintservice = array(#"hash_cfe3836bc9ca39", #"hash_4b18b104deb5d028");
	...
	level.var_5a599dbf[2] = {#vo_line:registerrobot_name_3sprintservice, #hash_85f707f6:0};
	...
	level.var_a035a0b9 = cschashed-3\script_e2bef0652b31f68::function_bffcedde("office_punch_card", "targetname", "script_int");
...
function function_bdadef61(var_5ea5c94d)
{
	if(!var_5ea5c94d)
	{
		...
		var_1ba68ef8 = struct::get("server_part_pickup");
		var_1ba68ef8 zm_unitrigger::create(#"", 64, &function_8703c1fe);
		level flag::wait_till(#"hash_4c30d0428f1d4060");
		var_185199a1 = getent(var_1ba68ef8.target, "targetname");
		var_185199a1 playsound(#"hash_18f957b8000dd0c6");
		var_185199a1 delete();
		zm_unitrigger::unregister_unitrigger(var_1ba68ef8.s_unitrigger);
		var_1ba68ef8 struct::delete();
...
function function_e8d6a81b(var_2e1f34dd)
{
	...
	self thread namespace_891c9bac::function_a2bd5a0c(#"hash_7e030fccc2c5a121");
...
function function_54db89ef()
{
	...
	while(true)
	{
		self waittill(#"play_audio");		if(isdefined(level.var_fcbb6a6b))
		{
			var_fda22235 = level.var_fcbb6a6b;
			self.in_use = 1;
			var_fda22235.var_85f707f6 = 0;
			function_2f5993d6();
			level thread function_9f206255();
			level flag::wait_till("card_inserted");
			cschashed-3\script_e2bef0652b31f68::function_52c3fe8d(var_fda22235.vo_line, level.var_a73534b7.origin);
