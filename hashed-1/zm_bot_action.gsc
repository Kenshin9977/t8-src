...
function function_66dacac1()
{
	...
	bot_action::register_action(#"zombie_auto_revive", &bot_action::rank_priority, &function_f4707540, &zombie_auto_revive);	bot_action::register_action(#"zombie_reload_weapon", &bot_action::current_weapon_rank, &bot_action::reload_weapon_weight, &zombie_reload_weapon);	bot_action::register_action(#"zombie_revive_player", &bot_action::rank_priority, &function_296516b4, &bot_action::revive_player);	bot_action::register_action(#"hash_501bf349716d3a07", &bot_action::function_728212e8, &bot_action::scan_for_threats_weight, &function_3061f67f);
}
...
/*
	...
	Flags: Linked
*/
function function_213b8261(var_b594a2cd)
{
...
/*
	...
	Flags: Linked
*/
function function_180db145(var_b594a2cd)
{
