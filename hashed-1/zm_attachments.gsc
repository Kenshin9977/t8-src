...
function __init__()
{
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_72a155025f3da562", 100, 3);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_1c9af7bb427952d", 0.85, 1);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_1d07249a2211a81d", 0.9, 1);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_721bfbe781c0d680", 0.95, 1);
}
...
function function_9f8d8c38()
{
	if(isdefined(self.var_6f84b820))
	{
		...
		{
			self thread cschashed-3\script_d67878983e3d7c::slowdown(var_3e5502b5);
		}
	}
}
...
function dragons_breath(e_attacker, n_damage, weapon)
{
	...
	if(self.archetype === #"zombie")
	{
		...
		{
			self cschashed-3\script_d67878983e3d7c::burn(#"hash_72a155025f3da562", e_attacker, weapon);
		}
		else
		{
			self.var_b364c165 = 1;
