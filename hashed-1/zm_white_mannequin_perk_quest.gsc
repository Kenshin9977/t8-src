...
#namespace cschashed-1\script_3eb41f1152506dc6;
...
function init()
{
	namespace_c3287616::register_archetype(#"mannequin", &function_f3cef15a, &function_b2e030f, &function_293e9585, 5);
...
function function_5b685950()
{
	...
	var_e0cfcdd = self.weapon.name === #"galvaknuckles_t8";
	return var_8ce4094 && !var_e0cfcdd;
}
...
function function_6e0162e8()
{
	...
	var_e0cfcdd = self.mod === "MOD_MELEE";
	return var_8ce4094 && !var_e0cfcdd;
}
...
function function_663fd427()
{
	...
	var_e0cfcdd = self function_7b33625a();
	return var_8ce4094 && !var_e0cfcdd;
}
...
function function_8d3f2364(waitresult)
{
	...
	if(level.var_e80139f === 0)
	{
		if(waitresult.mod === "MOD_MELEE")
		{
			...
			{
				level.var_e80139f = 3;
				zm_sq::start(#"hash_3eeb31180b204955");
				/#
					if(getdvarint(#"hash_11ad6a9695943217", 0))
					{
						if(getdvarint(#"hash_11ad6a9695943217", 0))
			...
			{
				level.var_e80139f = 2;
				zm_sq::start(#"hash_1e9936918d3e7bdd");
				/#
					if(getdvarint(#"hash_11ad6a9695943217", 0))
					{
						if(getdvarint(#"hash_11ad6a9695943217", 0))
		...
		{
			level.var_e80139f = 1;
			zm_sq::start(#"hash_104f80e15d623b58");
			/#
				if(getdvarint(#"hash_11ad6a9695943217", 0))
				{
					if(getdvarint(#"hash_11ad6a9695943217", 0))
	...
	else if(!level.var_e80139f == 4)
	{
		if(waitresult function_5b685950() || waitresult function_6e0162e8() || waitresult function_663fd427())
		{
			...
			zm_sq::start(#"hash_638821b038a894ea");
			level.var_e80139f = 4;
...
function function_edcadf04()
{
	...
	self endon(#"death");
	e_head = self;
	if(zm_utility::can_enable_ee() || level flag::get(#"hash_502f2e83a538c679"))
	{
...
function function_6e678915()
{
	...
	while(isdefined(self))
	{
		...
		while(!b_player_in_range)
		{
			...
			player = cschashed-3\script_e2bef0652b31f68::function_3815943c();
			if(isdefined(player))
			{
...
function function_800ff39e()
{
	...
	level.var_57ce903d notify(#"follow_complete");	level.var_5f4eaf85.var_3d366381 = undefined;
...
{
	self endon_callback(&function_33e0a5d1, #"death");
	while(true)
	{
...
{
	self endon(#"follow_complete");	level endon(#"hash_366807a48fc105bb");
	while(true)
	{
