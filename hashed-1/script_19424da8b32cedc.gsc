...
#namespace cschashed-3\script_2580d0da9fe8d268;
...
private function gladiatortargetservice(entity)
{
	...
	if(entity.entity_type == #"gladiator_marauder" && (!(isdefined(entity.var_4f1b8d2b) && entity.var_4f1b8d2b)))
	{
		entity.favoriteenemy = entity.var_93a62fe;
	}
	else if(entity.entity_type == #"gladiator_destroyer")
	{
		entity.favoriteenemy = entity.var_93a62fe;
	}
	...
	if(!(isdefined(entity.hasseenfavoriteenemy) && entity.hasseenfavoriteenemy))
	{
		if(entity cansee(entity.favoriteenemy) || isdefined(entity.var_cb89528d))
		{
			...
			if(entity.entity_type == #"gladiator_destroyer")
			{
			...
			if(entity.entity_type == #"gladiator_marauder")
			{
...
private function function_edd0777f(entity)
{
	...
	if(cschashed-1\script_5a012bbb9342dbdf::function_54054394(entity))
	{
		return 0;
	}
...
function function_13f886a2(entity)
{
	...
	if(self.entity_type == #"gladiator_marauder")
	{
	...
	else if(self.entity_type == #"gladiator_destroyer")
	{
		z_diff = abs(entity.origin[2] - entity.favoriteenemy.origin[2]);
		var_4ea3ded6 = 48;
		if(isdefined(entity.favoriteenemy.zone_name) && entity.favoriteenemy.zone_name == #"zone_starting_area_center")
...
function function_61e7d5f5(entity)
{
	...
	if(self.entity_type != #"gladiator_destroyer")
	{
		return 0;
	}
	if(self.var_d9b1cc0e && self.var_4e00bc1)
...
private function function_caed4d61()
{
	...
	else if(self.entity_type == #"gladiator_marauder")
	{
...
private function function_75f32da6(inflictor, attacker, damage, idflags, meansofdeath, weapon, point, dir, hitloc, offsettime, boneindex, modelindex)
{
	...
	if(isdefined(attacker) && isplayer(attacker) && self.entity_type == #"gladiator_marauder" && !isdefined(self.var_4f1b8d2b) && isdefined(zm_zonemgr::function_54fc7938(attacker, self)))
	{
	...
	var_ae30c5b0 = 0;
	if(isdefined(weapon) && (cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon) || (isdefined(weapon.ignorespowerarmor) && weapon.ignorespowerarmor)))
	{
		var_ae30c5b0 = 1;
	}
	var_786d7e06 = cschashed-1\script_5a012bbb9342dbdf::function_422fdfd4(self, attacker, weapon, boneindex, hitloc, point);
...
private function function_3b8907b9(s_params)
{
	...
	self val::set(#"gladiator_death", "takedamage", 0);	if(isdefined(self.axe_model))
	{
...
function function_831dd6bd()
{
	...
	if(shouldrepath)
	{
		...
		{
			goalent = cschashed-1\script_5a012bbb9342dbdf::function_a2e8fd7b(self, self.favoriteenemy);
