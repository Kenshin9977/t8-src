...
#namespace cschashed-3\script_520360b6c44baa8b;
...
function main()
{
	...
	level.var_2481807a = struct::get_array("s_float_path", "script_noteworthy");
...
function function_ea0c7ed8()
{
	...
	self endon(#"death", #"player_frozen");	while(true)
	{
		foreach(e_water in level.a_e_water)
		{
...
{
	level endon(#"end_game");
	self endon(#"death", #"player_frozen");	self.b_in_water = 1;
...
{
	level endon(#"end_game");
	self endon(#"death", #"player_frozen");	self.b_in_water = 0;
...
function water_player_freeze()
{
	...
	self.var_7dc2d507 = 1;
	self notify(#"player_frozen");	self namespace_565e073b::function_3931c78();
...
function function_46c3bbf7()
{
	...
	{
		self cschashed-2\script_29ccb18ac19d72ef::function_b4bd25ef();
	}
	else
	{
...
function function_34e1762b()
{
	...
	self.var_7dc2d507 = 1;
	self notify(#"player_frozen");	self function_e22d95bc();
	self clientfield::set("" + #"hash_55543319943057f1", 1);
	self clientfield::set_to_player("" + #"hash_5160727729fd57a2", 1);
...
{
	self endon_callback(&function_26234f4c, #"disconnect");
	self val::set(#"fasttravel", "freezecontrols", 1);	self val::set(#"fasttravel", "ignoreme", 1);	if(!self laststand::player_is_in_laststand())
	{
...
function function_d793c8ff()
{
	...
	self val::set(#"fasttravel", "freezecontrols", 0);	self val::set(#"fasttravel", "takedamage", 1);	self val::set(#"fasttravel", "ignoreme", 0);	self unlink();
	if(isdefined(self.e_tag))
	{
		self.e_tag delete();
	}
