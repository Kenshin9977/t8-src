...
function function_8dec32e2()
{
	...
	namespace_3fffba66::function_cfca77a7(var_e9b0099b, #"hash_9ecf8085fb7a68f", &cschashed-3\script_7114102541e1f8c8::function_39212989, 10, undefined, undefined, "aib_vign_zm_zod_bltfthr_spawn_pre_split", "aib_vign_zm_zod_bltfthr_spawn_post_split");
	var_c1da220b = getent("zombie_spawn_1", "script_string");
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_7c89b1397a38e3ad", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_corrosive_spawn_pre_split", "aib_vign_zm_zod_catalyst_corrosive_spawn_post_split");
	var_c1da220b = getent("zombie_spawn_2", "script_string");
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_7c89ae397a38de94", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_water_spawn_pre_split", "aib_vign_zm_zod_catalyst_water_spawn_post_split");
	var_c1da220b = getent("zombie_spawn_3", "script_string");
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_7c89af397a38e047", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_electric_spawn_pre_split", "aib_vign_zm_zod_catalyst_electric_spawn_post_split");
	var_c1da220b = getent("zombie_spawn_4", "script_string");
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_7c89ac397a38db2e", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_plasma_spawn_pre_split", "aib_vign_zm_zod_catalyst_plasma_spawn_post_split");
}
...
function function_51e51897(var_5ea5c94d)
{
	...
	level cschashed-2\script_52ab76d6216ed2cc::function_77a859a8(1);
...
function boss_teleport_players(str_loc)
{
	...
	level cschashed-2\script_52ab76d6216ed2cc::function_43a16eb7(str_loc, struct::get(#"boss_fight"));
}
...
function function_482a7a01()
{
	...
	level cschashed-2\script_52ab76d6216ed2cc::function_77a859a8(1, 0, 0);
}
...
/*
	...
	Flags: Linked
*/
function function_c8f90603(var_da816ebe, b_solid)
{
	...
	else
	{
		foreach(e_blocker in a_blockers)
		{
			...
			if(isdefined(e_blocker.var_c2a873f6))
			{
				...
				{
					mdl_fx thread cschashed-2\script_52ab76d6216ed2cc::function_73145dbe();
...
function function_8f3497ee(n_stage, str_loc)
{
	...
	level.powerup_vo_available = &cschashed-2\script_52ab76d6216ed2cc::return_false;
	switch(n_stage)
	{
		case 1:
		{
			...
			level thread cschashed-2\script_52ab76d6216ed2cc::function_53802e89(#"hash_696f2e5fafff5614", undefined, array(2, 1, 4, 3));
			wait(1.5);
...
function function_1122d832(var_d503d5d9, str_loc, n_stage)
{
	...
	level thread function_f74b38da("zm_power_on_rumble");
	level thread cschashed-2\script_52ab76d6216ed2cc::function_63a0f09e(1, 0);
	wait(0.5);
...
function function_bb528a4b()
{
	...
	while(true)
	{
		b_cancelled = 0;
		s_notify = undefined;
		s_notify = self.var_a6ed9e82 waittill(#"damage");
		...
		if(isalive(s_notify.attacker) && isplayer(s_notify.attacker))
		{
			...
			if(s_notify.attacker hasperk(#"hash_6afc24062d2515a2"))
			{
...
function function_47073904(v_loc, n_time = 8)
{
	...
	while(n_time_passed <= n_time)
	{
		...
		{
			if(!ai_zombie cschashed-3\script_291730b3e6bd8c52::function_50a8406d())
			{
				ai_zombie thread cschashed-3\script_291730b3e6bd8c52::function_e5e8cbd2(0);
			}
		}
		wait(0.1);
...
function function_f5b2d086()
{
	...
	while(true)
	{
		...
		if(var_6c463143 && !cschashed-2\script_260abbdf1ff0aa9a::function_abf1dcb4(var_c0958d26))
		{
			cschashed-2\script_260abbdf1ff0aa9a::function_bdd8aba6(var_c0958d26);
			level.var_9eaf1031--;
		}
		wait(2);
	}
	...
	while(var_b5a033fe == 0 || var_5b839378 < var_b5a033fe)
	{
		...
		while(var_8b999044.size < var_36f58c64)
		{
			while(!isdefined(var_9cc45d9e))
			{
				...
				var_9cc45d9e = cschashed-1\script_1d99711a5c22bdef::function_6249817(1, var_bb492495[var_c979da59], n_round);
			}
...
{
	level endon(#"hash_38f29f9cb03586ea", #"spawn_zombies", #"intermission");
	var_2208179c = struct::get_array(#"blightfather_spawn");	var_7bb1ca00 = level.var_f3c4bd00;
	...
	while(var_24b27265 < var_dbb23c7)
	{
		...
		{
			cschashed-2\script_260abbdf1ff0aa9a::function_bdd8aba6(#"hash_9ecf8085fb7a68f");
