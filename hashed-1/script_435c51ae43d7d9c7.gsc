...
function init_level_vars()
{
	...
	namespace_c3287616::function_2876740e(#"zombie_electric", &function_ae7c2601);	zm_utility::function_2959a3cb(#"zombie_dog", &function_126999be);
...
function function_ca35fa36()
{
	...
	cschashed-3\script_31055dfc068c1e62::function_602d605();
	...
	foreach(var_a84febff in level.var_4d8e32c8)
	{
		...
		{
			var_a84febff thread cschashed-3\script_f459be361894751::function_e3921120(1);
		}
	}
	...
	namespace_c3287616::function_306ce518(#"zombie_electric", &function_b60250);	level thread function_6091b49b();
	util::delay(4, undefined, &zm_utility::function_11101458, var_f79ff5ec);
	zm_zonemgr::function_8caa21df(s_defend_area.a_str_zones);
	wait(25);
	zm_utility::function_33798535(s_defend_area.var_39c44288, s_defend_area.a_str_zones, s_defend_area.var_ed1db1a7, undefined, undefined, 45);
	...
	for(i = 0; i < 3; i++)
	{
		cschashed-1\script_4f00f8c9cdfa5084::function_61511fcf(i);
	}
