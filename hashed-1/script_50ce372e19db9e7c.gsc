...
{
	projectile endon(#"spear_death");	result = undefined;
	...
	if(!(isdefined(projectile.isdamaged) && projectile.isdamaged))
	{
		if(isdefined(result.position))
		{
			...
			if(isdefined(function_9cc082d2(result.position, 30)))
			{
				...
				{
					aoe = cschashed-2\script_235cad39dd72e0ac::function_371b4147(id, var_f34f8a95, groundtrace(result.position + vectorscale((0, 0, 1), 8), result.position + vectorscale((0, 0, -1), 100000), 0, projectile)[#"position"], var_c3f91959);
				}
				else
				{
					aoe = cschashed-2\script_235cad39dd72e0ac::function_371b4147(id, var_f34f8a95, groundtrace(result.position + vectorscale((0, 0, 1), 8), result.position + vectorscale((0, 0, -1), 100000), 0, projectile)[#"position"]);
				}
			}
			var_a5a1f99c = getaiarchetypearray(#"zombie");
			var_a5a1f99c = arraycombine(var_a5a1f99c, getaiarchetypearray(#"catalyst"), 0, 0);			var_a5a1f99c = arraycombine(var_a5a1f99c, getaiarchetypearray(#"tiger"), 0, 0);
...
function function_6b086058(inflictor, attacker, damage, idflags, meansofdeath, weapon, point, dir, hitloc, offsettime, boneindex, modelindex)
{
	...
	if(!isdefined(var_88cb1bf9))
	{
		...
		var_786d7e06 = cschashed-1\script_5a012bbb9342dbdf::function_422fdfd4(self, attacker, weapon, boneindex);
	...
	if(self.ai.var_112ec817 == #"hash_8e173ae91589439")
	{
		...
		{
			var_786d7e06 = cschashed-1\script_5a012bbb9342dbdf::function_422fdfd4(self, attacker, weapon, var_88cb1bf9, undefined, undefined, var_dd54fdb1);
