...
function __init__()
{
	...
	clientfield::register("toplayer", "" + #"swordpistol_rumble", 1, 3, "counter", &swordpistol_rumble, 0, 0);	level._effect[#"hash_25626300bbf56aa7"] = #"hash_6a8080a7153541f6";
...
function function_61659b2f(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.var_cc9c5baa))
	{
