...
private function function_557051df(planner, constants)
{
	...
	var_8498b0f1 = [];
	distancesq = constants[#"distance"] * constants[#"distance"];
	switches = planner::getblackboardattribute(planner, #"zm_switches");	if(!isdefined(switches))
	{
		switches = [];
	}
	path = undefined;
...
private function function_393b9c76(planner, constants)
{
	...
	var_8c60fdb3 = [];
	distancesq = constants[#"distance"] * constants[#"distance"];
	wallbuys = planner::getblackboardattribute(planner, #"zm_wallbuys");	if(!isdefined(wallbuys))
	{
		wallbuys = [];
	}
