...
function __main__()
{
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_541a4d5c476468f4"))
	{
		...
		var_35da56ee = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(#"zblueprint_mansion_ww_lvl2");
		var_35da56ee.var_670f9944.var_62a98b13 = #"hash_5b861e557c672a2b";
		var_35da56ee.var_2e0a273a.var_62a98b13 = #"hash_42e3673730d13c20";
		cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"zblueprint_mansion_ww_lvl2", &function_1d1da682);
...
function function_6231b511()
{
	while(!level flag::get("ww_lvl2_crafting_completed"))
	{
		...
		if(s_notify.blueprint.name === "zblueprint_mansion_ww_lvl2")
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_5ddc0f3d5535879b", 1);
		}
	}
}
...
function function_514a3f80()
{
	...
	namespace_93829f86::function_4d230236(cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683(#"hash_5dba850c6ed3ebee"), &function_b9cbdac6);
	namespace_93829f86::function_4d230236(cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683(#"hash_3f639544c52d4fa3"), &function_b9cbdac6);
	namespace_93829f86::function_4d230236(cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683(#"hash_3f639644c52d5156"), &function_b9cbdac6);
...
function function_ea6f56ee()
{
	while(true)
	{
		...
		if(level flag::get("flag_player_grabbed_werewolf_material") && !level flag::get("flag_player_grabbed_werewolf_prima"))
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3761ebdf006d549e", 0);
		}
		else if(level flag::get("flag_player_grabbed_catalyst_material") && !level flag::get("flag_player_grabbed_bat_prima"))
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09edf042e93c7", 0);
		}
		else if(level flag::get("flag_player_grabbed_nosferatu_material") && !level flag::get("flag_player_grabbed_nosferatu_prima"))
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09ddf042e9214", 0);
		}
...
function function_b9cbdac6(e_holder, var_9c95ad05)
{
	...
	switch(var_9c95ad05.name)
	{
		...
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3761ebdf006d549e", 2);
			level flag::set("flag_player_grabbed_werewolf_prima");
			break;
		}
		case "hash_3f639544c52d4fa3":
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09edf042e93c7", 2);
			level flag::set("flag_player_grabbed_bat_prima");
			break;
		}
		case "hash_3f639644c52d5156":
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09ddf042e9214", 5);
...
function function_1d1da682(e_player)
{
	...
	wait(0.1);
	unitrigger_stub cschashed-1\script_6d85b093d74cdfdd::function_6dccf508();
...
{
	can_use = self.stub cschashed-1\script_6d85b093d74cdfdd::function_18f2be60(e_player);
