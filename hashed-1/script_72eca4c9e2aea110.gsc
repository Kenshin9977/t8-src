...
#namespace cschashed-1\script_4f00f8c9cdfa5084;
...
function init()
{
	clientfield::register("scriptmover", "" + #"dynamite_explosion_fx", 24000, 1, "counter");	clientfield::register("actor", "" + #"hash_6adfdd12c9656e1c", 24000, 1, "int");
...
function main()
{
	...
	level.var_d867b9f3 = array(namespace_a1d9b01d::function_4c2f8683("zitem_orange_dynamite_bomb_part_1"), namespace_a1d9b01d::function_4c2f8683("zitem_orange_dynamite_bomb_part_2"), cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683("zitem_orange_dynamite_bomb_part_3"));
	level.var_1daa43ee = 1;
	callback::function_74872db6(&function_74872db6);
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(level.var_d867b9f3[0], &function_168f686b);
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(level.var_d867b9f3[1], &function_168f686b);
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(level.var_d867b9f3[2], &function_168f686b);
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"hash_2ca3c1e10bdf8cdb", &function_7056aa62);
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"hash_1255a9a8cf55727d", &function_7056aa62);
	function_e55e2a5e();
	...
	array::run_all(var_b3e4b8b8, &function_7aaec3a4);
...
function function_e93a8e82(v_pos, v_angles)
{
	...
	{
		var_b82ff340 = cschashed-3\script_e2bef0652b31f68::function_6d41bab8(v_pos, 360);
		if(isdefined(v_drop))
		{
...
private function function_e3203a2()
{
	...
	if(level.var_1daa43ee && self.archetype === #"zombie" && self.entity_type !== #"hash_1c5b32be3f2c9b67" && (math::cointoss(20) || level flag::get(#"hash_98e32feb5b8ac79")))
	{
...
{
	var_2b198109 = cschashed-3\script_e2bef0652b31f68::function_795d5b4f(getaiteamarray(level.zombie_team), v_pos, 250);
	array::run_all(var_2b198109, &dodamage, 500, v_pos, undefined, undefined, undefined, "MOD_EXPLOSIVE");
	a_e_players = cschashed-3\script_e2bef0652b31f68::function_795d5b4f(getplayers(), v_pos, 250);
...
function function_8f6cb08()
{
	...
	var_25a548fa = level function_e93a8e82(self.origin, self.angles);
...
function function_7056aa62()
{
	...
	if(var_4b912983.blueprint.name == #"zblueprint_orange_dynamite_bomb")
	{
		...
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("orange_dynamite_bomb_part_1_owned", 0);
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("orange_dynamite_bomb_part_2_owned", 0);
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("orange_dynamite_bomb_part_3_owned", 0);
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("dynamite_bomb_phase", 1);
	}
}
...
function function_4c525901()
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("orange_dynamite_bomb_complete", 1);
	zm_unitrigger::unregister_unitrigger(self.s_unitrigger);
	self hide();
}

/*
	Name: function_7aaec3a4
	Namespace: cschashed-1\script_4f00f8c9cdfa5084
	Checksum: 0xF6A19F0F
	Offset: 0x19A0
	Size: 0x3C
...
function function_170afe2c(b_main_quest = 0)
{
	...
	level.var_518d6e34 = 0;
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("orange_dynamite_bomb_complete", 0);
	zm_unitrigger::unregister_unitrigger(self.s_unitrigger);
...
function function_2e1427a3()
{
	...
	#/
	wait(1);
	e_bomb clientfield::increment("" + #"dynamite_explosion_fx", 1);	level function_d8f300c3(self.origin);
...
function function_65026f4d()
{
	...
	array::run_all(var_b3e4b8b8, &cschashed-3\script_e2bef0652b31f68::function_7a5ba111);
...
function function_6ecfea46()
{
	...
	if(level.var_37078af7 < 4)
	{
		...
		{
			foreach(var_707469b3 in level.var_4fe2f84d[#"hash_1255a9a8cf55727d"])
			{
		...
		{
			foreach(var_707469b3 in level.var_4fe2f84d[#"hash_2ca3c1e10bdf8cdb"])
			{
				if(isdefined(s_crafting.blueprint) && s_crafting.blueprint.name === "zblueprint_orange_dynamite_bomb" && (!(isdefined(s_crafting.registered) && s_crafting.registered)))
				{
					var_707469b3 cschashed-1\script_6d85b093d74cdfdd::function_6dccf508();
		...
		level.var_1daa43ee = 1;
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("dynamite_bomb_phase", 0);
	}
	else
	{
