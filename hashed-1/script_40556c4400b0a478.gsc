...
{
	if(self.entity_type !== #"hash_273dea5b2e3044c0")
	{
		return;
	}
	...
	/#
		switch(cmd)
		{
			case "hash_3b5a33d5b7ae4e80":
			{
				...
				{
					if(spawner.entity_type === #"hash_273dea5b2e3044c0" && isdefined(spawner.script_noteworthy))
					{
			...
			case "hash_2e229b658a79d09f":
			{
				...
				{
					if(brutus.entity_type === #"hash_273dea5b2e3044c0")
					{
