...
#namespace cschashed-3\script_403955577807b291;
...
private function function_aadad2c(var_dbd1a594, var_11a83c3a)
{
	...
	#/
	var_8b745faa = getweapon(#"gadget_icepick");
	scoreevents::processscoreevent(#"hacked_enemy", var_dbd1a594, var_11a83c3a, var_8b745faa);	var_11a83c3a clientfield::set_player_uimodel("hudItems.hackedRebootProgress", 0);
...
private function function_bf744a1e(var_dbd1a594, var_11a83c3a)
{
	var_11a83c3a.var_e2131267 = var_dbd1a594;
	var_8b745faa = getweapon(#"gadget_icepick");
	scoreevents::processscoreevent(#"hacked_enemy", var_dbd1a594, var_11a83c3a, var_8b745faa);	var_51d5c26f = function_13f4415c();
