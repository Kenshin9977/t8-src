...
function __main__()
{
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(#"hash_2ca39a768b9be4ab", #"werewolf", &function_39212989, 1, undefined, undefined, "aib_vign_zm_mnsn_werewolf_pre_transform", "aib_vign_zm_mnsn_werewolf_post_transform", &function_5c0a0b26);
}
...
{
	if(!cschashed-1\script_5a012bbb9342dbdf::function_db610082())
	{
		return 0;
	}
	return 1;
...
function function_774f6e70(s_spawn_loc, var_58a8a3cb = 1, var_cda6f9a7 = undefined, var_d5e7e76d = undefined)
{
	...
	{
		var_a8a8b6f8 = cschashed-1\script_5a012bbb9342dbdf::function_35eac38d(getnode(s_spawn_loc.target, "targetname"));
		cschashed-1\script_5a012bbb9342dbdf::start_patrol(self, var_a8a8b6f8.path, var_a8a8b6f8.loops, var_cda6f9a7, var_d5e7e76d);
		if(var_58a8a3cb)
		{
			...
			cschashed-1\script_5a012bbb9342dbdf::stop_patrol(self);
		}
	}
}
