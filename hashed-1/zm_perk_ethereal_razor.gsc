...
#namespace cschashed-3\script_3489095373476b58;
...
function function_1f7c6bb9(var_d4f8477f, var_2b9d3880, var_48e9b3cc, is_lunge = 0)
{
	...
	foreach(e_target in a_e_targets)
	{
		...
		{
			var_c63f626a = n_base_damage + var_d4f8477f.meleedamage;
		}
		if(is_lunge)
		{
		...
		e_target dodamage(var_c63f626a, self.origin, self, undefined, e_target.var_39c64392, "MOD_MELEE", 0, var_d4f8477f);
...
{
	if(!(isdefined(var_d4f8477f.isriotshield) && var_d4f8477f.isriotshield) && !cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(var_d4f8477f) && (!(isdefined(var_d4f8477f.isbulletweapon) && var_d4f8477f.isbulletweapon)) && (!(isdefined(var_d4f8477f.isprimary) && var_d4f8477f.isprimary) || var_d4f8477f.isballisticknife))
	{
		return 1;
	}
	return 0;
