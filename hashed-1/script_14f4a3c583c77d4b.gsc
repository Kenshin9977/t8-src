...
#namespace cschashed-2\script_709bf7c56eb65adf;
...
function function_54cb37a4(weapon)
{
	...
	{
		cschashed-2\script_257d7bea5de94cbf::player_pick_up(self, weapon);
		return;
	}
	if(zm_equipment::is_equipment(weapon))
	{
...
function register_offhand_weapons_for_level_defaults()
{
	...
	if(cschashed-2\script_18a9e529264a3d29::function_166646a6() == 1)
	{
...
function give_start_weapon(b_switch_weapon)
{
	...
	if(isdefined(var_57e2f3cf) && isdefined(var_57e2f3cf.var_3cf2d21) && namespace_59ff1d6c::function_bce642a1(var_57e2f3cf) && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_7bc64c0823c87e41"))
	{
		self zm_weapons::weapon_give(getweapon(var_57e2f3cf.var_3cf2d21), 1, b_switch_weapon);
		if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_7bc64c0823c87e41") && isdefined(self.var_8313fee5))
		{
	...
	else
	{
		...
		if(isdefined(var_57e2f3cf) && (!namespace_59ff1d6c::function_bce642a1(var_57e2f3cf) || !cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_7bc64c0823c87e41")))
		{
			self thread cschashed-3\script_12282e6b2cc91b42::function_343353f8();
		}
	}
}
