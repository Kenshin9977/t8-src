...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_4c1b3f603272e5fc", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85()
{
	...
	foreach(player in getplayers())
	{
		...
		player.var_5f4eaf85 thread cschashed-1\script_3eb41f1152506dc6::function_d10bf985();
	}
	level.var_5f4eaf85.var_72411ccf = undefined;
	level.var_5f4eaf85 zombie_utility::set_zombie_run_cycle("super_sprint");
	level.var_5f4eaf85 thread cschashed-1\script_3eb41f1152506dc6::function_d10bf985();
}
...
private function on_player_damage(params)
{
	if(isai(params.eattacker) || isai(params.einflictor) && (params.idamage > 0 || (isdefined(self.armor) && self.armor > 0)) && params.eattacker.archetype === #"hash_777dead372b3a736")
	{
		...
		cschashed-1\script_3c362258ff800237::fail(#"hash_41122a695bc6065d", var_57807cdc);
	}
}
