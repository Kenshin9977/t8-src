...
private function function_d1de6a85(var_c8a36f90, var_a9dd1993, var_2953986a, var_3790b4e4, var_edc5a14f)
{
	...
	{
		array::thread_all(getplayers(), &cschashed-1\script_3d5821d793ed4c6::function_9bf8e274);
	}
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(level.var_e91491fb === #"prone")
	{
		array::thread_all(getplayers(), &cschashed-1\script_3d5821d793ed4c6::function_73ff0096);
	}
	...
	while(true)
	{
		if(self function_26f124d8() && var_407eb07)
		{
			...
			if(var_9d590e70)
			{
				...
				self cschashed-1\script_3d5821d793ed4c6::function_dc0859e(var_3940c585);
			}
			var_407eb07 = 0;
		}
...
private function function_33f0ddd3(s_event)
{
	...
	{
		if(!self function_26f124d8() && !cschashed-2\script_709bf7c56eb65adf::function_2ff6913(s_event.weapon))
		{
