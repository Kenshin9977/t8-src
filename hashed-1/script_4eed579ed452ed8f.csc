...
function __init__()
{
	...
	clientfield::register("scriptmover", "" + #"hemera_impact", 16000, 1, "counter", &function_305c64d5, 0, 0);	clientfield::register("allplayers", "hemera_proj_flash", 16000, 1, "int", &function_c6d1bdb0, 0, 0);
...
function function_ab086ad8(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump)
{
	...
	else if(isdefined(self) && isdefined(self.var_d3316606))
	{
