...
#namespace cschashed-1\script_2cb5724648b5b416;
...
function function_77a0aab6(var_5ea5c94d)
{
	if(!var_5ea5c94d)
	{
		...
		level thread cschashed-3\script_28144a2871e71a78::function_5fbede7a();
		var_7a5bbd26 = getent("insanity_mode_damage_trigger", "targetname");
		while(true)
		{
			...
			{
				level thread cschashed-3\script_28144a2871e71a78::function_60f15ca8();
...
function function_1541f1c9()
{
	...
	array::run_all(getaiarray(), &cschashed-3\script_d67878983e3d7c::freeze);
	wait(1);
	namespace_3e3742fd::function_32c317fb();
	cschashed-1\script_4c9e3a985ae04008::function_5c2807fc();
	function_69a6d31a(1);
	function_83c13f8e();
	function_5ac5f2aa();
	function_4f84973a();
	...
	{
		a_e_players[i] cschashed-2\script_27ba6748d83412fd::function_2aed1d83(var_a0b0c8c4[i], 1);
	}
	wait(2 + 1);
	function_411302d7();
...
function function_ff416940()
{
	...
	foreach(e_player in a_e_players)
	{
		var_ac6ee9a0 = e_player cschashed-2\script_709bf7c56eb65adf::get_player_lethal_grenade();
