...
function function_f968291b(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump)
{
	...
	else if(newval == 2)
	{
		...
		self.var_7a00469e = util::playfxontag(localclientnum, level._effect[#"portal_activate"], self, "tag_origin");		self playsound(localclientnum, #"hash_4941fd3f3fa17a5e");
		if(isdefined(self.var_767d572c))
		{
			killfx(localclientnum, self.var_767d572c);
			self.var_767d572c = undefined;
...
{
	if(isdefined(self.n_tugboat_fx))
	{
		stopfx(localclientnum, self.n_tugboat_fx);
		self.n_tugboat_fx = undefined;
	}
	...
	if(newval == 1)
	{
		self.n_tugboat_fx = util::playfxontag(localclientnum, level._effect[#"tugboat_fx"], self, "tag_body");	}
}
...
function function_58397147(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwasdemojump)
{
	...
	if(newval > 0)
	{
		...
		var_9094730f = cschashed-1\script_6a0e50bc15d725a9::function_98890cd8(player.weapon, 1);
		if(!var_9094730f)
		{
