...
hashed-2\script_260abbdf1ff0aa9a.csc;
hashed-2\script_29ce920f87896297.csc;
...
function __init__()
{
	...
	level._effect[#"hash_48f6440bb2d0067e"] = "player/fx8_plyr_pstfx_vomit_loop";
	level._effect[#"hash_6553828310934056"] = "zm_ai/fx8_blightfather_vomit";
	level._effect[#"hash_6c3415e2a989a2e0"] = "zm_ai/fx8_blightfather_vomit_object";
	level._effect[#"hash_230802cc4433af6c"] = "zm_ai/fx8_blightfather_vomit_purchase";
	level._effect[#"hash_4de3555fcfb16c37"] = "zm_ai/fx8_blightfather_vomit_statue_purchase";
	level._effect[#"hash_583fd136df952ff6"] = "zm_ai/fx8_blightfather_vomit_box_purchase";
	level._effect[#"hash_3411d7d89ef6dc3b"] = "zm_ai/fx8_blightfather_vomit_craft_purchase";
...
private function function_2c098ccc(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	switch(newval)
	{
		case 1:
		{
			self.var_32caa02 = util::playfxontag(localclientnum, level._effect[#"hash_230802cc4433af6c"], self, "tag_origin");
			break;
		}
		case 2:
		{
			self.var_32caa02 = util::playfxontag(localclientnum, level._effect[#"hash_4de3555fcfb16c37"], self, "tag_origin");
			break;
		}
		case 3:
		{
			self.var_32caa02 = util::playfxontag(localclientnum, level._effect[#"hash_583fd136df952ff6"], self, "tag_origin");
			break;
		}
		case 4:
		{
			self.var_32caa02 = util::playfxontag(localclientnum, level._effect[#"hash_3411d7d89ef6dc3b"], self, "tag_origin");
			break;
		}
		default:
		{
...
private function function_2d7f68ab(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(newval)
	{
		self.var_185f551 = playfxoncamera(localclientnum, level._effect[#"hash_48f6440bb2d0067e"]);
...
function function_1ca2497b()
{
	...
	while(!var_e935ecce)
	{
		...
		if(var_72840ba5 <= 0)
		{
			self function_5d482e78("rob_zm_viewarm_vomit");
			var_e935ecce = 1;
			break;
		}
		wait(0.1);
