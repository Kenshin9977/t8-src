...
#using hashed-2\zm_perk_death_dash.gsc;
...
#namespace cschashed-3\script_32855d6e00e2e627;
		...
		foreach(ai_zombie in a_ai_zombies)
		{
			...
			switch(ai_zombie.var_6f84b820)
			{
				...
				case "popcorn":
				{
					...
					ai_zombie thread cschashed-3\script_65206f3a5652e056::function_c1c51837(self);
