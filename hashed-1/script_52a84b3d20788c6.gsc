...
#namespace cschashed-3\script_291730b3e6bd8c52;
...
function __init__()
{
	...
	zm_utility::function_d0f02e71(#"catalyst");	zm_player::register_player_damage_callback(&function_22e12b7);
	namespace_57ff8cbb::function_39553a7c(#"catalyst", &function_5ea7ae19);	namespace_57ff8cbb::function_cdf5a512(#"catalyst", &function_3eaa8337);	namespace_32192f7::function_95c1dd81(#"catalyst", &function_52ce9654);	level.var_3ecc60fc[0] = 1;
	...
	level thread aat::register_immunity("zm_aat_brain_decay", #"catalyst", 1, 1, 0);	level thread aat::register_immunity("zm_aat_kill_o_watt", #"catalyst", 1, 1, 0);	zm_spawner::register_zombie_death_event_callback(&killed_callback);
	namespace_c3287616::register_archetype(#"catalyst", &function_55f82550, &round_spawn, undefined, 25);	namespace_c3287616::function_306ce518(#"catalyst", &function_587a3171);	/#
	...
	spawner::function_89a2cd87(#"catalyst", &function_47fdbfbb);	function_6e75e858();
...
private function function_52ce9654()
{
	if(isarray(level.zm_loc_types) && level.zm_loc_types[#"zombie_location"].size > 0)
	{
		...
		{
			var_47c2dcf7 cschashed-2\script_260abbdf1ff0aa9a::function_bbaec2fd();
...
/*
	...
	Flags: Linked, Private
*/
private function registertransformations()
{
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(function_bbb2bab5(1), #"hash_78ca8e8e6bdbc8ab", &function_39212989, 5, &function_f4043bc8, &function_2ed1300e, "aib_vign_zm_zod_catalyst_corrosive_spawn_pre_split", "aib_vign_zm_zod_catalyst_corrosive_spawn_post_split");
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(function_bbb2bab5(3), #"hash_266b62e342076a90", &function_39212989, 5, &function_f4043bc8, &function_2ed1300e, "aib_vign_zm_zod_catalyst_electric_spawn_pre_split", "aib_vign_zm_zod_catalyst_electric_spawn_post_split");
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(function_bbb2bab5(2), #"hash_5cfa99582cc66c59", &function_39212989, 5, &function_f4043bc8, &function_2ed1300e, "aib_vign_zm_zod_catalyst_plasma_spawn_pre_split", "aib_vign_zm_zod_catalyst_plasma_spawn_post_split");
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(function_bbb2bab5(4), #"hash_5d6b55906fc82ff2", &function_39212989, 5, &function_f4043bc8, &function_2ed1300e, "aib_vign_zm_zod_catalyst_water_spawn_pre_split", "aib_vign_zm_zod_catalyst_water_spawn_post_split");
}
...
function function_3eaa8337()
{
	...
	if(isdefined(self) && isentity(self))
	{
		...
		self cschashed-1\script_5a012bbb9342dbdf::function_a8dc3363(var_d7eff26a);
		if(isdefined(self))
		{
			self clientfield::set("catalyst_aura_clientfield", self.var_62e81e47);
			if(self.var_62e81e47 == 1)
...
function function_5ea7ae19(var_3a145c54)
{
	if(var_3a145c54)
	{
		level thread function_616468cb(self.entity_type);
	}
}
...
function function_616468cb(var_56c95dd4)
{
	...
	cschashed-2\script_260abbdf1ff0aa9a::function_bdd8aba6(var_56c95dd4);
}
...
{
	return self.entity_type === #"hash_78ca8e8e6bdbc8ab";
}
...
private function function_3b07d86e()
{
	...
	if(isdefined(self))
	{
		...
		self val::set(#"catalyst", "hide", 2);		if(isalive(self))
		{
			self.takedamage = 1;
			self.allowdeath = 1;
			self kill();
...
/*
	...
	Flags: Linked, Private
*/
private function function_72a1933a(zombie, catalyst)
{
...
function function_bbb2bab5(var_3d9951bb)
{
	...
	{
		if(e_spawner.entity_type == var_b62aefe1)
		{
			return e_spawner;
		}
	}
...
function function_39212989()
{
	...
	if(cschashed-1\script_5a012bbb9342dbdf::function_db610082() == 0)
	{
		return 0;
	}
...
function function_b2090194(var_3d9951bb)
{
	...
	{
		cschashed-2\script_260abbdf1ff0aa9a::function_d2374144(self, function_e1763259(randomintrange(1, 5)));
	}
	else
	{
		var_b62aefe1 = function_e1763259(var_3d9951bb);
		cschashed-2\script_260abbdf1ff0aa9a::function_d2374144(self, var_b62aefe1);
	}
}
...
function round_spawn()
{
	...
	cschashed-2\script_260abbdf1ff0aa9a::function_bdd8aba6(function_e1763259(var_3d9951bb));
	return 0;
}
...
private function function_fa69f8d2(type)
{
	/#
		...
		{
			if(spawner.entity_type === var_7a56405a[type])
			{
		...
		{
			wait(0.5);
			var_7f972dff cschashed-2\script_260abbdf1ff0aa9a::function_bbaec2fd();
