...
#namespace cschashed-2\script_14e736d5e4272b3d;
...
private function function_b60df00d()
{
	...
	{
		level.var_ae5fb719.s_start = cschashed-3\script_e2bef0652b31f68::function_4e7f5b2e("mk2x_start");
	}
...
private function function_4e9f1680()
{
	...
	while(true)
	{
		...
		if(s_notify cschashed-3\script_e2bef0652b31f68::function_69320b44("zm_aat_frostbite"))
		{
			self setcandamage(0);
...
private function function_9d66ea6f(var_2e1f34dd, e_player)
{
	...
	cschashed-1\script_4deda6ab11ad22af::function_605e5c25(e_player);
	e_player.var_9c20e2c9 = 1;
	e_player playsound("evt_canister_pickup");
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mod_phase", 1, e_player);
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2x_ammo", 1, e_player);
...
function function_130ea633()
{
	if(zm_utility::is_classic())
	{
		...
		self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_x_ammo_pickup");
...
function function_cdddec81(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	{
		if(attacker cschashed-3\script_e2bef0652b31f68::function_fab5fb4d(weapon, "zm_aat_frostbite"))
		{
...
private function function_75edd32b(b_frozen = 1)
{
	if(b_frozen)
	{
		...
		self cschashed-3\script_d67878983e3d7c::freeze();
		self.var_7ba65499 = 1;
	}
	else
	{
...
private function function_cf69599(var_2e1f34dd, e_player)
{
	...
	if(level.var_ae5fb719.var_128cd2c8 == 2)
	{
		if(zm_utility::is_classic())
		{
			e_player thread cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_x_goo_acquire");
		}
	}
...
private function function_473f437()
{
	...
	while(true)
	{
		...
		if(function_18a1849f(s_notify.e_who))
		{
			...
			if(zm_utility::is_classic())
			{
				level.var_ae5fb719.e_player thread cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_x_charge");
			}
...
private function function_b9a31cb(var_2e1f34dd, e_player)
{
	...
	#/
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2x_ammo", 2, e_player);
...
function function_c6fc34a()
{
	...
	{
		self namespace_891c9bac::function_57b8cd17();
		self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_x_craft");
		if(!namespace_3e3742fd::function_6cebbce1())
		{
