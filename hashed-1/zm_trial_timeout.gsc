...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"timeout", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_9eb4b9f8, var_1215371f, grace_period, var_29cadcde, var_c811984d, var_26be3f81, var_6b594c52, var_afb6cb74)
{
	...
	switch(getplayers().size)
	{
		case 1:
		{
			var_690d3062 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_29cadcde);
			break;
		}
		case 2:
		{
			var_690d3062 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_c811984d);
			break;
		}
		case 3:
		{
			var_690d3062 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_26be3f81);
			break;
		}
		case 4:
		{
			var_690d3062 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_6b594c52);
			break;
		}
		default:
		{
	...
	grace_period = cschashed-1\script_3c362258ff800237::function_5769f26a(grace_period);
...
private function function_cbd444ad(params)
{
	...
	{
		cschashed-1\script_3c362258ff800237::fail(#"hash_73d4bcc7d0dd1647");
	}
}
...
function function_35cda2d8(params)
{
	...
	if(cschashed-2\script_709bf7c56eb65adf::is_melee_weapon(params.weapon) || zm_weapons::function_35746b9c(params.weapon))
	{
		return 1;
	}
...
private function function_8b87e57c(var_9eb4b9f8, grace_period, var_690d3062, var_1215371f)
{
	...
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d5821d793ed4c6::start_timer(var_690d3062);
		if(level.var_f6f33e5f === #"melee_only")
		{
	...
	wait(var_690d3062);
	cschashed-1\script_3c362258ff800237::fail(var_1215371f);
}
...
private function function_31f197c2()
{
	...
	if(!level.var_f995ece6 zm_trial_timer::is_open(self))
	{
		...
		self cschashed-1\script_3d5821d793ed4c6::start_timer(level.var_869f4c31);
	}
}
