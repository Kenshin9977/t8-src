...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_5c3f988812660d49", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(perk_count)
{
	...
	#/
	self.var_851a4ca6 = cschashed-1\script_3c362258ff800237::function_5769f26a(perk_count);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(!round_reset)
	{
		...
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_397117e332ee81a0" + self.var_851a4ca6, var_57807cdc);
		}
		else if(var_57807cdc.size > 1)
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_4cf7d929e75b3da3" + self.var_851a4ca6, var_57807cdc);
		}
	}
	foreach(player in getplayers())
	{
