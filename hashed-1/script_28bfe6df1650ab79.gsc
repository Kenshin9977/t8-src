...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_27897abffa9137fc", &function_d1de6a85, &function_9e7b3f4d);
}
...
function is_active()
{
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_27897abffa9137fc");
...
private function function_6a8979c9()
{
	...
	{
		if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon) || (isdefined(weapon.isriotshield) && weapon.isriotshield))
		{
