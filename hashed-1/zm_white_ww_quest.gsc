...
function preload()
{
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_ww_screen1", 20000, "sc_ww_screen1", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_ww_screen2", 20000, "sc_ww_screen2", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_ww_screen3", 20000, "sc_ww_screen3", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_ww_screen4", 20000, "sc_ww_screen4", &function_8598f0d4, &function_3bdbb583, 1);
}
...
function init()
{
	...
	level.var_cb94d41d.var_e76526e8 = [];
	level.var_cb94d41d.var_e76526e8[0] = {#hash_2153c223:level.var_2aeeb358[4], #n_state:1};
	level.var_cb94d41d.var_e76526e8[1] = {#hash_2153c223:level.var_2aeeb358[6], #n_state:1};
	level.var_cb94d41d.var_e76526e8[2] = {#hash_2153c223:level.var_2aeeb358[8], #n_state:1};
	level.var_cb94d41d.var_e76526e8[3] = {#hash_2153c223:level.var_2aeeb358[10], #n_state:1};
	...
	{
		n_code = cschashed-3\script_28144a2871e71a78::function_4696e086(1, &function_256cc56e);
		level.var_276bd207 = cschashed-3\script_28144a2871e71a78::function_da24090c(n_code);
	}
	function_63841688();
}
...
function function_dd535733()
{
	...
	level.var_d9d721fd.entity = level.var_d9d721fd.scene_ents[#"hash_7aff0ee60ddd937b"];
	for(i = 0; i < 4; i++)
	{
...
function function_da84e99e(var_5ea5c94d)
{
	...
	if(!var_5ea5c94d)
	{
		...
		{
			cschashed-3\script_28144a2871e71a78::function_4da0eaff();
		}
	}
}
...
function function_dc4f41f7()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_2a94055d(self.var_b9989e12);
}
...
function function_46006d68()
{
	switch(self.var_53d39cb3)
	{
		...
		case 1:
		{
			...
			self.var_53d39cb3 = 2;
			cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(self.var_b9989e12);
			break;
		}
		case 2:
		{
...
function function_41464ab6()
{
	...
	self.e_tv thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_661a3ece5f5b3f0b", 0, 0);
}
...
function function_6e0328a9()
{
	...
	self.e_tv.name = level.var_8200dc81.name;
	self.e_tv namespace_891c9bac::function_57b8cd17();
	self.e_tv cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_6827b81ddbd26677", 0, 0);
	if(level flag::get(#"hash_6cf22ddb4ddabbaa"))
	{
		wait(1);
		self.e_tv cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_ce23c02d2c80867", 0, 0);
	}
}
...
function function_256cc56e()
{
	...
	if(!zm_utility::can_enable_ee())
	{
		level cschashed-3\script_28144a2871e71a78::function_31890499();
	...
	cschashed-2\script_102fa70a8153e81f::start_quest();
	cschashed-2\script_14e736d5e4272b3d::start_quest();
	cschashed-1\script_3ba495e039989116::start_quest();
	cschashed-2\script_27a4aedb3d2a899b::start_quest();
}
...
function function_c3076788(e_player)
{
	...
	{
		w_give = level.var_cb94d41d.var_e76526e8[e_player.var_bec34462.var_bcd1c2ff].var_2153c223;
	}
...
{
	self.var_382b64f2 = 1;
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_husk_part", 1, self);
	self playsound("evt_rgun_frame_pickup");
	var_bcd1c2ff = self.var_bec34462.n_slot;
	if(isdefined(var_bcd1c2ff) && level.var_cb94d41d.var_e76526e8[n_slot].n_state == 1)
	{
		level.var_d9d721fd.entity hidepart("tag_gun_" + n_slot);
		level.var_cb94d41d.var_e76526e8[n_slot].n_state = 0;
	}
	else
	{
		function_47181de();
	...
	if(!array::contains(level.var_cb94d41d.var_bfee6dc4, self))
	{
		if(!array::contains(level.var_cb94d41d.var_5300c2f5, self))
		{
			...
			{
				namespace_891c9bac::function_8e0f4696("vox_ww_mod_hint_rush_0", 0, 1, 0, 0, 1);
			}
		}
		if(!isdefined(level.var_cb94d41d.var_bfee6dc4))
		{
...
{
	var_bcd1c2ff = function_5c934f81(1);
	if(isdefined(n_slot))
	{
		level.var_cb94d41d.var_e76526e8[n_slot].n_state = 0;
		level.var_d9d721fd.entity hidepart("tag_gun_" + n_slot);
...
function function_a9051a62()
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_husk_part", 0, self);
	level.var_d9d721fd.entity playsound("evt_rgun_frame_putback");
	var_bcd1c2ff = self.var_bec34462.n_slot;
	if(isdefined(var_bcd1c2ff) && level.var_cb94d41d.var_e76526e8[n_slot].n_state == 0)
	{
		level.var_d9d721fd.entity showpart("tag_gun_" + n_slot);
		level.var_cb94d41d.var_e76526e8[n_slot].n_state = 1;
	}
	else
	{
		function_cf5be182();
...
{
	var_bcd1c2ff = self.var_bec34462.n_slot;
	var_2c912e22 = level.var_cb94d41d.var_e76526e8[n_slot];
	zm_weapons::weapon_give(var_2c912e22.var_2153c223, 1);
	if(isdefined(s_slot.n_ammo_clip))
	{
		self setweaponammoclip(var_2c912e22.var_2153c223, s_slot.n_ammo_clip);
		self setweaponammostock(var_2c912e22.var_2153c223, var_2c912e22.var_510d7f2b);
		if(isdefined(var_2c912e22.var_f702cf26))
		{
			self setweaponammoclip(var_2c912e22.var_2153c223.dualwieldweapon, var_2c912e22.var_f702cf26);
		}
	}
	s_slot.n_state = 0;
...
{
	var_bcd1c2ff = function_50564ecc(var_ea6b9209);
	var_2c912e22 = level.var_cb94d41d.var_e76526e8[n_slot];
	s_slot.n_ammo_clip = n_ammo_clip;
	var_2c912e22.var_510d7f2b = var_510d7f2b;
	var_2c912e22.var_f702cf26 = var_f702cf26;
	function_83699c26(n_slot);
	s_slot.n_state = 2;
	var_2c912e22.var_2153c223 = var_ea6b9209;
...
{
	var_bcd1c2ff = function_5c934f81(0);
	if(isdefined(n_slot))
	{
		level.var_cb94d41d.var_e76526e8[n_slot].n_state = 1;
		level.var_d9d721fd.entity showpart("tag_gun_" + n_slot);
...
{
	var_e76526e8 = level.var_cb94d41d.var_e76526e8;
...
function function_117157d7()
{
	...
	{
		if(self cschashed-3\script_28144a2871e71a78::function_bcec00bc(s_ww_pickup.origin, 15, 0))
		{
	...
	if(isdefined(n_slot))
	{
		...
		if(level.var_cb94d41d.var_e76526e8[n_slot].n_state == 2)
		{
			if(var_1c55459)
			{
		...
		else if(level.var_cb94d41d.var_e76526e8[var_bcd1c2ff].n_state == 1 && namespace_9cf755b::function_c654e39a(var_2c09b688))
		{
			s_action.n_id = 6;
		}
	}
...
{
	foreach(var_2c912e22 in level.var_cb94d41d.var_e76526e8)
	{
		if(s_slot.n_state == 1)
		{
			return 1;
...
private function function_33f0ddd3(s_event)
{
	if(s_event.event === "take_weapon" && namespace_9cf755b::function_c654e39a(s_event.weapon))
	{
		...
		{
			var_963473a1 = !isinarray(self.var_c27f1e90, #"specialty_additionalprimaryweapon") && self.var_2a62e678 === var_ea6b9209;
		}
		else
		{
			...
			var_bcd1c2ff = function_50564ecc(var_ea6b9209);
			var_87103d2d = level.var_cb94d41d.var_e76526e8[n_slot].n_state == 2;
