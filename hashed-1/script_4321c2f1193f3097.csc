...
function __init__()
{
	...
	clientfield::register("allplayers", "" + #"hash_dce196aefa0c9d", 1, 1, "counter", &function_cde26b0e, 1, 0);
	clientfield::register("allplayers", "" + #"hash_50aa88683b97ef09", 1, 1, "counter", &function_3f83a22f, 0, 0);
	...
	clientfield::register("toplayer", "" + #"scepter_rumble", 1, 3, "counter", &scepter_rumble, 0, 0);	level._effect[#"hash_1c2f974106158a5f"] = #"hash_7c1a6aad09dc0d7a";
...
function function_f11b8d1d(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.var_ff2eebc7))
	{
...
{
	if(newvalue && !cschashed-2\script_70ab01a7690ea256::is_active(#"hash_65cfe78dc61dd3af"))
	{
...
function revive_fx(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.var_a776839a))
	{
