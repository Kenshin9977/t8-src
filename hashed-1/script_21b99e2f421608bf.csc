...
hashed-1\script_1d99711a5c22bdef.csc;
...
function init_clientfields()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp1", 8000, #"kp_1", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp2", 8000, #"kp_2", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp3", 8000, #"kp_3", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp1_halfway", 8000, #"hash_5ff0996978af5e05", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp2_halfway", 8000, #"hash_2e71806f86ca448c", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp3_halfway", 8000, #"hash_11f38acf5e773a0b", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_forest", 8000, #"kp_forest", 400, level._effect[#"hash_2f7d514a39482700"], level._effect[#"hash_27063b90fbaa52"], undefined, undefined, 1);
}
...
function function_da63d789(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.fx_blue_fire))
	{
...
function function_41640257(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.fx_wisp))
	{
		stopfx(localclientnum, self.fx_wisp);
