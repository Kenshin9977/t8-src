...
function function_5dff542c()
{
	...
	while(true)
	{
		...
		foreach(player in level.players)
		{
			if(isalive(player))
			{
				player gsczm_powerup_dung::function_b8dfa139(#"hash_5986c925a370e137");
			}
		}
	}
}
...
function function_ac904e5e()
{
	...
	namespace_c3287616::function_306ce518(#"catalyst", &function_40dfd00b);	namespace_c3287616::function_306ce518(#"blight_father", &function_dcf7377c);
	namespace_c3287616::function_cc103b38(#"catalyst", 6);	level thread function_11962516();
}
