...
#namespace cschashed-1\script_4b4a4b9186e38fd6;
...
function preload()
{
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"little_bird_1", 24000, "little_bird_1", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"little_bird_2", 24000, "little_bird_2", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"little_bird_3", 24000, "little_bird_3", &function_8598f0d4, &function_3bdbb583, 1);
...
function function_742dfdb5(var_a276c861)
{
	if(!var_a276c861)
	{
		...
		{
			wait(2);
			level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_fuse_lighthouse", 0, 0, 1);
		}
		...
		if(level.var_98138d6b > 1)
		{
			level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_fuse_partial_charge", 0, 0, 1);
		}
	}
}
...
function door_think()
{
	...
	if(level.var_98138d6b > 1)
	{
		level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_shard_reveal", 0, 0, 1);
	}
}
...
function function_c723e684(var_a276c861)
{
	if(!var_a276c861)
	{
		...
		{
			level thread cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(var_b4602d24.var_b9989e12);
		}
		...
		if(level.var_98138d6b > 1)
		{
			level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_fuse_complete_charge", 0, 0, 1);
		}
		wait(3);
...
{
	if(isdefined(ent) && ent.entity_type === #"zombie_electric")	{
