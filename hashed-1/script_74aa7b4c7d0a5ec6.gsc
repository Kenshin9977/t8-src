...
#namespace cschashed-3\script_1897274c91c06252;
...
{
	self cschashed-3\script_56196bc0b4296d0c::function_1d34f2b6();
...
{
	return isdefined(self.entity_type) && self.entity_type == #"hash_536e9f304d677717";
}
...
{
	return isdefined(self.entity_type) && self.entity_type == #"hash_3a67e595e19f61b2";
}
...
{
	function_c33d4387();
	cschashed-3\script_56196bc0b4296d0c::function_c5b157a6(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime);
}
...
private function function_6e16f65f(entity)
{
	...
	{
		var_473f60e5 = entity getblackboardattribute("_phase_direction");
		result = var_473f60e5 != "NONE";
	}
	return result;
}
...
private function function_ac651298(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	else if(self.archetype == #"nova_crawler" && isdefined(self.entity_type) && self.entity_type == #"hash_536e9f304d677717" && !isplayer(attacker))
	{
		return 0;
	}
	return -1;
...
private function function_91582c6(entity, start_location, var_85e6dc61)
{
	...
	if(isdefined(entity.entity_type) && entity.entity_type == #"hash_536e9f304d677717")
	{
...
function function_c36cef22(origin)
{
	...
	foreach(player in players)
	{
		...
		{
			player status_effect::status_effect_apply(function_4d1e7b48(#"hash_1b824ff143d6ba43"), undefined, player, 0);
		}
	}
...
function function_3ec863f5()
{
	...
	while(true)
	{
		...
		foreach(player in players)
		{
			...
			{
				player status_effect::status_effect_apply(function_4d1e7b48(#"hash_1b824ff143d6ba43"), undefined, player, 1);
			}
		}
		wait(0.15);
	}
