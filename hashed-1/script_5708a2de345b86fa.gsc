...
function main()
{
	...
	while(true)
	{
		...
		{
			level cschashed-3\script_318816742cac11da::function_6acd363d(0);
		}
	}
}
...
function function_21e77256()
{
	...
	foreach(m in level.var_df3991a)
	{
		if(isdefined(m))
		{
			m thread cschashed-1\script_3eb41f1152506dc6::function_edcadf04();
		}
	}
}
...
function spawn_boss()
{
	...
	cschashed-3\script_12549eb8cb2580e4::spawn_boss();
	if(isdefined(level.var_43c333a8))
	{
...
function spawn_done(n_threshold)
{
	...
	if(isdefined(level.var_43c333a8))
	{
		...
		self cschashed-2\script_46e91476638fe176::function_ed39491e(1);
	}
	...
	if(isdefined(level.var_43c333a8))
	{
		self cschashed-2\script_46e91476638fe176::function_ed39491e(4);
		...
		level thread cschashed-3\script_12549eb8cb2580e4::function_3418b6f6();
	}
}
