...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_4803a4a42dd83650", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(!round_reset)
	{
		if(!level flag::get(level.var_5bfd847e))
		{
			...
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_ad3c47f53414b85");
			}
			else
			{
				cschashed-1\script_3c362258ff800237::fail(#"hash_765b6a6e9523c15a");
			}
		}
	}
}
