...
autoexec function main()
{
	...
	spawner::add_archetype_spawn_function(#"catalyst", &function_728127b);	spawner::add_archetype_spawn_function(#"catalyst", &function_5608540a);	namespace_c61045a2::registercatalystinterfaceattributes();
}
...
function function_5608540a()
{
	...
	if(isdefined(self.entity_type) && isdefined(var_9d3ec6f[self.entity_type]))
	{
		function_27c82a36(self, var_9d3ec6f[self.entity_type]);
	}
}
