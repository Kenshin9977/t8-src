...
#namespace cschashed-1\script_6b91760bb3045851;
...
function init(var_5ea5c94d)
{
	...
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"zblueprint_mansion_silver_bullet", &function_5a6cebce);
...
function function_766980a4()
{
	...
	while(true)
	{
		...
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_26da6ef83af4ba62", 1);
			break;
		}
	}
}
...
{
	var_235457fd = self cschashed-1\script_6d85b093d74cdfdd::function_126fc77c(e_player);
	if(var_235457fd)
	{
		var_87d6e5ff = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(self.stub.blueprint.name);
		var_b3c7df1a = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(#"zblueprint_mansion_silver_molten");
		if(!namespace_93829f86::function_e60b2d22(e_player, var_87d6e5ff.var_7b8e4241) && namespace_93829f86::function_e60b2d22(e_player, var_b3c7df1a.var_99577dd3) && namespace_93829f86::function_e60b2d22(e_player, var_b3c7df1a.var_670f9944) && cschashed-2\script_257d7bea5de94cbf::function_e60b2d22(e_player, var_b3c7df1a.var_2e0a273a))
		{
...
function function_252cf612(player)
{
	...
	if(!cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(var_12680c28) && !zm_equipment::is_equipment(var_12680c28) && (!(isdefined(var_12680c28.isriotshield) && var_12680c28.isriotshield)) && !zm_weapons::is_wonder_weapon(var_12680c28) && var_12680c28 != level.weaponnone)
	{
...
function function_ec89dca9()
{
	...
	if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(w_current) || zm_equipment::is_equipment(w_current) || (isdefined(w_current.isriotshield) && w_current.isriotshield) || zm_weapons::is_wonder_weapon(w_current) || w_current == level.weaponnone)
	{
		return 1;
	}
