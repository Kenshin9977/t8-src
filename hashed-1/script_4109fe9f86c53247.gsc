...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_4dad05c408e466f5", &function_d1de6a85, &function_9e7b3f4d);
}
...
function function_202ee8fa()
{
	...
	if(isbot(self))
	{
		self thread cschashed-3\script_520360b6c44baa8b::function_8eb7b0f7();
	}
	else
	{
