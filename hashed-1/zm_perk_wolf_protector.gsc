...
#namespace cschashed-2\script_76d633558ae96abc;
...
function function_ce74ad2e()
{
	...
	self endon(#"death", #"disconnect", #"wolf_protector_spawn");	self.var_669304d0 = 1;
	wait(4);
...
function function_f3cd6eac()
{
	...
	while(self.var_669304d0)
	{
		...
		if(self.var_2dc0d63c >= level.zombie_health * 6 || self.var_841cdb3 >= 6 && !isdefined(self.var_5e8ff98e) && !self scene::is_igc_active())
		{
			...
			self notify(#"wolf_protector_spawn");			wait(1.5);
...
function function_562ade9e()
{
	...
	if(isdefined(spawn_location) && !function_94e08717(spawn_location))
	{
	...
	if(!isdefined(self.var_5e8ff98e))
	{
		...
		if(isdefined(ai))
		{
			...
			if(isdefined(ai))
			{
				ai show();
				ai spawn_shockwave();
				ai playsound(#"hash_23f910b5788fb93e");
...
/*
	...
	Flags: Linked
*/
function function_94e08717(pos)
{
...
function function_eb6d99d7(var_1483b30b)
{
	...
	while(n_time_left > 0)
	{
		...
		var_c2093736 = n_time_left / var_1483b30b;
		var_c2093736 = math::clamp(var_c2093736, 0.02, var_1483b30b);
		if(self hasperk(#"hash_4519dc1d3ac79139") && isdefined(self.var_7d46fb46))
		{
...
function function_7d72c6f9(var_85dcb56c)
{
	...
	while(true)
	{
		...
		var_c2093736 = 1 - self.var_72c60d5 / var_85dcb56c;
