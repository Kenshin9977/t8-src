...
#namespace cschashed-1\script_5eca3e484e3a306f;
...
function __init__()
{
	...
	clientfield::register("toplayer", "" + #"hammer_rumble", 1, 1, "counter");	level.hero_weapon[#"hammer"][0] = getweapon(#"hero_hammer_lv1");
	...
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_hammer_lv1");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_hammer_lv2");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_hammer_lv3");
...
function hammer_rumble(n_index)
{
	...
	if(n_index)
	{
		...
		switch(n_index)
		{
			...
			case 4:
			{
				self clientfield::increment_to_player("" + #"hammer_rumble", 4);				break;
			}
		}
	}
}
