...
#namespace cschashed-2\script_43de70169069c6ab;
...
function function_3fcb1e5e()
{
	...
	foreach(var_18b64c03 in var_679f0ee5)
	{
		...
		var_464b9245 = struct::get(var_f6cdf98c);
		var_464b9245.script_int = var_18b64c03.var_825e7054;
...
function function_88cbb4b3(player)
{
	...
	if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(player getcurrentweapon()))
	{
		self sethintstring("");
		return 0;
	}
...
function function_32fbad12(a_ents)
{
	...
	else
	{
		...
		if(n_chance < 4 || (isdefined(level.var_38e38e53) && level.var_38e38e53) && !isdefined(level.var_5c14fe03) && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive"))
		{
...
{
	/#
		var_1c01fdda = cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683(#"hash_1e5657f6a6f09389");
		foreach(e_player in level.activeplayers)
		{
			e_player cschashed-1\script_6d85b093d74cdfdd::function_3e29352d(var_1c01fdda);
		}
