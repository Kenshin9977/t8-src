...
#namespace cschashed-3\script_bcfea63f62d87d3;
...
function function_ef0bfb9d()
{
	...
	while(true)
	{
		...
		var_a5a1f99c = arraycombine(var_a5a1f99c, getaiarchetypearray(#"catalyst"), 0, 0);		var_61c9e8b6 = arraycombine(var_a5a1f99c, var_61c9e8b6, 0, 0);
