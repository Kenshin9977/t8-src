...
#using hashed-2\zm_bot_action.gsc;
...
private function function_70e42260()
{
	if(isprofilebuild())
	{
		if(getdvarint(#"hash_715f454c35bbf7d3", 0))
		{
			if(isbot(self))
			{
				self.allowdeath = 0;
...
{
	/#
		if(getdvarint(#"hash_19a03778c3d20a4a", 0) == 0)
		{
			return;
		}
		players = getplayers();
...
function function_e16b5033(actor)
{
	...
	if(level.var_faf67c27[actor.archetype].round_number != level.round_number)
	{
		...
		{
			max_health = float(actor cschashed-1\script_5a012bbb9342dbdf::function_8d44707e(level.var_faf67c27[actor.archetype].var_6109b81d, override_round_num));
		}
