...
#namespace cschashed-2\script_42dd312945896668;
...
function function_751c64a4(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(newval == 1)
	{
		self.fx_vortex = playfx(localclientnum, "zm_weapons/fx8_www_dazed_vortex", self.origin, v_forward, v_up);
		playsound(localclientnum, #"hash_65790bfd14f9d80e", self.sound_origin);
		audio::playloopat(#"hash_23133277b3364bd2", self.sound_origin);
	}
	else if(isdefined(self.fx_vortex))
	{
		stopfx(localclientnum, self.fx_vortex);
		self.fx_vortex = undefined;
	}
...
function function_84884488(localclientnum)
{
	...
	wait(0.7);
	if(self.archetype === #"zombie" || self.archetype === #"catalyst" || self.archetype === #"nosferatu")	{		if(!isdefined(level.var_4fea6622))
		{
