...
function init()
{
	...
	cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"zblueprint_trap_hellpools", &function_55d14d78);
}
...
function function_7cc8a854()
{
	...
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(var_d58ee8b5, &function_b54b9d5e);
...
private function function_a3661fef()
{
	...
	var_6645c992 = cschashed-1\script_6d85b093d74cdfdd::function_b18074d0(#"zblueprint_trap_hellpools");
	while(true)
	{
		level waittill(#"hash_78451720bf647f70");
		foreach(e_player in getplayers())
		{
			if(cschashed-1\script_6d85b093d74cdfdd::function_6d1e4410(e_player, var_6645c992))
			{
...
function function_55d14d78()
{
	...
	level thread cschashed-1\script_6d85b093d74cdfdd::function_ca244624("zblueprint_trap_hellpools");
	...
	if(isalive(self) && (!(isdefined(self.var_62b59590) && self.var_62b59590)))
	{
		...
		if(isplayer(self))
		{
			if(!self laststand::player_is_in_laststand() && !level flag::get("round_reset"))
			{
				...
				if(zm_utility::can_enable_ee() && self flag::get(#"hash_6757075afacfc1b4"))
				{
