...
#namespace cschashed-3\script_1964b042d2f814f9;
...
function preload()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"snowball_campfire_1", 24000, "snowball_campfire_1", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"snowball_campfire_2", 24000, "snowball_campfire_2", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"snowball_campfire_3", 24000, "snowball_campfire_3", &function_8598f0d4, &function_3bdbb583, 1);
...
function function_f77c5d83()
{
	...
	while(!b_hidden)
	{
		...
		if(s_result.weapon.name === #"hash_4b7e4696d38d13e3" || s_result.weapon.name === #"hash_1ecb90ddb44096f4")
		{
...
function function_37507fb7(var_a276c861)
{
	if(!var_a276c861)
	{
		foreach(var_5114825f in level.var_d41eca77)
		{
			...
			var_5114825f.var_29c7dbd6 = spawn("script_origin", s_campfire.origin);
			var_5114825f.var_29c7dbd6 playloopsound(#"hash_4557560b04b84279");
			cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(var_5114825f.var_b9989e12);
...
function function_c0ee8171()
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_spleen", 1, level.var_733d6b98);
...
function function_50cd80d8(e_who)
{
	...
	if(level.var_98138d6b > 1 && !level flag::get(#"hash_2b7269d8e32bf3d7"))
	{
		...
		level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_spleen_pickup", 0, 1, 0);
	}
}
...
function function_c9195d31()
{
	...
	if(level.pablo_npc.var_df3d62aa == 10)
	{
		...
		level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_spleen", 0, level.var_733d6b98);
	}
}
...
function function_d4d89065()
{
	...
	{
		level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_spleen_fail", 0, 1, 0);
	}
}
