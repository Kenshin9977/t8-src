...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_12dc7b4f915f4cf1", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(n_timer)
{
	...
	cschashed-1\script_3d5821d793ed4c6::function_2976fa44(function_d2a5d1f0());
	cschashed-1\script_3d5821d793ed4c6::function_2976fa44(function_e242d7a8());
	level thread function_b2fa4678();
	if(isdefined(n_timer))
	{
		self.n_timer = cschashed-1\script_3c362258ff800237::function_5769f26a(n_timer);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(!round_reset)
	{
		...
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_2c31c30f3d0b0484", getplayers());
		}
	}
...
private function function_b2fa4678()
{
	...
	while(true)
	{
		...
		if(var_54e16eaa != var_c43a6efa)
		{
			...
			{
				cschashed-1\script_3d5821d793ed4c6::function_dace284(var_54e16eaa);
			}
...
private function function_e04dd27a(n_timer)
{
	...
	foreach(player in getplayers())
	{
		player cschashed-1\script_3d5821d793ed4c6::function_128378c9(n_timer, 1, #"hash_c2b77be4cf5b142");
	}
