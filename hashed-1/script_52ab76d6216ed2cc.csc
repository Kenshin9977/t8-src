...
function init_clientfields()
{
	...
	clientfield::register("scriptmover", "" + #"land_fx", 1, 1, "int", &function_48719840, 0, 0);	clientfield::register("scriptmover", "" + #"hash_1f082a274b1fb6e8", 1, 1, "int", &function_92436a06, 0, 0);
	...
	clientfield::register("scriptmover", "" + #"blocker_fx", 1, 1, "int", &function_74e395f7, 0, 0);	clientfield::register("scriptmover", "" + #"hash_68e2384b254175da", 1, 1, "counter", &function_9a686624, 0, 0);
	...
	clientfield::register("toplayer", "" + #"boiler_fx", 1, 1, "int", &function_d592393d, 0, 0);	clientfield::register("toplayer", "" + #"hash_2bde374c37c3f679", 1, 1, "int", &function_94822f89, 0, 0);
...
function init_fx()
{
	...
	level._effect[#"hash_493ce8ba1e437ab7"] = #"hash_464f27bfbf0ce7bf";
	...
	level._effect[#"hash_2f74b3d9f5d2a35f"] = #"hash_6a4db7ffc84cf7fc";
	level._effect[#"hash_91da44e288581b5"] = #"hash_6d900123df67f4ce";
	...
	level._effect[#"hash_3611c4f98f9c87d1"] = #"hash_454a052cba35b654";
	level._effect[#"hash_7c9e7b0f06e3ef6d"] = #"hash_22f995964a88d0e0";
	level._effect[#"hash_754edd15bdb86004"] = #"hash_39b325729fc733ae";
	level._effect[#"hash_5c7955474ae2180a"] = #"hash_4d7b9b72e10c3737";
	level._effect[#"hash_2c6e7e3b94da406f"] = #"hash_6776cc88134ba740";
}
...
{
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_41a5c5168ffb2a97", 1, #"hash_3d7f94e7862a63ab", 50, level._effect[#"hash_2e7f9a3bff90af4a"], level._effect[#"hash_59916e76378fa3d8"], undefined, &function_7729e81c);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_400a481490a4e390", 1, #"hash_3d7f94e7862a63ab", 50, level._effect[#"hash_573af1567956ac69"], level._effect[#"hash_1e6b4bfa36f9487b"], undefined, &function_7729e81c);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_5562e324d230f057", 1, #"hash_3d7f94e7862a63ab", 50, level._effect[#"hash_538a9337bb9927da"], level._effect[#"hash_4b9011909a431ac8"], undefined, &function_7729e81c);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_41fae186552f1259", 1, #"hash_3d7f94e7862a63ab", 50, level._effect[#"hash_3dba8e7d212e4382"], level._effect[#"hash_50a595992ac285d0"], undefined, &function_7729e81c);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_7182a46bb3cdf577", 1, #"hash_7182a46bb3cdf577", 111, level._effect[#"hash_2e7f9a3bff90af4a"], level._effect[#"hash_59916e76378fa3d8"], undefined);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_466c2764cc790370", 1, #"hash_466c2764cc790370", 111, level._effect[#"hash_573af1567956ac69"], level._effect[#"hash_1e6b4bfa36f9487b"], undefined);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_34f2b4c4f7d74137", 1, #"hash_34f2b4c4f7d74137", 111, level._effect[#"hash_538a9337bb9927da"], level._effect[#"hash_4b9011909a431ac8"], undefined);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"hash_49ad34a64ecaebb9", 1, #"hash_49ad34a64ecaebb9", 111, level._effect[#"hash_3dba8e7d212e4382"], level._effect[#"hash_50a595992ac285d0"], undefined);
}
...
function function_bcb676b9()
{
	...
	{
		s_result = undefined;
		s_result = level waittill_timeout(20, #"hash_5010527c7518e767");
...
function function_49661954(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.var_9176527d))
	{
...
function function_9a686624(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	if(newval)
	{
		fx = util::playfxontag(localclientnum, level._effect[#"glyph_activate"], self, "tag_origin");		playsound(localclientnum, #"hash_6dfc68e5f7739824", self.origin);
		wait(3.5);
		if(isdefined(fx))
		{
...
function function_92436a06(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else if(isdefined(self.var_92d5024f))
	{
...
function function_9f92e675(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(newval == 1)
	{
		util::playfxontag(localclientnum, level._effect[#"tree_activate"], self, "tag_origin");		self playsound(localclientnum, #"hash_35bdc93fbbad3294");
...
function function_57196646(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	if(newval == 1)
	{
		util::playfxontag(localclientnum, level._effect[#"tree_trail"], self, "tag_origin");		self playsound(localclientnum, #"hash_c5737dedcdad3a8");
	}
	else
	{
		util::playfxontag(localclientnum, level._effect[#"tree_impact"], self, "tag_origin");		self playsound(localclientnum, #"hash_3d9dcef3d979480b");
		function_36e4ebd4(localclientnum, #"hash_2e8bb4e737eaf9b0");
	}
}
