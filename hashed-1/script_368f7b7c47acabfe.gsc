...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_32bd34ef989ddd03", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(n_count)
{
	...
	level.var_195590fb = cschashed-1\script_3c362258ff800237::function_5769f26a(n_count);
	foreach(player in getplayers())
	{
		player.var_92cd5237 = [];
		player cschashed-1\script_3d5821d793ed4c6::function_c2cd0cba(level.var_195590fb);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(!round_reset)
	{
		...
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_6dbd3c476c903f66", var_57807cdc);
		}
		else if(var_57807cdc.size > 1)
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_59d734dda39935cf", var_57807cdc);
		}
	}
...
private function function_aebeafc0(upgraded_weapon)
{
	...
	{
		cschashed-1\script_3d5821d793ed4c6::function_2190356a(self.var_92cd5237.size);
	}
}
