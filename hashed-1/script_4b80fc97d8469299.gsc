...
function preload()
{
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_pap_beach", 24000, "sc_pap_beach", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_pap_boathouse", 24000, "sc_pap_boathouse", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_pap_ship", 24000, "sc_pap_ship", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_pap_lagoon", 24000, "sc_pap_lagoon", &function_8598f0d4, &function_3bdbb583, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_pap_island", 24000, "sc_pap_island", &function_8598f0d4, &function_3bdbb583, 1);
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 6);
	if(!var_5ea5c94d)
	{
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 9);
	if(!var_5ea5c94d)
	{
		...
		level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_17b44ac72ae4b92f", -1, 0, 1);
		level thread function_8c273b51();
		while(!cschashed-3\script_e2bef0652b31f68::any_player_in_zone(array("ice_floe")))
		{
			waitframe(1);
		}
...
function function_3c9be590(var_5ea5c94d, ended_early)
{
	...
	cschashed-3\script_20422991283c1b8::spawn_guide();
...
function function_dc380897()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(var_deb6871b.var_b9989e12);
	level flag::set(#"infinite_round_spawning");
