...
#namespace cschashed-2\script_442a4e554bcd7c3b;
...
function main()
{
	...
	level.var_63a35083 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0("mq_blood_loc", "targetname", "script_int");
	level.var_e70fa660 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0("mq_blood_whisp_loc", "targetname", "script_int");
...
function function_8d43b840(var_5ea5c94d)
{
	if(!var_5ea5c94d)
	{
		...
		switch(level.var_9e3c632e)
		{
			case 1:
			{
				cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 3);
				break;
			}
			case 2:
			{
				cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 5);
				break;
			}
			case 3:
			{
				cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_2fbec633e5118bab", 7);
				break;
			}
		}
		while(!cschashed-3\script_e2bef0652b31f68::any_player_in_zone(array("artifact_storage")))
		{
			waitframe(1);
		}
		switch(level.var_9e3c632e)
		{
			case 1:
			{
				level.var_60b08c24 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3cd0832e040f6c84", -1, 0, 1);
				break;
			}
			case 2:
			{
				level.var_60b08c24 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_65bb9d30e635b942", -1, 0, 1);
				break;
			}
			case 3:
			{
				level.var_60b08c24 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_6222894db8f79c0c", -1, 0, 1);
				break;
			}
		}
...
function function_5a12b82()
{
	...
	switch(level.var_9e3c632e)
	{
		...
		case 3:
		{
			level.var_60b08c24 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_554da7ef3c71bc2a", -1, 0, 1);
			break;
		}
	}
	...
	switch(level.var_9e3c632e)
	{
		case 2:
		{
			...
			{
				level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_1ab690c8635a053b", -1, 0, 1);
			}
			break;
		}
		case 4:
...
function function_7535dc08()
{
	...
	level.var_60b08c24 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_17d537f3403651e2");
}
...
{
	level endon(#"end_game");
	level.var_60b08c24 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_359fe3561c4d0623", 0, 0, 1);
	level.var_60b08c24 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_359fe3561c4d0623", 1, 0, 1);
}
