...
function toggle_fire_sale_on()
{
	...
	for(i = 0; i < level.chests.size; i++)
	{
		...
		if(show_firesale_box)
		{
			...
			{
				if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_4e0ec3fe56f08b47") != 3)
				{
...
{
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_4e0ec3fe56f08b47") == 0 || zombie_utility::function_d2dfacfd(#"zombie_powerup_fire_sale_on") == 1 || level.chest_moves < 1 || (isdefined(level.disable_firesale_drop) && level.disable_firesale_drop))
	{
		return 0;
	}
	return 1;
