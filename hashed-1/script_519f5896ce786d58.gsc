...
function function_53e45f4e()
{
	...
	while(true)
	{
		...
		if(isdefined(b_in_range) && b_in_range && (!(isdefined(self clientfield::get("" + #"force_stream_model")) && self clientfield::get("" + #"force_stream_model"))))		{			self clientfield::set("" + #"force_stream_model", 1);		}
		else if(!isdefined(b_in_range) && (isdefined(self clientfield::get("" + #"force_stream_model")) && self clientfield::get("" + #"force_stream_model")))		{			self clientfield::set("" + #"force_stream_model", 0);		}
...
function function_8bb2971c()
{
	...
	arrayremovevalue(var_50b185d1, n_solution);
...
function function_4e833729()
{
	...
	foreach(var_c3be418 in var_ecc45b8c)
	{
		...
		{
			var_9e7c3935 = util::spawn_model(s_symbol.model, s_symbol.origin, s_symbol.angles);
		}
	}
	level flag::wait_till(#"hash_65224b2f37fb9446");
