...
function function_7b29c2d2(weapon)
{
	...
	{
		self thread cschashed-2\script_158d50d476435605::function_896ac347(weapon, #"hash_31b99e3970f80a7f", 1);
		self.var_88ebd633.var_d9449a3 = 0;
...
function function_432cf6d(weapon)
{
	...
	{
		self thread cschashed-2\script_158d50d476435605::function_896ac347(weapon, #"hash_25e0a2c8e52ead0d", 1);
		self.var_88ebd633.var_bcacb3a3 = 0;
...
function function_4092decc(weapon)
{
	...
	{
		self cschashed-2\script_158d50d476435605::function_896ac347(weapon, #"hash_203688d7883cf38c", 1);
		if(zm_pap_util::function_7352d8cc(weapon))
		{
			self cschashed-2\script_158d50d476435605::function_896ac347(weapon, #"hash_300fdf15a515feda", 1);
		}
	}
	else
	{
