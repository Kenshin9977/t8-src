...
function __init__()
{
	...
	spawner::add_archetype_spawn_function(#"nosferatu", &function_c12f7b53);	namespace_57ff8cbb::function_cdf5a512(#"nosferatu", &function_4c71848e);	callback::on_player_damage(&function_8dc028ba);
	...
	zm_score::function_e5d6e6dd(#"nosferatu", 60);	zm_score::function_e5d6e6dd(#"crimson_nosferatu", 80);	namespace_c3287616::register_archetype(#"nosferatu", &function_cf877849, &round_spawn, &function_74f25f8a, 25);	namespace_c3287616::register_archetype(#"crimson_nosferatu", &function_97f1f86e, &function_a8a8c2fb, undefined, 100);	namespace_c3287616::function_306ce518(#"crimson_nosferatu", &function_57abef39);	level.var_243137e = getentarray("zombie_nosferatu_spawner", "script_noteworthy");
...
private function function_c12f7b53()
{
	...
	var_eb297ead = cschashed-1\script_5a012bbb9342dbdf::function_8d44707e(0);
	...
	self.var_fad2bca9 = 1;
	self.var_ccb2e201 = 0;
	if(self.entity_type === #"crimson_nosferatu")	{
		self.var_dd6fe31f = 1;
		self.var_f46fbf3f = 1;
		self.var_126d7bef = 1;
...
private function function_e05b2c36()
{
	...
	self.var_1c152654 = 1;
	self val::set(#"nosferatu", "health_regen", 0);	wait(self.var_cd35302f);
	self val::reset(#"nosferatu", "health_regen");	waitframe(5);
...
function function_8dc028ba(s_params)
{
	...
	if(isdefined(attacker) && isdefined(attacker.archetype) && attacker.archetype == #"nosferatu" && s_params.idamage > 0)	{
		...
		if(namespace_59ff1d6c::function_901b751c(#"hash_5c47775ddd2e17dd") == 2 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_5fbcaf0a1daae566") == 1)
		{
...
{
	var_219a33e2 = getaiarchetypearray(#"nosferatu");	var_e02fe4cb = var_219a33e2.size;
...
private function function_82785646(entity)
{
	...
	if(!isdefined(self.entity_type) || self.entity_type != #"crimson_nosferatu")	{
		return 0;
	}
...
{
	ai endon(#"death");
	ai val::set(#"nosferatu_spawn", "allowdeath", 0);	ai setfreecameralockonallowed(0);
	wait(1.5);
	...
	/#
		assert(isalive(ai), "");
	#/
	ai val::reset(#"nosferatu_spawn", "allowdeath");	wait(0.1);
	ai show();
	ai setfreecameralockonallowed(1);
	ai val::reset(#"nosferatu_spawn", "ignoreme");	ai notify(#"visible");
}
