...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_1d70527739c796e5", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	...
	foreach(player in getplayers())
	{
		...
		player thread cschashed-1\script_3d5821d793ed4c6::function_73ff0096();
	}
	level.var_7f31a12d = undefined;
	level cschashed-3\script_31055dfc068c1e62::function_d85bd834();
}
...
private function setup_lighthouse()
{
	...
	if(level.var_7d8bf93f zm_pack_a_punch::is_on())
	{
		...
		if(isdefined(var_611e46b7))
		{
			...
			var_611e46b7 thread cschashed-3\script_f459be361894751::function_69a4b74b(1);
			if(isdefined(var_611e46b7.target))
			{
				clip_brush = getent(var_611e46b7.target, "targetname");
				clip_brush thread cschashed-3\script_f459be361894751::function_4d7320f5(1);
			}
		}
	}
	...
	level thread cschashed-3\script_31055dfc068c1e62::function_ad646ef8(0);
...
function function_dbad2f5a()
{
	...
	self cschashed-3\script_31055dfc068c1e62::function_1b488412(vh_target.origin, 1);
	...
	self.vh_target thread cschashed-3\script_31055dfc068c1e62::function_18f63949();
	self cschashed-3\script_31055dfc068c1e62::function_2b2f2a7f();
	wait(1);
...
function function_f223e16f(round_reset)
{
	...
	if(round_reset !== 1)
	{
		level thread cschashed-3\script_31055dfc068c1e62::function_ad646ef8(1);
...
private function function_33f0ddd3(s_event)
{
	if(s_event.event === "give_weapon")
	{
		...
		else if(!var_f2b6fe6e && !cschashed-2\script_709bf7c56eb65adf::function_2ff6913(s_event.weapon))
		{
