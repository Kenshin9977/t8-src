...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_252ca56770c46935", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(timeout_time, var_b2c60867)
{
	...
	self.timeout_time = cschashed-1\script_3c362258ff800237::function_5769f26a(timeout_time);
...
private function function_ad32d69(var_b2c60867, timeout, var_ca735ce8, var_a4a28ac7)
{
	...
	self cschashed-1\script_3d5821d793ed4c6::start_timer(timeout - var_ca735ce8);
	while(true)
	{
