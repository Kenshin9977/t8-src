...
/*
	...
	Flags: None
*/
function function_52dff030(var_35ec2dc3)
{
	player = self;
	player giveweapon(var_35ec2dc3);
	player givemaxammo(var_35ec2dc3);
}
...
/*
	...
	Flags: None
*/
function function_263aa67d(str_team, str_targetname, var_216e25ba = 0, var_29b433bd)
{
...
/*
	...
	Flags: None
*/
function function_4d9cfd95(var_9bff2467, str_team, str_targetname, var_216e25ba = 0)
{
...
function on_bot_spawned()
{
	...
	{
		if(randomfloatrange(0, 1) < (isdefined(level.var_6dc9075f) ? level.var_6dc9075f : level.var_abdff161))
		{
...
function function_59458966(nd_spawn, n_state)
{
	...
	while(isdefined(nd_spawn.target))
	{
		...
		if(isdefined(nd_spawn.script_wait) && nd_spawn.script_wait > 0)
		{
			...
			self notify(#"hash_7302df3669fb310b");
		}
	}
...
{
	self endon(#"death", #"hash_7302df3669fb310b");
	while(true)
	{
