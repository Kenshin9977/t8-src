...
function enable_electric_cherry_perk_for_level()
{
	...
	{
		zm_perks::register_perk_basic_info(#"specialty_electriccherry", #"perk_electric_cherry", 3000, #"hash_4ab9a44c3f91468e", getweapon("zombie_perk_bottle_cherry"), getweapon("zombie_perk_totem_electric_burst"), #"hash_77c5cc2d9b6ca16c");
	}
...
function electric_cherry_laststand()
{
	...
	if(isdefined(self))
	{
		...
		{
			if(isalive(self) && isalive(a_zombies[i]) && !namespace_6b49f66b::is_active())
			{
