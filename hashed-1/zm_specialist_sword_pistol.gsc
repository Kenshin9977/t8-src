...
#namespace cschashed-2\script_52f584056ffc5d28;
...
function __init__()
{
	...
	clientfield::register("toplayer", "" + #"swordpistol_rumble", 1, 3, "counter");	level.hero_weapon[#"sword_pistol"][0] = getweapon(#"hero_sword_pistol_lv1");
	...
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_sword_pistol_lv1");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_sword_pistol_lv2");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_sword_pistol_lv3");
...
private function function_698ddbd9(weapon)
{
	...
	else if(n_level > 0)
	{
		...
		registerguy1_walla = a_trace[#"position"];
		check1 = distance(var_2ed6f142, registerguy1_walla);
		check2 = distance(var_2ed6f142, v_end);
		if(distancesquared(var_2ed6f142, var_a1db2464) < distancesquared(var_2ed6f142, v_end))
		{
			var_fb504c3b = registerguy1_walla;
		}
		else
		{
			var_fb504c3b = v_end;
...
private function function_e47a52e0(weapon)
{
	...
	var_f0ccd955 = (800_stomach_ > 0.1 ? 800_stomach_ : 0.1);
...
function function_974102c0(var_b2e05bae)
{
	...
	if(var_b2e05bae)
	{
		...
		switch(var_b2e05bae)
		{
			...
			case 2:
			{
				self clientfield::increment_to_player("" + #"swordpistol_rumble", 2);				break;
			}
			case 3:
			{
			...
			case 4:
			{
				self clientfield::increment_to_player("" + #"swordpistol_rumble", 4);				break;
			}
			case 5:
			{
				self clientfield::increment_to_player("" + #"swordpistol_rumble", 5);				break;
			}
		}
	}
}
