...
#namespace cschashed-2\script_102fa70a8153e81f;
...
function function_1c530e2d()
{
	/#
		...
		cschashed-3\script_318816742cac11da::function_6acd363d(1);
	#/
}
...
private function function_b60df00d()
{
	...
	{
		level.var_9eccff99.s_start = cschashed-3\script_e2bef0652b31f68::function_4e7f5b2e("mk2v_start");
	}
...
private function function_1129876d()
{
	...
	while(true)
	{
		...
		if(s_notify cschashed-3\script_e2bef0652b31f68::function_69320b44("zm_aat_kill_o_watt"))
		{
...
private function function_9d66ea6f(var_2e1f34dd, e_player)
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mod_phase", 0, e_player);
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2v_ammo", 1, e_player);
...
function function_130ea633()
{
	if(zm_utility::is_classic())
	{
		...
		self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_v_ammo_pickup");
...
private function function_e90f6026(var_2e1f34dd, e_player)
{
	...
	#/
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_ww_mk2v_ammo", 2, e_player);
...
function function_9d800221()
{
	if(zm_utility::is_classic())
	{
		cschashed-3\script_e2bef0652b31f68::function_29fe9a5d();
		self namespace_891c9bac::function_57b8cd17();
		self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_v_pickup");
		if(!namespace_3e3742fd::function_6cebbce1())
		{
...
function function_62ac32b9()
{
	if(zm_utility::is_classic())
	{
		cschashed-3\script_e2bef0652b31f68::function_29fe9a5d();
		self namespace_891c9bac::function_57b8cd17();
		self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_ww_v_craft");
		if(!namespace_3e3742fd::function_6cebbce1())
		{
