...
#namespace cschashed-3\script_31055dfc068c1e62;
...
{
	var_5de7068d = level.var_7d8bf93f.origin;
...
function function_320f5fb3()
{
	...
	switch(level.var_98138d6b)
	{
		...
		case 2:
		{
			level thread cschashed-3\script_f459be361894751::function_56db9cdc();
			if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerstate") != 2)
			{
				wait(3);
				level.var_1c53964e cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_power_switch_2_activate");
		...
		case 3:
		{
			...
			level thread cschashed-3\script_f459be361894751::function_2401694f();
			if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerstate") != 2)
			{
				wait(3);
				level.var_1c53964e thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_power_switch_3_activate");
			}
			break;
		}
	}
	...
	if(var_5606acc0.var_58df9892 !== n_state)
	{
		...
		switch(var_5606acc0.var_58df9892)
		{
			...
			case 1:
			{
				...
				var_628a2951 = zm_traps::function_da13db45(60, var_5606acc0.var_d9ae30d6);
			...
			case 6:
			{
				var_5606acc0 thread function_2675a3ff(var_5606acc0.var_d0b39293, var_5606acc0.var_d9ae30d6);
				break;
			}
			case 7:
			{
...
/*
	...
	Flags: Linked
*/
function function_2675a3ff(v_target, var_64c09f7f)
{
	self endon(#"death", #"hash_1aa56851d9d4ec0d");
	wait(0.5);
	function_8231044b(v_target, var_64c09f7f);
...
/*
	...
	Flags: Linked
*/
function function_8231044b(v_pos, var_64c09f7f)
{
	...
	if(isdefined(level.var_f18fbea5) && isdefined(level.var_f18fbea5.var_4eed727b))
	{
		if(distancesquared(v_pos, level.var_f18fbea5.var_4eed727b.origin) <= 250 * 250)
		{
...
function function_27304b98(var_a5a067c5, var_a75e9b3b)
{
	...
	var_548dce62 = var_a5a067c5.origin + var_82224aaf * cschashed-3\script_e2bef0652b31f68::function_b649cf93();
...
function function_2ad3b642(s_trap)
{
	...
	level.var_ab11c23d.var_223285b1 = var_3b2c2d10.var_223285b1;
...
function trap_switch_init()
{
	...
	a_pieces = cschashed-3\script_e2bef0652b31f68::function_bffcedde(self.target, "targetname", "script_noteworthy");
...
function function_85d3d607(e_player)
{
	if(level.var_98138d6b < 1)
	{
		self cschashed-3\script_e2bef0652b31f68::function_b2e1326(1);
	}
	else if(isdefined(level.var_4f7df1ac) && level.var_4f7df1ac)
	{
		self cschashed-3\script_e2bef0652b31f68::function_b2e1326(0);
	}
	else
	{
		switch(level.var_ab11c23d.var_58df9892)
		{
			...
			case 1:
			{
				self cschashed-3\script_e2bef0652b31f68::function_b2e1326(4);
				break;
			}
			case 2:
			{
				...
				{
					self cschashed-3\script_e2bef0652b31f68::function_b2e1326(2, int(500));
				}
				else
				{
					self cschashed-3\script_e2bef0652b31f68::function_b2e1326(2, 1000);
				}
				break;
			}
			case 3:
			...
			case 7:
			{
				self cschashed-3\script_e2bef0652b31f68::function_b2e1326(3);
				break;
			}
		}
	}
	...
	while(true)
	{
		if(isdefined(level.var_f18fbea5) && isdefined(level.var_f18fbea5.s_placement) && level.var_f18fbea5.s_placement.var_4eed727b istouching(self))
		{
			...
			if(var_76b556c9 >= 1)
			{
				...
				level.s_soapstone.is_charged = 1;
				level.s_soapstone.is_hot = 1;
				level.var_f18fbea5.s_placement.var_4eed727b clientfield::set("soapstone_start_fx", 2);
				level.var_f18fbea5.s_placement.var_4eed727b setmodel("p8_zm_ora_soapstone_01_hot");
				if(level.var_f18fbea5.var_b6e5b65f == 2)
				{
					level.var_f18fbea5.s_placement.var_28f1732d clientfield::set("soapstone_start_fx", 2);
					level.var_f18fbea5.s_placement.var_28f1732d setmodel("p8_zm_ora_soapstone_01_hot");
				}
				break;
			}
		}
...
{
	/#
		level.var_10f86d56 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0("", "", "");
		adddebugcommand("");
		adddebugcommand("");
		adddebugcommand("");
		while(true)
