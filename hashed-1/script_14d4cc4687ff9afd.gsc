...
#namespace cschashed-2\script_70e92046734b4a71;
...
function main()
{
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(getweapon(#"hash_7ca6dc6b2bfb8745"), &function_13febd4b);
	cschashed-2\script_257d7bea5de94cbf::function_4d230236(getweapon(#"hash_7ca6d96b2bfb822c"), &function_13febd4b);
...
function function_13febd4b(e_holder, var_9c95ad05)
{
	switch(var_9c95ad05.name)
	{
		case "hash_7ca6dc6b2bfb8745":
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_crank_1", 1);
		...
		{
			level.var_1537d233++;
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_crank_2", 1);
			self playsound(#"hash_3ec95ad193e1c377");
			break;
		}
	}
...
function function_2713a96a()
{
	...
	while(true)
	{
		...
		if(level.var_1537d233 > 0)
		{
			...
			{
				level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_crank_1", 0);
				level flag::clear(#"hash_7d230fa8f283c105");
			}
			else
			{
				level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_crank_2", 0);
			}
			self.var_2e77da49 = 1;
			level.var_1b737b93++;
			level.var_1537d233--;
...
function function_7ee05d66()
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_phase_num", 1);
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_zipquest_handle", 1);
}
...
function function_5dbd6a40(s_zipline_use)
{
	...
	self playsound(#"evt_zipline_start");	self.var_b20b0960 playloopsound(#"hash_19ebbf7f8bd1d5a5");
	...
	if(var_63259c33)
	{
		s_landing_point = self thread cschashed-2\script_27ba6748d83412fd::function_d4fbc062(s_zipline_use.var_508d5a11);
...
function function_fc9707f4(vnd_start, s_zipline_use)
{
	...
	if(cschashed-2\script_709bf7c56eb65adf::is_placeable_mine(w_current) || zm_equipment::is_equipment(w_current) || ability_util::is_weapon_gadget(w_current) || ability_util::is_hero_weapon(w_current))
	{
