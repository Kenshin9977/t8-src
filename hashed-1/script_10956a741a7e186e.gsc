...
#namespace cschashed-3\script_318816742cac11da;
...
function function_2790a022()
{
	...
	var_c247a965 = cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_29004a67830922b6");
	if(var_c247a965 === 1)
	{
...
function function_dc9c5c32()
{
	...
	if(isdefined(var_2b95ab5b))
	{
		...
		level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_38a4d1f9d149b97b", 0, 0);
		if(!(isdefined(level.var_15747fb1) && level.var_15747fb1 || (isdefined(level.var_4a03b294) && level.var_4a03b294) || !cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerstate") == 1))
		{
		...
		wait(1.5);
		level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_38a4d0f9d149b7c8", 0, 0);
	}
}
	...
	while(self.var_a1edb69e < 10)
	{
		...
		while(b_using && (!level flag::get(#"hash_1478cafcd626c361") || level flag::get(#"circuit_step_complete")))
		{
			...
			if(self.var_a1edb69e >= 10)
			{
				...
				{
					e_who cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_generic_responses_positive");
				}
...
function function_7103a97e()
{
	...
	level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_air_vent_repair", 0, 0);
	thread cschashed-3\script_e2bef0652b31f68::function_fd24e47f("vox_air_vent_repair_react", -1, 0, 1);
}
	...
	else
	{
		switch(level.var_bcaf8591)
		{
			...
			case 4:
			{
				...
				level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_7305313894f05e93", 0, 0);
				break;
			}
		}
	}
...
function function_b990c084()
{
	...
	zm_sq::start(#"hash_290a78ab47105457");
}
...
{
	level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_66d4e14752453ba5", 0, 0);
	level cschashed-3\script_e2bef0652b31f68::function_3c173d37();
	level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_66d4e047524539f2", 0, 0, 1);
	level cschashed-3\script_e2bef0652b31f68::function_3c173d37();
	level cschashed-3\script_e2bef0652b31f68::function_fd24e47f("vox_air_vent_repaired_react", -1, 0, 1);
}
	...
	while(level.var_bcaf8591 < 4 && n_spawned < n_to_spawn)
	{
		...
		if(isdefined(s_spawn_loc) && !level flag::get("mee_round"))
		{
			...
			if(isdefined(ai))
			{
				...
				ai cschashed-3\script_1897274c91c06252::function_dc0238e4();
				wait(6);
			}
		}
		wait(1);
...
function function_3e2137a4()
{
	...
	{
		self cschashed-3\script_1897274c91c06252::function_850768d1();
	}
}
		...
		if(level.var_154aee78 <= namespace_a28acff3::get_round_number())
		{
			...
			switch(level.var_bcaf8591)
			{
				case 0:
				{
					...
					level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3ed78c28756a66f", 0, 0);
					cschashed-3\script_e2bef0652b31f68::function_fd24e47f("vox_air_vent_repair", -1, 1);
					break;
				}
				case 1:
				{
				...
				case 3:
				{
					...
					level thread function_5be4c9e4(1);
					level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_48d01436dc5c21bb", 0, 0);
					var_e29c5f3b = function_21a3a673(1, 2);
					cschashed-3\script_e2bef0652b31f68::function_fd24e47f("vox_air_vent_repair", n_variant, 1);
...
{
	level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_4e0bf2b29c38452f", 0, 0);
	level thread cschashed-3\script_e2bef0652b31f68::function_fd24e47f("vox_generator_defend", -1, 1);
}
...
function function_2330b278()
{
	...
	level.var_63fca02d[#"portal_power"] thread cschashed-1\script_4c9e3a985ae04008::function_978923cd();
	level.var_63fca02d[#"portal_power"].b_active = 0;
	waitframe(1);
	level.var_63fca02d[#"portal_power"] thread cschashed-1\script_4c9e3a985ae04008::function_16ccd69f(0);
	...
	/#
		iprintlnbold("");
	#/
	level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_56c42fa94656e07b", 0, 0);
...
function function_6acd363d(is_completed)
{
	...
	level.var_63fca02d[#"portal_power"] cschashed-1\script_4c9e3a985ae04008::function_97d4ad50();
	if(level.var_63fca02d[#"portal_power"].b_placed === 1)
	{
		...
		{
			level.var_63fca02d[#"portal_power"] cschashed-1\script_4c9e3a985ae04008::function_16ccd69f();
		}
	}
	...
	if(is_completed)
	{
		...
		wait(1.5);
		level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_45611e2b5750e320", 0, 0);
		wait(1);
	...
	else
	{
		...
		wait(2);
		level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_213e287fc814959d", 0, 0);
	...
	while(level flag::get(#"hash_639e8274a1b57729") && !level flag::get(#"hash_40856b65dff0f6eb"))
	{
		...
		if(!var_d1ef124f)
		{
			switch(var_e6da0a39)
			{
				case 0:
				{
					level.var_8200dc81 cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e2502279778f5", 0, 0);
					level.var_7a86ba58 function_ccc74648("strong_04");
					break;
				}
				case 1:
				{
					level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e23022797758f", 0, 0);
					break;
				}
				case 2:
				{
					level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e2202279773dc", 0, 0);
					break;
				}
				case 3:
				{
					level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e210227977229", 0, 0);
					break;
				}
				case 4:
				{
					level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e200227977076", 0, 0);
					break;
				}
				case 5:
				{
					level.var_8200dc81 thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_737e1f0227976ec3", 0, 0);
					break;
				}
			}
...
function function_e2260632()
{
	...
	{
		ai = cschashed-1\script_5fb8da2731850d9e::function_62db7b1c(0, level function_d39f2f3e());
		level.var_9291cfb3 = #"zombie_dog";
		if(isdefined(ai))
		{
	...
	while(true)
	{
		...
		for(i = 0; i < players.size; i++)
		{
			if(players[i] istouching(self))
			{
				...
				{
					players[i] thread cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_nova_gas_encounter", -1, 1);
...
function function_b448360c()
{
	...
	var_905a9429 = [];
	var_51fb0ec7 = [];
	e_target = cschashed-3\script_e2bef0652b31f68::function_3815943c();
	...
	if(isentity(self))
	{
		self cschashed-1\script_5a012bbb9342dbdf::function_a8dc3363(s_spawn_loc);
		self ghost();
...
function function_75309b09()
{
	ai = undefined;
	e_target = namespace_df88241c::function_a5abd591();
	var_4a106fbe = cschashed-3\script_1897274c91c06252::function_51e81aba(level.var_b389ecc9);
