...
function function_e45ccfd7()
{
	...
	while(true)
	{
		...
		if(zm_utility::can_enable_ee() && isdefined(var_be17187b.var_4f3558ce))
		{
...
function function_10ef0925(var_4f3558ce)
{
	...
	function_8237489a(1);
	function_5c1184e(0);
	level clientfield::set("" + #"crowd_react_wave", 1);	if(isdefined(var_4f3558ce))
	{
	...
	level clientfield::set("" + #"crowd_react_wave", 0);	wait(3);
	function_5c1184e(1);
	function_8237489a(0);
...
function function_9c5fb1b5()
{
	...
	if(cschashed-1\script_3c362258ff800237::function_b47f6aba() || zm_utility::is_standard() || zm_utility::is_tutorial())
	{
		return;
	}
	while(true)
