...
#using hashed-3\killstreak_detect.gsc;
...
function function_d08e9d7f()
{
	...
	level notify(#"stop_nag");
	level notify(#"chasm_complete");	level notify(#"start_grapple_ledgel_collision");
...
{
	level endon(#"combattraining_logic_finished", #"chasm_complete");	level.var_8d109684 = undefined;
...
function function_e340db61()
{
	...
	level thread namespace_8c007aa6::function_14b08e49(array(#"hash_2774943be9e5dbd9"), "stop_nag");
	e_player = namespace_73e1c3e3::get_player();
	e_player thread namespace_73e1c3e3::player_collisionbox("s_hellstorm_start_obj", undefined, 2);
