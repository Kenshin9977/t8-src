...
{
	system::register(#"hash_56a68c2250d5f4e3", &__init__, &__main__, undefined);
}
...
function __main__()
{
	...
	else
	{
		...
		var_bbdf7e33 = struct::get_array("s_a_lo");
		foreach(var_ae1b7342 in var_bbdf7e33)
		{
...
{
	namespace_ee206246::register(#"hash_306a7f142403b7c6", #"1", #"hash_3203b932029a4e0b", &function_4d029800, &function_e3a2a8ab);
	namespace_ee206246::register(#"hash_11b42c4f95b60662", #"1", #"hash_4f409d159ce41d57", &function_cb19e12a, &function_a4810c2);
	...
	namespace_ee206246::register(#"hash_e1a54725ab6e00b", #"hash_66e936afdcdd5d4d", #"hash_574005386f679cf6", &function_21d4e9e9, &function_e7aa5f07);
	namespace_ee206246::register(#"hash_e1a54725ab6e00b", #"hash_385585cb6cbead68", #"hash_574004386f679b43", &function_14154e6a, &function_8d4b5efe);
	namespace_ee206246::register(#"hash_e1a54725ab6e00b", #"hash_42a50f35aa200869", #"hash_574003386f679990", &function_bd0aa04e, &function_13ebfa5e);
	namespace_ee206246::register(#"hash_43c0d767e3153981", #"hash_438156183f3f5ffa", #"hash_4ece05a6bb055afc", &function_71e9c5c6, &function_6bb97cee);
	namespace_ee206246::register(#"hash_43c0d767e3153981", #"hash_bf8e42b419290b3", #"hash_4ece08a6bb056015", &function_63afa952, &function_bec90157);
	namespace_ee206246::register(#"laundry_day", #"1", #"hash_77cae6c10f2939fa", &laundry_day, &function_50204407);
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_65a1298089d361f1") && !zm_utility::is_standard())
	{
	...
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_65a1298089d361f1") && !zm_utility::is_standard())
	{
		zm_sq::start(#"hash_43c0d767e3153981", 1);
	}
}
...
function function_d74dcf11()
{
	...
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c("zmPowerupDouble"))
	{
		arrayremovevalue(var_d0686fde, "double_points");
	}
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c("zmPowerupMaxAmmo"))
	{
		arrayremovevalue(var_d0686fde, "full_ammo");
	}
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c("zmPowerupInstakill"))
	{
...
function function_13ee3d14(n_index, var_5bb38717)
{
	...
	var_5bb38717.var_2f217f28 notify(#"hash_7e05ecbcf6c25592");
...
function spawn_infinite_powerup_drop(v_origin, str_type)
{
	...
	var_7d81025 = zm_powerups::specific_powerup_drop(str_type, v_origin);
...
{
	self endon(#"hash_7e05ecbcf6c25592");
...
function track_player_eyes()
{
	...
	while(!b_saw_the_wth)
	{
		...
		&& self zm_zonemgr::entity_in_zone("zone_catwalk_03") 
		&& is_weapon_sniper(self getcurrentweapon()) 
		&& self zm_utility::is_player_looking_at(var_616e76c5.origin, 0.9975, 0, self))
		{
...
function laundry_day(var_a276c861)
{
	...
	{
		s_result = undefined;
		s_result = var_5b4aa809.t_damage waittill(#"damage");
		if(isplayer(s_result.attacker))
		{
			var_5b4aa809.t_damage playsound(#"hash_33b90d54346e57e" + var_57724709);
			var_57724709++;
			wait(8.1);
		}
		if(var_57724709 >= 3)
...
/*
	...
	Flags: Linked
*/
function function_50204407(var_a276c861, var_19e802fa)
{
	var_5b4aa809 = struct::get("s_laundry_day", "targetname");
	if(isdefined(var_5b4aa809.t_damage))
	{
		var_5b4aa809.t_damage delete();
	}
}
...
/*
	...
	Flags: Linked
*/
function function_a4810c2(var_a276c861, var_19e802fa)
{
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_35a7187c()
{
	var_474ede10 = getent("graphic_01", "targetname");
	...
	while(true)
	{
		...
		if(isplayer(s_result.attacker))
		{
			if(cschashed-1\script_3a10f19f96036e97::function_b1dc801b(s_result.weapon, 3) && isdefined(s_result.attacker.var_be72e7c2))
			{
				break;
			}
		}
...
private function function_7f53281f()
{
	...
	while(true)
	{
		...
		{
			if(s_result.weapon == getweapon(#"hash_52b03a79f854eed3") || s_result.weapon == getweapon(#"hash_32a584f5a65c70d1") || s_result.weapon == getweapon(#"spknifeork"))
			{
				break;
			}
		}
...
private function function_62878c3d()
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.attacker))
		{
			if(s_result.weapon === getweapon(#"hash_32a584f5a65c70d1") || s_result.weapon == getweapon(#"spknifeork"))
			{
				break;
			}
		}
...
private function function_83abdd2b()
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.attacker))
		{
			if(cschashed-2\script_784bc1aee23dbf1f::function_c740060f(s_result.weapon, 2))
			{
				break;
			}
		}
...
function function_bdd1bac8(var_a1a0c2e3)
{
	...
	level endon_callback(&function_96c2cea0, #"hash_3698278a3a5d8beb");
	self endon_callback(&function_96c2cea0, #"stop_damage", #"hash_6ce63d9afba84f4c");
...
function function_8996bf17(var_6e6ec518, var_f67ecd64)
{
	...
	self.var_5ba94c1e = 1;
	level thread cschashed-1\script_6a0e50bc15d725a9::function_265e517c(self);
...
function function_f8c71bba()
{
	...
	var_7e484060 = struct::get_array("mg_fire_urn", "targetname");
	var_1d7104d7 = [];
	foreach(var_be23d332 in var_7e484060)
	{
		if(isdefined(var_be23d332.var_936d26df) && var_be23d332.var_936d26df)
		{
	...
	while(true)
	{
		...
		s_result = self waittill(#"throwing_tomahawk");
		var_288eb627 = s_result.e_grenade;
		self thread function_766c869a(var_288eb627);
		...
		while(isdefined(var_288eb627))
		{
			...
			{
				var_288eb627 clientfield::set("tomahawk_trail_fx", 2);
...
/*
	...
	Flags: Linked
*/
function function_766c869a(var_288eb627)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_47d4daf5()
{
...
/*
	...
	Flags: Linked
*/
function function_1877cfe4(var_288eb627)
{
...
function function_dab3dcc3()
{
	...
	var_6eb21a54 = util::spawn_model(#"hash_7e904f02c722b68b", var_c6b58daa.origin, var_c6b58daa.angles);
...
{
	self endon_callback(&function_1650b924, #"disconnect", #"hash_120fbb364796cd32");
	while(true)
	{
		s_result = undefined;
...
function function_90dac8fa()
{
	...
	while(true)
	{
		if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_4deb3ae7a73c87f3"))
		{
		...
		foreach(e_player in level.activeplayers)
		{
			if(e_player flag::exists(#"hash_120fbb364796cd32") && e_player flag::get(#"hash_120fbb364796cd32") && !e_player flag::get(#"hash_11ab20934759ebc3"))
			{
				...
				if(isdefined(e_dog))
				{
					...
					e_dog thread namespace_54386dac::function_7273c33d(var_3c29eed1, 0);
					e_dog setteam(#"allies");
					e_dog.script_noteworthy = "blast_attack_interactables";
					e_dog.var_c95261d = 0;
					e_dog.disable_flame_fx = 1;
					e_dog setcandamage(0);
					e_dog.var_77858b62 = &cschashed-2\script_711bbbba637da80::function_1cda4094;
...
function function_ac75d5bf(e_player, var_8ba7b26b)
{
	...
	if(isdefined(e_player))
	{
		...
		self waittill_timeout(8, #"hash_4607576ad3772956");
	}
...
function function_ef5a3a9d()
{
	...
	while(true)
	{
		...
		if(isplayer(e_attacker) && isalive(e_attacker) && e_attacker == self.e_owner && e_attacker flag::get(#"hash_120fbb364796cd32") && !e_attacker flag::get(#"hash_11ab20934759ebc3"))
		{
			...
			e_attacker thread zm_audio::create_and_play_dialog(#"hash_74a0ff3487006243", #"generic");
			self ghost();
			self setcandamage(1);
...
function function_f5a3ba79()
{
	...
	while(true)
	{
		...
		foreach(var_9c95ad05 in var_eecd6160)
		{
			if(var_9c95ad05.item == getweapon(#"hash_1e5656f6a6f091d6"))
			{
				var_a72ea4cb = var_9c95ad05;
				break;
			}
		}
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator) && isalive(s_result.activator))
		{
			...
			if(array::contains(var_24cc214c, w_current))
			{
				...
				s_result.activator thread cschashed-1\script_6a0e50bc15d725a9::function_804309c();
			...
			{
				s_result.activator status_effect::status_effect_apply(function_4d1e7b48(#"hash_19533caf858a9f3b"), undefined, self);
...
/*
	...
	Flags: Linked, Private
*/
private function function_c8220768()
{
	if(!isdefined(self))
	{
		return;
...
/*
	...
	Flags: Linked
*/
function function_ed96eb60(var_64c09f7f)
{
	if(isplayer(var_64c09f7f) && (isdefined(self.var_623f6a70) && self.var_623f6a70))
	{
		if(level.var_1a50fe78 == 0)
		{
			var_64c09f7f thread zm_audio::create_and_play_dialog(#"teleport", #"activate");
		}
		...
		var_64c09f7f playrumbleonentity(#"hash_38b09871eb37ced4");
		var_1da0aee8 setmodel(#"hash_622074cd880dc267");
		if(self.targetname == "walnut_teleporter_01")
		{
		...
		else
		{
			...
			{
				var_64c09f7f thread zm_audio::create_and_play_dialog(#"teleport", #"destroy");
			}
...
/*
	...
	Flags: Linked, Private
*/
private function function_beab34f9(v_origin)
{
...
function function_63afa952(var_a276c861)
{
	...
	{
		s_result.e_player thread zm_audio::create_and_play_dialog(#"hash_74a0ff3487006243", #"generic");
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_24089629()
{
	/#
	...
	var_bbdf7e33 = struct::get_array("s_a_lo");
	array::thread_all(var_bbdf7e33, &audio_log);
}
...
/*
	...
	Flags: Linked, Private
*/
private function audio_log()
{
	self.var_64c09f7f = self zm_unitrigger::function_fac87205("", 64);
	if(!isplayer(self.var_64c09f7f))
	{
		return;
	}
	...
	/#
		switch(cmd)
		{
			case "hash_8a61bbec91098c":
			{
				...
				foreach(var_af0a8dfc in var_64de1b5a)
				{
					util::spawn_model(#"hash_7e904f02c722b68b", s_glyph.origin, s_glyph.angles);
				}
				break;
			}
		}
