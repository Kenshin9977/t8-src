...
#namespace cschashed-3\script_d67878983e3d7c;
...
/*
	...
	Flags: Linked
*/
function function_9d45c058(str_type, var_34ebe248, n_duration, var_f472bfc, var_5713c703)
{
	...
	level.var_981dd9cf[#"burn"][str_type] = {#hash_5713c703:var_5713c703, #hash_f472bfc:var_f472bfc, #n_duration:n_duration, #hash_34ebe248:n_dps};
}
...
private function function_8aefaae3(s_burn)
{
	...
	while(true)
	{
		...
		foreach(str_type, var_39d0f0a8 in self.var_88421cc2)
		{
			...
			{
				var_34ebe248 = var_39d0f0a8.var_477abb8f;
			}
			else
			{
				var_34ebe248 = level.var_981dd9cf[#"burn"][str_type].n_dps;
			}
		...
		if(n_total_damage)
		{
			self dodamage(var_c63f626a, self.origin, var_2af3b934, undefined, "none", "MOD_BURNED", 0, weapon);
		}
		if(!self.var_88421cc2.size)
		{
...
function slowdown(str_type, var_a47cf2b2)
{
	...
	var_b2b7a523 = level.var_981dd9cf[#"slow"][str_type];
	n_time = gettime();
