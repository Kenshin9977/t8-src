...
#namespace cschashed-2\script_30ace59de1b1bb3a;
...
function __main__()
{
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_541a4d5c476468f4"))
	{
		...
		cschashed-1\script_6d85b093d74cdfdd::function_d1f16587(#"zblueprint_chaos_lvl3", &function_8bca35b9);
...
function function_c73f430e()
{
	while(true)
	{
		...
		if(isdefined(self.stub.var_b434e769) & !level flag::get("flag_player_grabbed_catalyst_material"))
		{
			...
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09edf042e93c7", 1);
...
function function_c60245c1(e_player)
{
	...
	level.n_bile++;
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09ddf042e9214", level.n_bile);
	if(level.n_bile > 2)
	{
...
{
	if(self.entity_type === #"crimson_nosferatu" && isplayer(s_params.eattacker) && level flag::get("flag_crimson_nosferatu_set_intro") && !level flag::get("flag_player_grabbed_nosferatu_material"))	{
		s_loc = spawnstruct();
...
function function_6f3f4e18(s_loc)
{
	...
	if(!level flag::get("flag_player_grabbed_nosferatu_material"))
	{
		...
		level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_3eb09ddf042e9214", 4);
...
function function_ee901070(e_attacker)
{
	...
	if(isdefined(self.var_3ca04328) && self.var_3ca04328 && (!level flag::get(#"hash_1d477cd627a495d9") || !isdefined(e_attacker.var_cbdbce01)) && (isdefined(self function_2e1a2c88()) && self function_2e1a2c88()))
	{
		...
		self thread cschashed-2\script_42dd312945896668::function_b47bcfb0(e_attacker, 60);
		while(true)
		{
...
function function_a2256244(var_f9105ee8, var_f1935ec8)
{
	...
	{
		var_9c95ad05 = cschashed-1\script_6d85b093d74cdfdd::function_4c2f8683("zitem_chaos_lvl3_part_3");
		var_5ab22b80 = cschashed-2\script_257d7bea5de94cbf::spawn_item(var_9c95ad05, var_f9105ee8.origin, var_f9105ee8.angles, 1);
