...
#namespace cschashed-3\script_28144a2871e71a78;
...
function function_4da0eaff()
{
	...
	level.var_f13364b4.var_1a37ad02 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0("keypad_keys", "targetname", "script_int");
...
function function_f359c8a0(s_key, e_player)
{
	...
	switch(s_key.script_string)
	{
		case "number":
		{
			...
			/#
				iprintlnbold("" + s_key.script_string + "" + s_key.script_int);
			#/
...
{
	level thread cschashed-2\script_518e526a2898bf6d::fall();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::grav();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::guns();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::time();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::function_e0b95486();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::cola();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::soda();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::noob();
...
{
	level thread cschashed-2\script_518e526a2898bf6d::bank();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::door();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::warp();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::shed();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::nuke();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::hero();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::puke();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::club();
...
{
	level thread cschashed-2\script_518e526a2898bf6d::duck();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::song();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::function_a2c208d5();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::ugly();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::joke();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::yawn();
...
{
	level thread cschashed-2\script_518e526a2898bf6d::vent();
...
{
	level thread cschashed-2\script_518e526a2898bf6d::love();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::life();
}
...
{
	level thread cschashed-2\script_518e526a2898bf6d::boom();
...
{
	level thread cschashed-2\script_518e526a2898bf6d::pack();
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3d3b83078e638263", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_24f10736d61f17be", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_5f8cf3a67798b7ab", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_5ec22c1b18a29d51", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_346e9556bd641875", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_774ea9ca1a48e4d", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3d1ea1a6ac1bd74c", 0, 1);
}
...
{
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_57bcd7bd5e8ab56e", 0, 1);
}
...
function function_7ee18649()
{
	...
	var_2ec8989 = cschashed-3\script_e2bef0652b31f68::function_bffcedde("mesh_code_display_01", "script_noteworthy", "script_int");
	...
	var_dad3f7bf = cschashed-3\script_e2bef0652b31f68::function_bffcedde("sawyer_authorization_code", "targetname", "script_int");
...
function rushmore_speech_hamilton()
{
	...
	while(!b_spoke)
	{
		...
		{
			level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3bb62fc3dd0ef854", 0, 0);
			b_spoke = 1;
		}
		else
		{
...
function rushmore_speech_franklin()
{
	...
	while(!b_spoke)
	{
		...
		if(level.var_5dd0d3ff zm_audio::function_65e5c19a())
		{
			level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_3d5961d25aa763a8", 0, 0);
			b_spoke = 1;
		}
		else
		{
...
function rushmore_speech_madison()
{
	...
	while(!b_spoke)
	{
		...
		if(level.var_5dd0d3ff zm_audio::function_65e5c19a())
		{
			level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_6bbfaf4e608a79b8", 0, 0);
			b_spoke = 1;
		}
		else
		{
...
function rushmore_speech_jefferson()
{
	...
	while(!b_spoke)
	{
		...
		if(level.var_5dd0d3ff zm_audio::function_65e5c19a())
		{
			level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_c11fc3ab92db957", 0, 0);
			b_spoke = 1;
		}
		else
		{
...
function function_5b16217f()
{
	...
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_45f67ba6693762f7", 0, 0);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_45f67ba6693762f7", 1, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_45f67ba6693762f7", 2, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d(#"hash_45f67ba6693762f7", 3, 0, 1);
}
