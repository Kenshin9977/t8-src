...
function main()
{
	...
	namespace_ee206246::start(#"hash_507adabe6ce05360", zm_utility::can_enable_ee());
...
function function_b5fd797c(var_a276c861, var_19e802fa)
{
	...
	var_57e06cb cschashed-3\script_e2bef0652b31f68::function_6099877a(72, "end_game", #"hash_6001ebf204288bf8", #"hash_3fe9eae6f03accce");
	...
	cschashed-3\script_e2bef0652b31f68::function_2ba419ee(1, int(max(199, level.round_number)));
...
{
	level endon(#"end_game");
	self endon(#"death", #"player_frozen");	self thread function_6577cacc();
...
{
	level endon(#"end_game");
	self endon(#"death", #"player_frozen");	self notify(#"hash_668824b34b3076bc");
	self allowslide(1);
	self thread cschashed-3\script_520360b6c44baa8b::function_d2dd1f2b();
...
{
	self endon_callback(&cschashed-3\script_520360b6c44baa8b::function_c64292f, #"death");
	self.var_7dc2d507 = 1;
	self notify(#"player_frozen");	self cschashed-3\script_520360b6c44baa8b::function_bad6907c();
	...
	self thread cschashed-3\script_520360b6c44baa8b::function_872ec0b2(var_1d3683e1);
	self thread cschashed-3\script_520360b6c44baa8b::function_6cadbaff();
