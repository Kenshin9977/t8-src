...
#using hashed-1\zm_bgb_bullet_boost.gsc;
...
{
	e_player.var_4a25bda8 = var_bfc1607c zm_unitrigger::create(&function_4909d78c, 64, &function_2c76782d);
...
function function_324787f7()
{
	...
	if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(wpn_current) || (isdefined(wpn_current.isriotshield) && wpn_current.isriotshield))
	{
		return 0;
	}
	return 1;
...
function function_123bcbcf()
{
	...
	switch(self.var_9e09931e)
	{
		...
		{
			a_str_rewards = [];
			if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive"))
			{
			...
			if(!self hasweapon(var_dabfe5ee) && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_26f3528e8457207a"))
			{
		...
		case 2:
		{
			...
			if(!self hasweapon(var_9bd91d5a) && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_26f3528e8457207a"))
			{
				a_str_rewards[a_str_rewards.size] = #"bowie_knife";
			}
			var_53890456 = function_56c888ce(a_str_rewards);
		...
		case 3:
		{
			...
			if(namespace_59ff1d6c::function_901b751c(#"hash_b066c34278e6394") && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive"))
			{
		...
		case 4:
		{
			...
			a_str_rewards = array(#"weapon");
			if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_3d18f84f48bd5d1f") && self.var_123836f9 < 2)
			{
				a_str_rewards[a_str_rewards.size] = #"free_perk";
			}
			a_players = getplayers();
			if(a_players.size == 1 && (!(isdefined(self.var_17d719b9) && self.var_17d719b9)) && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive") && !zm_utility::is_trials())
			{
				a_str_rewards[a_str_rewards.size] = #"extra_life";
			}
			var_b42aa272 = 1;
			...
			if(var_b42aa272 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_65a1298089d361f1") && zm_weapons::get_is_in_box(level.var_49d60273))
			{
...
function function_d36fb590(var_aa4f9213, var_6c9485fc = 15, n_fx_type = 1)
{
	...
	var_15d8d23b = self function_dcda5d87(var_4d0b3b87, 1, 1, n_fx_type);
	if(b_give_reward)
	{
...
/*
	...
	Flags: Linked
*/
function function_11be5095(var_7ed75e97, var_6c9485fc = 15, var_6026cca1 = 0, var_5876e0e2 = undefined)
{
	self endon(#"death");
	if(var_6c9485fc)
	{
	...
	var_15d8d23b = self function_dcda5d87(var_4d0b3b87, b_rotate, 0, 1);
	if(b_give_reward)
	{
...
function function_53a333a8(var_ecffa2a8, var_41f9c5ff = undefined, var_893baaf = undefined)
{
	...
	if(isdefined(var_41f9c5ff))
	{
		if(!(isdefined(self.var_4373c66b) && self.var_4373c66b))
		{
			...
			self function_71c9ab64(self.var_3eb67d69 + var_41f9c5ff);
...
function function_b858f95a()
{
	...
	if(isplayer(self) && isdefined(self.s_tribute_bowl))
	{
		...
		if(isdefined(var_bfc1607c.var_9d32404) && isdefined(self.var_9e09931e))
		{
			var_bfc1607c.var_9d32404 clientfield::set("" + #"hash_21f5fab6a3d22093", self.var_9e09931e);
		}
	}
}
...
function function_ae2c0ba5()
{
	...
	return self.var_3eb67d69 - n_step * self.var_9e09931e / n_step;
}
...
function function_a8243f37()
{
	...
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_1f6665b5581f6b6e"))
	{
	...
	level.var_fc2d4a2 = [];
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_1d5c8e6f0e20201a"))
	{
		level.var_fc2d4a2[level.var_fc2d4a2.size] = #"ar_galil_t8";
	}
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_edfb07f798aaab5"))
	{
	...
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_5bfd047c58816496"))
	{
...
function function_dcda5d87(var_4d0b3b87, b_rotate = 1, var_b9b24 = 1, n_fx_type = 1)
{
	...
	self thread zm_audio::create_and_play_dialog(#"tribute", #"boon");	return 1;
}
...
function function_6c62f074(var_9e09931e)
{
	switch(var_9e09931e)
	{
		case 2:
		{
			if(math::cointoss() && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive"))
			{
				if(math::cointoss())
				{
...
{
	var_c481f7e6 = randomint(1000);
	if(var_c481f7e6 < 166 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_65a1298089d361f1"))
	{
...
function function_abd417dc(var_7ed75e97, var_5876e0e2 = undefined, b_upgraded = 1)
{
	...
	wait(var_cef149e8);
	var_15d8d23b = self function_cdb9fba6(var_4d0b3b87, 0, 0, 1);
	if(b_give_reward)
	{
...
{
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_137eb8d53913f781"))
	{
		return;
	}
	var_78e5d9d1 = level.var_d5ba7324.origin + vectorscale((0, 0, -1), 8);
