...
function preload()
{
	...
	clientfield::register("world", "" + #"lava_init", 24000, 1, "int", &lava_init, 0, 0);	clientfield::register("world", "" + #"lava_control", 24000, 2, "int", &lava_control, 0, 0);	clientfield::register("world", "" + #"hash_72b5b0359ca48427", 24000, 1, "int", &function_bd0807f3, 0, 0);
	...
	clientfield::register("vehicle", "" + #"lantern_explode_fx", 24000, 1, "counter", &function_8c0856ff, 0, 0);	clientfield::register("toplayer", "" + #"hash_78b8d89d34b32241", 24000, 2, "int", &function_19f2f0f2, 0, 0);
	clientfield::register("scriptmover", "" + #"hash_54e24ec6e84ad6e6", 24000, 1, "int", &function_cbc22c9d, 0, 0);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_1", 24000, "sc_lantern_1", 400, level._effect[#"hash_5f479f0ba680df7b"], level._effect[#"hash_7336b7a4cc9d2581"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_2", 24000, "sc_lantern_2", 400, level._effect[#"hash_5f479f0ba680df7b"], level._effect[#"hash_7336b7a4cc9d2581"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_3", 24000, "sc_lantern_3", 400, level._effect[#"hash_5f479f0ba680df7b"], level._effect[#"hash_7336b7a4cc9d2581"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_4", 24000, "sc_lantern_4", 400, level._effect[#"hash_5f479f0ba680df7b"], level._effect[#"hash_7336b7a4cc9d2581"], undefined, undefined, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"sc_lantern_end", 24000, "sc_lantern_end", 400, level._effect[#"hash_5f479f0ba680df7b"], level._effect[#"hash_7336b7a4cc9d2581"], undefined, undefined, 1);
}
