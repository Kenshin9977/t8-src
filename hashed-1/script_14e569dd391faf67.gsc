...
#namespace cschashed-2\script_356ad5dd4af06a33;
...
function teleport_player(user)
{
	...
	playfx(level._effect[#"hash_61fb06e6b1e29b45"], user.origin);
	...
	user cschashed-2\script_27ba6748d83412fd::function_66d020b0(undefined, undefined, undefined, undefined, destination, undefined, string(self.n_dest), 0);
	...
	playfx(level._effect[#"hash_692bbec56d4f9a18"], user.origin);
	...
	user.floor = namespace_47276bad::function_35babccd(user);
...
function function_9d689cc4(portal, portal_exit)
{
	...
	if(!isdefined(portal_exit))
	{
		...
		{
			self.favoriteenemy = cschashed-3\script_e2bef0652b31f68::function_3815943c();
		}
		if(!isdefined(self.favoriteenemy))
		{
...
function function_1f034d46(destination)
{
	...
	if(isdefined(self.var_b940d6ea))
	{
		self.var_f4bf0819 = namespace_47276bad::function_cd2f24b2(zm_zonemgr::get_zone_from_position(self.var_b940d6ea, 1));
	}
	else
	{
...
function function_bb3f9afd()
{
	...
	playfx(level._effect[#"portal_spawn"], s_portal.origin, (1, 0, 0), (0, 0, 1));	if(level flag::get("defcon_active") || util::function_5df4294() == #"zstandard")
	{
...
function setup_portals()
{
	...
	level.var_3f3c65c7.var_52a6f692 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0(level.var_3f3c65c7.target, "targetname", "script_int");
...
function portal_init()
{
	...
	self.var_d99a94d9 = 0;
	self.var_52a6f692 = cschashed-3\script_e2bef0652b31f68::function_2719d4c0(self.target, "targetname", "script_int");
...
function cage_portal_init()
{
	...
	level.var_4d648134.var_a1cf77d2 = util::spawn_model("tag_origin", level.s_cage_portal.origin, level.s_cage_portal.angles);
