...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_3ad5e71a03ad70c1", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85()
{
	...
	callback::function_f77ced93(&cschashed-1\script_3d5821d793ed4c6::function_79518194);
	foreach(player in getplayers())
	{
		player thread cschashed-1\script_3d5821d793ed4c6::function_bf710271(1, 1, 1, 0, 0);
		player thread cschashed-1\script_3d5821d793ed4c6::function_dc9ab223(1, 0);
...
private function function_9e7b3f4d(round_reset)
{
	...
	callback::function_5a753d97(&cschashed-1\script_3d5821d793ed4c6::function_79518194);
...
private function refill_ammo()
{
	...
	foreach(player in getplayers())
	{
		...
		{
			if(zm_loadout::is_lethal_grenade(w_weapon) || zm_loadout::is_melee_weapon(w_weapon) || cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(w_weapon))
			{
				continue;
			}
...
{
	foreach(weapon in cschashed-2\script_709bf7c56eb65adf::function_5a5a742a("tactical_grenade"))
	{
...
private function function_33f0ddd3(s_event)
{
	if(s_event.event === "give_weapon")
	{
		...
		if(zm_loadout::is_lethal_grenade(s_event.weapon) || cschashed-2\script_709bf7c56eb65adf::is_tactical_grenade(s_event.weapon, 1))
		{
...
private function function_29ee24dd()
{
	...
	while(true)
	{
		...
		else
		{
			...
			{
				if(!(zm_loadout::is_lethal_grenade(weapon) || cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon)))
				{
...
function is_active()
{
	s_challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_3ad5e71a03ad70c1");
...
private function function_af55104(var_f2c84b6b)
{
	...
	foreach(weapon in a_weapons)
	{
		if(zm_loadout::is_hero_weapon(weapon) || cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(weapon))
		{
			continue;
			continue;
		}
