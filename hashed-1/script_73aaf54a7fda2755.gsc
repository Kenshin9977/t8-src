...
#namespace cschashed-1\script_4f52494a6ac904e9;
...
{
	if(isdefined(self.entity_type) && self.entity_type == #"zombie_electric")	{
...
{
	if(isdefined(params.eattacker) && isdefined(params.eattacker.entity_type) && isdefined(params.smeansofdeath) && params.eattacker.entity_type == #"zombie_electric" && params.smeansofdeath == "MOD_MELEE")	{
...
private function function_25c6cba0(entity, origin)
{
	...
	{
		if(zombie.archetype == #"zombie" && (!isdefined(zombie.entity_type) || zombie.entity_type != #"zombie_electric") && (isdefined(entity.b_in_water) && entity.b_in_water) && (isdefined(zombie.b_in_water) && zombie.b_in_water) && distancesquared(origin, zombie.origin) <= 250000)		{
