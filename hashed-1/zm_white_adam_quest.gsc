...
#namespace cschashed-1\script_2c0ec1d40a3e4c77;
...
function function_eb06b83()
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_white_private_mannequin_key_part", 1);
	var_f0aefc5c = getent("pernell_key", "targetname");
...
function function_79248781()
{
	...
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_start", 0, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_start", 1, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_start", 2, 0, 1);
}
...
function function_d1086c12()
{
	...
	self endon(#"hash_78e2cadb25129fa2");
	level cschashed-3\script_e2bef0652b31f68::function_3c173d37();
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_sawyer", 0, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_sawyer", 1, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_sawyer", 2, 0, 1);
}
...
function function_5de15b91()
{
	...
	self endon(#"hash_78e2cadb25129fa2");
	level cschashed-3\script_e2bef0652b31f68::function_3c173d37();
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_mccain", 0, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_mccain", 1, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_mccain", 2, 0, 1);
}
...
function visit_prototype_minigun()
{
	...
	self endon(#"hash_78e2cadb25129fa2");
	level cschashed-3\script_e2bef0652b31f68::function_3c173d37();
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_pernell", 0, 0, 1);
	level.var_5dd0d3ff cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_code_pernell", 1, 0, 1);
	level.var_f13364b4.var_12633dc5 cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_adam_code_pernell", 2, 0);
}
...
function function_88265619()
{
	...
	while(true)
	{
		...
		wait(1.5);
		level.var_8943f7db thread cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_activated");
...
{
	self cschashed-3\script_e2bef0652b31f68::function_51b752a9("vox_adam_activate");
}
...
function timer_actual(kills, time)
{
	...
	while(gettime() < timer)
	{
		if(self.killcounter > kills)
		{
			...
			{
				level.var_8943f7db cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_multi_kill", function_f20dfe6a(), 0, 1);
			}
			if(math::cointoss())
			{
				players = getplayers();
...
function function_e453faa6(e_reviver)
{
	...
	while(true)
	{
		...
		{
			level.var_8943f7db cschashed-3\script_e2bef0652b31f68::function_6a0d675d("vox_adam_revive", function_9368a51d(), 0, 1);
