...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_3d10e2fd98b0c3ab", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85()
{
	...
	foreach(player in getplayers())
	{
		...
		{
			if(namespace_2ba51478::is_lethal_grenade(var_64225f6c.weapon) || cschashed-2\script_709bf7c56eb65adf::is_melee_weapon(var_64225f6c.weapon))
			{
