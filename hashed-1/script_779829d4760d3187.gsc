...
#namespace cschashed-1\script_1b8495d48ac2c853;
...
function function_53935f3d(var_5ea5c94d, ended_early)
{
	...
	else
	{
		...
		wait(3);
		cschashed-3\script_e2bef0652b31f68::function_e308175e(#"hash_40c5232d4f3e85b", level.mcnamara.origin);
	}
}
...
function function_fe3de565(var_5ea5c94d, ended_early)
{
	...
	else
	{
		...
		level.var_38ea4233 clientfield::increment_to_player("" + #"hash_7eefa4acee4c1d55", 1);
		wait(3);
		cschashed-3\script_e2bef0652b31f68::function_e308175e(#"hash_338550de989ad1a7", level.mcnamara.origin);
	}
}
...
function function_3409e90e(var_5ea5c94d, ended_early)
{
	...
	else
	{
		...
		level.var_38ea4233 clientfield::increment_to_player("" + #"hash_7eefa4acee4c1d55", 1);
		wait(3);
		cschashed-3\script_e2bef0652b31f68::function_e308175e(#"hash_182892c4bb99b96a", level.mcnamara.origin);
	}
}
...
function function_c2bd8b3d(var_5ea5c94d, ended_early)
{
	...
	else
	{
		...
		level.var_38ea4233 clientfield::increment_to_player("" + #"hash_7eefa4acee4c1d55", 1);
		wait(3);
		cschashed-3\script_e2bef0652b31f68::function_e308175e(#"hash_1d3964f5cb0069af", level.mcnamara.origin);
	}
}
...
function function_d8b688e7(var_5ea5c94d, ended_early)
{
	...
	else
	{
		...
		level.var_38ea4233 clientfield::increment_to_player("" + #"hash_7eefa4acee4c1d55", 1);
		wait(3);
		cschashed-3\script_e2bef0652b31f68::function_e308175e(#"hash_e51948d3d12b229", level.mcnamara.origin);
	}
