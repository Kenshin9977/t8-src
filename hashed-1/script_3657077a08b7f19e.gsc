...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"special_enemy", &function_d1de6a85, &function_9e7b3f4d);}
...
private function function_d1de6a85(enemy_type, var_6b96eb7b, var_46cce0c5, var_6ad4e7c6, var_44445188)
{
	...
	{
		self.enemy_count = cschashed-1\script_3c362258ff800237::function_5769f26a(var_46cce0c5);
	}
	else
	{
		self.enemy_count = cschashed-1\script_3c362258ff800237::function_5769f26a(var_6b96eb7b);
	}
	...
	if(isdefined(var_6ad4e7c6))
	{
		...
		cschashed-1\script_3d5821d793ed4c6::function_2976fa44(self.enemy_count);
		cschashed-1\script_3d5821d793ed4c6::function_dace284(self.enemies_killed);
	}
}
...
{
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"special_enemy");	/#
	...
	{
		cschashed-1\script_3c362258ff800237::fail(#"hash_11e532a4f9c3e482", array(params.eattacker));
		return;
	}
	challenge.enemies_killed++;
	if(isdefined(level.var_d0be33a6) && level.var_d0be33a6)
	{
		cschashed-1\script_3d5821d793ed4c6::function_dace284(challenge.enemies_killed);
	}
}
...
{
	var_f63f3454 = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_a0e875894ebc5ff");
...
function is_active()
{
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"special_enemy");	return isdefined(challenge);
}
