...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_4043192ca121b4d4", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_59803fa8)
{
	...
	level.var_3c453815 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_59803fa8);
	foreach(player in getplayers())
	{
		player cschashed-1\script_3d5821d793ed4c6::function_8677ce00(1);
		player.b_hit = 0;
		...
		{
			if(namespace_2ba51478::is_melee_weapon(var_64225f6c.weapon) || cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(var_64225f6c.weapon))
			{
				player function_28602a03(var_64225f6c.weapon, 1, 1);
			}
		}
		player cschashed-1\script_3d5821d793ed4c6::function_dc9ab223(1, 1);
	}
...
private function function_9e7b3f4d(round_reset)
{
	...
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d5821d793ed4c6::function_dc9ab223(0, 1);
		player cschashed-1\script_3d5821d793ed4c6::function_8677ce00(0);
	}
...
function is_active()
{
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_4043192ca121b4d4");
...
private function function_33f0ddd3(s_event)
{
	if(s_event.event === "give_weapon")
	{
		...
		if(zm_loadout::is_melee_weapon(s_event.weapon) || cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(s_event.weapon))
		{
