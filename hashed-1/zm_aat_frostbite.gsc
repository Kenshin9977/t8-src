...
function __init__()
{
	...
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_7cb479d48ba9bbd6", 0.1, 3);
}
...
function function_158a3a18(attacker, mod, weapon, var_e1ec1eee = 0)
{
	...
	self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_7cb479d48ba9bbd6", self.var_cbf4894c);
...
function function_35d3ac3b(attacker, mod, weapon)
{
	...
	if(isdefined(self))
	{
		...
		{
			self cschashed-3\script_d67878983e3d7c::function_520f4da5(#"hash_7cb479d48ba9bbd6");
		}
	}
}
