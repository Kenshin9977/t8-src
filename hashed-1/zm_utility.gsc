...
#using hashed-2\zm_arcade_timer.gsc;
...
/*
	...
	Flags: Linked
*/
function open_door(var_68454baa, var_47eb646a = 0, var_91ccb2d7, b_play_audio = 0)
{
	if(!isdefined(var_68454baa))
	{
		var_68454baa = [];
	}
	else if(!isarray(var_68454baa))
	{
		var_68454baa = array(var_68454baa);
	}
	if(var_47eb646a)
	{
	...
	var_6e4ed9cd = 0;
	var_37cb3654 = 0;
	foreach(str_door_name in var_68454baa)
	{
		var_df1533c0 = getentarray(str_door_name, "target");
		if(!var_6e4ed9cd && b_play_audio)
		{
			if(var_68454baa.size > 1 || var_df1533c0.size > 1)
			{
...
function function_be2022f8()
{
	...
	var_df1533c0 = arraycombine(var_4506f72b, a_zombie_debris, 0, 0);
	return var_df1533c0;
}
...
function function_27b4c2be(var_35200797 = 1)
{
	...
	var_df1533c0 = function_be2022f8();
	foreach(e_door in var_df1533c0)
	{
		if(!isdefined(e_door))
		{
			continue;
...
/*
	...
	Flags: Linked
*/
function function_214563e(var_35200797 = 1, var_fff0c919)
{
	self endon(#"death");
	if(var_35200797)
	{
		if(var_fff0c919 == "symbol_front" || var_fff0c919 == "symbol_back")
		{
	...
	else if(var_fff0c919 == "symbol_front" || var_fff0c919 == "symbol_back")
	{
...
function function_9dc9326c(player)
{
	...
	if(!(isdefined(level.var_77f262b9) && level.var_77f262b9) && function_166646a6() === 2)
	{
...
function function_279ca150()
{
	...
	{
		v_start = self.origin;
		foreach(var_b30c192b, var_6f1036dd in level.var_26a5066b)
		{
			if(var_6f1036dd.var_6faa5e34)
			{
				continue;
			}
			if(var_b30c192b <= var_f1e10d43 || n_chance < level.var_4ffadb4c)
			{
				var_6f1036dd.var_6faa5e34 = 1;
				...
				for(i = 0; i < var_6f1036dd.var_232e4ebc; i++)
				{
					level thread function_aad01548(v_start, var_ebcac3c2);
					var_ebcac3c2 = 1;
				}
			}
		}
...
/*
	...
	Flags: Linked
*/
function function_aad01548(v_start_pos, var_b545186e = 0)
{
...
{
	var_9cd8223f = arraycopy(level.var_f05f7e16[var_573c22c3].var_cc0c35ca);
...
/*
	...
	Flags: Linked
*/
function function_11101458(var_f79ff5ec, var_6cc77d4e = #"hash_3a35084ee8c333b2", var_9c19b511 = "creating_zone_defend_area")
{
	...
	if(isdefined(var_679cd7a8.var_9fc5eea1) && !isplayer(self))
	{
		...
		{
			e_player thread function_428cfaae(var_679cd7a8, var_6cc77d4e, var_9c19b511, n_obj_id, var_e1feb2f6);
		}
		level util::delay(var_9c19b511, "end_game", &function_b1f3be5c, n_obj_id);
...
/*
	...
	Flags: Linked
*/
function function_428cfaae(var_679cd7a8, var_6cc77d4e, var_9c19b511, n_obj_id, var_e1feb2f6)
{
...
function function_33798535(var_31721422, a_str_zones, var_ed1db1a7, var_6cc77d4e = #"hash_683cf7d37afcc3ae", var_de0f1997 = 45, var_f7c3c527 = 60, var_232e4ebc = 0, var_b96be97f = undefined)
{
	...
	if(level flag::exists(#"hash_1b9ecc7979b0fcfb") && (!(isdefined(level.var_81c681aa) && level.var_81c681aa)))
	{
		level flag::set(#"hash_1b9ecc7979b0fcfb");
	}
	level waittill(#"hash_7a04a7fb98fa4e4d");
	if(level flag::exists(#"hash_1b9ecc7979b0fcfb"))
	{
		level flag::clear(#"hash_1b9ecc7979b0fcfb");
	}
	level thread play_sound_2d("zmb_rush_defend_end");
	level thread zm_audio::sndannouncerplayvox(#"defend_complete", undefined, undefined, undefined, 1, 1);	if(!var_33747ab1)
	{
...
function function_3b09971f(var_ed1db1a7, var_de0f1997, a_str_zones)
{
	...
	while(var_de0f1997 >= 0)
	{
		...
		if(var_33e8cae6 && n_time_elapsed >= 5)
		{
		...
		if(var_33e8cae6 && var_de0f1997 < 10 && (!(isdefined(level.var_54f329be) && level.var_54f329be)))
		{
			function_9757d4d2(1);
...
function function_f7bb860a()
{
	...
	if(isdefined(var_88febab4) && isarray(var_88febab4.pathpoints) && var_88febab4.status === "succeeded")
	{
		...
		if(function_25e3484e(s_defend_area.origin) && !isdefined(s_defend_area.var_7d81025))
		{
			s_defend_area.var_7d81025 = function_ce46d95e(s_defend_area.origin, 1, 0);
		}
	}
}
...
function function_766eff6(var_31721422, a_str_zones, var_de0f1997, var_f7c3c527)
{
	...
	cschashed-1\script_3d5821d793ed4c6::stop_timer();
	waitframe(1);
	level.var_f995ece6 zm_trial_timer::open(self);
	level.var_f995ece6 zm_trial_timer::function_8ede8e82(self, var_31721422);
	self cschashed-1\script_3d5821d793ed4c6::start_timer(var_de0f1997);
	s_defend_area = struct::get(level.var_9149f3ac);
	n_time = var_de0f1997;
	while(n_time >= 0)
	{
			...
			foreach(player in level.activeplayers)
			{
				if(isalive(player) && player zm_zonemgr::is_player_in_zone(a_str_zones))
				{
					...
					if(!(isdefined(player.var_fd3dfced) && player.var_fd3dfced))
					{
						...
						level.var_f995ece6 zm_trial_timer::function_8ede8e82(player, #"hash_64e686d0e2a5bfcb");
					}
					continue;
				}
				if(isalive(player) && !player zm_zonemgr::is_player_in_zone(a_str_zones) && (isdefined(player.var_fd3dfced) && player.var_fd3dfced))
				{
					...
					level.var_f995ece6 zm_trial_timer::function_8ede8e82(player, var_31721422);
				}
			}
		}
		n_time--;
	...
	while(true)
	{
		...
		if(!self zm_zonemgr::is_player_in_zone(a_str_zones) && self.sessionstate !== "spectator")
		{
			...
			if(!(isdefined(var_9faecc20) && var_9faecc20))
			{
				...
				{
					level.var_f995ece6 zm_trial_timer::open(self);
					level.var_f995ece6 zm_trial_timer::function_8ede8e82(self, #"hash_4bef74a6e7f21aa0");
					self cschashed-1\script_3d5821d793ed4c6::start_timer(n_time);
				}
			}
...
function function_9b7bc715(str_archetype, var_f6e469ad = 1)
{
	...
	switch(str_archetype)
	{
		case "brutus":
		{
			...
			level thread zm_audio::sndannouncerplayvox(#"warden", undefined, undefined, undefined, 1);			break;
		}
		case "catalyst":		{
			level function_e64ac3b6(1, #"hash_451da0cb46417560");
			level thread zm_audio::sndannouncerplayvox(#"catalyst", undefined, undefined, undefined, 1);			break;
		}
		...
		case "blight_father":
		{
			...
			var_62af6f1 = array::random(array(#"hash_1abc3796d2516587", #"blightfather"));
		...
		case "tiger":
		{
			...
			var_68f478a5 = array::random(array(#"zmb_tigers", #"tigers"));			level thread zm_audio::sndannouncerplayvox(var_68f478a5, undefined, undefined, undefined, 1);
			break;
		}
		case "zombie_dog":
		{
		...
		case "nova_crawler":
		{
			...
			level thread zm_audio::sndannouncerplayvox(#"hash_3a6c12bfc807aa2", undefined, undefined, undefined, 1);
			break;
		}
	}
	level.arena_twist[str_archetype] = 1;
...
{
	if(!isdefined(self.var_7d81025))
	{
		self.var_7d81025 = self function_ce46d95e(self.origin, b_permanent);
	}
...
/*
	...
	Flags: None
*/
function function_cbc75463(b_enable = 0, var_909e9d3d = 0, str_value, str_key, var_34451c07)
{
	if(isdefined(str_value) && isdefined(str_key))
	{
		var_3fde5055 = getentarray(str_value, str_key);
	}
	else
	{
		var_3fde5055 = getentarray("use_elec_switch", "targetname");
	}
	if(b_enable)
	{
		var_c996d382 = 0;
		foreach(var_923d12da in var_3fde5055)
		{
			var_923d12da.var_b9eb2dbb = undefined;
			var_923d12da setvisibletoall();
			if(var_909e9d3d)
			{
				player = arraygetclosest(var_923d12da.origin, level.activeplayers);
				var_923d12da notify(#"trigger", {#activator:player});
				if(!var_c996d382)
				{
					var_c996d382 = 1;
	...
	else
	{
		foreach(var_923d12da in var_3fde5055)
		{
			...
			{
				var_923d12da.var_b9eb2dbb = 1;
				var_923d12da sethintstring(var_34451c07);
				continue;
			}
			var_923d12da setinvisibletoall();
		}
	}
}
