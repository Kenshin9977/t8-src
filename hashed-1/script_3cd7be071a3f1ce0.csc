...
function init_clientfields()
{
	...
	clientfield::register("toplayer", "" + #"player_dragged", 8000, 1, "int", &function_a5f32c8f, 0, 0);	clientfield::register("toplayer", "" + #"hash_4be98315796ad666", 8000, 1, "int", &function_f568352e, 0, 0);
...
function function_a5f32c8f(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, wasdemojump)
{
	...
	if(newval == 1)
	{
		self.var_fe11bb61 = playfxoncamera(localclientnum, level._effect[#"player_afterlife"]);		self postfx::playpostfxbundle(#"hash_66a9fee7028a1e13");
