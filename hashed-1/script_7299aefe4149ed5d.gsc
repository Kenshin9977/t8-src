...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_576c8d43b54453d0", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_bd9d962 = #"invert")
{
	...
	switch(level.var_2439365b)
	{
		...
		case "turret":
		{
			foreach(player in getplayers())
			{
				player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"zm_bgb_anywhere_but_here", 1);
				player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"hash_a303f67afd6f4a8", 1);
...
private function function_9e7b3f4d(round_reset)
{
	switch(level.var_2439365b)
	{
		...
		case "turret":
		{
			foreach(player in getplayers())
			{
				player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"zm_bgb_anywhere_but_here", 0);
				player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"hash_a303f67afd6f4a8", 0);
