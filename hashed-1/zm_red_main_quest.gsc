...
function function_3335f286()
{
	...
	namespace_ee206246::register(#"hash_162fe3b17b2752e7", #"hash_7751da18864137ca", #"shoot_roots", &function_6c7d67a0, &function_593e3d1f);	namespace_ee206246::register(#"hash_162fe3b17b2752e7", #"hash_2e55ff1b489306ce", #"hash_2e55ff1b489306ce", &function_c311ba46, &function_d0656fba);
	...
	namespace_ee206246::register(#"light", #"hash_b2e4c67e2932769", #"give_ankh", &function_7c9ece4f, &function_3b1a65ee);	namespace_ee206246::register(#"light", #"hash_177b41a8c9da003b", #"hash_177b41a8c9da003b", &function_4259a2c9, &function_ddcd9609);
...
/*
	...
	Flags: Linked
*/
function function_e4dadb03(b_skipped)
{
	level.var_38ee0d9e = array(0, 0, 0);
	level flag::wait_till(#"pap_quest_completed");
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 1);
...
function function_40b663e7()
{
	...
	cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_26b7fbb55bad5c2f", 16, 6);
	zm::function_84d343d(#"zhield_zpear_dw", &function_b252fc5);
	zm::function_84d343d(#"zhield_zpear_turret", &function_b252fc5);	level.var_ec37138d = 1;
}
...
function function_eebc7e40(s_target, str_notify)
{
	...
	while(!var_c4b94b6)
	{
		...
		s_target.t_damage.health = s_target.t_damage.health + s_result.amount;
...
function function_b252fc5(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	if(isplayer(attacker) && (isdefined(attacker.var_b4f85096) && attacker.var_b4f85096))
	{
		...
		self cschashed-3\script_d67878983e3d7c::burn(#"hash_26b7fbb55bad5c2f", attacker, weapon, 16);
	}
	return damage;
}
...
function function_881659b(n_index, b_skipped)
{
	...
	{
		var_c4b94b6 = 0;
		str_notify = #"oil_fire_" + n_index;		while(!var_c4b94b6)
		{
			a_players = getplayers();
			foreach(player in a_players)
			{
...
/*
	...
	Flags: Linked
*/
function function_8da2802b(b_skipped)
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 2);
	if(!b_skipped)
	{
...
function function_9388cf21()
{
	...
	s_result = undefined;
	s_result = level waittill(#"hash_2a4e028a916b763d");
...
function function_a9bde51()
{
	...
	{
		s_result.e_player namespace_891c9bac::function_a2bd5a0c(#"hash_5b6e60c5280dcb1c");
	}
	else
	{
		a_e_players = util::get_active_players();
...
function function_8142733f()
{
	...
	while(!level flag::get(#"hash_4e74b4172497a14a"))
	{
		...
		if(self istouching(var_c29a1099))
		{
			...
			s_result = undefined;
			s_result = self waittill(#"hash_6976c1afc34dbda5", #"hash_56c5053f5e67838b", #"hash_2a4e028a916b763d");
...
function function_47c0d27()
{
	...
	{
		s_result = undefined;
		s_result = level waittill(#"hash_1bf3d1cc10e09c43");
		if(isdefined(self))
		{
			if(s_result.e_entity === self && self == level.var_67c7040c)
			{
				if(isplayer(s_result.player) && (isdefined(s_result.player.var_a56de6e0) && s_result.player.var_a56de6e0))
				{
					...
					s_result.player notify(#"hash_2a4e028a916b763d");
					level notify(#"hash_2a4e028a916b763d", {#e_player:s_result.player});
...
function spartan_monuments()
{
	...
	while(level.var_6775c28d.size > 0)
	{
		...
		{
			if(isdefined(var_407cfce6) && (!(isdefined(var_407cfce6.var_344e2520) && var_407cfce6.b_shot)))
			{
				level.var_67c7040c = var_407cfce6;
				level flag::set(#"hash_288dea8dd196ef3");
				var_4c07cedf = function_2a9c51b5();
				s_result = undefined;
				s_result = var_407cfce6 waittill_timeout(var_4c07cedf, #"hash_2a4e028a916b763d");
	...
	while(!var_b6225a1f)
	{
		var_4c07cedf = function_2a9c51b5();
		s_result = undefined;
		s_result = level.var_67c7040c waittill_timeout(var_4c07cedf, #"clean_up", #"hash_2a4e028a916b763d");
		if(s_result._notify == #"hash_2a4e028a916b763d")
		{
			var_b6225a1f = 1;
...
function function_46087bd2(var_77104def, var_19e802fa)
{
	...
	s_mirror = struct::get(#"hash_1f35a43b3fe90f67");
	var_919d328 = util::spawn_model(s_mirror.model, s_mirror.origin, s_mirror.angles);
...
/*
	...
	Flags: Linked
*/
function function_fa377cf7(b_skipped)
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 3);
...
function function_8b20a029()
{
	...
	while(!var_61550b0)
	{
		...
		t_damage.health = t_damage.health + s_result.amount;
		if(isplayer(s_result.inflictor))
		{
			t_damage delete();
			var_61550b0 = 1;
	...
	if(isdefined(self.var_86928b64))
	{
		...
		switch(self.var_86928b64)
		{
			case 0:
			{
				...
				var_e18247ac = var_e18247ac + (n_diff * -1, 0, 0);
				break;
			}
			case 1:
			{
				var_b3337edf = var_a0fca4e1[1] - var_99fea1a4.origin[1];
				var_e18247ac = var_e18247ac + (0, n_diff * -1, 0);
				break;
			}
			case 2:
			{
				var_b3337edf = var_a0fca4e1[2] - var_99fea1a4.origin[2];
				var_e18247ac = var_e18247ac + (0, 0, n_diff * -1);
				break;
			}
			default:
			{
...
function function_a0111782(var_99fea1a4)
{
	...
	while(true)
	{
		...
		self.var_f1560899.health = self.var_f1560899.health + s_result.amount;
		var_2f3fee37 = abs(self.origin[self.n_axis] - var_99fea1a4.origin[self.n_axis]);
...
/*
	...
	Flags: Linked
*/
function function_922154d9(b_reset = 1)
{
...
/*
	...
	Flags: Linked
*/
function function_6c7d67a0(b_skipped)
{
	...
	while(true)
	{
		...
		{
			cschashed-1\script_4ebfbab5572ecfe9::function_6d783edd(mdl_target);
		}
...
{
	level endon(#"end_game", #"shoot_roots" + "_ended_early");	var_1f976659 = level.var_cc9c60d2;
	...
	if(s_result.var_f9486bd2 != var_ee799ebb.size)
	{
		foreach(mdl_target in var_79a46648)
		{
...
function function_c538a5b7(mdl_target)
{
	...
	cschashed-1\script_4ebfbab5572ecfe9::function_5fc81f0a(mdl_target);
	while(true)
	{
...
/*
	...
	Flags: Linked
*/
function function_c311ba46(b_skipped)
{
	...
	while(true)
	{
		var_8756a1bd = namespace_75cbf125::spawn_single(1, s_scene);
	...
	var_8756a1bd cschashed-1\script_5c00cc602bff1634::function_59e9f77b();
	var_8756a1bd.var_e946c8e8 = 1;
	var_8756a1bd cschashed-1\script_5c00cc602bff1634::function_d06af584();
...
function function_907d5e60(death, inflictor, attacker, damage, flags, mod, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	if(isdefined(s_prophecy))
	{
		...
		{
			self cschashed-1\script_5c00cc602bff1634::function_59e9f77b();
		}
	}
	return damage;
}
...
/*
	...
	Flags: Linked
*/
function function_f7b5ebc7(b_skipped)
{
...
/*
	...
	Flags: Linked
*/
function function_ceb38216(b_skipped)
{
	level endon(#"end_game", #"hash_7f8f1fe8f7b285d0" + "_ended_early");
	/#
		if(b_skipped)
...
function function_8d2b7b74(var_77104def, var_19e802fa)
{
	...
	var_eb37cc87 = util::spawn_model("c_t8_zmb_dlc2_gegenees_spear_golden", s_spear.origin, s_spear.angles);
	...
	var_eb37cc87 rotateto(v_rotate, 1);
...
/*
	...
	Flags: Linked
*/
function function_d424710c(b_skipped)
{
...
function function_4c903aa5()
{
	...
	foreach(var_1222bd48, var_d0cd0dba in var_61bf8b71)
	{
		...
		while(true)
		{
			...
			str_shot = var_7a64a440 + "_0" + n_opening + "_open";
			...
			str_shot = var_7a64a440 + "_0" + n_opening + "_close";
			level scene::play(str_scene, str_shot);
			...
			if(isdefined(var_1f976659.var_113bf6cb) && var_1f976659.var_113bf6cb)
			{
				...
				var_d0cd0dba.angles = var_58cb9965 - v_adjust;
...
function function_ca906c66(e_player)
{
	...
	level endon(#"end_game", #"hash_38a06e6fa57d2c74" + "_ended_early");
	e_player endon(#"disconnect");
	if(e_player cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6")))
	{
		if(zm_utility::is_player_valid(e_player))
		{
...
{
	if(self.archetype == #"hash_1bab8a0ba811401e" && self.entity_type == #"hash_266b62e342076a90")
	{
		var_1f976659 = level.var_cc9c60d2;
		var_eb37cc87 = var_1f976659.var_eb37cc87;
...
function function_3c71e07d()
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		while(true)
		{
			...
			var_e244831f = getaiarchetypearray(#"catalyst");			var_e7f5b3e0 = 1;
			foreach(var_47c2dcf7 in var_e244831f)
			{
				if(isalive(var_47c2dcf7) && var_47c2dcf7.entity_type == #"hash_266b62e342076a90")
				{
					var_e7f5b3e0 = 0;
					break;
				}
			}
			if(var_e7f5b3e0 && !cschashed-2\script_260abbdf1ff0aa9a::function_abf1dcb4(#"hash_266b62e342076a90"))
			{
				a_ai_zombies = getaiarchetypearray(#"zombie");
				a_ai_zombies = array::randomize(a_ai_zombies);
				foreach(ai_zombie in a_ai_zombies)
				{
					if(isdefined(ai_zombie.completed_emerging_into_playable_area) && ai_zombie.completed_emerging_into_playable_area && !zm_utility::is_magic_bullet_shield_enabled(ai_zombie) && (!(isdefined(ai_zombie.marked_for_death) && ai_zombie.marked_for_death)) && (!(isdefined(ai_zombie.var_94c53b42) && ai_zombie.var_94c53b42)) && (!(isdefined(ai_zombie.var_52531256) && ai_zombie.var_52531256)) && (!(isdefined(ai_zombie.var_3c394b1b) && ai_zombie.var_3c394b1b)) && ai_zombie cschashed-1\script_5a012bbb9342dbdf::function_db610082())
					{
						b_has_spawned = 1;
						level thread cschashed-2\script_260abbdf1ff0aa9a::function_9acf76e6(ai_zombie, #"hash_266b62e342076a90");
						break;
					}
				}
			}
...
/*
	...
	Flags: Linked
*/
function function_f342bc18(b_skipped)
{
...
function function_49b3f5aa()
{
	...
	while(true)
	{
		...
		if(var_eb3b90d.size > 0)
		{
			...
			while(true)
			{
				var_8756a1bd = namespace_75cbf125::spawn_single(1, s_spawn);
				if(isdefined(var_8756a1bd))
				{
					return;
				}
...
/*
	...
	Flags: Linked
*/
function function_5cd1e2d4(b_skipped)
{
...
/*
	...
	Flags: Linked
*/
function function_7c9ece4f(b_skipped)
{
	level endon(#"end_game", #"give_ankh" + "_ended_early");	s_loc = struct::get(#"hash_68e5680a6c84cf71");
	/#
		if(b_skipped)
		{
			s_loc struct::delete();
...
/*
	...
	Flags: Linked
*/
function function_4259a2c9(b_skipped)
{
...
function function_ecbc541d()
{
	...
	var_8d5cca6b[0] = util::spawn_model(#"hash_733272a4848675e2", s_runes.origin, s_runes.angles);
	var_8d5cca6b[1] = util::spawn_model(#"hash_733271a48486742f", s_runes.origin, s_runes.angles);
	var_8d5cca6b[2] = util::spawn_model(#"hash_733270a48486727c", s_runes.origin, s_runes.angles);
...
function function_3288a0d2()
{
	...
	while(true)
	{
		...
		var_d01e844a = var_be17187b.n_cf;
...
function function_202bd7b8()
{
	...
	while(true)
	{
		if(!cschashed-2\script_260abbdf1ff0aa9a::function_abf1dcb4(#"blight_father"))
		{
			...
			if(var_2d23a7ee.size == 0)
			{
				...
				foreach(ai_zombie in a_ai_zombies)
				{
					if(isdefined(ai_zombie.completed_emerging_into_playable_area) && ai_zombie.completed_emerging_into_playable_area && !zm_utility::is_magic_bullet_shield_enabled(ai_zombie) && (!(isdefined(ai_zombie.marked_for_death) && ai_zombie.marked_for_death)) && (!(isdefined(ai_zombie.var_94c53b42) && ai_zombie.var_94c53b42)) && (!(isdefined(ai_zombie.var_52531256) && ai_zombie.var_52531256)) && (!(isdefined(ai_zombie.var_3c394b1b) && ai_zombie.var_3c394b1b)) && ai_zombie cschashed-1\script_5a012bbb9342dbdf::function_db610082())
					{
						level thread cschashed-2\script_260abbdf1ff0aa9a::function_9acf76e6(ai_zombie, #"blight_father");
						return;
					}
				}
			}
...
function function_e4162ab8()
{
	...
	level notify(#"hash_d0d79bd22a685c1", {#hash_d01e844a:n_cf, #hash_83aeafd6:self});
...
/*
	...
	Flags: Linked
*/
function function_ec93aa41(b_skipped)
{
...
/*
	...
	Flags: Linked
*/
function function_1533614(b_skipped)
{
...
function function_5436fd42()
{
	...
	var_be17187b = undefined;
	var_be17187b = level waittill_timeout(60, #"light_second_part");	if(var_be17187b._notify == "light_second_part")
	{
...
function function_29a8dcd4(b_skipped)
{
	...
	zm_sq::start(#"light");
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 4);
	/#
		if(b_skipped)
		{
			return;
...
function function_488a4eb2(var_77104def, var_19e802fa)
{
	...
	/#
		if(var_77104def || var_19e802fa)
		{
			var_3a390e15 = array(#"prophecy", #"light");			foreach(var_de782fc6 in var_3a390e15)
			{
				var_401b2544 = level.var_ec84950b[str_step];
...
function play_setup(b_skipped)
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 5);
	/#
		if(b_skipped)
		{
			return;
	...
	while(true)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					cschashed-1\script_3c362258ff800237::fail(#"hash_3cd5b19b981e5c3c", getplayers());
					cschashed-1\script_3c362258ff800237::function_ae725d63(5);
				}
			}
		}
	}
...
function function_c3d19eae(death, inflictor, attacker, damage, flags, mod, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	if(is_wonder_weapon(weapon, var_2c03c1e4, b_uncharged) && mod !== "MOD_MELEE")
	{
		return self.health + 666;
	}
...
function function_93e711a6(s_params)
{
	...
	if(is_wonder_weapon(w_weapon, var_2c03c1e4, b_uncharged) && str_mod !== "MOD_MELEE")
	{
		var_99c9ce0c = level.var_28dcf408;
...
/*
	...
	Flags: Linked
*/
function function_e028a26f(var_2c03c1e4, var_9410d484 = 1, b_return = 0)
{
	self endon(#"disconnect");
	var_99c9ce0c = level.var_28dcf408;
...
/*
	...
	Flags: Linked
*/
function function_3d581a6(var_2c03c1e4, b_uncharged = 0)
{
	if(b_uncharged)
	{
...
/*
	...
	Flags: Linked
*/
function is_wonder_weapon(w_weapon, var_2c03c1e4, b_uncharged = 0)
{
		...
		for(i = 0; i < n_parts; i++)
		{
			...
			foreach(var_2c03c1e4, e_player in var_fc14780a)
			{
				if(isinarray(var_bddee53a, var_2c03c1e4))
				{
					...
					str_task = var_5841fdb6[n_task];
					var_32617a77 = array::find(var_59f7dee9, s_spotlight);
					n_spotlight++;
...
function function_a6ec87a7()
{
	...
	var_5841fdb6 = array(#"uncharged", #"charged");	for(i = 1; i <= 3; i++)
	{
		switch(i)
		{
			case 1:
...
function function_9cb5a6ac(var_2c03c1e4, str_task, var_12caf287, var_32617a77, var_d8d4faff)
{
	...
	else
	{
		...
		var_c016547 = var_59f7dee9[n_spotlight];
	...
	if(!var_fb51c008)
	{
		...
		self thread function_e028a26f(var_2c03c1e4, 0, b_return);
...
function function_542a6ee4(e_player, var_2c03c1e4, str_task, var_32617a77, var_d8d4faff)
{
	...
	if(str_task == #"both")
	{
		var_5841fdb6 = array(#"uncharged", #"charged");	}
	else
	{
	...
	foreach(str_task in var_5841fdb6)
	{
		if(str_task == #"uncharged")		{
			var_59f7dee9 = var_99c9ce0c.var_59f7dee9;
			var_c016547 = var_59f7dee9[n_spotlight];
			var_eb3b90d = struct::get_array(s_spotlight.target);
...
function function_6cdf4b0(var_2c03c1e4, var_adf060c6, var_ad7a4904, var_d8d4faff)
{
	...
	if(b_stationary)
	{
		ai_zombie val::set(#"play_ignoreall", "ignoreall", 1);		ai_zombie.start_inert = 1;
		ai_zombie.var_67faa700 = 1;
		ai_zombie thread function_d9b360d2(self);
	}
	ai_zombie thread function_790e49a5(var_2c03c1e4, b_uncharged);
	return ai_zombie;
}
...
/*
	...
	Flags: Linked
*/
function function_790e49a5(var_2c03c1e4, b_uncharged)
{
	switch(var_2c03c1e4)
	{
		case "death":
...
/*
	...
	Flags: Linked
*/
function function_2954c1bf(b_skipped)
{
	level endon(#"end_game", #"blood" + "_ended_early");
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 6);
...
/*
	...
	Flags: Linked
*/
function function_1cb738a0(b_skipped)
{
...
function function_153ee6c7(str_character)
{
	foreach(e_player in getplayers())
	{
		if(e_player cschashed-1\script_2c454d63a96d2d0b::is_character(str_character))
		{
			return e_player;
		}
	}
...
/*
	...
	Flags: Linked
*/
function function_ce32cc66(b_skipped)
{
	...
	if(!isdefined(var_5e0ce220))
	{
		...
		var_5e0ce220 cschashed-1\script_2c454d63a96d2d0b::set_character(array(#"hash_3e63362aea484e09", #"hash_5a906d7137467771"));
		var_5e0ce220 init_bot();
	}
	if(!isdefined(var_5adbb2f7))
	{
		var_5adbb2f7 = bot::add_bot(#"allies");
		var_9586c2b5.var_208b164f = var_5adbb2f7;
		var_5adbb2f7 cschashed-1\script_2c454d63a96d2d0b::set_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6"));
		var_5adbb2f7 init_bot();
	}
	...
	foreach(e_actor in array(var_5e0ce220, var_5adbb2f7))
	{
		...
		foreach(var_b9a803af in var_2d23a7ee)
		{
			...
			if(var_beb2295 === e_actor)
			{
				...
				level thread cschashed-3\script_7114102541e1f8c8::function_c526065b(var_b9a803af);
				break;
			}
		}
		...
		if(isdefined(var_c7410412))
		{
			...
			if(e_actor gadgetisactive(var_bcd1c2ff) || e_actor function_36dfc05f(n_slot))
			{
	...
	while(true)
	{
		...
		foreach(e_player in array(var_5e0ce220, var_5adbb2f7))
		{
			...
			if(isdefined(var_bcd1c2ff) && (e_player gadgetisactive(var_bcd1c2ff) || e_player function_36dfc05f(n_slot)))
			{
				var_b5d11642 = 0;
				break;
			}
...
function function_f81bfa93(a_ents)
{
	...
	var_5e0ce220 = a_ents[#"e_blood_scar"];	var_5adbb2f7 = a_ents[#"e_blood_brute"];	var_5adbb2f7 playsoundtoplayer(#"hash_6469d6b70bfbf855", var_5adbb2f7);
...
function function_5a8c0d95()
{
	...
	playsoundatposition(#"hash_396f1597d3662c78", (0, 0, 0));
	var_919d328 = util::spawn_model(s_mirror.model, v_mirror, s_mirror.angles);
...
function function_dcc3c705()
{
	...
	self endon(#"disconnect");
	if(!self cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_3e63362aea484e09", #"hash_5a906d7137467771")))
	{
		return;
	}
...
/*
	...
	Flags: Linked
*/
function function_d2ab893e(b_skipped)
{
...
/*
	...
	Flags: Linked
*/
function function_5e84e8f9(b_skipped)
{
...
/*
	...
	Flags: Linked
*/
function function_2f9d2650(b_skipped)
{
...
function function_358b40ed(var_77104def, var_19e802fa)
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_566a6ec283e2360a", 7);
...
/*
	...
	Flags: Linked
*/
function function_22165535(b_skipped)
{
...
function function_9f8fe5ae(var_77104def, var_19e802fa)
{
	...
	level thread cschashed-1\script_6b0e57a9841b472d::function_3a2efd4e(0);
}
...
function function_72004612(e_player)
{
	...
	{
		n_dist = distance2dsquared(var_cd411384.origin, v_teleport);
		if(n_dist > 128 * 128)
		{
			b_ready = 0;
			break;
