...
function __init__()
{
	clientfield::register("actor", "" + #"gaia_impact_zombie", 16000, 1, "counter", &function_b5b0d652, 0, 0);	clientfield::register("scriptmover", "" + #"hash_90f855c336338af", 16000, 1, "counter", &function_e8dc2680, 0, 0);
	clientfield::register("scriptmover", "" + #"gaia_impact", 16000, 1, "counter", &function_da7cbe2, 0, 0);	clientfield::register("scriptmover", "" + #"spike_explode", 16000, 1, "counter", &function_10485953, 0, 0);	clientfield::register("scriptmover", "" + #"spike_spawn", 16000, 1, "counter", &function_3672d8a5, 0, 0);	level._effect[#"hash_10c872875a19ee24"] = #"hash_5873b3e8eed6eece";
