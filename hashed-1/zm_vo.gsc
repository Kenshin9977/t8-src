...
{
	var_2f0fa840 = cschashed-1\script_2c454d63a96d2d0b::function_dc232a80(character1);
	var_7a0bbe3b = cschashed-1\script_2c454d63a96d2d0b::function_dc232a80(character2);
...
{
	var_53297699 = var_2e6c012e cschashed-1\script_2c454d63a96d2d0b::function_dc232a80();
	var_b1411c83 = var_2e6c012e function_82f9bc9f();
	var_6095116c = e_player_2 cschashed-1\script_2c454d63a96d2d0b::function_dc232a80();
	...
	for(i = 0; i < a_players.size; i++)
	{
		for(j = 0; j < a_players.size; j++)
		{
			if(a_players[i] != a_players[j])
			{
				...
				if(isdefined(player1))
				{
					var_2f0fa840 = player1 cschashed-1\script_2c454d63a96d2d0b::function_dc232a80();
				}
				if(isdefined(player2))
				{
					var_7a0bbe3b = player2 cschashed-1\script_2c454d63a96d2d0b::function_dc232a80();
				}
				var_ac829b0 = min(var_2f0fa840, var_7a0bbe3b) + "-" + max(var_2f0fa840, var_7a0bbe3b);
...
function function_8e0f4696(str_vo_alias, n_delay = 0, b_wait_if_busy = 0, var_2cb3b5d = 0, var_34e7887 = 0, var_d7714e4e = 0, var_9c64da7c = 0, var_67fee570 = 0)
{
	...
	if(cschashed-1\script_3c362258ff800237::function_b47f6aba() || zm_utility::is_standard() && !var_9c64da7c || (isdefined(level.var_d555ff19) && level.var_d555ff19))
	{
		return 0;
	}
	if(isplayer(self))
