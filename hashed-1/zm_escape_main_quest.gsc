...
#using hashed-2\zm_game_over.gsc;
#using hashed-3\bot.gsc;
#using script_27c22e1d8df4d852;
#using hashed-1\ability_player.gsc;
...
#namespace cschashed-2\script_28d5e820ed15e2a7;
...
function init()
{
	...
	init_fx();
	function_3335f286();
	scene::add_scene_func(#"hash_5360029a47cadd01", &function_512a6b36, "init");
...
function main()
{
	...
	if(zm_utility::can_enable_ee())
	{
		...
		{
			level cschashed-2\script_711bbbba637da80::function_18b599e0();
		}
...
function function_842831cf()
{
	...
	clientfield::register("scriptmover", "" + #"hash_7e426bfd123d0beb", 1, var_440ad52e, "int");
	...
	clientfield::register("scriptmover", "" + #"orb_explosion", 1, 1, "int");	clientfield::register("scriptmover", "" + #"hash_6e2f9a57d1bc4b6a", 1, 1, "int");
	clientfield::register("scriptmover", "" + #"hash_3eb94ba53dd09196", 1, 1, "int");
	clientfield::register("scriptmover", "" + #"hash_3d147d21de9de5c7", 1, 1, "int");
	...
	clientfield::register("toplayer", "" + #"hash_564a175f749f8d5b", 1, 1, "int");
...
function init_flags()
{
	...
	level flag::init(#"hash_7a6c2fc48d2d09ee");
	level flag::init(#"hash_1b4b6ce05cb62d56");
	level flag::init(#"hash_3d16465b22e70170");
	level flag::init(#"hash_233bb105ee83c609");
...
{
	namespace_891c9bac::function_577efa88(5);
	namespace_891c9bac::function_577efa88(6);
	namespace_891c9bac::function_577efa88(7);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"1", #"hash_53dd4dd26004594b", &step_1, &function_64809180);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"2", #"hash_53dd4ed260045afe", &step_2, &function_bb332956);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"3", #"hash_53dd4fd260045cb1", &step_3, &function_8a5e22a9);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"4", #"hash_53dd50d260045e64", &step_4, &function_d332dd57);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"5", #"hash_53dd51d260046017", &step_5, &function_2aa0f2b7);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"6", #"hash_53dd52d2600461ca", &step_6, &function_618ac765);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"7", #"hash_53dd53d26004637d", &step_7, &function_bb4eb989);
	namespace_ee206246::register(#"hash_62ca600e9c6f07c0", #"outro", #"hash_4b2d3fa2839cfcf8", &outro, &outro_cleanup, 1, &function_f7a9d7c4);
}
...
function step_1(var_a276c861)
{
	...
	if(isalive(s_result.var_de86a1af))
	{
		s_result.var_de86a1af thread function_b4ab4a64();
	}
	...
	level thread scene::init_streamer(#"hash_1eef3ca99bb2b0b2", #"allies", 0, 0);
	s_orb = struct::get("s_house_orb");
	var_72814265.var_b7eee573 = util::spawn_model(#"hash_27ac5ad4aaeb197", s_orb.origin, s_orb.angles);
	var_72814265.s_unitrigger_stub = var_72814265 zm_unitrigger::create("", 48, &function_1af254ac);
...
function function_64809180(var_a276c861, var_19e802fa)
{
	...
	s_orb = struct::get("s_house_orb");
	if(isdefined(var_72814265.var_b7eee573))
	{
		var_72814265.var_b7eee573 delete();
	}
...
function function_c4299d51()
{
	...
	while(true)
	{
		...
		if(s_result.weapon == getweapon(#"hash_52b03a79f854eed3") || s_result.weapon == getweapon(#"hash_32a584f5a65c70d1") || s_result.weapon == getweapon(#"golden_knife") || s_result.weapon == getweapon(#"spknifeork"))
		{
...
*/
private function function_b4ab4a64()
{
	self endon(#"death");
	self clientfield::set("brutus_spawn_clientfield", 0);
	wait(0.1);
	level thread namespace_54386dac::function_37aed203(self, 0);
}
...
function function_1af254ac()
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator) && isalive(s_result.activator))
		{
			...
			s_result.activator thread zm_audio::create_and_play_dialog(#"hash_44b4edd3d705820d", #"generic");
			return;
		}
	}
}
...
function function_1f975a04()
{
	...
	e_player thread namespace_891c9bac::function_a2bd5a0c(#"hash_68b4a0bee89499a7");
}
...
function function_fc4ee98b()
{
	...
	namespace_891c9bac::function_3c173d37(e_player.origin, 512);
	e_player thread namespace_891c9bac::function_a2bd5a0c(#"hash_61bd637d16f1ea90");
	...
	if(isalive(e_richtofen))
	{
		if(util::get_active_players().size > 1)
		{
			...
			namespace_891c9bac::function_3c173d37(e_player.origin, 512);
			e_player namespace_891c9bac::function_a2bd5a0c(#"hash_69e992122611c96f", 0, 1, 9999);
		}
		if(isalive(e_richtofen))
		{
			namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
			e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_69e992122611c96f", 0, 1, 9999);
		}
	}
	else
	{
		e_player = array::random(util::get_active_players());
		namespace_891c9bac::function_3c173d37(e_player.origin, 512);
		e_player namespace_891c9bac::function_a2bd5a0c(#"hash_69e992122611c96f");
	}
...
function function_952c0e76()
{
	...
	b_play_vo = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_5ef24b746faa2e43", 0, 1, 9999, 1, 1, 1);
	if(b_play_vo)
	{
		namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
		b_play_vo = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_31282f9cdf8f5f22", 0, 1, 9999);
	}
	if(b_play_vo)
	{
		e_richtofen namespace_891c9bac::function_57b8cd17();
		b_play_vo = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_54b5a3377a36a0cd", 0, 1, 9999, 1, 1, 1);
		if(b_play_vo)
		{
			namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
			b_play_vo = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_31282d9cdf8f5bbc", 0, 1, 9999);
		}
		if(b_play_vo)
		{
			e_richtofen namespace_891c9bac::function_57b8cd17();
			b_play_vo = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_65d3caef1dcbd8af", 0, 1, 9999, 1, 1, 1);
			if(b_play_vo)
			{
				namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
				b_play_vo = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_31282b9cdf8f5856", 0, 1, 9999);
				if(b_play_vo && util::get_active_players().size > 1)
				{
					...
					{
						namespace_891c9bac::function_3c173d37(var_b63113d5.origin, 512);
						b_play_vo = var_b63113d5 namespace_891c9bac::function_a2bd5a0c(#"hash_31282a9cdf8f56a3", 0, 1, 9999);
						if(b_play_vo)
						{
							namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
							e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_3128299cdf8f54f0", 0, 1, 9999);
						}
					}
				}
			}
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 2);
	if(var_a276c861)
	{
		return;
	}
...
function function_bb332956(var_a276c861, var_19e802fa)
{
	...
	{
		if(isdefined(level.var_dcc985c4.var_5b1e58f2))
		{
			level.var_dcc985c4.var_5b1e58f2 delete();
		}
...
/*
	...
	Flags: Linked, Private
*/
private function function_dc04e77e()
{
	...
	var_2f3fca78.mdl_origin scene::play(#"hash_9307bb172366651", "materialize", var_2f3fca78.var_4527036f);
	var_2f3fca78.mdl_origin thread scene::play(#"hash_9307bb172366651", "attack", var_2f3fca78.var_4527036f);
	var_2f3fca78.var_4527036f waittill(#"att_fx");	var_2f3fca78.var_4527036f clientfield::set("" + #"hash_3d147d21de9de5c7", 1);
	...
	var_2f3fca78.mdl_origin thread scene::play(#"hash_9307bb172366651", "loop_anim", var_2f3fca78.var_4527036f);
	wait(1.5);
	...
	while(isdefined(var_21fedc12))
	{
		...
		{
			var_2f3fca78.mdl_origin thread scene::play(#"hash_9307bb172366651", "dissolve", var_2f3fca78.var_4527036f);
		}
	...
	var_2f3fca78.var_4527036f notify(#"hash_3efcdd76ab70e782");
...
/*
	...
	Flags: Linked, Private
*/
private function function_90d12e87()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d8d3d62()
{
	...
	else
	{
		...
		while(!var_7e4a1da8)
		{
			...
			foreach(e_player in util::get_active_players())
			{
				var_e31b4998 = zm_zonemgr::function_54fc7938(e_player, mdl_origin);
	...
	#/
	level waittill(#"hash_70eeaf5dc2405f84");
	level.var_487c1bca++;
	function_94cbd473();
	foreach(e_player in util::get_active_players())
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_26e380c2()
{
	level endon(#"hash_36138b6e1d539829", #"hash_1b94645b5f964ebe");
	var_3d950183 = struct::get_array("s_p_s2_b_loc");
	var_dcc985c4 = array::random(var_3d950183);
...
function function_5d904e7d(var_dcc985c4, var_a6c68ee8 = 1, var_cc91eb05 = 0)
{
	...
	switch(n_item)
	{
		case 0:
		{
			var_dcc985c4.var_5b1e58f2 = util::spawn_model(#"hash_31ef150281f66fc1", var_dcc985c4.origin, var_dcc985c4.angles);
			break;
		}
		case 1:
		{
			var_dcc985c4.var_5b1e58f2 = util::spawn_model(#"hash_155e10710d250b83", var_dcc985c4.origin + (0, 0, 1), var_dcc985c4.angles);
			break;
		}
		case 2:
		{
			var_dcc985c4.var_5b1e58f2 = util::spawn_model(#"hash_153ac5fda9f2b0c9", var_dcc985c4.origin, var_dcc985c4.angles);
			break;
		}
	}
	var_2c82917f = struct::get_array(var_dcc985c4.target);
	var_a0dabce1 = array::random(var_2c82917f);
	...
	var_dcc985c4.var_e5c7e01a clientfield::set("" + #"hash_3d147d21de9de5c7", 1);
	...
	var_dcc985c4.mdl_origin thread scene::play(#"hash_9307bb172366651", "idle_grounded_loop", var_dcc985c4.var_e5c7e01a);
	...
	{
		var_dcc985c4.var_617131bd = util::spawn_model(#"hash_4890ab9a9e28d94d", s_book.origin, s_book.angles);
		var_dcc985c4.var_617131bd clientfield::set("" + #"hash_6e2f9a57d1bc4b6a", 1);
	}
	if(isdefined(var_dd293727) && !var_cc91eb05)
	{
...
{
	level endon(#"hash_70eeaf5dc2405f84", #"hash_36138b6e1d539829");
	self setcandamage(1);
	...
	while(true)
	{
		...
		level notify(#"hash_70eeaf5dc2405f84");
	}
}
...
function function_a039c992()
{
	...
	while(true)
	{
		if(self.currentweapon == level.var_4e845c84 || self.currentweapon == level.var_58e17ce3)
		{
			...
			a_str_active_zones = namespace_57ff8cbb::get_adjacencies_to_zone(level.var_dcc985c4.script_string);
...
/*
	...
	Flags: Linked, Private
*/
private function function_e4a9da98()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f1d0739()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c4a07f79()
{
	function_94cbd473();
	/#
		iprintln("");
...
/*
	...
	Flags: Linked, Private
*/
private function function_787bed75()
{
	...
	{
		s_result = undefined;
		s_result = level.var_dcc985c4.var_e5c7e01a waittill(#"hash_6fd7f8e1f00deffe");
...
function function_66677663(e_grenade, n_grenade_charge_power)
{
	...
	if(isdefined(level.var_dcc985c4.var_e5c7e01a.var_98ceb3be) && level.var_dcc985c4.var_e5c7e01a.var_98ceb3be)
	{
		if(isdefined(level.var_dcc985c4.var_617131bd))
		{
			var_6e6ec518 = cschashed-3\script_7228a45f434ec207::tomahawk_spawn(e_grenade.origin);
			...
			self thread cschashed-3\script_7228a45f434ec207::tomahawk_return_player(var_6e6ec518, undefined, 800);
...
{
	self endon_callback(&function_4dd32050, #"disconnect");
...
private function function_750df71a()
{
	...
	#/
	var_21841d64 = util::spawn_model(#"hash_4890ab9a9e28d94d", v_pos + vectorscale((0, 0, 1), 24));
...
/*
	...
	Flags: Linked, Private
*/
private function function_e645ca47()
{
	self endon(#"death");
...
function function_94cbd473()
{
	...
	{
		level.var_dcc985c4.mdl_origin scene::play(#"hash_9307bb172366651", "fly_off", level.var_dcc985c4.var_e5c7e01a);
...
/*
	...
	Flags: Linked, Private
*/
private function function_1bf68b9d(v_position, v_angles)
{
	if(!isdefined(v_position))
	{
		return;
...
function function_1798f59a(e_player)
{
	...
	{
		namespace_891c9bac::function_3c173d37(e_player.origin, 512);
		e_player namespace_891c9bac::function_a2bd5a0c(#"hash_61ec04cf6e717320");
	}
}
...
function function_779a8baa()
{
	...
	namespace_891c9bac::function_3c173d37(e_player.origin, 512);
	b_played_line = e_player namespace_891c9bac::function_a2bd5a0c(#"hash_7ece3932c57d8fad", 0, 1);
...
function function_c362eae3()
{
	...
	e_richtofen namespace_891c9bac::function_57b8cd17();
	var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_3017e53254e0b2b0", 0, 1, 9999, 1, 1, 1);
	if(b_say)
	{
		namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_26737a9cd8eaf393", 0, 1, 9999);
		if(b_say)
		{
			e_richtofen namespace_891c9bac::function_57b8cd17();
			var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_680ce96c277ba84e", 0, 1, 9999, 1, 1, 1);
			if(b_say)
			{
				namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
				var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_26737c9cd8eaf6f9", 0, 1, 9999);
				if(b_say && util::get_active_players().size > 1)
				{
					...
					{
						namespace_891c9bac::function_3c173d37(var_95b25b2e.origin, 512);
						var_26e0e1ec = var_95b25b2e namespace_891c9bac::function_a2bd5a0c(#"hash_26737d9cd8eaf8ac", 0, 1, 9999);
						if(b_say)
						{
							e_richtofen namespace_891c9bac::function_57b8cd17();
							var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_400c40774d03001d", 0, 1, 9999, 1, 1, 1);
							if(b_say)
							{
								namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
								var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_26737f9cd8eafc12", 0, 1, 9999);
								if(b_say)
								{
									e_richtofen namespace_891c9bac::function_57b8cd17();
									var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_1aa5f5d5b29633d3", 0, 1, 9999, 1, 1, 1);
								}
							}
						}
					}
...
function function_b1203924(var_4527b4bf = 0)
{
	...
	{
		if(e_player cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
		{
...
function function_b61881e5(e_richtofen)
{
	...
	{
		if(!e_player cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")) && isalive(e_player) && isalive(e_richtofen) && distancesquared(e_player.origin, e_richtofen.origin) < 589824)
		{
	...
	while(true)
	{
		if(self.currentweapon == level.var_4e845c84 || self.currentweapon == level.var_58e17ce3 && (!(isdefined(self.var_32a62723) && self.var_32a62723)))
		{
			if(isdefined(level.var_dcc985c4.var_e5c7e01a) && distancesquared(level.var_dcc985c4.var_e5c7e01a.origin, self.origin) < 262144)
			{
				...
				if(n_trace > 0.65)
				{
					namespace_891c9bac::function_3c173d37(self.origin, 512);
					self.var_32a62723 = self namespace_891c9bac::function_a2bd5a0c(#"hash_13cd65f9025f98b", 0, 1, 9999);
				}
			}
		}
		wait(1);
...
{
	self namespace_891c9bac::function_3c173d37(self.origin, 512);
	self namespace_891c9bac::function_a2bd5a0c(#"hash_51734ccae106d149", 0, 1, 9999);
}
...
function scr_safehouse_testrageservice()
{
	...
	e_richtofen endon(#"death", #"disconnect");
	e_richtofen namespace_891c9bac::function_57b8cd17();
	var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_7fdd1ff9ab5956e1", 0, 1, 9999, 1, 1, 1);
	if(b_say)
	{
		namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1f24619cd5290718", 0, 1, 9999);
		if(b_say)
		{
			e_richtofen namespace_891c9bac::function_57b8cd17();
			var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_42cfc3e346da1d7", 0, 1, 9999, 1, 1, 1);
			if(b_say)
			{
				namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
				var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1f24639cd5290a7e", 0, 1, 999);
				if(b_say)
				{
					var_95b25b2e = function_b61881e5(e_richtofen);
					...
					{
						namespace_891c9bac::function_3c173d37(var_95b25b2e.origin, 512);
						var_26e0e1ec = var_95b25b2e namespace_891c9bac::function_a2bd5a0c(#"hash_1f24669cd5290f97", 0, 1, 9999);
						if(b_say)
						{
							e_richtofen namespace_891c9bac::function_57b8cd17();
							var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_69c55b111354ddfc", 0, 1, 9999, 1, 1, 1);
							if(b_say)
							{
								namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
								var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1f24689cd52912fd", 0, 1, 9999);
								if(b_say)
								{
									e_richtofen namespace_891c9bac::function_57b8cd17();
									var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_7168ed7a57c9729a", 0, 1, 9999, 1, 1, 1);
								}
							}
						}
					}
...
function function_9465204c(var_64c09f7f)
{
	...
	namespace_891c9bac::function_3c173d37(var_64c09f7f.origin, 512);
	var_26e0e1ec = var_64c09f7f namespace_891c9bac::function_a2bd5a0c(#"hash_53ef8e09c9b4d690", 0, 1, 9999);
	if(var_26e0e1ec && isalive(var_64c09f7f) && !var_64c09f7f cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
	{
		e_richtofen = function_b1203924();
		if(isalive(e_richtofen) && distancesquared(e_richtofen.origin, var_64c09f7f.origin) < 589824)
		{
			namespace_891c9bac::function_3c173d37(e_richtofen.origin, 768);
			var_f5f9c084 = cschashed-1\script_2c454d63a96d2d0b::function_9004475c(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae"));
			e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_53ef8e09c9b4d690", 0, 1, 9999);
		}
	}
}
		...
		switch(cmd)
		{
			...
			case "hash_39361a1fa06167ab":
			{
				...
				foreach(s_loc in var_20279738)
				{
					...
					var_2c82917f[0] thread scene::play(#"hash_9307bb172366651", "", s_loc.var_231e3f97);
					var_dd293727 = struct::get(var_2c82917f[0].target);
					if(isdefined(s_book))
					{
						s_loc.var_39fa0e01 = util::spawn_model(#"hash_4890ab9a9e28d94d", s_book.origin, s_book.angles);
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 3);
	level thread cschashed-2\script_711bbbba637da80::function_307fdd13(var_a276c861);
	if(!var_a276c861)
	{
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 4);
...
function function_d332dd57(var_a276c861, var_19e802fa)
{
	...
	level namespace_54386dac::function_67710e66(1);
	foreach(e_player in util::get_players())
	{
		...
		{
			e_player cschashed-1\script_3d5821d793ed4c6::function_d37a769(e_player.var_1b7ab815);
			e_player.var_1b7ab815 = undefined;
		}
		e_player cschashed-1\script_3d4e88c949caf53e::function_ac9cb612(0);
	}
	level.var_d668eae7[0] spawner::remove_spawn_function(&function_90ce7724);
	if(isdefined(level.var_dc4013b0))
	{
		namespace_54386dac::function_37aed203(level.var_dc4013b0);
	...
	if(isdefined(level.var_7a548c75))
	{
		...
		level.var_7a548c75 notify(#"hash_3efcdd76ab70e782");
...
/*
	...
	Flags: Linked, Private
*/
private function function_2aee0563()
{
...
function function_ed3077c1()
{
	...
	while(true)
	{
		var_a0195777 = distance2dsquared(s_summoning_key.origin, self.origin);
		if(!var_3d569543 && self zm_zonemgr::is_player_in_zone("zone_warden_home") && var_a0195777 <= 13456)
		{
			self clientfield::set_to_player("rumble_spinning_trap", 1);
			self clientfield::set("" + #"hash_4f58771e117ee3ee", 1);
			var_3d569543 = 1;
		}
		else if(var_3d569543 && (!self zm_zonemgr::is_player_in_zone("zone_warden_home") || var_a0195777 > 13456))
		{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d82c14e8()
{
	level endon(#"hash_2f347ddff9fdaeb9");
	s_summoning_key = struct::get(#"s_p_s4_s_k_ins");
	while(true)
...
/*
	...
	Flags: Linked, Private
*/
private function function_adb645f2()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_9e1e3766()
{
	...
	if(isdefined(var_3270baa7[0]))
	{
		...
		var_3270baa7[0] notify(#"trigger", {#hash_3fc8547c:1, #activator:a_e_players[0]});
	}
	namespace_54386dac::function_2f9d355c();
	foreach(e_player in util::get_players())
	{
	...
	var_e0630bbb = struct::get("p_s_4_bag");
	function_6932a6d4("" + #"hash_564a175f749f8d5b");
	...
	scene::add_scene_func("aib_vign_zm_mob_brutus_monologue", &function_e3337dc9, "play");
	var_669d3a02 = getentarray("mdl_p_s_4_clip", "script_noteworthy");
...
/*
	...
	Flags: Linked, Private
*/
private function function_5526beaa()
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_1c2b53df()
{
	self endon(#"disconnect");
...
/*
	...
	Flags: Linked, Private
*/
private function function_b1130e05()
{
	self endon(#"disconnect");
	var_24cc214c = array(getweapon(#"tomahawk_t8"), getweapon(#"tomahawk_t8_upgraded"), getweapon(#"hash_52b03a79f854eed3"), getweapon(#"hash_32a584f5a65c70d1"), getweapon(#"spknifeork"), getweapon(#"knife"));
	var_5c9fee42 = [];
	var_597c1a0b = self getweaponslist();
	foreach(var_2336847 in var_597c1a0b)
	{
		if(isinarray(var_24cc214c, var_2336847))
		{
			...
			if(!isinarray(var_5c9fee42, var_2336847))
			{
				var_5c9fee42[var_5c9fee42.size] = var_2336847;
			}
		}
	}
...
function function_3035b012()
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator) && isalive(s_result.activator))
		{
			...
			e_player clientfield::set_to_player("" + #"hash_564a175f749f8d5b", 0);
...
/*
	...
	Flags: Linked, Private
*/
private function function_90ce7724()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f01e5d6d()
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_ddc5b4e9()
{
	level namespace_54386dac::function_67710e66(0);
	...
	level.var_7a548c75 clientfield::set("" + #"hash_3d147d21de9de5c7", 1);
	...
	level.var_7a548c75 function_5b5fc6fb(var_2f3fca78.target);
	level.var_7a548c75.mdl_origin thread scene::play(#"hash_9307bb172366651", "attack", level.var_7a548c75);
	level.var_7a548c75 waittill(#"att_fx");	v_position = function_9cc082d2(level.var_7a548c75.origin, 512);
	if(isdefined(v_position))
	{
	...
	var_a8d69fbd notify(#"hash_6fd7f8e1f00deffe");
	...
	function_c2746c7c();
	level.var_7a548c75 thread function_5b5fc6fb("s_p4_gull_wait_0", undefined, 500);
...
/*
	...
	Flags: Linked, Private
*/
private function function_c2746c7c()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_2e3734e2()
{
	level endon(#"hash_6048c3f423fd987");
	level.var_7a548c75 thread function_5b7ba6e0();
	level.var_db931455 = struct::get("p_s_4_br_patrol_spawn");
	if(!isdefined(level.var_dc4013b0))
	{
		level.var_dc4013b0 = zombie_utility::spawn_zombie(level.var_d668eae7[0], undefined, level.var_db931455);
	}
	level.var_dc4013b0.b_alerted = 0;
	level.var_dc4013b0 thread function_5bc6515c(level.var_db931455);
...
/*
	...
	Flags: Linked, Private
*/
private function function_5b7ba6e0()
{
	self endon(#"death");
	s_result = undefined;
	s_result = level waittill(#"hash_71944131dc1aa5f0", #"hash_3fbae87a461a2833");
	self thread function_5b5fc6fb("s_p4_gull_wait_1", #"hash_3ae7273b29d5ffee", 500);
	level waittill(#"hash_27676df2bce09242");
	self thread function_5b5fc6fb("s_p4_gull_wait_3", #"hash_1eb5db47aabd9f93", 500);
	...
	if(isalive(level.var_dc4013b0))
	{
		self thread function_5b5fc6fb("s_p4_gull_wait_4", #"spawn_dog_patrol", 500, 1);		level waittill(#"hash_27c8ecf60a651408", #"hash_61d9bcdf0dc6a4cc", #"hash_671f280acd6d81fc");
		wait(2.9);
	}
	if(isalive(level.var_dc4013b0) && level.var_dc4013b0 ai::get_behavior_attribute("scripted_mode"))
	{
		...
		level thread namespace_54386dac::function_37aed203(level.var_dc4013b0);
		wait(1);
	}
	self thread function_5b5fc6fb(#"hash_20824ff037f0ef57", #"hash_573bca7543322902", 500);
}
...
/*
	...
	Flags: Private
*/
private function function_9e1370d4()
{
	level endon(#"hash_6048c3f423fd987");
...
/*
	...
	Flags: Linked, Private
*/
private function function_5bc6515c(var_db931455)
{
	self endon(#"death", #"damage", #"hash_717a037bb411c6e4", #"hash_57283f8a57179332");
	level endon(#"hash_6048c3f423fd987");
	if(var_db931455.targetname === "p_s_4_br_patrol_spawn")
	{
		self thread function_9a832000();
		level waittill(#"hash_3fbae87a461a2833");
		wait(0.1);
	}
	s_next = struct::get(var_db931455.target);
	while(isdefined(s_next))
	{
		self setgoal(s_next.origin, 1);
		self waittill(#"goal");
		level.var_db931455 = s_next;
...
/*
	...
	Flags: Linked, Private
*/
private function function_1d0df68c(var_b631c17a)
{
	self endon(#"death", #"hash_717a037bb411c6e4");
	while(true)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_a7c869fb(n_wait)
{
	self endon(#"death");
	self endon_callback(&function_75b71c1f, #"damage", #"hash_717a037bb411c6e4");
	level endon(#"hash_6048c3f423fd987");
	...
	while(true)
	{
		...
		foreach(e_player in util::get_active_players())
		{
			if(distance2dsquared(e_player.origin, self.origin) < 116 * 116)
			{
				...
				{
					self notify(#"hash_717a037bb411c6e4");
				}
			}
		}
		if(var_252b80e8)
...
{
	level.var_dc4013b0 endon(#"hash_717a037bb411c6e4", #"death");
	...
	while(b_continue)
	{
		var_8ee30071 = util::get_active_players()[0];
		if(util::get_active_players().size > 1)
		{
			n_dist_sq_closest = distance2dsquared(var_8ee30071.origin, level.var_dc4013b0.origin);
			for(i = 1; i < util::get_active_players().size; i++)
			{
				...
				{
					var_8ee30071 = util::get_active_players()[i];
					n_dist_sq_closest = n_dist_sq;
				}
			}
		}
		if(!var_8ee30071 util::is_looking_at(level.var_dc4013b0))
		{
			b_continue = 0;
			break;
		}
	...
	{
		level.var_dc4013b0 notify(#"hash_57283f8a57179332");
		level.var_dc4013b0 clientfield::set("brutus_spawn_clientfield", 0);
		level.var_db931455 = struct::get(str_teleport_name);
		level.var_dc4013b0 forceteleport(level.var_db931455.origin, level.var_db931455.angles);
		waitframe(1);
		level.var_dc4013b0 clientfield::set("brutus_spawn_clientfield", 1);
		level.var_dc4013b0 function_5bc6515c(level.var_db931455);
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_68a43add(str_zone, var_c34665fc)
{
...
{
	function_16253726(#"hash_71c45db075d0f127", #"spawn_dog_patrol");	s_spawn = struct::get(#"hash_d808e38f50220cb");
	...
	waitframe(1);
	level.var_c28f6f4b namespace_54386dac::function_7273c33d(s_spawn);
	level.var_c28f6f4b val::set(#"dog_patrol", "ignoreall", 1);
	while(!level.var_c28f6f4b.var_47a79a2f && isdefined(level.var_dc4013b0) && !level.var_dc4013b0.b_alerted)
	{
		foreach(player in util::get_active_players())
		{
...
/*
	...
	Flags: Private
*/
private function function_26609819()
{
	...
	while(true)
	{
		...
		{
			ai_dog = cschashed-1\script_5fb8da2731850d9e::function_62db7b1c(1, undefined);
			waitframe(1);
		}
		if(isdefined(ai_dog))
		{
...
/*
	...
	Flags: Linked, Private
*/
private function function_474ba3b0()
{
	level endon(#"hash_6048c3f423fd987");
	level waittill(#"spawn_dog_patrol");	var_db931455 = struct::get("p_s_4_br_stun_spawn");
	var_996029a9 = zombie_utility::spawn_zombie(level.var_d668eae7[0]);
	waitframe(1);
	var_996029a9 forceteleport(var_db931455.origin, var_db931455.angles);
...
/*
	...
	Flags: Linked, Private
*/
private function function_6758392d()
{
	self endon_callback(&function_ac2a83ab, #"damage", #"hash_42a8552839190aae");
	self endon(#"death");
	b_continue = 1;
	...
	self notify(#"hash_42a8552839190aae");
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_65c7c787(var_de86a1af)
{
	level notify(#"hash_573bca7543322902");
	var_de86a1af val::set(#"hash_54a371c662e546eb", "allowdeath", 0);
	while(isalive(var_de86a1af) && distance2dsquared(var_de86a1af.origin, level.var_7a548c75.mdl_origin.origin) > 147456)
	{
		waitframe(1);
	}
	level notify(#"hash_573bca7543322902");
	...
	if(isalive(var_de86a1af))
	{
		var_de86a1af thread function_dbe333cb(2.9);
	}
	else
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_dbe333cb(n_time)
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_8e52cae7()
{
	level endon(#"hash_6048c3f423fd987");
	callback::remove_on_spawned(&function_1c2b53df);
	...
	var_250c0b66 = struct::get_array("s_p_s_4_c_d_s");
	foreach(s_spawn in var_250c0b66)
	{
...
{
	level endon(#"hash_6048c3f423fd987");
	self thread function_5b5fc6fb("s_p4_gull_wait_6", #"s_player_w_g_1", 500);
	level waittill(#"s_player_w_g_1");
	self thread function_5b5fc6fb("s_p4_gull_wait_7", #"s_player_w_g_2", 500);
	level waittill(#"s_player_w_g_2");
	self thread function_5b5fc6fb("s_p4_gull_wait_8", #"s_player_w_g_3", 500);
	level waittill(#"s_player_w_g_3");
	self thread function_5b5fc6fb("s_p4_gull_wait_9", #"s_player_w_g_4", 500);
	level waittill(#"s_player_w_g_4");
	self thread function_5b5fc6fb("s_p4_gull_wait_10", #"s_player_w_g_5", 500);
	level waittill(#"s_player_w_g_5");
	self thread function_5b5fc6fb("s_p4_gull_wait_11", #"s_player_w_g_6", 500);
	level waittill(#"s_player_w_g_6");
	self thread function_5b5fc6fb("s_p4_gull_wait_12", #"s_player_w_g_7", 500);
	level waittill(#"s_player_w_g_7");
	self thread function_5b5fc6fb("s_p4_gull_wait_13", undefined, 500);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_1e1e575e()
{
	level endon(#"hash_6048c3f423fd987");
...
/*
	...
	Flags: Linked, Private
*/
private function function_3ec723c4()
{
...
/*
	...
	Flags: Private
*/
private function function_8a1ab660()
{
	level endon(#"hash_6048c3f423fd987");
	level.var_dc4013b0 endon(#"death", #"hash_717a037bb411c6e4");
	if(!isdefined(level.var_dc4013b0))
	{
		return;
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_c482e40a()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_5deecaa4()
{
	...
	while(true)
	{
		...
		foreach(e_player in util::get_active_players())
		{
			...
			{
				cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1);
				break;
			}
		}
	}
...
function function_868655b9(str_notify)
{
	...
	if(var_42c622b6.size > 1)
	{
		for(i = 0; i < var_42c622b6.size - 1; i++)
		{
			var_de86a1af = var_42c622b6[i];
			namespace_54386dac::function_37aed203(var_de86a1af);
		}
	}
}
...
/*
	...
	Flags: Private
*/
private function function_f28c854b()
{
	level endon(#"hash_6048c3f423fd987", #"hash_6bacf600a3126b18");
	while(true)
	{
		var_42c622b6 = getaiarchetypearray(#"brutus");
		if(var_42c622b6.size == 0)
		{
			cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1);
		}
		wait(2);
...
/*
	...
	Flags: Linked, Private
*/
private function function_d8e03d9e()
{
	level endon(#"hash_6048c3f423fd987", #"hash_6bacf600a3126b18");
	...
	var_5358f4e7 = struct::get_array(self.target);
	foreach(var_90da597 in var_5358f4e7)
	{
		if(!isdefined(s_dog_spawn.script_int) || (isdefined(s_dog_spawn.script_int) && s_dog_spawn.script_int <= util::get_active_players().size))
		{
			...
			if(isalive(e_dog))
			{
				e_dog thread namespace_54386dac::function_7273c33d(s_dog_spawn);
...
/*
	...
	Flags: Linked, Private
*/
private function function_67646b91()
{
	level endon(#"hash_6048c3f423fd987", #"hash_6bacf600a3126b18");
	var_bc24de55 = [];
	var_ca5e7ac8 = [];
	...
	while(true)
	{
		...
		if(isdefined(s_loc))
		{
			...
			{
				waitframe(1);
				e_dog thread namespace_54386dac::function_7273c33d(s_loc);
				e_dog ai::set_behavior_attribute("sprint", 1);
			}
		}
		wait(randomfloatrange(1.6, 2.9));
...
/*
	...
	Flags: Linked, Private
*/
private function function_83467abf()
{
	level endon(#"hash_6048c3f423fd987", #"hash_6bacf600a3126b18");
	while(true)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c53dbd56()
{
	var_42c622b6 = getaiarchetypearray(#"brutus");
	foreach(var_de86a1af in var_42c622b6)
	{
		level thread namespace_54386dac::function_37aed203(var_de86a1af);
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_8562a40f()
{
	level endon(#"hash_6048c3f423fd987");
	scene::add_scene_func(#"hash_314849ff967504f5", &function_b2c57ad7, "play");
	s_orb = struct::get("s_p_s_4_b_g_p_orb");
	var_72814265.var_b7eee573 = util::spawn_model(s_orb.model, s_orb.origin, s_orb.angles);
	var_72814265.var_b7eee573 setscale(3);
	var_72814265.var_b7eee573 ghost();
	...
	level.var_7a548c75.mdl_origin scene::play(#"hash_9307bb172366651", "dissolve", level.var_7a548c75);
	...
	var_72814265.var_b7eee573 show();
	var_97bc4cb3 = struct::get(s_orb.target);
	var_72814265.var_b7eee573 moveto(var_97bc4cb3.origin, 0.5);
	var_72814265.var_b7eee573 waittill(#"movedone");
	var_72814265.var_b7eee573 playsound(#"hash_748c338212771d3");
	function_314447b(0);
...
{
	var_de86a1af = a_ents[#"brutus"];
	var_de86a1af thread zombie_utility::delayed_zombie_eye_glow();
	var_de86a1af clientfield::set("" + #"hash_df589cc30f4c7dd", 1);
	var_75b1acf = a_ents[#"hash_10960c53b3d53ea4"];
	var_352a766d = a_ents[#"hash_10960f53b3d543bd"];
	var_237bd310 = a_ents[#"hash_10960e53b3d5420a"];
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_a98a79b(var_64c09f7f)
{
	level endon(#"end_game", #"hash_2f347ddff9fdaeb9");
	namespace_891c9bac::function_3c173d37(var_64c09f7f.origin, 512);
	var_26e0e1ec = var_64c09f7f namespace_891c9bac::function_a2bd5a0c(#"hash_2efc94b2753043b4", 0, 1, 9999);
	if(b_say)
	{
		if(var_64c09f7f cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
		{
			e_richtofen = var_64c09f7f;
		}
		if(util::get_players().size > 1 && !var_64c09f7f cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
		{
			e_richtofen = function_b1203924();
			if(isalive(e_richtofen))
			{
				var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_2efc94b2753043b4", 0, 1, 9999);
			}
		}
		if(var_26e0e1ec && isdefined(e_richtofen) && isalive(e_richtofen) && (isdefined(e_richtofen.var_59dde2f6) && e_richtofen.var_59dde2f6))
		{
			e_richtofen namespace_891c9bac::function_57b8cd17();
			var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_157c5eae4ea7f8a5", 0, 1, 9999, 1, 1, 1);
			if(b_say && isalive(e_richtofen))
			{
				namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
				e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_2efc96b27530471a", 0, 1, 9999);
			}
		}
	}
...
function function_bdaf22e8(a_ents)
{
	...
	level thread scene::play(#"hash_2895f6970f1a603f", "Main & Idle Loop Out");
	namespace_891c9bac::function_3c173d37(a_ents[#"brutus"].origin, 1024);
	foreach(e_player in util::get_players())
	{
		e_player namespace_891c9bac::function_3c173d37(e_player.origin, 512);
	}
	a_ents[#"brutus"] waittill(#"hash_392051d5f049dcd0");
	wait(soundgetplaybacktime(#"hash_243ad34fa49f53fd") * 0.001);
	e_player = array::random(util::get_players());
	if(e_player cschashed-1\script_2c454d63a96d2d0b::function_69e9e553(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")) && (isdefined(e_player.var_59dde2f6) && e_player.var_59dde2f6))
	{
		var_b710dc9e = randomint(2);
		if(var_b710dc9e == 0)
		{
			e_player namespace_891c9bac::function_8e0f4696(#"hash_b95a5dba1c61ea3", 0, 1, 9999, 1, 1, 1);
		}
		else
		{
			e_player namespace_891c9bac::function_3c173d37(e_player.origin, 512);
			e_player namespace_891c9bac::function_a2bd5a0c(#"hash_7dbb3706a13991c");
		}
	}
	else
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_ac2fa9a4()
{
	level endon(#"hash_4ff99434ccb06268");
	if(isdefined(level.var_3e89bfdf) && level.var_3e89bfdf)
	{
	...
	if(var_d3456dff)
	{
		if(util::get_players().size > 1)
		{
			...
			var_ee033f8 thread namespace_891c9bac::function_a2bd5a0c(#"hash_26999951d3a44c87", 0, 1, 9999);
		}
		e_richtofen namespace_891c9bac::function_57b8cd17();
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_7a09fcd3369d5af", 0, 1, 9999, 1, 1, 1);
		if(isalive(e_richtofen))
		{
			var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1544b0fcee3d5f56", 0, 1, 9999);
			if(b_say && isalive(e_richtofen))
			{
				e_richtofen namespace_891c9bac::function_57b8cd17();
				var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_560988b67c3da339", 0, 1, 9999, 1, 1, 1);
				if(isalive(e_richtofen))
				{
					var_26e0e1ec = e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1544aefcee3d5bf0", 0, 1, 9999);
				}
			}
		}
	}
	else
	{
		...
		var_ee033f8 namespace_891c9bac::function_a2bd5a0c(#"hash_26999951d3a44c87", 0, 1, 9999);
		namespace_891c9bac::function_7922807c(5);
	}
}

/*
	Name: function_e3337dc9
	Namespace: cschashed-2\script_28d5e820ed15e2a7
	Checksum: 0x85E70C5D
	Offset: 0x10B10
	Size: 0xDC
	...
	Flags: Linked, Private
*/
private function function_e3337dc9(a_ents)
{
	var_de86a1af = a_ents[#"brutus"];
	var_de86a1af.var_e8920729 = 1;
	var_de86a1af waittill(#"hash_369ca9a71e9123ab");
	wait(soundgetplaybacktime(#"hash_2e270a777e3c775") * 0.001);
	var_ee033f8 = array::random(util::get_active_players());
	var_ee033f8 namespace_891c9bac::function_a2bd5a0c(#"hash_46c5bad902f6e46a", 0, 1, 9999);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_27097e44()
{
	if(util::get_active_players().size == 1)
	{
		if(util::get_active_players()[0] cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
		{
			wait(5);
		}
		else
		{
			namespace_891c9bac::function_3c173d37(util::get_active_players()[0].origin, 512);
			util::get_active_players()[0] namespace_891c9bac::function_a2bd5a0c(#"hash_46c5b5d902f6dbeb", 3, 1, 9999);
		}
	}
	else
	{
		var_ee033f8 = array::random(util::get_active_players());
		while(var_ee033f8 cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
		{
			var_ee033f8 = array::random(util::get_active_players());
		}
		namespace_891c9bac::function_3c173d37(var_ee033f8.origin, 512);
		var_ee033f8 namespace_891c9bac::function_a2bd5a0c(#"hash_46c5b5d902f6dbeb", 3, 1, 9999);
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ff0c4916()
{
	e_richtofen = function_b1203924();
	if(isalive(e_richtofen) && (isdefined(e_richtofen.var_59dde2f6) && e_richtofen.var_59dde2f6))
	{
		e_richtofen namespace_891c9bac::function_57b8cd17();
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_1e34b3a0b6f70e26", 0, 1, 9999, 1, 1, 1);
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_1c978623()
{
	level endon(#"hash_6048c3f423fd987");
	e_richtofen = function_b1203924();
	if(isalive(e_richtofen))
	{
		if(util::get_players().size > 1)
		{
			...
			namespace_891c9bac::function_3c173d37(var_ee033f8.origin, 512);
			var_ee033f8 namespace_891c9bac::function_a2bd5a0c(#"hash_46c5b7d902f6df51", 0, 1, 999);
		}
		if(isalive(e_richtofen))
		{
			namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
			e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_46c5b0d902f6d36c", 0, 1, 999);
			if(isalive(e_richtofen) && (isdefined(e_richtofen.var_59dde2f6) && e_richtofen.var_59dde2f6))
			{
				e_richtofen namespace_891c9bac::function_57b8cd17();
				var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_4f8bc80733e3575d", 0, 1, 9999, 1, 1, 1);
			}
		}
	}
	else
...
/*
	...
	Flags: Linked, Private
*/
private function function_ddf8f11()
{
	level endon(#"hash_6048c3f423fd987");
	var_ee033f8 = array::random(util::get_active_players());
	namespace_891c9bac::function_3c173d37(var_ee033f8.origin, 512);
	var_ee033f8 namespace_891c9bac::function_a2bd5a0c(#"hash_5931ce3f54ff9613", 0, 1, 999);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_914f17b9()
{
	e_richtofen = function_b1203924();
	if(isalive(e_richtofen))
	{
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_2853b0b1b9bd2301", 0, 1, 9999);
	}
	else
	{
		e_player = array::random(util::get_active_players());
		e_player namespace_891c9bac::function_a2bd5a0c(#"hash_2853b0b1b9bd2301", 0, 1, 9999);
	}
}
...
{
	namespace_891c9bac::function_2fd1af0(6);
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 5);
	...
	mdl_door scene::play(#"hash_6a7a3a4d90881074", mdl_door);
	if(!var_a276c861)
	{
	...
	var_82a6de88 thread scene::play(#"hash_731fa3000a672f67", "OPENED", var_82a6de88);
	wait(1.6);
	var_6fb54924 delete();
	if(!var_a276c861)
	{
...
function function_f1659bd5(var_141689f1, var_a9d2fdec)
{
	...
	for(i = 1; i <= 4; i++)
	{
		...
		var_c9b94f85 setmodel(#"hash_7dab1546d207d407");
		if(i > var_141689f1)
		{
			var_c9b94f85 setmodel(#"hash_55a8e771dde6c619");
...
function function_37838b09()
{
	...
	foreach(player in util::get_active_players())
	{
		if(isdefined(player.var_8af2cb1a))
		{
			player.var_8af2cb1a delete();
		}
	}
}
		...
		while(true)
		{
			...
			if(!array::contains(level.var_b519da5d, s_info.activator) || level.var_be5976c4 > util::get_active_players().size && !var_c9b94f85.var_89bffd7b.b_locked)
			{
				...
				if(level.var_b519da5d.size == level.var_be5976c4)
				{
					...
					var_af1bea51 = array(#"hash_12a631be319641a1", #"hash_7680c620ba7315e5");
					var_a4937b41 = level flag::wait_till_any(var_af1bea51);
					foreach(player in util::get_active_players())
					{
						if(isdefined(player.var_8af2cb1a))
						{
...
function function_256e70d7(var_3104b082)
{
	...
	self.var_8af2cb1a = spawn("trigger_box_use", var_3104b082 + (0, 12, 61), 0, 16, 16, 61);
	self.var_8af2cb1a sethintstring(#"hash_6d663dca450595ef");
	self.var_8af2cb1a setcursorhint("HINT_NOICON");
	self.var_8af2cb1a triggerignoreteam();
	self.var_8af2cb1a setvisibletoplayer(self);
	while(true)
	{
		s_info = undefined;
		s_info = self.var_8af2cb1a waittill(#"trigger");
...
function function_4ff97a71(var_386f3ef3)
{
	...
	namespace_891c9bac::function_3c173d37(var_386f3ef3.origin, 512);
	var_386f3ef3 namespace_891c9bac::function_a2bd5a0c(#"hash_49dd995af5e92761", 0, 1, 9999);
	e_richtofen = function_b1203924();
	if(isdefined(e_richtofen))
	{
		namespace_891c9bac::function_3c173d37(e_richtofen.origin, 512);
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_49dd985af5e925ae", 0, 1, 9999);
	}
	if(isdefined(e_richtofen) && (isdefined(e_richtofen.var_59dde2f6) && e_richtofen.var_59dde2f6))
	{
		e_richtofen namespace_891c9bac::function_57b8cd17();
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_996507b15245f1", 0, 1, 9999, 1, 1, 1);
		if(b_say && isalive(e_richtofen))
		{
			e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_49dd965af5e92248", 0, 1, 9999);
		}
	}
}
...
function step_6(var_a276c861)
{
	...
	var_b05e79d7 = getent("mechanical_chair", "targetname");
	var_b05e79d7 show();
	level thread scene::play(#"hash_6a623b9fefbdc80d", "IDLE");
	exploder::kill_exploder("fxexp_poison_ambient");
	exploder::exploder("lgtexp_bossArena_on");
	zm_bgb_anywhere_but_here::function_886fce8f(0);
	function_6b40f92e();
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 6);
	...
	if(!var_a276c861)
	{
		...
		scene::add_scene_func(#"hash_6c8ed7f336f9ee3c", &function_79a55fbd, "done");
...
/*
	...
	Flags: Linked
*/
function function_79a55fbd(a_ents)
{
	playsoundatposition(#"hash_8a68e0d5ec39687", (9860, 10237, 617));
	wait(soundgetplaybacktime(#"hash_8a68e0d5ec39687") * 0.001);
	e_player = array::random(util::get_active_players());
	e_player namespace_891c9bac::function_a2bd5a0c(#"hash_16dd5249cdc08382", 0, 1, 9999);
}
...
function function_fd915ab5()
{
	...
	else
	{
		...
		for(i = 1; i <= util::get_active_players().size; i++)
		{
			...
			s_teleport = struct::get(#"c29_teleport_" + i);			util::get_active_players()[i - 1] setorigin(s_teleport.origin);
...
function function_e9910473()
{
	...
	wait(0.9);
	var_b681bc7d = function_4d1e7b48(#"hash_19533caf858a9f3b");
	self status_effect::status_effect_apply(var_b681bc7d, undefined, self, 0);
	if(isdefined(self.var_5dfdbf1))
	{
		s_goto = struct::get(#"c29_teleport_" + self.var_5dfdbf1);		mdl_origin moveto(s_goto.origin, 1.6, 0.2, 0.9);
	}
	wait(1.6);
...
function function_6b40f92e()
{
	...
	var_94b03771.targetname = "c29_energy";
	var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 3);
	var_94b03771.script_noteworthy = "blast_attack_interactables";
	var_94b03771 thread function_2f4c3a4e();
...
function function_f90d2c81(inflictor, attacker, damage, flags, meansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype)
{
	...
	else if(isdefined(self.entity_type) && self.entity_type == #"hash_273dea5b2e3044c0" && !level.var_b491030)
	{
		n_damage = 0;
	}
	return n_damage;
...
/*
	...
	Flags: Linked
*/
function function_37d4f9(var_f6d24584, var_d93def40 = 0, var_b8fc6ea2 = 0, var_49770f00 = 0, var_63a54520)
{
	...
	if(n_brutus != 0)
	{
		level thread function_a4e995fb(var_d93def40, var_49770f00);
	}
	...
	while(level.var_dcff743c)
	{
		...
		if(util::get_active_players().size == 1 && level flag::get(#"hash_233bb105ee83c609") && !level flag::get(#"hash_68a1656980e771da"))
		{
			if(var_d8036031 >= 23)
			{
				wait(var_45e9dd93);
		...
		if(isdefined(var_63a54520) && var_d8036031 >= var_63a54520)
		{
			wait(var_45e9dd93);
			continue;
		}
...
function function_8d744628()
{
	self endon(#"death");
	waitframe(1);
	self thread namespace_54386dac::function_24d3ec02();
...
function function_23bd9529(s_spawn_loc)
{
	self endon(#"death");
	waitframe(1);
	self thread namespace_54386dac::function_7273c33d(s_spawn_loc);
...
/*
	...
	Flags: Linked
*/
function function_a4e995fb(var_d93def40, var_49770f00 = 0)
{
	if(var_49770f00)
	{
	...
	while(level.var_dcff743c)
	{
		cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_west_side_exterior_upper_03", 1);
		s_waittill = undefined;
		var_d1a0c048 = level waittill(var_9bc12626);
		if(isdefined(s_waittill.ai_brutus))
		{
			level.n_brutus_spawned++;
			var_d1a0c048.ai_brutus.var_ece4a895 = &function_bba62242;
			s_waittill.ai_brutus ai::set_behavior_attribute("can_ground_slam", 1);
			var_d1a0c048.ai_brutus.var_db8b3627 = 1;
			s_waittill.ai_brutus waittill_timeout(12.6, #"death");
...
function function_645562a2(s_cloud)
{
	...
	var_81f76694 clientfield::set("" + #"hash_3eb94ba53dd09196", 1);
...
{
	wait(6.1);
	self clientfield::set("" + #"hash_3eb94ba53dd09196", 0);
}
...
{
	if(util::get_active_players().size == 1 && util::get_active_players()[0] cschashed-1\script_2c454d63a96d2d0b::is_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae")))
	{
	...
	{
		level flag::wait_till_timeout(16, #"hash_233bb105ee83c609");
	}
	var_b932e751 = getent("spawner_zm_brutus_special", "targetname");
	var_3ded86ce = zombie_utility::spawn_zombie(var_b932e751);
	...
	var_3ded86ce thread cschashed-2\script_20bca15cf8b82d6b::brutus_spawn(undefined, undefined, undefined, undefined, "zone_west_side_exterior_upper_03");
	...
	var_3ded86ce clientfield::set("" + #"hash_df589cc30f4c7dd", 1);
	var_3ded86ce val::set(#"boss_special", "takedamage", 0);	level notify(#"hash_7fbbfdf42f9d741");
	var_3ded86ce thread function_81771803();
	level waittill(#"hash_64c87773fb1cf778");
	var_3ded86ce clientfield::set("" + #"hash_df589cc30f4c7dd", 0);
	var_3ded86ce ai::stun(2.9);
	level.var_b491030 = 1;
	var_3ded86ce val::reset(#"boss_special", "takedamage");	var_3ded86ce waittill(#"death");
	level.var_dcff743c = 0;
...
function function_81771803()
{
	...
	{
		wait(16);
		if(!namespace_891c9bac::function_45e29f06())
		{
...
function function_77cf4d4a()
{
	...
	if(!isdefined(e_richtofen))
	{
		...
		e_richtofen cschashed-1\script_2c454d63a96d2d0b::set_character(array(#"hash_59f3598ad57dadd8", #"hash_2bcebdf1bef33311", #"hash_5a715cb0a6e071ae"));
		e_richtofen endon(#"disconnect");
		e_richtofen val::set(#"boss_bot", "takedamage", 0);		e_richtofen val::set(#"boss_bot", "ignoreme", 1);		while(e_richtofen.sessionstate !== "playing")
		{
			waitframe(1);
		}
	...
	level flag::set(#"hash_7a6c2fc48d2d09ee");
	if(!isbot(e_richtofen))
	{
		s_interact = struct::get(#"dm_activate");		s_interact zm_unitrigger::create(&function_6234ba97, undefined, &function_42f33811);
		...
		e_richtofen val::set(#"boss_bot", "takedamage", 0);		e_richtofen val::set(#"boss_bot", "ignoreme", 1);	}
	else
	{
		s_location = struct::get(#"hash_2e58b4c02c5d22f8");
		e_richtofen namespace_87f62ea8::function_23cbc6c1(s_location.origin, 1, 16);
		e_richtofen waittill_timeout(60, #"goal");
	}
	...
	level thread scene::play(#"hash_6a623b9fefbdc80d", "RICH_IN");
	level scene::play(#"hash_15674d3b96867b43", e_richtofen);
	e_richtofen thread lui::screen_flash(0.1, 1, 0.6, 1, "white");
	level flag::set(#"hash_233bb105ee83c609");
	e_richtofen function_8fd843dd(2);
	waitframe(1);
	...
	scene::add_scene_func(#"hash_55cf700c69e28ede", &function_f25f7e7d, "play");
	function_f4b4e39f(1);
	if(isbot(e_richtofen))
	{
		s_door = struct::get(#"hash_5835bfd32af5f016");
		e_richtofen namespace_87f62ea8::function_23cbc6c1(s_door.origin, 1, 16);
		e_richtofen waittill_timeout(20, #"goal");
	...
	else
	{
		...
		if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(w_current))
		{
			n_slot = e_richtofen gadgetgetslot(w_current);
			e_richtofen ability_player::turn_gadget_off(n_slot, w_current);
			e_richtofen waittill_timeout(4, #"weapon_change_complete");
		}
		level scene::play(#"hash_55cf700c69e28ede", e_richtofen);
		function_37838b09();
	}
	...
	{
		e_richtofen val::reset(#"boss_bot", "takedamage");		e_richtofen val::reset(#"boss_bot", "ignoreme");	}
}
...
/*
	...
	Flags: Linked
*/
function function_f25f7e7d(a_ents)
{
	level waittill(#"hash_64c87773fb1cf778");
...
function function_81eedba4(e_richtofen)
{
	...
	{
		var_45adf42 namespace_891c9bac::function_a2bd5a0c(#"hash_1afa41c004f5c759", 0, 1, 9999);
	}
	if(isdefined(e_richtofen))
	{
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1afa40c004f5c5a6", 0, 1, 9999);
	}
	if(isdefined(e_richtofen) && (isdefined(e_richtofen.var_59dde2f6) && e_richtofen.var_59dde2f6))
	{
		var_26e0e1ec = e_richtofen namespace_891c9bac::function_8e0f4696(#"hash_67275e4d65416fa9", 0, 1, 9999, 1, 1, 1);
		if(b_say && isalive(e_richtofen))
		{
			e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_1afa3ec004f5c240", 0, 1, 9999);
		}
	}
	level flag::wait_till(#"hash_1b4b6ce05cb62d56");
	level waittill_timeout(7, #"hash_3f8d7d050298fd50");
	var_45adf42 = function_f2c42deb();
	if(isdefined(var_45adf42))
	{
		var_45adf42 namespace_891c9bac::function_a2bd5a0c(#"hash_68855270c2084c93", 0, 1, 9999);
	}
	level flag::wait_till(#"hash_68923445ebf488f0");
	if(isdefined(e_richtofen))
	{
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_30d26ca75e303a02", 0, 1, 9999, 1, 1);
	}
	if(isdefined(e_richtofen))
	{
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_30d26da75e303bb5", 0, 1, 9999, 1, 1);
	}
	...
	ai_boss namespace_891c9bac::function_8e0f4696(#"hash_7d4215782b23c898");
	if(isdefined(e_richtofen))
	{
		e_richtofen namespace_891c9bac::function_a2bd5a0c(#"hash_581bb829fc9a0c1f", 0, 1, 9999);
	}
	level zm_audio::sndvoxoverride(0);
	namespace_891c9bac::function_7922807c(7);
...
function function_30febada()
{
	...
	var_14ed46ec = util::spawn_model(#"hash_874c7d1d780b141", var_31ad8eb4.origin + vectorscale((0, 0, -1), 61), var_31ad8eb4.angles);
	...
	level waittill_timeout(11.6, #"hash_7f4869ad69727e65");
	level.var_dcff743c = 0;
	...
	if(level.var_7fe331bf)
	{
		...
		level waittill_timeout(6.1, #"hash_6721db7073dcfe48");
...
{
	var_94b03771 = getent("c29_energy", "targetname");
	if(var_466b0d0c)
	{
		var_94b03771 playsound(#"hash_3ea52c9c66d5dc24");
		var_94b03771 playloopsound(#"hash_4d39ae8a8d729ec4");
	}
	else
	{
		var_94b03771 playsound(#"hash_414b783a085076e0");
		wait(0.5);
		var_94b03771 stoploopsound();
	}
}
...
{
	level waittill(#"boss_despawn");	if(isdefined(a_ents[#"boss"]))
	{
		a_ents[#"boss"] clientfield::increment("" + #"hash_29d283d7f747d358");
...
function function_7cfcac59()
{
	...
	if(isdefined(var_e083ecbd))
	{
		...
		{
			namespace_891c9bac::function_3c173d37(level.var_4f538b17.origin, 512);
			var_a8d847a7 = level.var_4f538b17 namespace_891c9bac::function_a2bd5a0c(str_vo_line, 0, 1, 9999);
		}
	}
...
function function_6f05bd7c()
{
	...
	{
		var_94b03771 = getent("c29_energy", "targetname");
		var_94b03771 playsoundtoteam(#"hash_5ec49e32f2e3d497" + var_e083ecbd, util::get_active_players()[0].team);
	}
}
...
function function_4e2f5d87(var_1f61bd3e)
{
	...
	{
		wait(1.6);
		var_a0195777 = distance2dsquared(var_1f61bd3e, self.origin);
		var_533bc5e8 = 65536;
		if(var_a0195777 > var_533bc5e8)
		{
...
function function_2aa1c625(var_896fa160, var_1f61bd3e)
{
	...
	for(i = 1; i <= 3; i++)
	{
		var_72814265 = struct::get(var_896fa160 + "_" + i);
...
function function_2ffe7896(var_386e5658, s_info)
{
	...
	else
	{
		...
		{
			var_a0195777 = distance2dsquared(self.var_1f61bd3e, s_info.eattacker.origin);
			var_533bc5e8 = 65536;
			if(var_a0195777 > var_533bc5e8)
			{
				n_damage = 0;
...
function function_bceb2f4c()
{
	...
	self clientfield::set("" + #"orb_explosion", 1);	self ghost();
	level.var_ed0d6c7d++;
	if(level.var_ed0d6c7d == 3)
	{
		level notify(#"hash_7f4869ad69727e65");
...
function function_360daff1()
{
	...
	if(level.var_a36cbfaf == 2)
	{
		...
		var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 1);
	}
	else if(level.var_a36cbfaf == -2)
	{
		var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 5);
		wait(1.6);
		...
		var_94b03771 playsoundtoteam(#"hash_7ae2ffc3070edcfc", util::get_active_players()[0].team);
		wait(soundgetplaybacktime(#"hash_7ae2ffc3070edcfc") * 0.001);
		level notify(#"end_game");
	}
	else if(level.var_a36cbfaf == 1)
	{
		var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 2);
	}
	...
	{
		var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 4);
	}
}
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7629706a5a9c7bf7", 7);
	...
	if(!var_a276c861)
	{
		...
		level flag::wait_till(#"hash_7a6c2fc48d2d09ee");
		level waittill_timeout(6.1, #"hash_1b4b6ce05cb62d56");
		level.musicsystemoverride = 1;
		music::setmusicstate("boss");
...
function outro(var_a276c861)
{
	...
	hidemiscmodels("mechanical_chair");
	var_b05e79d7 = getent("mechanical_chair", "targetname");
	level thread scene::stop(#"hash_6a623b9fefbdc80d");
	var_b05e79d7 hide();
	var_94b03771 = getent("c29_energy", "targetname");
	var_94b03771 clientfield::set("" + #"hash_7e426bfd123d0beb", 0);
	exploder::stop_exploder("fxexp_script_l_d");
	exploder::stop_exploder("fxexp_script_l_c");
	exploder::stop_exploder("fxexp_script_l_n_i");
	exploder::stop_exploder("fxexp_script_l_s");
	...
	callback::remove_on_connect(&namespace_54386dac::function_6a1500f1);
...
function function_44267df1(a_ents)
{
	...
	{
		if(isdefined(e_prop.model) && (e_prop.model == #"hash_7d8db72b88d71fd7" || e_prop.model == #"hash_551dbb04d3fde912" || e_prop.model == #"hash_463ef93e7556c574"))
		{
...
function function_ed66b9f7(a_ents)
{
	...
	var_e5c7e01a waittill(#"b_gh");	var_e5c7e01a hide();
}
...
function play_outro()
{
	...
	foreach(e_player in util::get_players())
	{
		...
		level.var_7c7c6c35 zm_game_over::set_state(e_player, #"hash_6a6a4ebfc877658c");
	}
	level notify(#"end_game");
}
...
function function_f7a9d7c4()
{
	...
	self namespace_ff457ca2::function_9a9ab6f6(#"hash_ad3a508a80a0e6e");
	if(!isdefined(self.var_6257071f))
	{
		self namespace_ff457ca2::function_979f4cc0(#"hash_6d551a71b5461906");
	}
}
...
/*
	...
	Flags: Linked
*/
function function_5b5fc6fb(var_813c2299, str_endon_notify, n_speed = 300, b_skippable = 0)
{
	...
	self.mdl_origin thread scene::play(#"hash_9307bb172366651", "loop_anim", self);
	...
	self.mdl_origin thread scene::play(#"hash_9307bb172366651", "idle_flying_loop", self);
...
function function_72f1cfd1(s_current, b_skippable)
{
	...
	if(var_d687a9b7 && isdefined(s_target) && isdefined(level.var_dc4013b0))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_30bab0b0(b_taken = 1)
{
	...
	if(b_taken)
	{
		...
		else if(self hasweapon(getweapon(#"hash_42a45d43be3dba42")))
		{
			self.var_719ddec1 = 1;
	...
	else if(isdefined(self.var_a4d61ba4) && self.var_a4d61ba4)
	{
	...
	if(isdefined(self.var_b3032361))
	{
		...
		self thread cschashed-1\script_6a0e50bc15d725a9::function_804309c();
...
/*
	...
	Flags: Linked, Private
*/
private function function_a90b7995()
{
	level.var_659daf1d = [];
	level.var_dd650b0e = [];
...
/*
	...
	Flags: Linked, Private
*/
private function function_5341907e()
{
	var_c699e2b5 = struct::get("s_p_s2_ins");
