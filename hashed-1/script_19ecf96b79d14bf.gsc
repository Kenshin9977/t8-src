...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_cb9d8a572a95c71", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e0e99e1()
{
	...
	while(true)
	{
		...
		else if(!var_f2b6fe6e && !var_407eb07)
		{
			...
			foreach(weapon in self getweaponslist(1))
			{
				if(cschashed-2\script_709bf7c56eb65adf::function_2ff6913(weapon) == 1)
				{
					self unlockweapon(weapon);
					if(weapon.isdualwield && weapon.dualwieldweapon != level.weaponnone)
					{
