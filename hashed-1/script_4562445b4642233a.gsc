...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_69330ea47008c27f", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	...
	{
		cschashed-1\script_3c362258ff800237::fail(#"hash_2c061f4e3509c0f4");
	}
...
private function function_f5ad51bd()
{
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"zm_bgb_newtonian_negation", 1);
	}
...
private function enable_newtonian_negation()
{
	foreach(player in getplayers())
	{
		...
		player cschashed-1\script_3d4e88c949caf53e::function_59004002(#"zm_bgb_newtonian_negation", 0);
	}
