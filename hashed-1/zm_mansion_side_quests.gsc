...
#namespace cschashed-2\script_47c293f002042d7e;
...
{
	namespace_ee206246::register(#"hash_4c0e5e4b34877996", #"step_1", #"hash_5b60b951867b6b11", &function_63ceee4b, &function_a1ed8c28);
	namespace_ee206246::register(#"hash_4c0e5e4b34877996", #"step_2", #"hash_5b60b651867b65f8", &function_4e14c2d7, &function_21e10c11);
	namespace_ee206246::register(#"hash_65636bbec86da22c", #"step_1", #"hash_1551692125951197", &function_6c1be65c, &function_e4b6830d);
	namespace_ee206246::register(#"hash_65636bbec86da22c", #"step_2", #"hash_15516a212595134a", &function_28995f54, &function_f5692472);
	namespace_ee206246::register(#"hash_4ca89643d74ccffb", #"step_1", #"hash_33b63d9ccbdb1e3e", &function_ffc4a06a, &function_a4daedbe);
	namespace_ee206246::register(#"hash_4ca89643d74ccffb", #"step_2", #"hash_33b63c9ccbdb1c8b", &function_f21f0537, &function_2ff803fa);
}
...
function function_ff726bbb(var_2afee46 = 1)
{
	...
	var_61243b5c = scene::get_active_scenes(#"hash_3abed67635ad8c53");
	var_b0db8553 = var_61243b5c[0];
	var_1d305e7f = var_b0db8553.scene_ents[#"hash_7aff0ee60ddd937b"];
	var_19d968b8 = getent("e_secret_clip_left", "targetname");
	var_19d968b8 linkto(var_1d305e7f, "tag_origin");
	var_bad218e = var_b0db8553.scene_ents[#"hash_7aff0fe60ddd952e"];
	...
	var_befaf308 = scene::get_active_scenes(#"hash_1b41a969a9fd202c");
	var_f6281a0 = var_befaf308[0];
	var_d3f97071 = var_f6281a0.scene_ents[#"hash_7aff0ee60ddd937b"];
	var_84d63a77 = getent("w_secret_clip_left", "targetname");
	var_84d63a77 linkto(var_d3f97071, "tag_origin");
	var_db4a4ab3 = var_f6281a0.scene_ents[#"hash_7aff0fe60ddd952e"];
	...
	var_d6a83f7c = array(#"hash_5a2bfdb29186d63c", #"hash_5a2bfeb29186d7ef", #"hash_5a2c00b29186db55", #"hash_5a2bfbb29186d2d6");
	var_a0cea409 = array("w_secret_left_object", "e_secret_left_object", "w_secret_right_object", "e_secret_right_object");
	...
	for(i = 0; i < var_b4536237.size; i++)
	{
		...
		var_aaa36da6 = struct::get(var_a0cea409[i], "targetname");
...
function function_941b297c(var_22c00989)
{
	if(var_22c00989 == #"east")
	{
		...
		level thread util::delay(2, undefined, &scene::play, #"hash_3abed67635ad8c53");
	}
	else
	{
		self.var_872e2994 = struct::get("w_secret_reward_pos", "targetname");
		level thread util::delay(2, undefined, &scene::play, #"hash_1b41a969a9fd202c");
	}
...
{
	var_997a158c = getweapon(var_1c855a0d);
	var_a76c9d75 = level.var_969e8ac2.var_64c09f7f;
	if(!isdefined(var_a76c9d75))
	{
		var_a76c9d75 = getplayers()[0];
	}
	mdl_weapon = zm_utility::spawn_buildkit_weapon_model(var_a76c9d75, var_997a158c, undefined, self.var_872e2994.origin + vectorscale((0, 0, 1), 16), self.var_872e2994.angles);
...
function function_6c1be65c(var_a276c861)
{
	...
	if(!var_a276c861)
	{
		...
		var_9890436b = scene::get_active_scenes(#"hash_3dab61c5371bc98b");
		var_7195997b = var_9890436b[0];
		var_c65c37fc = var_7195997b.scene_ents[#"hash_7aff0ee60ddd937b"];
...
function function_e4b6830d(var_a276c861, ended_early)
{
	if(var_a276c861 || ended_early)
	{
		foreach(var_48ffe137 in level.var_992001f4)
		{
			s_barrel notify(#"busted");
			if(isdefined(var_48ffe137.var_b0fe1e03))
			{
				var_48ffe137.var_b0fe1e03 delete();
			}
			if(isdefined(var_48ffe137.var_80221a28))
			{
				var_48ffe137.var_80221a28 delete();
			}
		}
	}
}
	...
	for(i = 0; i < level.var_992001f4.size; i++)
	{
		...
		/#
			if(var_2afee46)
			{
				...
				level.var_992001f4[i].var_b0fe1e03 thread cschashed-2\script_168eb2ab39a74080::function_95b6c945();
			}
		#/
	}
}
...
function function_e3a40726()
{
	...
	level thread util::delay(2, undefined, &scene::play, #"hash_3dab61c5371bc98b");
...
function function_410dd5a6(s_pos)
{
	...
	{
		var_47323b73 = var_e007f14b zm_unitrigger::create(&cschashed-1\script_6b91760bb3045851::function_252cf612, 64, &function_b601eebc);
...
function function_b601eebc()
{
	...
	while(true)
	{
		...
		if(player cschashed-1\script_6b91760bb3045851::function_ec89dca9())
		{
			continue;
		}
...
function function_35ab22f4()
{
	...
	foreach(var_2cbc52e0 in var_6f868336)
	{
		...
		{
			var_2cbc52e0 thread namespace_891c9bac::function_a2bd5a0c(#"hash_528e304a3656551c", 1);
...
function function_f21f0537(var_a276c861)
{
	...
	switch(level.var_691e2bc4)
	{
		...
		case 3:
		{
			...
			a_players[0] magicgrenadetype(getweapon(#"hash_34b7eb9fde56bd35"), s_pocket.origin + vectorscale((0, 0, 1), 12), vectorscale((0, 0, 1), 200));
...
function function_fd9b3e16(n_reward)
{
	var_8997b0bc = struct::get("billiard_table_center", "targetname");
	mdl_clip = getent("secret_furniture_clip", "targetname");
	var_cef195d9 = scene::get_active_scenes(#"hash_29d582a079d238c5");
	var_edd21e7e = var_cef195d9[0];
	var_89bf536b = var_edd21e7e.scene_ents[#"hash_7aff0ee60ddd937b"];
	mdl_clip enablelinkto();
	...
	level thread util::delay(2, undefined, &scene::play, #"hash_29d582a079d238c5");
...
function function_cd9f1d74(n_reward)
{
	...
	switch(n_reward)
	{
		...
		case 1:
		{
			var_b7a9df7c = #"hash_5f31d1bf67933013";
			var_ce5ed2e9 = #"hash_6953696819bf1875";
		}
		var_b7a9df7c = #"hash_144549dfb6b8bda5";
		var_ce5ed2e9 = #"zm_bgb_in_plain_sight";
		var_b7a9df7c = #"hash_65291a8ef0716ac6";
		var_ce5ed2e9 = #"hash_560ca45c0a2daef2";
		var_b7a9df7c = #"hash_59d206090210d6c9";
		var_ce5ed2e9 = #"zm_bgb_sword_flay";
		var_f1ef5a23 = util::spawn_model(var_b7a9df7c, s_shelf.origin, s_shelf.angles);
		var_7b57e2cc = util::spawn_model(#"hash_c71bb6432ef5d1f", s_shelf.origin + vectorscale((0, 0, 1), 6.75), s_shelf.angles);
...
function function_67c3a7dd()
{
	...
	if(1)
	{
		...
		var_4c47dfdb = var_163c35fc.var_ce5ed2e9;
		player thread function_7f4f9503(var_4c47dfdb);
...
/*
	...
	Flags: Linked
*/
function function_7f4f9503(var_4c47dfdb)
{
	self endon(#"death");
	self bgb::bgb_gumball_anim(var_4c47dfdb);
	if(level.bgb[var_4c47dfdb].limit_type == "activated")
	{
		self notify(#"hash_27b238d082f65849", var_4c47dfdb);
		self bgb::function_d841e500();
		self thread bgb::function_b7ba7d51(var_4c47dfdb);
	}
}
...
function function_63c873d9(var_dc2ad9ce)
{
	...
	while(true)
	{
		...
		for(i = 0; i < a_e_players.size; i++)
		{
			...
			if(a_e_players[i] namespace_c05f06c7::is_valid())
			{
				n_index = a_e_players[i] cschashed-1\script_2c454d63a96d2d0b::function_d35e4c92();
				...
				if(a_e_players[i].var_d2822b91 < var_a5e8d5c7.size)
				{
					...
					{
						var_36414a9f = a_e_players[i] namespace_891c9bac::function_8e0f4696(var_a5e8d5c7[a_e_players[i].var_d2822b91]);
