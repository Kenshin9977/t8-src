...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_2f8add191c45a722", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_faecf84e, var_142bab9f, var_2b2cdb01, var_85e291cf, var_b3c8256b, var_d42c8aaa)
{
	...
	{
		var_b3c8256b = cschashed-1\script_3c362258ff800237::function_5769f26a(var_b3c8256b);
	}
	...
	self.var_b49b94ed = cschashed-1\script_3c362258ff800237::function_5769f26a(n_kill_count);
	self.var_3fd9ed88 = 0;
	cschashed-1\script_3d5821d793ed4c6::function_2976fa44(self.var_b49b94ed);
	cschashed-1\script_3d5821d793ed4c6::function_dace284(self.var_3fd9ed88);
	if(isdefined(var_b3c8256b) && var_b3c8256b && isdefined(var_d42c8aaa))
	{
		level flag::set(#"infinite_round_spawning");
		level flag::set(#"pause_round_timeout");
		var_d42c8aaa = cschashed-1\script_3c362258ff800237::function_5769f26a(var_d42c8aaa);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(!round_reset)
	{
		...
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_729e15cd6b31df3");
		}
	}
}
...
private function function_ba517920(challenge)
{
	...
	while(challenge.var_3fd9ed88 < challenge.var_b49b94ed)
	{
		...
		cschashed-1\script_3d5821d793ed4c6::function_dace284(challenge.var_3fd9ed88);
	}
}
