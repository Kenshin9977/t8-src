...
#namespace cschashed-1\script_4ebfbab5572ecfe9;
...
function __init__()
{
	clientfield::register("actor", "" + #"gaia_impact_zombie", 16000, 1, "counter");	clientfield::register("scriptmover", "" + #"hash_90f855c336338af", 16000, 1, "counter");
	clientfield::register("scriptmover", "" + #"gaia_impact", 16000, 1, "counter");	clientfield::register("scriptmover", "" + #"spike_explode", 16000, 1, "counter");	clientfield::register("scriptmover", "" + #"spike_spawn", 16000, 1, "counter");	level.var_53789618 = getweapon(#"hash_67c8dea04eccf4ab");
	...
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_4689473b7f0df2f7", 0.1, 3);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_2b068d1172ea957", 0.3, 3);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_315cdbcb170fa2c4", 0.5, 3);
...
function function_31ad5b3d(b_up)
{
	...
	if(isdefined(registerchase_vo1ids))
	{
		var_4784577e = var_180d380d.size;
		var_f9486bd2 = 0;
		registerchase_vo1ids = array::remove_undefined(registerchase_vo1ids);
		registerchase_vo1ids = arraysortclosest(registerchase_vo1ids, self.origin);
		foreach(e_target in registerchase_vo1ids)
		{
		...
		{
			if(var_f9486bd2 == registerchase_vo1ids.size)
			{
				foreach(var_ef7e8e7c in registerchase_vo1ids)
				{
...
function function_ce711b5c(e_projectile, ai_zombie, n_damage)
{
	...
	if(!isdefined(ai_zombie))
	{
		...
		e_projectile clientfield::increment("" + #"gaia_impact");		waitframe(1);
	}
	else
	{
...
function function_85d88e17(e_target, b_charged, v_dir, n_damage)
{
	...
	if(isalive(e_target))
	{
		e_target clientfield::increment("" + #"gaia_impact_zombie");		waitframe(1);
		if(n_damage >= e_target.health)
		{
			e_target.marked_for_death = 1;
		}
...
function function_f2f6947f(e_target)
{
	...
	switch(e_target.var_6f84b820)
	{
		...
		case "enhanced":
		{
			e_target thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_4689473b7f0df2f7");
			break;
		}
		case "heavy":
		{
			e_target thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_2b068d1172ea957");
			break;
		}
		case "miniboss":
		{
			e_target thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_315cdbcb170fa2c4");
			break;
		}
	}
	wait(3);
