...
#using hashed-1\zm_perk_widows_wine.gsc;
...
function function_dae1df4d(var_7d81025, player)
{
	...
	{
		if(level.headshots_only && cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(w_weapon))
		{
			continue;
		}
		...
		{
			if(cschashed-2\script_709bf7c56eb65adf::is_lethal_grenade(w_weapon))
			{
