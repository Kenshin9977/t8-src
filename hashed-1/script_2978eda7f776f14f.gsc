...
#namespace cschashed-1\script_4dd199a80c8813bb;
...
function __main__()
{
	...
	level.var_e8ccb5b4[level.var_e8ccb5b4.size] = getweapon(#"equip_sprout");	level thread function_25efffc0();
...
private function function_e1bfb2de()
{
	...
	while(true)
	{
		...
		if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmpowerupsactive") && zm_utility::is_player_valid(self) && !self zm_utility::is_drinking() && (!(isdefined(var_59130748) && var_59130748)) && !self zm_laststand::is_reviving_any())
		{
...
private function function_5e8518bb(n_boon)
{
	...
	for(var_41e8954e = self.var_b22aca27[var_8c451643].var_e7a18e05; n_rounds > 0; n_rounds--)
	{
