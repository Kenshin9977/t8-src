...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_69bf786a279d4ca6", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	if(!round_reset)
	{
		...
		if(var_696c3b4.size)
		{
			cschashed-1\script_3c362258ff800237::fail(#"hash_10a895033b20c705", var_696c3b4);
		}
	}
	foreach(player in getplayers())
	{
