...
#namespace cschashed-3\script_412188df54bb77d9;
...
function function_31c7123b()
{
	...
	var_3b2c2d10.var_28ea1870 = struct::get_array(s_trap.target3, "targetname");
	var_3b2c2d10.var_54a168f2 = struct::get_array(s_trap.target2, "targetname");
	s_trap.a_e_lights = getentarray(s_trap.target4, "targetname");
	var_3b2c2d10.var_2c0d31a5 = struct::get_array(s_trap.target5, "targetname");
...
function function_f24b1ecb()
{
	...
	while(true)
	{
		...
		if(zm_utility::is_player_valid(e_who) && level.s_fire_trap.var_41ee2ddc === 1)
		{
			...
			self notify(#"fire_trap_activated");			self.var_64c09f7f = e_who;
...
function function_64fa1b6a()
{
	...
	while(true)
	{
		self waittill(#"fire_trap_activated");		function_91ecec97(level.s_fire_trap.a_e_lights, "p8_zm_off_trap_switch_light_red_on");
...
function function_11e5b2ee(var_64c09f7f, e_volume)
{
	...
	level notify(#"fire_trap_kill", {#e_player:var_64c09f7f});	if(isdefined(self.animname) && self.animname != "zombie_dog")
	{
...
function spinning_trap_activate(e_player)
{
	...
	self notify(#"spinning_trap_complete");	level.s_spinning_trap.e_volume playsound(#"hash_632248542476cd73");
...
{
	self endon(#"spinning_trap_complete");	while(true)
	{
...
function function_bcfd9acb(s_trap)
{
	...
	s_trap waittill(#"spinning_trap_complete");	var_44342e79 = var_e72c9959 scene::function_8582657c(#"hash_3ca93b4e1742ee26", "Shot 2");
