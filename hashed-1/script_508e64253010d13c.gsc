...
#namespace cschashed-3\script_7114102541e1f8c8;
...
function __init__()
{
	...
	cschashed-2\script_260abbdf1ff0aa9a::function_cfca77a7(var_c85e8942, #"blight_father", &function_39212989, 10, &function_3a0cdf7f, &function_8e4c43d3, "aib_vign_zm_zod_bltfthr_spawn_pre_split", "aib_vign_zm_zod_bltfthr_spawn_post_split");
	zm_spawner::register_zombie_death_event_callback(&killed_callback);
	callback::on_ai_killed(&function_7bef9c3c);
	namespace_c3287616::register_archetype(#"blight_father", &function_633d7436, &round_spawn, undefined, 300);
	namespace_c3287616::function_306ce518(#"blight_father", &function_fa00e485);
	namespace_57ff8cbb::function_cdf5a512(#"blight_father", &function_2628e1c2);
	if(-1)
	{
		level.var_445e24c8 = [];
		for(i = 0; i < 12; i++)
	...
	cschashed-1\script_5a012bbb9342dbdf::function_2ad308c4(#"blight_father", &function_744be31d);
	namespace_32192f7::function_95c1dd81(#"blight_father", &function_2315440d);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_2fd5f5f16583a427", 0.8);
	...
	/#
		spawner::add_archetype_spawn_function(#"blight_father", &zombie_utility::function_27ba8249);
...
*/
private function function_3e8300e9(entity, attribute, oldvalue, value)
{
	if(value == "low")
	{
		entity thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_2fd5f5f16583a427");
	}
	else
	{
		entity thread cschashed-3\script_d67878983e3d7c::function_520f4da5(#"hash_2fd5f5f16583a427");
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ce1b7f67()
{
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_7bef9c3c(params)
{
	if(self.archetype !== #"blight_father")
	{
		return;
...
{
	if(namespace_cb42c6c0::function_7bfa8895(self))
	{
		stub = namespace_cb42c6c0::function_87c1193e(self);
		var_4afb24b6 = namespace_cb42c6c0::function_dab6d796(self, stub);
...
private function function_f2914d65(entity)
{
	...
	enemies = arraycombine(enemies, getaiarchetypearray(#"catalyst"), 0, 0);	enemies = array::filter(enemies, 0, &function_3d752709, entity);
...
/*
	...
	Flags: Linked, Private
*/
private function function_69b8daf(origin, angles)
{
...
{
	return function_917cd51d(entity) || zm_behavior::zombieshouldstun(entity) || function_2ed4a174(entity) || zm_behavior::zombieshouldknockdown(entity);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_515b4a87(inflictor, attacker, damage, flags, meansofdamage, weapon, point, dir, hitloc, offsettime, boneindex, modelindex)
{
	if(!(isdefined(self.var_c8f98f87) && self.var_c8f98f87) && isdefined(self.var_beb2295) && (hitloc == "head" || attacker === self.var_beb2295))
	{
	...
	if(!(isdefined(self.var_c8f98f87) && self.var_c8f98f87) && isdefined(self.var_beb2295) && (cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon) || meansofdamage === "MOD_PROJECTILE"))
	{
		self ai::stun();
	}
	return damage;
...
/*
	...
	Flags: Linked, Private
*/
private function function_76c1f56f()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_cf18d183(grapplee)
{
...
{
	entity val::set(#"blight_father_death", "takedamage", 0);	if(level.var_79b2615b === entity)
	{
	...
	if(!entity isragdoll())
	{
		...
		var_a1a553e5 thread function_529b7fb9();
...
/*
	...
	Flags: Linked, Private
*/
private function blightfathershouldmelee(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_66e66814(entity)
{
...
private function function_ac921de9(entity)
{
	...
	foreach(player in var_5c2f5f9a)
	{
		...
		if(vectordot(vec_to_player, var_cb50d98f) < var_9b246038)
		{
			continue;
		}
...
/*
	...
	Flags: Linked, Private
*/
private function function_911c3934(entity)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_928e66ad(entity, asmstatename)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f108c0ea(entity)
{
...
function function_6f109d76(ai)
{
	if(level.var_a51ca41a <= 2)
	{
		...
		{
			self thread zm_audio::create_and_play_dialog(#"blight_father", #"hash_4e07b77652d2af45");
		}
	}
}
...
private function function_afce1cf(inflictor, attacker, damage, flags, meansofdamage, weapon, point, dir, hitloc, offsettime, boneindex, modelindex)
{
	...
	var_786d7e06 = cschashed-1\script_5a012bbb9342dbdf::function_422fdfd4(self, attacker, weapon, boneindex, hitloc, point, var_dd54fdb1);
	damage_scale = var_786d7e06.damage_scale;
	var_84ed9a13 = var_786d7e06.var_84ed9a13;
	var_7d87f2d4 = var_786d7e06.var_7d87f2d4;
	if(zm_utility::is_explosive_damage(meansofdamage))
	{
		damage_scale = max(damage_scale, entity ai::function_9139c839().var_da5a2805);
		final_damage = int(damage * damage_scale);
		if(meansofdamage === "MOD_PROJECTILE" && isdefined(var_84ed9a13) && var_7d87f2d4)
		{
	...
	{
		final_damage = int(damage * damage_scale);
		if(isdefined(var_84ed9a13) && var_7d87f2d4)
		{
...
/*
	...
	Flags: Linked, Private
*/
private function function_35edac9c(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_aaad8487(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_3782350(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_4bd1c37e(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_2784f3ff(entity)
{
	...
	foreach(player in level.players)
	{
		...
		var_a612be61 = function_5d7f8057(entity, player);
...
/*
	...
	Flags: Linked, Private
*/
private function function_d6ded650(entity)
{
	return isdefined(entity.var_beb2295);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_e0b3baff(notifyhash)
{
	function_c526065b(self);
...
/*
	...
	Flags: Linked, Private
*/
private function function_96f5d05a(entity, var_4c0587b)
{
	if(!isdefined(entity))
	{
		return;
	...
	entity endon_callback(&function_e0b3baff, #"death", #"hash_2fb2eddfa6a0ef3f");
	var_ded8c89 = zm_grappler::function_6be863a(entity gettagorigin("tag_jaw"), entity.angles);
	var_3a3a2919 = zm_grappler::function_6be863a(entity gettagorigin("tag_jaw"), entity.angles * -1);
	var_3a3a2919.prone_2_run_roll = entity;
	var_ded8c89 linkto(entity, "tag_jaw");
	entity.var_54c1950f = {#hash_5273e1a0:[], #status:0, #hash_65bf647c:var_3a3a2919, #hash_a733d0aa:var_ded8c89};
	thread zm_grappler::function_30a5f5c1(var_ded8c89, var_3a3a2919);
	util::wait_network_frame();
	n_time = distance(var_3a3a2919.origin, var_4c0587b) / entity ai::function_9139c839().var_4a5ffac;
	n_time = max(0.1, n_time);
	entity.var_54c1950f.status = 1;
	var_3a3a2919 playsound(#"zmb_grapple_start");
	var_3a3a2919 moveto(var_4c0587b, n_time, 0, n_time * 0.1);
	var_3a3a2919.var_740e58e6 = entity zm_grappler::function_f21c3519();
	...
	var_3a3a2919 flagsys::wait_till("grapple_moveto_done");
	var_3a3a2919 flagsys::clear("grapple_moveto_done");
	entity.var_54c1950f.status = 2;
	n_time = distance(var_3a3a2919.origin, var_3a3a2919.var_740e58e6) / entity ai::function_9139c839().var_4a5ffac;
	var_3a3a2919 moveto(var_3a3a2919.var_740e58e6, n_time, n_time * 0.1, 0);
	var_51c441a4 = entity.var_beb2295;
	var_3a3a2919 playsound(#"zmb_grapple_pull");
	thread function_9d1a26f1(entity, entity ai::function_9139c839().var_23426e9a * entity ai::function_9139c839().var_23426e9a, level.players);
	var_3a3a2919 flagsys::wait_till("grapple_moveto_done");
	var_3a3a2919 flagsys::clear("grapple_moveto_done");
	if(!isdefined(var_51c441a4) && isdefined(entity.var_beb2295))
	{
		n_time = distance(var_3a3a2919.origin, var_3a3a2919.var_740e58e6) / entity ai::function_9139c839().var_4a5ffac;
		var_3a3a2919 moveto(var_3a3a2919.var_740e58e6, n_time, 0, 0);
		var_3a3a2919 waittill(#"movedone");
	}
	if(isdefined(entity.var_beb2295))
	{
		var_148b92ae = function_f9d9f198(entity);
		var_1b40c6fd = entity.origin - var_148b92ae;
		angles = vectortoangles(var_1b40c6fd);
		var_3a3a2919.angles = (var_3a3a2919.angles[0], angles[1], var_3a3a2919.angles[2]);
		entity.var_beb2295 util::delay(0.5, undefined, &zm_audio::create_and_play_dialog, #"blight_father", #"vomit", undefined, 2);
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_55cba1f3(prone_2_run_roll)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_28dddd64(entity)
{
	...
	if(zombie_utility::is_player_valid(entity.var_bef7624d, 1, 1, 0))
	{
		...
		var_a612be61 = worldtrace(entity zm_grappler::function_f21c3519(), var_4c0587b);
...
function function_9d1a26f1(entity, var_8a713db5, var_3e06882e)
{
	...
	entity.var_54c1950f.var_65bf647c endon_callback(&function_31963d63, #"death", #"movedone");
	/#
		...
		if(!isdefined(entity.var_beb2295))
		{
			/#
				if(getdvarint(#"hash_692fb9cc4cff6541", 0))
				{
					...
					if(!isinarray(var_e41cb172, entity.var_54c1950f.var_65bf647c.origin))
					{
						var_e41cb172[var_e41cb172.size] = entity.var_54c1950f.var_65bf647c.origin;
					}
			...
			#/
			var_beb2295 = function_5afb347c(entity, entity.var_54c1950f.var_65bf647c.origin, var_8a713db5, var_3e06882e);
			if(isdefined(var_beb2295))
			{
				entity.var_54c1950f.var_65bf647c.var_740e58e6 = entity gettagorigin("tag_jaw");
				if(isdefined(var_beb2295.hasriotshieldequipped) && var_beb2295.hasriotshieldequipped)
				{
					...
					if(!isinarray(entity.var_54c1950f.var_5273e1a0, var_beb2295))
					{
						entity.var_54c1950f.var_5273e1a0[entity.var_54c1950f.var_5273e1a0.size] = var_beb2295;
					}
					var_beb2295 thread riotshield::player_take_riotshield();
				}
				else if(var_beb2295 function_61efcfe5())
				{
					if(!isdefined(entity.var_54c1950f.var_5273e1a0))
					{
						entity.var_54c1950f.var_5273e1a0 = [];
				...
				{
					function_91dcbd1c(entity, entity.var_54c1950f.var_65bf647c, var_beb2295);
				}
				entity.var_54c1950f.var_65bf647c flagsys::set("grapple_moveto_done");
				return;
			}
		}
		waitframe(1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_5afb347c(entity, var_6aab4b, var_8a713db5, var_3e06882e)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c1b0cbda()
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_91dcbd1c(prone_2_run_roll, var_a424c06a, var_beb2295)
{
	if(!isdefined(var_a424c06a))
	{
		return;
	}
	prone_2_run_roll.var_beb2295 = var_beb2295;
	var_beb2295 zm_grappler::function_a60cb756(1, 0);
	if(isplayer(var_beb2295))
	{
		var_beb2295 thread function_c1b0cbda();
		var_beb2295 function_5d851a4e();
	}
	...
	#/
	var_a424c06a.var_740e58e6 = var_148b92ae;
	var_ca015b6f = util::spawn_model("tag_origin", var_beb2295.origin, var_beb2295.angles);
	var_ca015b6f linkto(var_a424c06a, "tag_origin", vectorscale((0, 0, 1), 35) * -1);
	var_beb2295.var_ca015b6f = var_ca015b6f;
	if(isplayer(var_beb2295))
	{
		var_beb2295 playerlinkto(var_ca015b6f, "tag_origin", 1, 40, 40, 80, 15);
		/#
			recordstar(var_148b92ae, (1, 0, 0));
			recordstar(var_beb2295 geteye(), (0, 0, 1));
		#/
		angles = vectortoangles(var_148b92ae - var_beb2295 geteye());
		var_a424c06a.angles = (0, angles[1], 0);
		var_beb2295 setplayerangles(angles);
		var_beb2295 setstance("stand");
		var_beb2295 allowcrouch(0);
		var_beb2295 allowprone(0);
		var_beb2295 function_babdb8e7();
	}
	else
	{
		var_beb2295 linkto(var_a424c06a);
	}
	if(isdefined(prone_2_run_roll) && isdefined(var_beb2295) && isplayer(var_beb2295))
	{
		var_beb2295 thread function_55cba1f3(prone_2_run_roll);
	}
...
{
	var_88ceadf1 = var_e0ef3075;
	if(isdefined(entity))
	{
		entity.var_eb3ff149 = undefined;
		var_88ceadf1 = entity.var_beb2295;
	}
	if(!isdefined(var_88ceadf1) || (!(isdefined(var_88ceadf1.var_564dec14) && var_88ceadf1.var_564dec14)))
	{
		return;
	}
	if(isdefined(entity))
	...
	grapplee unlink();
	if(isdefined(var_88ceadf1.var_ca015b6f))
	{
		var_88ceadf1.var_ca015b6f delete();
		var_88ceadf1.var_ca015b6f = undefined;
	}
	var_88ceadf1 zm_grappler::function_a60cb756(0, 0);
	if(isplayer(grapplee))
	{
		var_88ceadf1 function_1fd426b6();
	...
	var_88ceadf1 function_def41e89();
	if(isdefined(entity))
	{
		entity.var_beb2295 = undefined;
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_def41e89()
{
	...
	foreach(enemy in enemies)
	{
		if(self istouching(enemy))
		{
			...
			{
				enemy namespace_57ff8cbb::function_23621259();
				enemy kill();
				continue;
			}
...
function function_d67c455e(notifyhash)
{
	...
	e_source = entity.var_54c1950f.var_a733d0aa;
	var_28ac1348 = entity.var_54c1950f.var_65bf647c;
...
/*
	...
	Flags: Linked, Private
*/
private function function_babdb8e7()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_299dd40e(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration)
{
	if(zm_utility::is_player_valid(entity.var_bef7624d))
	{
		var_aa80d8e1 = entity.var_bef7624d.origin - entity.origin;
		var_47d9e0ed = vectortoangles(var_aa80d8e1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_689831cf(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration)
{
	if(function_ef973b70(entity) === 0 && zm_utility::is_player_valid(entity.var_bef7624d) && !isdefined(entity.var_beb2295))
	{
		/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_42de48fb(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_b62014ac(entity, asmstatename)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_8cbef8fd(entity, asmstatename)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c0ea1203(grappler)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_5e853c85(grappler)
{
...
/*
	...
	Flags: Private
*/
private function function_e989972e(grappler)
{
	/#
		self endon(#"disconnect");
		grappler endon(#"death", #"hash_2fb2eddfa6a0ef3f");
		while(true)
		{
			...
			{
				var_3b80134d function_76c1f56f();
...
/*
	...
	Flags: Linked, Private
*/
private function function_62b3b7a3(entity)
{
	var_88ceadf1 = entity.var_beb2295;
	if(isdefined(grapplee))
	{
		...
		if(isdefined(var_88ceadf1.var_ca015b6f))
		{
			var_88ceadf1.var_ca015b6f unlink();
			var_938dbbaa = vectortoangles(entity.origin - var_88ceadf1.var_ca015b6f.origin);
			var_7e28b231 = entity gettagangles("tag_tongue");
			var_88ceadf1.var_ca015b6f linkto(entity, "tag_tongue", vectorscale((0, 0, 1), 35) * -1, (var_7e28b231[0] * -1, var_938dbbaa[1] - var_7e28b231[1], var_7e28b231[2] * -1));
...
/*
	...
	Flags: Linked, Private
*/
private function function_1d2646(entity)
{
	var_78a5a6c3 = 0;
	var_88ceadf1 = entity.var_beb2295;
	if(isdefined(var_88ceadf1) && isplayer(var_88ceadf1) && (!(isdefined(var_88ceadf1.var_16735873) && var_88ceadf1.var_16735873)) && (!(isdefined(var_88ceadf1.var_77f481e1) && var_88ceadf1.var_77f481e1)))
	{
		var_88ceadf1.var_f4e33249 = 1;
		var_78a5a6c3 = 1;
		...
		var_88ceadf1 thread function_c0ea1203(entity);
		var_88ceadf1 thread function_5e853c85(entity);
		/#
			var_88ceadf1 thread function_e989972e(entity);
		#/
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_563d56de(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d6fbf1b7(entity)
{
	return zombie_utility::is_player_valid(entity.var_beb2295, undefined, undefined, 0);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_bc3eb15a(entity)
{
	entity showpart("tag_tongue_grab", "c_t8_zmb_blightfather_tongue2", 1);
	if(isdefined(entity.var_beb2295))
	{
		...
		if(isplayer(var_88ceadf1) && var_88ceadf1 islinkedto(var_88ceadf1.var_ca015b6f))
		{
			var_88ceadf1 lerpviewangleclamp(0, 0, 0, 20, 20, var_495f8389, var_6f2b0bce);
		}
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_1d9f449a(entity)
{
	var_88ceadf1 = entity.var_beb2295;
...
/*
	...
	Flags: Linked, Private
*/
private function function_25f9cc48(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_1177eb85(entity)
{
	function_25f9cc48(entity);
	entity hidepart("tag_tongue_grab", "c_t8_zmb_blightfather_tongue2", 1);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_1dac0714(entity)
{
	function_25f9cc48(entity);
	function_c526065b(entity);
	entity showpart("tag_tongue_grab", "c_t8_zmb_blightfather_tongue2", 1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_fc84db95(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_2ed4a174(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_7a634eaa(entity)
{
	var_88ceadf1 = entity.var_beb2295;
	if(isdefined(grapplee))
	{
		entity clientfield::set("blight_father_vomit_fx", 1);
		var_88ceadf1 thread function_d5ba6cc6(entity, grapplee);
	}
	else
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d5ba6cc6(blight_father, player)
{
	player endon(#"death", #"disconnect");
	player clientfield::set_to_player("blight_father_vomit_postfx_clientfield", 1);
	while(isdefined(blight_father) && isalive(blight_father) && zm_utility::is_player_valid(blight_father.var_beb2295, undefined, undefined, undefined, 0) && blight_father.var_beb2295 === player)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_b3f66ac3(entity)
{
	entity clientfield::set("blight_father_vomit_fx", 0);
	function_f108c0ea(entity);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_51ead3e8(entity)
{
	entity showpart("tag_tongue_grab", "c_t8_zmb_blightfather_tongue2", 1);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_bb6aa70c(entity)
{
	entity hidepart("tag_tongue_grab", "c_t8_zmb_blightfather_tongue2", 1);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_7fe36aac(entity, minplayerdist)
{
	playerpositions = [];
	foreach(player in getplayers())
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_c90a5ebb(entity, attribute, oldvalue, value)
{
	if(!value)
	{
		var_65ba9602 = namespace_cb42c6c0::function_87c1193e(entity);
...
/*
	...
	Flags: Linked, Private
*/
private function function_7055b26(entity)
{
	/#
	...
	if(isdefined(var_65ba9602))
	{
		if(!namespace_cb42c6c0::function_c9105448(entity, var_65ba9602))
		{
			namespace_cb42c6c0::function_77caff8b(var_65ba9602);
			entity.var_3acacb18 = undefined;
			entity.b_ignore_cleanup = entity.var_ca0d8389;
	...
	var_c0c93f86 = [];
	if(!isdefined(var_c0c93f86))
	{
		var_c0c93f86 = [];
	}
	else if(!isarray(var_c0c93f86))
	{
		var_c0c93f86 = array(var_c0c93f86);
	}
	var_c0c93f86[var_c0c93f86.size] = "lockdown_stub_type_wallbuys";
	if(!isdefined(var_c0c93f86))
	{
		var_c0c93f86 = [];
	}
	...
	var_c0c93f86[var_c0c93f86.size] = "lockdown_stub_type_crafting_tables";
	if(!isdefined(var_c0c93f86))
	{
		var_c0c93f86 = [];
	}
	...
	var_c0c93f86[var_c0c93f86.size] = "lockdown_stub_type_perks";
	if(!isdefined(var_c0c93f86))
	{
		var_c0c93f86 = [];
	}
	...
	var_c0c93f86[var_c0c93f86.size] = "lockdown_stub_type_pap";
	if(!isdefined(var_c0c93f86))
	{
		var_c0c93f86 = [];
	}
	...
	var_c0c93f86[var_c0c93f86.size] = "lockdown_stub_type_magic_box";
	max_height = entity ai::function_9139c839().var_ee9586a9;
	if(isdefined(level.var_1c666963))
	{
		max_height = level.var_1c666963;
	}
	var_9c3aab26 = namespace_cb42c6c0::function_9b84bb88(entity, var_c0c93f86, entity ai::function_9139c839().var_8ae9a3a7, max_height);
	...
	var_4afb24b6 = namespace_cb42c6c0::function_dab6d796(entity, stub);
	if(!isdefined(var_4afb24b6))
	{
		/#
	...
	if(!ispointonnavmesh(start_origin, entity))
	{
		/#
			if(isdefined(var_4afb24b6))
			{
				namespace_cb42c6c0::function_78eae22a(entity, stub, 14, start_origin, var_4afb24b6);
			}
		#/
		return;
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_158a1b7e()
{
	self endon(#"death");
	for(;;)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d6e82d62(stub)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_b9a828e1(model)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e1ba6416(entity)
{
	if(isdefined(entity.var_c8f98f87) && entity.var_c8f98f87)
	{
		return 0;
	}
	if(!namespace_cb42c6c0::function_7bfa8895(entity))
	{
		return 0;
	}
	if(!isdefined(entity.var_3acacb18))
...
/*
	...
	Flags: Linked, Private
*/
private function function_a0edafd0(entity)
{
	if(namespace_cb42c6c0::function_7bfa8895(entity))
	{
		stub = namespace_cb42c6c0::function_7258b5cc(entity, &function_b57f31b6, &function_158a1b7e, &function_d6e82d62);
		if(!isdefined(stub))
		{
			return;
		}
		switch(stub.var_895b6b)
		{
			...
			{
				var_680c2eca = 2;
				var_8354cf7d = namespace_cb42c6c0::function_da72073(stub);
				break;
			}
...
/*
	...
	Flags: Linked, Private
*/
private function function_6ab8460f(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration)
{
	stub = namespace_cb42c6c0::function_87c1193e(entity);
	var_4afb24b6 = namespace_cb42c6c0::function_dab6d796(entity, stub);
	if(isdefined(var_4afb24b6))
...
/*
	...
	Flags: Linked, Private
*/
private function function_19249d10(entity)
{
	if(isdefined(level.var_9cfa4efd) && level.var_9cfa4efd)
	{
		return 0;
	...
	var_a612be61 = function_5d7f8057(entity, entity.favoriteenemy);
...
private function function_5f3390fd(var_61622673, var_4fee43d4)
{
	...
	while(isdefined(var_892397fd))
	{
		...
		players = arraysortclosest(var_b5b576a7, var_892397fd.origin, undefined, 0, var_4fee43d4);
		if(players.size > 0)
		{
			var_892397fd thread function_124486ee(0);
		}
...
private function function_124486ee(delay)
{
	...
	if(isdefined(var_892397fd))
	{
		...
		radiusdamage(explosion_point, blast_radius, var_83f35abe, var_6927cfa0, var_a7530fbc, "MOD_UNKNOWN", w_weapon);
...
{
	if(!self cschashed-1\script_5a012bbb9342dbdf::function_db610082())
	{
		return 0;
	}
...
{
	forced = namespace_5869722f::function_ff2a74e7(#"blight_father");
...
{
	/#
		var_c862d3c3 = getspawnerarray("", "");
		if(var_c862d3c3.size == 0)
		{
			iprintln("");
			return;
		}
...
/*
	...
	Flags: Linked, Private
*/
private function function_2315440d()
{
	...
	var_944250d2 cschashed-2\script_260abbdf1ff0aa9a::function_bbaec2fd();
	return 1;
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ef860973(params)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_6fa41b21(params)
{
...
/*
	...
	Flags: Private
*/
private function function_ebc88dbd(part_name)
{
	/#
...
/*
	...
	Flags: Private
*/
private function function_cab68577(var_f16c2276)
{
	/#
		...
		foreach(enemy in enemies)
		{
			if(isalive(enemy))
			{
				var_84ed9a13 = namespace_81245006::function_37e3f011(enemy, var_f16c2276);
				...
				enemy function_afce1cf(level.players[0], level.players[0], var_84ed9a13.maxhealth, undefined, undefined, level.players[0] getcurrentweapon(), level.players[0].origin, undefined, undefined, 0, var_f16c2276);
			}
		}
	#/
}
...
/*
	...
	Flags: Private
*/
private function function_f8411b4d(blight_father)
{
	/#
...
/*
	...
	Flags: Private
*/
private function function_a2751530()
{
	/#
...
/*
	...
	Flags: Private
*/
private function function_4d72a4a6()
{
	/#
		var_c862d3c3 = getspawnerarray("", "");
		...
		var_c862d3c3[0].script_forcespawn = 1;
		entity = zombie_utility::spawn_zombie(var_c862d3c3[0], undefined, spawn_point);
		if(!isdefined(entity))
		{
			return;
		}
		...
		entity cschashed-2\script_260abbdf1ff0aa9a::function_bbaec2fd();
...
/*
	...
	Flags: Private
*/
private function function_d420b133()
{
	/#
		enemies = getaiarchetypearray(#"blight_father");
		foreach(enemy in enemies)
