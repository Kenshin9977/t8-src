...
#namespace cschashed-3\script_4716533215778f7f;
...
function main()
{
	...
	level flag::init(#"hash_1e9939091ee8cb9b");
	...
	namespace_ee206246::register(#"edge_of_the_world", #"step_2", #"hash_32fca8166d23c911", &function_8bc27fd3, &function_f2bde2d9);
...
function function_abf8d5ce()
{
	...
	while(true)
	{
		...
		{
			if(self.var_f9ae8dab[i].var_a2b878e7 === 1 && self.var_f9ae8dab[i].b_placed === 0)
			{
...
function function_a4e86068()
{
	...
	namespace_c3287616::function_b4a8f95a(#"zombie_electric", var_d1ec2571, &function_a092874, &function_a1b4b25d, &function_c83f59db, &function_5bfaa04, 0);	if(namespace_c3287616::function_40229072(level.round_number) && !level flag::get("special_round"))
	{
...
function function_a092874()
{
	...
	namespace_c3287616::function_5bc2cea1(&cschashed-1\script_5fb8da2731850d9e::function_ed67c5e7);
...
function function_500dfb49()
{
	...
	if(a_players.size < 2)
	{
		...
		cschashed-3\script_e2bef0652b31f68::function_2ba419ee();
	}
}
...
function sq_glasses()
{
	...
	var_98262e3d function_ea04cfd2();
}
...
function function_a589e722(var_5ea5c94d)
{
	...
	if(!var_5ea5c94d)
	{
		...
		namespace_85e029d3::function_f6ecebca(13, #"hash_15b81856e839fed9", #"hash_eb543cd4ec82ae7", &function_bfb15d08);
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_1", 0);
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_1", 2);
...
function function_a2993671()
{
	...
	flinger cschashed-1\script_1edaf4333ed0bece::function_60325438(0);
	if(!level flag::get(#"hash_72bd35eacb1940de"))
	{
		...
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_1", 1);
	}
	else
	{
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_2", 1);
	}
}
...
function function_1856c416()
{
	...
	flinger = struct::get(self.target, "targetname");
	flinger cschashed-1\script_1edaf4333ed0bece::function_60325438(1);
	...
	{
		cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_2", 0);
	}
}
...
function function_594f2c26(var_5ea5c94d)
{
	...
	if(!var_5ea5c94d)
	{
		...
		var_3fae43ee function_a2993671();
		var_3fae43ee.b_picked_up = undefined;
		namespace_85e029d3::function_f6ecebca(14, #"hash_494d7fc0d10e2ff6", #"hash_9af968cebf182d2", &function_b37bdeb4);
...
{
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("flinger_gear_box_2", 2);
...
{
	level flag::set(#"hash_1e9939091ee8cb9b");
...
function function_fdc3c7c4()
{
	...
	{
		if(cschashed-1\script_7a71fa3cd7dff849::is_valid_target(player) && (!(isdefined(player.var_cdce7ec) && player.var_cdce7ec)))
		{
	...
	{
		s_player_respawn = self cschashed-1\script_7a71fa3cd7dff849::get_best_spawnpoint(player);
