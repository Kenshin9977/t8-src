...
function init()
{
	namespace_c3287616::function_2669b95a(#"bat", #"nosferatu");	level.var_4c350e72 = 0;
	...
	namespace_c3287616::function_2876740e(#"catalyst", &function_2ffc8cca);	level waittill(#"all_players_spawned");
	if(zm_utility::is_standard())
	{
		level thread function_6957c745(#"catalyst", 3);	}
	else
	{
		level thread function_6957c745(#"catalyst", 7);		level thread function_6957c745(#"werewolf", 30, "flag_werewolf_set_intro");
		level thread function_6957c745(#"bat", 12, "flag_bat_nosferatu_set_intro");
		level thread function_6957c745(#"nosferatu", 12, "flag_bat_nosferatu_set_intro");		level thread function_6957c745(#"crimson_nosferatu", 35, "flag_crimson_nosferatu_set_intro");	}
	/#
...
function function_50ec1ddf()
{
	...
	foreach(s_spawn_loc in a_s_spawn_locs)
	{
		if(zm_zonemgr::zone_is_enabled(s_spawn_loc.zone_name))
		{
			...
			if(s_spawn_loc.var_39512f0e === "power_on3" && namespace_59ff1d6c::function_901b751c("zmPowerState") == 2 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_29004a67830922b6") == 0)
			{
				return s_spawn_loc;
			}
		}
...
function function_d1371239(var_a9e4d1ee)
{
	...
	while(var_a9e4d1ee > 0)
	{
		...
		do
		{
			ai = cschashed-1\script_5fb8da2731850d9e::function_62db7b1c(1, undefined);
			var_18f8f237--;
			waitframe(1);
		}
