...
#using hashed-1\killstreak_bundles.gsc;
#using hashed-3\heatseekingmissile.gsc;
#using hashed-3\aiutility.gsc;
#using hashed-2\killstreakrules.gsc;
...
#using hashed-1\humaninterface.gsc;
...
#using hashed-2\archetype_human.gsc;
...
function __init__()
{
	...
	callback::on_actor_killed(&function_ddaaaeee);
	callback::on_player_killed_with_params(&function_ddaaaeee);
	...
	killstreaks::function_e4ef8390("killstreak_swat_team", &function_87bf6422);
	killstreaks::register_alt_weapon("swat_team", getweapon(#"hash_216eeca7a4295e4"));
...
/*
	...
	Flags: Linked
*/
function function_fe5b1120(helicopter, var_dbd1a594)
{
...
function function_87bf6422(killstreak)
{
	...
	context.var_597ac911 = &function_d00082ce;
...
function function_6936559a(context)
{
	...
	if(isdefined(trace[#"position"]) && isdefined(trace[#"normal"]))
	{
		...
		easter_base4 = util::spawn_model("wpn_t8_eqp_ir_strobe_world", origin, angles);
		if(isdefined(easter_base4))
		{
			context.easter_base4 = easter_base4;
			easter_base4 clientfield::set("swat_light_strobe", 1);
			easter_base4 waittill_timeout(10, #"hash_1e4c945d50deb21d");
			easter_base4 clientfield::set("swat_light_strobe", 0);
			waitframe(2);
			easter_base4 delete();
		}
	}
...
private function registerbehaviorscriptfunctions()
{
	...
	behaviortreenetworkutility::registerbehaviortreescriptapi(#"swatshouldmelee", &swatshouldmelee);	/#
		assert(isscriptfunctionptr(&swatshouldmelee));
	#/
	behaviorstatemachine::registerbsmscriptapiinternal(#"swatshouldmelee", &swatshouldmelee);	animationstatenetwork::registeranimationmocomp("mocomp_swat_team_pain", &function_6edff1e1, undefined, &function_8acd749d);
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_7b12237f(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_5bc83fac(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_5e207da3(entity)
{
...
*/
private autoexec function function_60aca60a()
{
	classes.var_60aca60a[0] = spawnstruct();
	classes.var_60aca60a[0].__vtable[913321084] = &namespace_60aca60a::__destructor;
	classes.var_60aca60a[0].__vtable[674154906] = &namespace_60aca60a::__constructor;
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_91228fe2(entity)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_a72ef6ce(entity, newspot)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_f046ec67(entity)
{
	function_91228fe2(entity);
	object = new var_60aca60a();
	[[ object ]]->__constructor();
	entity.ai.var_5cb410bc = object;
...
/*
	...
	Flags: Linked, Private
*/
private function function_615dc1b2(entity)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_ddaaaeee(params)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_493691bc()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_6f7a6cbc(params)
{
	if(!(isdefined(self.ai.var_ac89e6f6) && self.ai.var_ac89e6f6))
	{
		return;
...
/*
	...
	Flags: Linked, Private
*/
private function function_b4f4603e()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e69272bf()
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_ace0a9bc()
{
	self endon(#"death");
...
/*
	...
	Flags: Linked, Private
*/
private function function_8fa2faa5(swat, helicopter, position)
{
	swat endon(#"death", #"stop_riding");
	helicopter endon(#"death", #"hash_216c905d79c8bbea");
	level endon(#"game_ended");
	var_2d1d099c = undefined;
	switch(position)
	{
		case 0:
		{
			var_2d1d099c = "ai_swat_rifle_ent_litlbird_rappel_stn_base_01_idle";
			break;
		}
		case 1:
		{
			var_2d1d099c = "ai_swat_rifle_ent_litlbird_rappel_stn_base_02_idle";
			break;
		}
		case 2:
		{
			var_2d1d099c = "ai_swat_rifle_ent_litlbird_rappel_stn_base_03_idle";
			break;
		}
		default:
		{
	...
	/#
		assert(isdefined(var_2d1d099c));
	#/
	if(isdefined(var_2d1d099c))
	{
		while(true)
		{
			if(isalive(swat) && swat hasanimtree())
			{
				swat animation::play(var_2d1d099c, helicopter, "tag_origin", 1, 0.2, 0.1, undefined, undefined, undefined, 0);
			}
		}
	}
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_67260255(swat, helicopter, killstreak_id)
{
	swat endon(#"hash_251a6c153b9f57c3", #"death");
	...
	if(isdefined(swat.script_owner))
	{
		...
		swat.script_owner notify(#"hash_d843795c594bf0e");
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ab6f69a1(swat)
{
	swat endon(#"hash_251a6c153b9f57c3");
	swat waittill(#"death");
...
/*
	...
	Flags: Linked
*/
function function_e24bfb9f(swat, helicopter, position, var_a298d55b, var_eead001f)
{
	swat endon(#"death");
	level endon(#"game_ended");
	var_90b83efc = undefined;
	switch(position)
	{
		case 0:
		{
			var_90b83efc = "ai_swat_rifle_ent_litlbird_rappel_stn_base_01";
			break;
		}
		case 1:
		{
			var_90b83efc = "ai_swat_rifle_ent_litlbird_rappel_stn_base_02";
			break;
		}
		case 2:
		{
			var_90b83efc = "ai_swat_rifle_ent_litlbird_rappel_stn_base_03";
			break;
		}
		default:
		{
	...
	/#
		assert(isdefined(var_90b83efc));
	#/
	swat notify(#"stop_riding");
	swat pathmode("dont move");
	if(isalive(swat) && swat hasanimtree() && isdefined(var_90b83efc))
	{
		swat animation::play(var_90b83efc, helicopter.origin, helicopter.angles, 1.2, 0.2, 0.3, undefined, undefined, undefined, 0);
	}
	swat unlink();
	if(var_eead001f)
	{
	...
	swat notify(#"hash_251a6c153b9f57c3");
}
...
/*
	...
	Flags: Linked, Private
*/
private function function_8de67419(leavenode)
{
	self endon(#"death");
...
function function_9fe56d0b(helicopter)
{
	...
	if(isdefined(helicopter))
	{
		...
		helicopter waittill_timeout(20, #"near_goal", #"death");
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_5ca48510(helicopter, var_1c996690)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_67c394f2(helicopter, destination)
{
	helicopter endon(#"death");
	...
	if(isdefined(level.var_e071ed64) && level.var_e071ed64)
	{
		...
		if(!ispointinnavvolume(var_7f4a508d, "navvolume_big"))
		{
			...
			if(isdefined(var_7f4a508d))
			{
				...
				if(!ispointinnavvolume(var_7f4a508d, "navvolume_big"))
				{
					self waittill_timeout(10, #"hash_340ab3c2b94ff86a");
				}
			}
		}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ab26fd70(helicopter)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_61baa879(helicopter)
{
	if(!isdefined(helicopter.rope))
	{
		return;
...
/*
	...
	Flags: Private
*/
private function function_b7ec43e(rope)
{
	rope endon(#"death");
	if(isdefined(rope))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_21f27c75(helicopter)
{
	level endon(#"game_ended");
	if(!isdefined(helicopter.rope))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d4331865(rope)
{
	if(isdefined(rope))
	{
		rope delete();
...
/*
	...
	Flags: Linked, Private
*/
private function function_7d90f954(origin, context)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_9153c267(origin, context, verticaloffset)
{
	if(isdefined(level.var_e071ed64) && level.var_e071ed64)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_accec5c5(origin, context, verticaloffset)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_fc826e6(tacpoints, context, verticaloffset)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_187f6d8f(tacpoints)
{
	/#
		assert(isdefined(tacpoints) && tacpoints.size);
	#/
...
{
	helicopter endon(#"death", #"hash_6736343f5a9c98f2", #"hash_216c905d79c8bbea");
	while(true)
	{
		/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_820e7c92(owner, var_1c996690, nodes, context)
{
	owner endon_callback(&function_d524c2b8, #"disconnect", #"joined_team", #"joined_spectators");
	level endon(#"game_ended");
	/#
	...
	if(isdefined(context.easter_base4))
	{
		context.easter_base4 notify(#"hash_1e4c945d50deb21d");
	}
	...
	foreach(swat in owner.swat_team)
	{
		if(isdefined(swat) && !function_3132f113(swat) && isalive(swat))
		{
			if(position == 0)
			{
				swat thread function_e24bfb9f(swat, helicopter, position, nodes[position], 1);
			}
			else
			{
				swat thread function_e24bfb9f(swat, helicopter, position, nodes[position], 0);
			}
		}
		position++;
	}
	...
	helicopter notify(#"hash_6736343f5a9c98f2");
...
function function_5479b133(team, killstreak_id)
{
	...
	self function_d00082ce(self.var_6c0553ea);
}
...
function spawn_swat_team(owner, context, origin)
{
	...
	var_1c996690 = origin;
	owner thread function_fb8614cc(context.killstreak_id);
...
/*
	...
	Flags: Linked, Private
*/
private function function_d1c52e08()
{
	self endon(#"death");
	while(true)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_2d44c54f(var_eca4744a, var_56bd1bef, nodes)
{
...
function function_4c2ed78d(owner, forced = 0)
{
	...
	var_17db3d7b = result[#"point"];
	if(!isdefined(var_17db3d7b))
	{
		return;
	}
	enemies = getplayers();
	...
	if(!forced)
	{
		...
		{
			var_56bd1bef = var_17db3d7b + vectorscale(vectornormalize(owner.var_546b8137), 200);
		}
		else
		{
			var_56bd1bef = var_17db3d7b + vectorscale(anglestoforward(owner.angles), 200);
		}
	}
	else
	{
		var_56bd1bef = var_17db3d7b;
	}
...
function swat_escort(playgesture = 1)
{
	...
	owner waittill(#"hash_6736343f5a9c98f2");
...
function swat_guard()
{
	...
	self.var_6c0553ea.var_79061c2 = 0;
}
...
function function_50adbe51(var_b05782ac)
{
	...
	if(isdefined(self.var_6c0553ea))
	{
		...
		if(isdefined(self.var_6c0553ea.easter_base4))
		{
			self.var_6c0553ea.easter_base4 notify(#"hash_1e4c945d50deb21d");
		}
		self function_d738127f();
		if(isdefined(self.var_6c0553ea.killstreak_id) && isdefined(self.var_6c0553ea.var_43dc1011))
		{
			function_d00082ce(self.var_6c0553ea);
		}
		if(isdefined(self.var_6c0553ea.remoteweapon))
		{
			self.var_6c0553ea.remoteweapon.usetrigger delete();
...
function function_610d3790(einflictor, victim, idamage, weapon)
{
	...
	if(isactor(einflictor))
	{
		...
		{
			attacker.var_6c0553ea.var_79061c2++;
			if(attacker.var_6c0553ea.var_79061c2 == 2)
			{
...
/*
	...
	Flags: Linked, Private
*/
private function function_59f58b93(origin)
{
	self function_d738127f();
...
/*
	...
	Flags: Linked, Private
*/
private function function_d738127f()
{
	if(!isdefined(self.var_6c0553ea))
	{
		return;
...
/*
	...
	Flags: Linked
*/
function function_d00082ce(context)
{
