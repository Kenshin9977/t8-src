...
function finalize_init()
{
	...
	if(can_process_contracts())
	{
		...
		register_player_contract_event(#"objective_ekia", &function_660b0026);		register_player_contract_event(#"damagedone", &function_6d90b18a, 1);
...
function can_process_contracts()
{
	...
	if(getdvarint(#"hash_336426e6c4d66833", 1) == 0)
	{
		return 0;
	}
...
function function_660b0026()
{
	...
	player = self;
	objective_ekia = player.pers[#"hash_73786dd8290616a2"] + 1;
...
function function_a4c8ce2a(data)
{
	...
	var_67d27328 = player stats::get_stat(#"arenastats", 2, #"hash_60f1e9335197f661", #"hash_36cd820c1ff6c16b");
	if(var_67d27328 > 0)
	{
...
function contract_win(winner)
{
	...
	var_15b1abd9 = winner stats::function_441050ca(#"hash_a06075423336d9c");
	if(var_15b1abd9 > 0)
	{
		if(var_15b1abd9 % 4 == 0)
		{
