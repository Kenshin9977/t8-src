...
function intro_nova_crawler(n_round_number)
{
	...
	level notify(#"crawlers_spawned");	zm_utility::function_9b7bc715(#"nova_crawler", 1);
}
...
function function_bee94926()
{
	...
	level waittill(#"crawlers_spawned");	level flag::clear(#"hash_2a1fc2e349c48462");
}
...
function function_c87db3f7(var_f79ff5ec)
{
	...
	if(var_f79ff5ec == #"groom_lake")
	{
		...
		cschashed-2\script_356ad5dd4af06a33::function_60abbae4(0);
	}
	cschashed-2\script_356ad5dd4af06a33::function_a6bb56f6();
	level waittill(#"hash_7a04a7fb98fa4e4d");
	wait(2);
	if(var_f79ff5ec == #"groom_lake")
	{
		level.s_cage_portal zm_unitrigger::create("", 32, &cschashed-2\script_356ad5dd4af06a33::portal_think, 0, 0);
		cschashed-2\script_356ad5dd4af06a33::function_60abbae4(1);
	...
	cschashed-2\script_356ad5dd4af06a33::function_cc9b97b0();
}
...
{
	self endon(#"defend_complete", #"disconnect");	str_player_zone = self zm_zonemgr::get_player_zone();
...
function enable_groom_lake()
{
	...
	cschashed-2\script_356ad5dd4af06a33::function_bb3f9afd();
...
function function_231d0b19()
{
	...
	{
		if(!isdefined(s_cage_debris.a_e_clip))
		{
			s_cage_debris.a_e_clip = [];
		}
		else if(!isarray(s_cage_debris.a_e_clip))
		{
			s_cage_debris.a_e_clip = array(s_cage_debris.a_e_clip);
		}
		...
		var_2b975c1a = getentarray(s_cage_debris.target, "targetname");
...
function function_cc31fe55(var_3e4bb460)
{
	...
	foreach(player in level.players)
	{
		...
		player cschashed-1\script_3d5821d793ed4c6::start_timer(30);
	}
