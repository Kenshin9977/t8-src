...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_1c600f8141a34a9", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_9e7b3f4d(round_reset)
{
	if(round_reset)
	{
		...
		cschashed-2\script_235cad39dd72e0ac::function_3690781e();
	}
	else
	{
...
private function start_boss_fight()
{
	...
	{
		cschashed-1\script_6b0e57a9841b472d::function_dfaf17c8();
		level thread cschashed-1\script_6b0e57a9841b472d::function_3a2efd4e(0, 0, 0);
	}
	else
	{
		wait(12);
		level lui::screen_fade_out(1);
		level thread cschashed-1\script_6b0e57a9841b472d::function_3a2efd4e(0, 0, 1);
		wait(0.5);
		level thread lui::screen_fade_in(1);
	}
	level flag::wait_till(#"boss_battle_complete");	level flag::clear(#"infinite_round_spawning");
	level flag::clear(#"pause_round_timeout");
