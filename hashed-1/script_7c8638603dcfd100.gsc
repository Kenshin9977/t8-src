...
#namespace cschashed-1\script_5c00cc602bff1634;
...
private function function_a231dd3b(s_params)
{
	...
	self val::set(#"gegenees_death", "takedamage", 0);	if(level flag::get("zombie_drop_powerups") && !zm_utility::is_standard() && (!(isdefined(self.no_powerups) && self.no_powerups)))
	{
		var_67a1b262 = 1;
