...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_6c9de9db7f3e44a3", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_d1de6a85(var_a84ac7c8, str_archetype, n_kill_count, str_destination, str_zone1, str_zone2, var_588808b1, var_91e2fb66, var_84245fe9)
{
	...
	level.var_c23449d8 = cschashed-1\script_3c362258ff800237::function_5769f26a(n_kill_count);
	self.var_925854c7 = var_a84ac7c8;
	level.var_fbca3288 = 0;
	cschashed-1\script_3d5821d793ed4c6::function_2976fa44(level.var_c23449d8);
...
private function function_9e7b3f4d(round_reset)
{
	...
	if(n_remaining > 0)
	{
		cschashed-1\script_3c362258ff800237::fail(self.var_925854c7, level.players);
	}
}
...
private function on_ai_killed(params)
{
	if(self.archetype === #"gladiator" && level.var_c23449d8 > 0)
	{
		...
		if(var_d217c89e)
		{
			level.var_c23449d8--;
			level.var_fbca3288++;
			cschashed-1\script_3d5821d793ed4c6::function_dace284(level.var_fbca3288);
		}
	}
}
