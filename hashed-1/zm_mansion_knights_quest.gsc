...
#namespace cschashed-2\script_21b99e2f421608bf;
...
function init()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp1", 8000, #"kp_1", &function_4175b958, &function_138b784e, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp2", 8000, #"kp_2", &function_53e85e3d, &function_25d21cdb, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp3", 8000, #"kp_3", &function_5e8b7383, &function_28082147, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp1_halfway", 8000, #"hash_5ff0996978af5e05", &function_a23300bc, &function_3d90aae2, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp2_halfway", 8000, #"hash_2e71806f86ca448c", &function_ecb921f0, &function_49798eb9, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_kp3_halfway", 8000, #"hash_11f38acf5e773a0b", &function_ba203e13, &function_60bda2cf, 1);
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(#"soul_capture_forest", 8000, #"kp_forest", &function_9b256116, &function_b570f926, 1);
	init_flags();
	function_c739f755();
	level thread function_c6e2a4fd();
	level thread start_triad();
...
function start_triad()
{
	...
	if(zm_utility::can_enable_ee())
	{
		...
		{
			zm_sq::start(#"hash_7242bba9d0b132f5");
		}
	}
}
...
function function_c6e2a4fd()
{
	...
	level thread function_aff73166();
	...
	{
		var_1e20c0e5 thread function_8c4357b4("hi", 1);
	}
}
...
function init_flags()
{
	...
	level flag::init(#"forest_complete");	level flag::init(#"hash_2d21160da504fb1");
...
function function_cdfe68a2(var_a276c861)
{
	...
	if(!var_a276c861)
	{
		...
		level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_7b00754a8b214587", 1);
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_22f194aa6971efed", 1);
	var_67b37a67 = struct::get_array("fireplace_location");
	foreach(var_1e20c0e5 in var_67b37a67)
	{
		var_1e20c0e5 thread function_8c4357b4("low", 0);
		var_1e20c0e5 thread function_8c4357b4("hi", 1);
	}
...
function function_97dd9a16()
{
	...
	if(!(isdefined(level.var_f1028094[#"hash_4768e5d68ac1bb63"]) && level.var_f1028094[#"hash_4768e5d68ac1bb63"]))
	{
		...
		if(zm_utility::is_player_valid(e_speaker))
		{
			...
			e_speaker namespace_891c9bac::function_a2bd5a0c("vox_generic_responses_positive", 0, 1);
		}
	}
}
...
{
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_22f193aa6971ee3a", 1);
...
function function_bafa7a2b(var_5ea5c94d, ended_early)
{
	...
	if(ended_early)
	{
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp1");
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp2");
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp3");
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp1_halfway");
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp2_halfway");
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_kp3_halfway");
	}
}
...
function function_86e35a69(var_a276c861)
{
	...
	level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(#"hash_22f192aa6971ec87", 1);
}
...
function function_a93d56b1(var_5ea5c94d, ended_early)
{
	...
	mdl_relic = util::spawn_model(#"hash_5751ec2bba176cf3", s_relic.origin, s_relic.angles);
	util::wait_network_frame();
	...
	level flag::set(#"forest_complete");	if(ended_early)
	{
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d("soul_capture_forest");
			...
			if(var_e4e66b68)
			{
				...
				if(self.script_int == 3)
				{
					if(isalive(e_player) && (!(isdefined(e_player.var_aed1893c[#"hash_7a226c41930a49a3"]) && e_player.var_aed1893c[#"hash_7a226c41930a49a3"])))
					{
						...
						e_player thread namespace_891c9bac::function_8e0f4696(str_vo, 0, 1, 9999);
					}
		...
		if(zm_utility::can_use(player))
		{
			switch(self.stub.script_string)
			{
				case "main_hall":
				{
					...
					var_64403099 util::delay(1.5, undefined, &scene::play, #"hash_2d547475e197c303", "crumble", var_64403099);
				...
				case "cemetery":
				{
					...
					var_64403099 util::delay(1.5, undefined, &scene::play, #"hash_8d059c440180175", "crumble", var_64403099);
				...
				case "greenhouse":
				{
					...
					var_64403099 util::delay(1.5, undefined, &scene::play, #"hash_2288da5701a3d59c", "crumble", var_64403099);
...
function function_226e15cc()
{
	...
	scene::add_scene_func(#"hash_3dcbc82609d561d0", &function_92227ee8, "rise");
	level.var_abe1b67c thread scene::play(#"hash_3dcbc82609d561d0", "rise", level.var_abe1b67c);
	level.var_fbcb1d5b thread scene::play(#"hash_3dcbc82609d561d0", "rise", level.var_fbcb1d5b);
	level.var_c22f75e6 scene::play(#"hash_3dcbc82609d561d0", "rise", level.var_c22f75e6);
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d("soul_capture_kp1");
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d("soul_capture_kp2");
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d("soul_capture_kp3");
}
...
/*
	...
	Flags: Linked
*/
function function_9b256116(var_88206a50, ent)
{
...
function function_b570f926(var_f0e6c7a2, ent)
{
	...
	level.n_forest++;
	if(level.var_b2ffedd4 >= var_c61e686c)
	{
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d(#"soul_capture_forest");
		level flag::set(#"hash_4751f59c00375059");
...
{
	self endon(#"death");
	self scene::play(#"hash_3dcbc82609d561d0", "crumble", self);
	...
	{
		cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(var_ea62e3e9);
	}
	self scene::play(#"hash_3dcbc82609d561d0", "rise", self);
...
function function_444d9cf8()
{
	...
	cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(#"soul_capture_forest");
	...
	while(!level flag::get(var_39cddd2a))
	{
		...
		if(level.var_34ac013b < n_active)
		{
			...
			if(isdefined(var_e3cf2cc7))
			{
				...
				var_e3cf2cc7 cschashed-2\script_260abbdf1ff0aa9a::function_bbaec2fd();
				var_e3cf2cc7 forceteleport(s_loc.origin, s_loc.angles);
				var_e3cf2cc7 callback::function_d8abfc3d(#"on_ai_killed", &function_906e3daf);
			}
		}
		wait(5);
	}
...
/*
	...
	Flags: Linked
*/
function function_906e3daf(params)
{
	level.var_34ac013b--;
	level.var_b02bf6d2++;
}
...
function function_5ffc956(v_zombie_origin)
{
	...
	e_closest_player = arraygetclosest(v_zombie_origin, namespace_891c9bac::function_347f7d34());
	...
	while(!level flag::get(#"hash_6402d013069eb3a"))
	{
		...
		if(level.var_8a64ef3a < 9 && a_zombies.size >= 9)
		{
			...
			foreach(ai in a_zombies)
			{
				...
				{
					cschashed-2\script_260abbdf1ff0aa9a::function_9acf76e6(ai, array::pop(var_18f3c565, undefined, 0));
					break;
				}
			}
		}
...
function forest_entrance()
{
	...
	scene::add_scene_func(#"hash_1870b1d91d488c55", &function_de7be188, "init");
	level scene::init(#"hash_1870b1d91d488c55");
	scene::remove_scene_func(#"hash_1870b1d91d488c55", &function_de7be188, "init");
...
function trigger_forest_entrance()
{
	...
	player = array::random(namespace_891c9bac::function_347f7d34());
	if(isdefined(player))
	{
		player thread namespace_891c9bac::function_a2bd5a0c(#"hash_7cedb4ec0f14ff50", 1);
	}
...
function function_a112ed5e()
{
	...
	level scene::play(#"hash_1870b1d91d488c55");
	wait(2.5);
	zm_sq::start(#"hash_221e18c31e82092d");
...
function function_f0a7d11b()
{
	...
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_48d8727043be63bc", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_corrosive_spawn_pre_split", "aib_vign_zm_zod_catalyst_corrosive_spawn_post_split");
	var_c1da220b = getspawnerarray("zombie_spawner_catalyst_water", "targetname")[0];
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_cc3279e1c9378c3", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_water_spawn_pre_split", "aib_vign_zm_zod_catalyst_water_spawn_post_split");
	var_c1da220b = getspawnerarray("zombie_spawner_catalyst_electric", "targetname")[0];
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_f320466b419b45", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_electric_spawn_pre_split", "aib_vign_zm_zod_catalyst_electric_spawn_post_split");
	var_c1da220b = getspawnerarray("zombie_spawner_catalyst_plasma", "targetname")[0];
	namespace_3fffba66::function_cfca77a7(var_c1da220b, #"hash_45bc5c87327d33a2", &cschashed-1\script_5a012bbb9342dbdf::function_db610082, 0, undefined, &function_724b3e30, "aib_vign_zm_zod_catalyst_plasma_spawn_pre_split", "aib_vign_zm_zod_catalyst_plasma_spawn_post_split");
}
