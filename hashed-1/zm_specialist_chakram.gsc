...
#namespace cschashed-3\script_43808e214c232a5c;
...
function __init__()
{
	...
	clientfield::register("toplayer", "" + #"chakram_rumble", 1, 3, "counter");	level.hero_weapon[#"chakram"][0] = getweapon(#"hero_chakram_lv1");
	...
	level.var_30d2c56e[#"chakram"][#"kill_limit"][0] = 4;	level.var_30d2c56e[#"chakram"][#"kill_limit"][1] = 4;	level.var_30d2c56e[#"chakram"][#"kill_limit"][2] = 4;	level.var_30d2c56e[#"chakram"][#"max_range"][0] = 512;
	...
	level.var_30d2c56e[#"chakram"][#"throw_model"][0] = "wpn_t8_zm_melee_chakram_lvl1_dw_projectile";	level.var_30d2c56e[#"chakram"][#"throw_model"][1] = "wpn_t8_zm_melee_chakram_lvl2_dw_projectile";	level.var_30d2c56e[#"chakram"][#"throw_model"][2] = "wpn_t8_zm_melee_chakram_lvl3_dw_projectile";	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_chakram_lv1");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_chakram_lv2");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level("hero_chakram_lv3");
	level.var_5d31a5ef = [];
...
private function function_dc7f8e67(player)
{
	...
	var_fc51fa3d = level.var_30d2c56e[#"chakram"][#"kill_limit"][player.var_72d6f15d];	var_e68de849 = level.var_30d2c56e[#"chakram"][#"max_range"][player.var_72d6f15d];
	var_931acaa7 = level.var_30d2c56e[#"chakram"][#"hash_5fc489e6007a6457"][player.var_72d6f15d];
	wait(var_e9ada947);
	n_kills = 0;
	if(!isdefined(player.var_89e9a4ce))
	{
		var_89e9a4ce = util::spawn_model(level.var_30d2c56e[#"chakram"][#"throw_model"][player.var_72d6f15d], player gettagorigin("tag_weapon_left"));		player.var_89e9a4ce = var_89e9a4ce;
	...
	else
	{
		...
		var_89e9a4ce setmodel(level.var_30d2c56e[#"chakram"][#"throw_model"][player.var_72d6f15d]);		var_89e9a4ce show();
	}
...
private function function_3adb0798(e_target, n_kills)
{
	...
	{
		e_target = self;
		var_fc51fa3d = level.var_30d2c56e[#"chakram"][#"kill_limit"][self.var_72d6f15d];		var_ece935b3 = var_ece935b3 / 2;
	}
	while(true)
	{
		if(!isdefined(e_target))
...
private function function_481a494b(var_5f94a2e7)
{
	...
	{
		self clientfield::increment_to_player("" + #"chakram_rumble", 6);		a_e_targets = zm_hero_weapon::function_7c3681f7();
...
function function_b9142dab(var_b2e05bae)
{
	if(isalive(self) && var_b2e05bae)
	{
		switch(var_b2e05bae)
		{
			...
			case 2:
			{
				self clientfield::increment_to_player("" + #"chakram_rumble", 2);				break;
			}
			case 3:
			{
			...
			case 4:
			{
				self clientfield::increment_to_player("" + #"chakram_rumble", 4);				break;
			}
			case 5:
			{
				self clientfield::increment_to_player("" + #"chakram_rumble", 5);				break;
			}
		}
	}
}
