...
#namespace cschashed-3\script_2630b7cb2596f8e4;
...
function __init__()
{
	...
	cschashed-2\script_709bf7c56eb65adf::register_lethal_grenade_for_level(#"hash_10f614b278daaebc");
}
...
{
	e_grenade endon_callback(&function_5e056d93, #"death");
...
*/
private function function_45eb4c80()
{
	self endon(#"death");
	self.var_8ea10940 = 1;
	switch(self.var_6f84b820)
...
function grenade_stolen_by_sam(e_grenade)
{
	...
	e_grenade.mdl_anchor waittill_timeout(5, #"movedone");
...
{
	self endon_callback(&function_5e056d93, #"death");
	self waittill_timeout(15, #"hash_90cfd38343f41f2");
...
function function_4d71ac38(str_alias, var_f2aa64f7 = 0)
{
	if(var_f2aa64f7)
	{
		self.mdl_anchor namespace_891c9bac::function_57b8cd17();
	}
	if(self depthinwater() < 6)
	{
		self.mdl_anchor namespace_891c9bac::function_8e0f4696(str_alias, undefined, undefined, undefined, 1, undefined, 1);
	}
}
