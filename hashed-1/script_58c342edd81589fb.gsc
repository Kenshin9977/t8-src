...
/*
	...
	Flags: Linked
*/
function function_b4a8f95a(var_616b394b, n_round, func_start, var_fa073075, var_124f39da, var_84f505b1, b_ignore_cleanup = 1)
{
	function_bc9fd0f8(n_round);
	...
	else if(!isdefined(var_616b394b))
	{
		var_616b394b = [];
	}
...
function function_f6cd912d(var_ef21400 = 0)
{
	if(isdefined(level.var_45827161))
	{
		...
		if(isdefined(var_af83ca3))
		{
			...
			var_bd87e810 = {#archetypes:(isdefined(var_a630f8a4.var_d7d3cd31) ? var_a630f8a4.var_d7d3cd31 : var_a630f8a4.var_a51dd114), #n_round:var_af83ca3};
...
/*
	...
	Flags: Linked
*/
function register_archetype(str_archetype, var_c48a6bb7, var_e48ad2cd, var_9a8e4fdb, var_376db024)
{
...
*/
private autoexec function function_557db8fd()
{
	classes.var_557db8fd[0] = spawnstruct();
	classes.var_557db8fd[0].__vtable[913321084] = &namespace_557db8fd::__destructor;
	classes.var_557db8fd[0].__vtable[674154906] = &namespace_557db8fd::__constructor;
}
...
/*
	...
	Flags: AutoExec, Private, 128
*/
private autoexec function function_2517dc3b()
{
	classes.var_2517dc3b[0] = spawnstruct();
	classes.var_2517dc3b[0].__vtable[913321084] = &namespace_2517dc3b::__destructor;
	classes.var_2517dc3b[0].__vtable[674154906] = &namespace_2517dc3b::__constructor;
}
...
*/
private function function_3d5b3f85(str_archetype)
{
	...
	/#
		var_e5aaf7f4 = {#hash_25a548fa:0, #n_spawn:var_31b155cf, #str_archetype:str_archetype};
...
/*
	...
	Flags: Linked, Private
*/
private function function_12b8d86()
{
	var_6c6d9742 = 0;
	if(isdefined(level.var_ff78f6de))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_20956f95()
{
	if(isdefined(level.var_b45615aa))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_adc96c10(str_archetype, n_round)
{
...
function function_191ae5ec()
{
	...
	if(isdefined(level.var_45827161) && isdefined(level.var_45827161[level.round_number]))
	{
		...
		if(cschashed-3\script_12282e6b2cc91b42::function_928e94b9(level.var_45827161[level.round_number].var_d7d3cd31))
		{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f3635804()
{
...
function function_6e064f4c(str_archetype)
{
	...
	else if(isinarray(array(#"hash_50f4e0eea9f4e4a4", #"skeleton", #"nova_crawler", #"tiger", #"hash_1bab8a0ba811401e", #"hash_78ca8e8e6bdbc8ab", #"hash_266b62e342076a90", #"hash_5cfa99582cc66c59", #"hash_5d6b55906fc82ff2"), hash(str_archetype)))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_bb169fc9(var_a630f8a4)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_979b03db(var_a630f8a4)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_926c3119(var_a630f8a4)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_44298b05()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_b72a438d()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_f5600e93()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_a845f70f(n_points, var_fadd1539)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_d7864087(var_dbce0c44)
{
	var_c766fbe6 = [];
	...
	for(i = 0; i < 4; i++)
	{
		...
		if(isdefined(var_fe695913[i]) && var_fe695913[i].size)
		{
			...
			foreach(str_archetype in var_fe695913[i])
			{
				...
				/#
					var_e5aaf7f4 = {#hash_25a548fa:0, #n_spawn:n_spawn, #str_archetype:str_archetype};
...
/*
	...
	Flags: Linked, Private
*/
private function function_3cfb36aa(var_75b393f9, var_dbce0c44)
{
	/#
...
/*
	...
	Flags: Linked, Private
*/
private function function_24ccde2(var_fe695913, var_a9facc6)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_9eefccc1(var_148cc603, str_archetype)
{
	if(isinarray(array(#"blight_father", #"brutus", #"gegenees"), hash(str_archetype)))
	{
		var_148cc603 = var_148cc603 * (isdefined(level.var_928a4995) ? level.var_928a4995 : 1);
...
/*
	...
	Flags: Linked, Private
*/
private function function_f2bdfd5a(str_archetype, var_376db024)
{
	if(isinarray(array(#"blight_father", #"brutus", #"gegenees"), hash(str_archetype)))
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_6eba74f3()
{
	level.var_65e3ac8a++;
...
/*
	...
	Flags: Linked, Private
*/
private function function_bc9fd0f8(n_round)
{
	if(!isdefined(level.var_865ea9f))
	{
		level.var_865ea9f = [];
	...
	/#
		...
		while(true)
		{
			...
			switch(str_command)
			{
				...
				case "hash_bca8c8423767010":
				{
					level.var_465f07b = !level.var_465f07b;
					break;
				}
				case "hash_badd57d27fc7652":
				{
...
/*
	...
	Flags: Private
*/
private function function_fc42d325()
{
	/#
		while(true)
		{
			...
			if(level.var_48babc04)
			{
				...
				foreach(var_1c924c4c in level.var_a06c0ea0)
				{
					var_a630f8a4 = level.var_f5db924c[n_special_round];
					str_text = "" + n_special_round + "";
					if(level flag::get(#"disable_special_rounds") || (isdefined(var_a630f8a4.var_77104def) && var_a630f8a4.b_skipped))
					{
						str_color = (1, 0, 0);
					}
					...
					if(isdefined(var_a630f8a4.var_77104def) && var_a630f8a4.b_skipped)
					{
						str_text = str_text + "";
					}
					debug2dtext((510, var_c708e6e1, 0), str_text, str_color, 1, (0, 0, 0), 0.8, 1, 2);
			...
			if(level.var_465f07b)
			{
				...
				{
					var_a17bf02f = 0;
					foreach(var_e6e359d1 in level.var_d112f81e)
					{
