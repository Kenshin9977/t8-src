...
#namespace cschashed-2\script_711bbbba637da80;
...
function function_307fdd13(var_a276c861)
{
	if(var_a276c861)
	{
		...
		foreach(var_1f5391d1 in var_328baab5)
		{
			...
			level thread cschashed-2\script_28d5e820ed15e2a7::function_e998f810("tag_socket_a");
			level thread cschashed-2\script_28d5e820ed15e2a7::function_e998f810("tag_socket_c");
			level thread cschashed-2\script_28d5e820ed15e2a7::function_e998f810("tag_socket_d");
			level thread cschashed-2\script_28d5e820ed15e2a7::function_e998f810("tag_socket_e");
			level thread cschashed-2\script_28d5e820ed15e2a7::function_e998f810("tag_socket_g");
...
private function function_486ef0f6()
{
	...
	while(level.var_85cc9fcc.size > 0)
	{
		if(!(isdefined(level.var_d486e9c4) && level.var_d486e9c4))
		{
			if(var_a9b19429)
			{
				level.var_bbc27d0e thread cschashed-2\script_28d5e820ed15e2a7::function_9e723e9(3, 1);
			}
		...
		if(!(isdefined(level.var_d486e9c4) && level.var_d486e9c4))
		{
			...
			while(true)
			{
				...
				if(s_result.var_d46a1171 == var_4894fd91)
				{
		...
		var_aa11c23c thread cschashed-2\script_28d5e820ed15e2a7::function_9e723e9();
		...
		if(!(isdefined(level.var_d486e9c4) && level.var_d486e9c4))
		{
			...
			s_result = undefined;
			s_result = var_aa11c23c waittill(#"hash_1726927392797d97", #"hash_6fd7f8e1f00deffe");
			if(s_result._notify == #"hash_1726927392797d97")
			{
	...
	level.var_bbc27d0e thread cschashed-2\script_28d5e820ed15e2a7::function_9e723e9();
...
private function function_23fa3cae()
{
	...
	while(!cschashed-3\script_675455e5e6c0c5ad::function_aac7105a(var_8171dd3a, var_8dfff656, var_44e1e41b))
	{
		var_8171dd3a = randomint(10);
		var_8dfff656 = randomint(10);
		var_44e1e41b = randomint(10);
...
private function function_bb47b90d(var_dcd55ef2)
{
	...
	while(true)
	{
		...
		800_stomach_ = n_dist / 45;
		self moveto(s_next_pos.origin, 800_stomach_);
		self rotateto(s_next_pos.angles, 800_stomach_);
		wait(800_stomach_);
...
private function function_c3923440()
{
	...
	if(!isdefined(level.var_558993a0) || s_result.var_84200bb4 !== level.var_558993a0)
	{
...
private function function_2b37242f()
{
	...
	if(!(isdefined(namespace_e0710ee6::function_2d29434e(level.var_7b71cdb7)) && cschashed-1\script_5a012bbb9342dbdf::function_2d29434e(level.var_7b71cdb7)))
	{
		cschashed-1\script_5a012bbb9342dbdf::function_8de1b5b9(level.var_7b71cdb7);
	}
	...
	if(isdefined(level.var_7b71cdb7))
	{
		if(isdefined(namespace_e0710ee6::function_2d29434e(level.var_7b71cdb7)) && cschashed-1\script_5a012bbb9342dbdf::function_2d29434e(level.var_7b71cdb7))
		{
			cschashed-1\script_5a012bbb9342dbdf::function_901eccf2(level.var_7b71cdb7);
		}
...
private function function_b88f57f9()
{
	...
	if(level.brutus_count + 1 <= level.brutus_max_count)
	{
		...
		if(isalive(ai_brutus))
		{
			...
			ai_brutus cschashed-2\script_20bca15cf8b82d6b::brutus_spawn(undefined, undefined, undefined, undefined, undefined);
...
private function function_6c1f6b4e()
{
	...
	s_result = undefined;
	s_result = level waittill(#"hash_4e2f6e88e9985f10");
	if(!isdefined(level.var_7b71cdb7) || s_result.var_84200bb4 !== level.var_7b71cdb7)
	{
		self notify(#"hash_300e9fed7925cd69", {#hash_d0af61fc:1, #b_success:0});
	}
...
private function function_cdc8090a()
{
	...
	s_result = undefined;
	s_result = self waittill_timeout(6, #"hash_754ca63bdd999035");
...
{
	e_ghost endon(#"death", #"ghost_seen");	self endon(#"disconnect");
	wait(1.6);
	while(true)
	{
...
private function function_d2bf4eeb()
{
	...
	s_result = undefined;
	s_result = level waittill(#"hash_4e2f6e88e9985f10");
	if(!isdefined(level.var_acc853e7) || s_result.var_84200bb4 !== level.var_acc853e7)
	{
		self notify(#"hash_300e9fed7925cd69", {#hash_d0af61fc:1, #b_success:0});
	}
...
private function function_b80b6749()
{
	...
	if(s_result._notify == #"hash_4636f041ae52f0fa" || !isalive(level.var_9d950ce5.var_64c09f7f))
	{
...
private function function_33701563()
{
	...
	while(true)
	{
		...
		s_result = undefined;
		s_result = self waittill_timeout(var_d61ccd7e, #"hash_4636f041ae52f0fa", #"hash_7953672ffc47be3");
...
private function function_6bb299fa()
{
	...
	while(level.var_b1060d52 < var_202d423f)
	{
		...
		if(var_6f89c2f6 != var_9cdf5d68 && n_blood < 9)
		{
			if(isdefined(level.var_4dad7caf))
			{
...
/*
	...
	Flags: Linked, Private
*/
private function function_580723de(b_shown = 1, e_player)
{
	self endon(#"death", #"hash_60f9171b687c9d06", #"hash_4636f041ae52f0fa", #"hash_300e9fed7925cd69");
	if(b_shown)
	{
...
private function function_c11e25eb()
{
	...
	s_result = undefined;
	s_result = self waittill(#"hash_75c79817bd1107aa");
...
private function function_eab368cb(s_interact)
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator))
		{
			s_interact.var_64c09f7f = s_result.activator;
			break;
		}
	}
...
private function function_dc164d78()
{
	...
	while(var_56eace20 <= level.var_6ab72806)
	{
		...
		s_result = undefined;
		s_result = self waittill_timeout(30, #"hash_34486fb413da1672");
		foreach(var_7b2c16b1 in level.var_f7febee4)
		{
			var_7b2c16b1.t_interact setinvisibletoall();
		}
...
private function function_81650808(var_aa11c23c, var_56eace20)
{
	...
	while(level.var_89231fe9 < var_56eace20)
	{
		...
		{
			var_aa11c23c notify(#"hash_34486fb413da1672", {#e_player:s_result.activator, #b_success:0});
		}
		level.var_89231fe9++;
	}
	var_aa11c23c notify(#"hash_34486fb413da1672", {#e_player:s_result.activator, #b_success:1});
}
...
private function function_1fb1907c()
{
	...
	self notify(#"hash_75c79817bd1107aa", {#activator:s_result.activator});
}
...
private function function_ac1d7a0e(var_5b9ba5a5, e_player)
{
	...
	e_richtofen = cschashed-2\script_28d5e820ed15e2a7::function_b1203924();
	var_2c5c52cb = e_player cschashed-1\script_2c454d63a96d2d0b::function_d35e4c92() - 5;
	switch(var_5b9ba5a5)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e128a8d4(b_immune = 1)
{
	if(!b_immune)
	{
...
private function function_768e71d5()
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator))
		{
			...
			self.var_64c09f7f = s_result.activator;
...
private function function_cd0d0123(var_498d47f7, str_exploder)
{
	...
	{
		var_71e6f067.mdl_collision = util::spawn_model("collision_player_wall_128x128x10", var_71e6f067.origin + var_d3c21d73, s_firewall.angles);
...
private function function_b952c1b(var_4bdd091b, str_tag = "j_spinelower")
{
	...
	while(n_dist_sq > 576 && isalive(var_4bdd091b))
	{
		...
		if(isalive(var_4bdd091b))
		{
			n_current_time = gettime();
			n_total_time = n_current_time - n_start_time / 1000;
			n_move_time = var_4bdd091b cschashed-1\script_6a0e50bc15d725a9::function_f40aa0ef(var_88f24b00, n_total_time);
			if(n_move_time == 0)
			{
				break;
			}
...
/*
	...
	Flags: Linked, Private
*/
private function function_ff88f6aa(v_teleport_position)
{
...
private function function_9b1d9d6a()
{
	...
	if(var_2287bf7c.size > 0)
	{
		...
		foreach(e_player in var_2287bf7c)
		{
			...
			{
				str_alias = #"hash_2240a0ede7e89d42" + e_player cschashed-1\script_2c454d63a96d2d0b::function_d35e4c92();
