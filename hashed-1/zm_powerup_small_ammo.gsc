...
function function_ae7afb91(player)
{
	...
	player notify(#"zmb_small_ammo");	player zm_placeable_mine::disable_all_prompts_for_player();
	foreach(w_weapon in a_w_weapons)
	{
		if(zm_loadout::is_lethal_grenade(w_weapon) || cschashed-2\script_709bf7c56eb65adf::is_offhand_weapon(w_weapon))
		{
			continue;
		}
