...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"acquire_weapon", &function_d1de6a85, &function_9e7b3f4d);}
...
private function function_d1de6a85(weapon_name, var_eaa7f0ba, var_957937ee, var_9c56c5a9, var_b896fe29)
{
	...
	{
		self.var_eaa7f0ba = cschashed-1\script_3c362258ff800237::function_5769f26a(var_eaa7f0ba);
	}
	...
	if(!round_reset)
	{
		...
		if(isdefined(self.var_eaa7f0ba) && self.var_eaa7f0ba)
		{
			if(var_57807cdc.size == getplayers().size)
			{
				...
				{
					cschashed-1\script_3c362258ff800237::fail(#"hash_753fe45bee19e131", var_57807cdc);
				}
				else
				{
					cschashed-1\script_3c362258ff800237::fail(#"hash_3539a53b7cf9ea2", var_57807cdc);
				}
			}
		}
...
private function function_fa5e5e08()
{
	...
	var_629c4c4a = 0;
	cschashed-1\script_3d5821d793ed4c6::function_7d32b7d0(0);
	while(true)
	{
		var_5cb7ddf1 = 0;
		foreach(player in getplayers())
