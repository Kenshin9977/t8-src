...
#namespace cschashed-2\script_673ffe64518b7ffb;
...
function function_84f1c310()
{
	...
	if(namespace_59ff1d6c::function_901b751c(#"zmpowerstate") == 1 && cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_29004a67830922b6") != 2)
	{
		...
		level.var_2ea46461 setmodel(#"hash_15a86c6d9bd77dbb");
		if(function_8b1a219a())
		{
			var_40762d8a sethintstring(#"hash_6c7c18e3ce28c91b");
		}
	...
	else if(namespace_59ff1d6c::function_901b751c("zmPowerState") == 2 || cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_29004a67830922b6") == 2)
	{
		var_40762d8a sethintstring(#"");
		var_325be437 sethintstring(#"");
...
function function_7b6777c5(t_spawner)
{
	...
	{
		var_54d9911f = strtok(var_564f954b.var_945ce5e, " ");
	...
	foreach(var_adad907f in var_d72fffcc)
	{
		...
		if(isdefined(level.var_a2831281) && level.var_a2831281)
		{
			...
			e_enemy cschashed-2\script_20bca15cf8b82d6b::brutus_spawn(250, 0);
			continue;
		}
		if(isdefined(level.var_2b94ce72) && level.var_2b94ce72)
		{
			...
			e_enemy thread namespace_54386dac::function_7273c33d(s_enemy_spawn);
		...
		if(var_adad907f.script_noteworthy == "spawn_location" && (!(isdefined(level.var_a2831281) && level.var_a2831281)) && (!(isdefined(level.var_2b94ce72) && level.var_2b94ce72)))
		{
			...
			e_enemy thread namespace_54386dac::function_24d3ec02("catwalk_event_zombie", 1);
			continue;
		}
...
function function_17ccf041()
{
	...
	while(true)
	{
		...
		while(namespace_54386dac::function_28d0cf11("catwalk_event_zombie") && !level.var_20cff6f0)
		{
...
function function_7ab912f2(s_loc)
{
	...
	#/
	self cschashed-1\script_5fb8da2731850d9e::zombie_setup_attack_properties_dog();
...
function function_bbc07822(a_ents)
{
	...
	if(level.brutus_count > 0)
	{
		...
		if(var_f1404f73 != var_de86a1af)
		{
			level thread namespace_54386dac::function_37aed203(var_f1404f73);
			level.var_43bca751 = 1;
		}
	}
	var_de86a1af.ignore_nuke = 1;
	var_de86a1af.b_ignore_cleanup = 1;
	if(isdefined(a_ents[#"brutus"].var_972a4b46))
	{
		a_ents[#"brutus"].var_972a4b46 delete();
	}
	var_de86a1af thread function_d0392daf();
}
...
function function_e7c9f15b(a_ents)
{
	...
	var_4bdae8cd thread scene::play("Main & Idle Loop Out");
	var_de86a1af = a_ents[#"brutus"];
	playsoundatposition(#"hash_66ef8de59c96e8d1", var_de86a1af gettagorigin("tag_eye"));
	var_de86a1af waittill(#"start_teleport");
	level thread function_21ccdb36();
	var_de86a1af waittill(#"teleport");
	var_de86a1af hide();
}
...
function play_brutus_scene_done(a_ents)
{
	...
	if(isdefined(level.var_43bca751) && level.var_43bca751 && !zm_utility::is_standard())
	{
		...
		{
			cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_catwalk_04");
		}
		else if(level.zones[#"zone_catwalk_03"].is_active)
		{
			cschashed-2\script_20bca15cf8b82d6b::attempt_brutus_spawn(1, "zone_catwalk_03");
		}
		else
		{
...
function function_993f4add()
{
	...
	if(s_result._notify == "death")
	{
		if(isdefined(self))
		{
			level thread cschashed-1\script_5fb8da2731850d9e::dog_explode_fx(self, self.origin);
		}
		level.var_43bca751 = 1;
	}
}
...
function function_e11ac4f5()
{
	...
	if(!level.dog_rounds_enabled)
	{
		...
		level thread cschashed-1\script_5fb8da2731850d9e::function_aec3446d(1);
	}
	if(isdefined(level.var_2ea46461))
	{
		level.var_2ea46461 delete();
