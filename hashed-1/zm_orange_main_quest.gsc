...
#namespace cschashed-3\script_f459be361894751;
...
function main()
{
	...
	function_f415e4d5();
	function_5c189332();
	var_15ed0976 = getentarray("t_pap_rock_damage", "targetname");
	level.t_pap_rock_damage = array::random(var_15ed0976);
	arrayremovevalue(var_15ed0976, level.t_pap_rock_damage);
	foreach(t_pap_rock_damage in var_15ed0976)
	{
	...
	namespace_ee206246::register(#"hash_5e9262eb6796af0a", #"step_1", #"hash_57c2f2030917f2e4", &function_f279da41, &function_45f8440b);
	namespace_ee206246::register(#"hash_5e9262eb6796af0a", #"step_2", #"hash_57c2f5030917f7fd", &function_b70e1954, &function_21b093ce);
	zm_sq::start(#"hash_5e9262eb6796af0a", !zm_utility::is_standard());
	namespace_85e029d3::function_f6ecebca(11, #"hash_1e1bf447950e7c92", #"hash_611a8728e3043a26", &function_f001370f);
...
*/
private function function_88228c58()
{
...
function function_56db9cdc()
{
	...
	while(true)
	{
		...
		function_1556161f();
		cschashed-3\script_31055dfc068c1e62::function_da304f6e(2);
		...
		else if(level.var_7d8bf93f == level.var_9d121dce)
		{
			...
			s_notify = undefined;
			s_notify = level waittill_timeout(120, #"hash_39b6629ce957cce9");
			if(level flag::get(#"hash_2923f30473421396"))
			{
				level waittill(#"hash_355e5e0bbf3760db");
			}
			if(isdefined(level.var_ab11c23d.var_729108f4) && level.var_ab11c23d.b_blue)
			{
		...
		{
			s_notify = undefined;
			s_notify = level waittill_timeout(180, #"hash_39b6629ce957cce9");
		...
		cschashed-3\script_31055dfc068c1e62::function_da304f6e(0);
		if(s_notify._notify !== #"hash_39b6629ce957cce9")
		{
			level waittill_timeout(30, #"hash_39b6629ce957cce9");
		}
	}
}
	...
	if(level flag::get(#"hash_5a3d0402a5557739") || var_35c3faab)
	{
		...
		if(b_show)
		{
			...
			if(level flag::get(#"hash_4898001eb77cb16f"))
			{
				...
				self cschashed-1\script_6fdaa897ed596805::function_3177f73c();
			}
		}
		else
		{
...
function function_ec4984c3()
{
	...
	level waittill_timeout(120, #"hash_7646638df88a3656");
	...
	namespace_17555f14::function_3b77181c(0);
	...
	while(true)
	{
		if(level.zones[#"ice_floe"].is_enabled === 0)
		{
			foreach(e_player in getplayers())
			{
				...
				{
					e_player cschashed-1\script_1edaf4333ed0bece::fling_player(level.var_f7c50c66);
				}
			}
		}
		wait(1);
...
function apc_restart_retreat()
{
	...
	level thread namespace_3263198e::function_fd24e47f(#"hash_84fa084a2617bf4", -1, 0, 1);
}
...
function function_21b093ce(var_5ea5c94d, ended_early)
{
	...
	if(level.var_98138d6b > 0)
	{
		...
		cschashed-3\script_31055dfc068c1e62::function_1f29d511();
	}
	var_e29c5f3b = function_21a3a673(0, 2);
...
function function_feee6e66()
{
	...
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_pap_rock", 1);
	self playsound(#"hash_5c0903506e9a705a");
	if(level flag::get(#"hash_641f14d0b2fd57d7"))
	{
		var_adea2587.e_who thread namespace_3263198e::function_51b752a9(#"hash_1558be2f4ebc39b5");
	}
	else
	{
		var_adea2587.e_who thread namespace_3263198e::function_51b752a9(#"hash_7e030fccc2c5a121");
	}
	level flag::set(#"hash_3310bb35ce396e49");
}
...
{
	level flag::set(#"hash_5a3d0402a5557739");
	cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60("zm_orange_pap_rock", 0);
}
...
function function_5535522e()
{
	...
	while(true)
	{
		...
		s_result.e_player thread namespace_3263198e::function_51b752a9("vox_golden_pap_weapon");
	}
}
