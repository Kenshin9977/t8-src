...
#namespace cschashed-3\script_65206f3a5652e056;
...
function __init__()
{
	...
	{
		function_27473e44();
		cschashed-3\script_d67878983e3d7c::function_9d45c058(#"hash_773d5ce33dd7cde9", 1, 6);
	}
}
...
function function_c1c51837(e_player)
{
	...
	self cschashed-3\script_d67878983e3d7c::burn(#"hash_773d5ce33dd7cde9", e_player, undefined, undefined);
	self.var_b364c165 = 1;
...
function function_7d72c6f9(var_85dcb56c)
{
	...
	while(true)
	{
		...
		var_c2093736 = 1 - self.var_d675d730.var_471d9402 / var_85dcb56c;
...
private function function_69153101()
{
	...
	if(cschashed-3\script_45657e86e8f90414::is_active())
	{
		return 0;
	}
