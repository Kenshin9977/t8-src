...
{
	if(meansofdeath === "MOD_MELEE" && !namespace_25f0796c::is_active() && !cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon) && weapon != level.weaponnone)
	{
...
{
	if(smeansofdeath === "MOD_MELEE" && !cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(weapon))
	{
