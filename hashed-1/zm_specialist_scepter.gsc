...
#namespace cschashed-3\script_4321c2f1193f3097;
...
function __init__()
{
	...
	clientfield::register("toplayer", "" + #"scepter_rumble", 1, 3, "counter");	level.hero_weapon[#"scepter"][0] = getweapon(#"hash_50f35e4cfb775e02");
	level.hero_weapon[#"scepter"][1] = getweapon(#"hash_50f35d4cfb775c4f");
	level.hero_weapon[#"scepter"][2] = getweapon(#"hash_50f35c4cfb775a9c");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_50f35e4cfb775e02");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_50f35d4cfb775c4f");
	cschashed-2\script_709bf7c56eb65adf::register_hero_weapon_for_level(#"hash_50f35c4cfb775a9c");
	...
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_6c580993aa401a5b", 0.6, 3);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_449bc314b0c3da73", 0.4, 3);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_6c580f93aa40248d", 0.6, 5);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_1cc2b03094ad09bd", 0.4, 5);
	cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_59b633ea4aeff841", 0.6, 0.5);
	if(!isdefined(level.var_cfeea502))
	{
		object = new throttle();
		[[ object ]]->__constructor();
		level.var_cfeea502 = object;
...
*/
private function function_63e57124()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_304a3c9b(var_c34665fc)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_4521ac7e(var_f2a06582, n_lvl)
{
	self endon_callback(&function_304a3c9b, #"hash_219c7081783c2153", #"player_downed", #"disconnect", #"hero_weapon_power_off");
	while(true)
	{
		s_result = undefined;
...
/*
	...
	Flags: Linked, Private
*/
private function function_4493c71b(weapon, n_lvl = 1)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_eae0296b(var_65b6e624, b_postfx = 0)
{
	if(b_postfx)
	{
...
/*
	...
	Flags: Linked, Private
*/
private function function_89fc5431()
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_e874c3e1(weapon)
{
...
/*
	...
	Flags: Linked, Private
*/
private function function_b67b2aff(e_target, n_damage, v_target_pos, w_hero, b_launched = 0, var_9a119ceb = 0)
{
	e_target endon(#"death");
	self endon(#"disconnect");
	if(!var_9a119ceb)
...
function function_1f6199f0(e_reviver)
{
	...
	else
	{
		...
		if(self.health < self.var_66cb03ad)
		{
			...
			self.health = math::clamp(var_88df2b99, 1, self.var_66cb03ad);
...
function function_97429d68(n_time = 5)
{
	...
	if(n_time == 5)
	{
		...
		{
			self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_1cc2b03094ad09bd");
		}
		else
		{
			self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_6c580f93aa40248d");
		}
	}
	else if(self.var_6f84b820 === #"heavy" || self.var_6f84b820 === #"miniboss")
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_449bc314b0c3da73");
	}
	else
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_6c580993aa401a5b");
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_717a1af2()
{
	self endon(#"bled_out", #"death", #"beacon_expired");	var_a23636f4 = getweapon(#"hash_50f35c4cfb775a9c");
	...
	while(var_be17187b.weapon != var_a23636f4);
	if(isdefined(self.var_165b5fce))
	{
		self gadgetpowerset(self gadgetgetslot(var_a23636f4), self.var_165b5fce);
		self.saved_spike_power = undefined;
	}
	else
	{
		self gadgetpowerset(self gadgetgetslot(var_a23636f4), 100);
	}
...
function weapon_drop_watcher()
{
	...
	while(true)
	{
		...
		if(cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(var_be17187b.w_current))
		{
...
function weapon_change_watcher()
{
	...
	while(true)
	{
		...
		if(isdefined(var_be17187b.w_previous) && cschashed-2\script_709bf7c56eb65adf::is_hero_weapon(var_be17187b.w_current))
		{
...
{
	self endon(#"disconnect");
	var_a23636f4 = getweapon(#"hash_50f35c4cfb775a9c");
	if(isdefined(self.var_8a5094fe) && self.var_8a5094fe)
	{
		util::wait_network_frame();
		self zm_weapons::weapon_give(var_a23636f4, 0, 1);
		self function_1728db6f(2);
	}
	self waittill(#"bled_out");
	if(self hasweapon(var_a23636f4))
	{
		self.var_8a5094fe = 1;
		self.var_3d89e839 = self gadgetpowerget(self gadgetgetslot(var_a23636f4));
		if(self.var_3d89e839 >= 100)
		{
			self.var_3d89e839 = undefined;
		}
		self.var_4831c9c9[#"hash_50f35c4cfb775a9c"] = self getweaponammoclip(var_a23636f4);
	}
...
/*
	...
	Flags: Linked
*/
function function_b603ab34(var_a23636f4)
{
	self endon_callback(&function_d14a3750, #"disconnect");
	...
	self thread zm_hero_weapon::function_4e984e83(var_a23636f4, 0.13);
	self thread function_4b4861a(var_a23636f4, var_4eaa1f4c);
	self.var_6d772cb = self.var_6afa034c;
	self.var_d6fe2916 = 1;
	var_1c136516 = self gadgetpowerget(level.var_a53a05b5);
	if(var_1c136516 > 5)
	{
		self thread function_d3dc001e(var_a23636f4);
		zm_utility::function_3e549e65();
		self waittill(#"hash_30d5ffa4b141582f", #"hash_43074b8aec1899da", #"death", #"hash_2b69105d9436130a");
		zm_utility::function_b7e5029f();
	}
	if(isdefined(self))
	{
		self thread function_f168b337();
		self notify(#"beacon_retrieved");		self ability_player::function_f2250880(var_a23636f4);
...
{
	self endon_callback(&function_e7e5d6f5, #"beacon_retrieved", #"death");	self.var_80612bea = 1;
	while(true)
	{
	...
	self notify(#"beacon_off");	self.var_80612bea = 0;
}
...
{
	self endon(#"disconnect", #"beacon_fx_off");	while(isdefined(self.var_6afa034c))
	{
...
function function_f168b337()
{
	...
	self notify(#"beacon_fx_off");	self function_1728db6f(4);
...
/*
	...
	Flags: Linked
*/
function function_4b4861a(var_a23636f4, var_4eaa1f4c)
{
	self endon(#"beacon_retrieved", #"death", #"bled_out", #"disconnect");	while(true)
	{
		slot = self gadgetgetslot(var_a23636f4);
...
function function_15c2525e(var_a7e57ef9, n_loop_time)
{
	...
	foreach(zombie in a_ai_zombies)
	{
		zombie function_9a25ee43(self, var_a7e57ef9, n_loop_time);
		n_count++;
		if(n_count == 4)
		{
			waitframe(1);
...
/*
	...
	Flags: Linked
*/
function function_9a25ee43(e_player, var_a7e57ef9, n_loop_time)
{
	e_player endon(#"beacon_retrieved", #"bled_out", #"death", #"disconnect");	if(isalive(self) && isdefined(self.var_6f84b820))
	{
...
/*
	...
	Flags: Linked
*/
function function_3024daa2(var_b2e05bae)
{
	if(var_b2e05bae)
	{
		switch(var_b2e05bae)
		{
			...
			case 2:
			{
				self clientfield::increment_to_player("" + #"scepter_rumble", 2);				break;
			}
			case 3:
			{
			...
			case 5:
			{
				self clientfield::increment_to_player("" + #"scepter_rumble", 5);				break;
			}
			case 6:
			{
				self clientfield::increment_to_player("" + #"scepter_rumble", 6);				break;
			}
		}
	}
}
