...
#namespace cschashed-3\script_747490fcd061d1b7;
...
function __init__()
{
	...
	{
		function_37c0d395();
		cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_5d9e1ae933ad6f87", 0.7, 3);
		cschashed-3\script_d67878983e3d7c::register_slowdown(#"hash_63a208b609d3fa87", 0.8, 3);
	}
}
...
function shell_explosion(e_attacker, w_weapon)
{
	...
	self clientfield::increment("" + #"zombshell_explosion");	if(!isdefined(e_attacker.var_c153f587))
	{
...
function function_a8e6f773(n_time = 3)
{
	...
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_63a208b609d3fa87");
	}
	else
	{
		self thread cschashed-3\script_d67878983e3d7c::slowdown(#"hash_5d9e1ae933ad6f87");
	}
	wait(n_time);
