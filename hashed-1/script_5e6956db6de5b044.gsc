...
#namespace cschashed-1\script_7ef002db7fb88ad0;
...
function function_5b8a557f()
{
	...
	while(true)
	{
		...
		if(isdefined(e_trap.var_23aecef0) && e_trap.var_23aecef0 || zm_utility::is_standard())
		{
			...
			{
				var_b5f26b1a = self zm_traps::function_3f0a4c65(e_player, e_trap.zombie_cost);
				if(!b_purchased)
				{
					continue;
				}
...
function function_7b170638(var_8163cc4, b_found)
{
	...
	if(isdefined(var_7a0a29e3))
	{
		if(b_found)
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(var_7a0a29e3, 1);
		}
		else
		{
			level cschashed-2\script_76b36ed1b7a51ed2::function_7df6bb60(var_7a0a29e3, 2);
		}
	}
}
...
function function_45a2294f(str_id)
{
	...
	var_628a2951 = zm_traps::function_da13db45(30, self);
	foreach(e_trap in level.var_ba53c5c5)
	{
		if(e_trap.script_string === str_id)
		{
...
function function_5ad19000(e_trap)
{
	...
	if(self.entity_type === #"hash_5cfa99582cc66c59" && e_trap flag::get(#"friendly") == 0)
	{
		return;
	}
	if(self.team === #"allies")
...
private function function_1eeda1e5()
{
	...
	self.var_a46d8eee = 1;
	n_character_index = cschashed-1\script_2c454d63a96d2d0b::function_d35e4c92();
	str_vo = "vox_generic_responses_positive_plr_" + n_character_index + "_" + randomint(9);
	self thread namespace_891c9bac::function_8e0f4696(str_vo, 0, 1, 9999);
}
...
function blue_fire()
{
	self thread cschashed-2\script_21b99e2f421608bf::function_40e665ab();
