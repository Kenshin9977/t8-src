...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge(#"hash_b7f913776f85df2", &function_d1de6a85, &function_9e7b3f4d);
}
...
{
	level.var_2e5ed433 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_2e5ed433) * 1000;
	if(isdefined(var_1532dab3))
	{
		var_1532dab3 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_1532dab3);
	}
	if(isdefined(var_94d24883))
	{
		var_94d24883 = cschashed-1\script_3c362258ff800237::function_5769f26a(var_94d24883);
	}
	foreach(player in getplayers())
	{
		player thread function_3daaa777(var_1532dab3, var_94d24883);
	}
}
...
function is_active()
{
	challenge = cschashed-1\script_3c362258ff800237::function_a36e8c38(#"hash_b7f913776f85df2");
...
/*
	...
	Flags: Private
*/
private function function_3daaa777(var_1532dab3 = 1, var_94d24883 = 0.9)
{
