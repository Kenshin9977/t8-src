...
function __init__()
{
	...
	cschashed-1\script_3c362258ff800237::register_challenge("nukerun", &function_d1de6a85, &function_9e7b3f4d);
}
...
private function function_33f0ddd3(s_event)
{
	...
	{
		if(!cschashed-2\script_709bf7c56eb65adf::function_2ff6913(s_event.weapon))
		{
