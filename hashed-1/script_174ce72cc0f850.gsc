...
{
	cschashed-2\script_624a704d0f6bf28d::function_d8383812(id, var_948bda55, script_noteworthy, &function_8598f0d4, &function_3bdbb583, 1);
	s_sc = struct::get(script_noteworthy, "script_noteworthy");
	var_3b901e6a.var_f929d531 = getent(s_sc.player_area, "targetname");
	var_3b901e6a.var_f929d531.id = id;
...
function start(id)
{
	...
	{
		var_3b901e6a = level.var_345df07[id];
		var_3b901e6a.var_7944be4a = 0;
		exploder::exploder(s_sc.fx_exp);
		cschashed-2\script_624a704d0f6bf28d::function_3f808d3d(id);
		var_3b901e6a.var_f929d531 thread function_fab8c488();
	}
}
...
function end(id)
{
	if(level.var_d2540500[id].active === 1)
	{
		...
		cschashed-2\script_624a704d0f6bf28d::function_2a94055d(id);
		var_3b901e6a.var_f929d531 notify(#"hash_63acd5ff4da933c5");
	}
}
...
private function function_fab8c488()
{
	...
	while(self cschashed-3\script_e2bef0652b31f68::function_b8a27acc())
	{
		wait(0.1);
	}
