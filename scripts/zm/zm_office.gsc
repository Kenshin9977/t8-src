...
event main(eventstruct)
{
	...
	level.pack_a_punch.custom_power_think = &cschashed-2\script_356ad5dd4af06a33::function_9b917fd5;
	...
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"zmenhancedstate") == 2)
	{
		level flag::set(#"hash_2a1fc2e349c48462");
	}
	level.var_b5c27895 = &function_b5c27895;
...
function wait_for_power()
{
	...
	level thread cschashed-2\script_356ad5dd4af06a33::teleporter_init();
	level flag::wait_till("power_on");
	level thread cschashed-2\script_356ad5dd4af06a33::function_ea199c46();
...
function function_4a3d7c9e(trigger)
{
	while(true)
	{
		...
		if(!(isdefined(e_player.var_4eee81de) && e_player.var_4eee81de))
		{
			...
			trigger playsound(#"evt_metal_detector");			e_player thread function_f9229e0c(trigger);
			wait(2);
		}
	}
}
...
/*
	...
	Flags: Linked
*/
function function_b5c27895(e_player)
{
		...
		while(true)
		{
			...
			switch(str_command)
			{
				...
				case "enable_ww_crate":				{
					level.var_c3970355 namespace_d8d92c8b::function_68f68bb4();
					break;
				}
			}
