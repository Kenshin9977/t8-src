...
private function function_c2e519e0()
{
	if(isdefined(self.var_7d0afffb))
	{
		for(i = 0; i < 4; i++)
		{
			...
			{
				self cschashed-1\script_3d4e88c949caf53e::function_7b91e81c(i, level.bgb[self.var_7d0afffb[i]].item_index);
			}
		}
		return;
	}
	...
	for(i = 0; i < 4; i++)
	{
		...
		if(cschashed-3\script_12282e6b2cc91b42::function_3ac936c6(var_4c47dfdb))
		{
		...
		{
			self thread cschashed-3\script_12282e6b2cc91b42::function_deae84ba();
		}
	}
	...
	if(cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_3ab7cedcfef7eacc"))
	{
		...
		foreach(bgb in level.bgb)
		{
			...
			if(bgb.rarity === 0 && str_name != #"hash_177ea318753f5418" && !array::contains(self.var_7d0afffb, str_name))
			{
				...
				if(!isdefined(var_544e77f8) || (isdefined(var_544e77f8) && var_6758c36a >= var_544e77f8 || function_bea73b01() == 1) && cschashed-3\script_12282e6b2cc91b42::function_3ac936c6(str_name))
				{
...
function function_188002fa(bgb)
{
	/#
		...
		var_cb2a0d7c = self.var_ed782493[bgb].var_c2a984f0 - self.var_ed782493[bgb].var_a286cbfb;
