...
{
	if(getnumexpectedplayers() == 1 && (!sessionmodeisonlinegame() || !sessionmodeisprivate() || cschashed-1\script_3c362258ff800237::function_b47f6aba()))
	{
...
*/
private function function_5dcc54a8(players)
{
...
function function_c52e1749(origin, players)
{
	...
	{
		var_f67d1ba2 = generatenavmeshpath(var_88e86621.origin, playerpositions, self);
	...
	{
		self.var_c6e0686b = var_f67d1ba2.pathdistance * var_f67d1ba2.pathdistance;
	}
...
function can_use(e_player, var_ea5d26bb = 0, var_67fee570 = 0)
{
	...
	if(var_ea5d26bb)
	{
		...
		if(!e_player zm_magicbox::can_buy_weapon(0) || e_player bgb::is_enabled(#"zm_bgb_disorderly_combat") || cschashed-2\script_709bf7c56eb65adf::is_placeable_mine(w_current) || zm_equipment::is_equipment(w_current) || ability_util::is_weapon_gadget(w_current))
		{
			return 0;
		}
	}
...
function spawn_buildkit_weapon_model(player, weapon, var_3ded6a21, origin, angles)
{
	...
	{
		var_3ded6a21 = player namespace_f063c3a8::function_4f727cf5(weapon);
	}
...
function can_enable_ee()
{
	...
	if(!cschashed-3\script_12282e6b2cc91b42::function_901b751c(#"hash_3c5363541b97ca3e"))
	{
		return 0;
	}
	if(level.gamedifficulty === 0)
...
function function_828bac1(n_character_index)
{
	...
	{
		if(character cschashed-1\script_2c454d63a96d2d0b::function_dc232a80() === n_character_index)
		{
			return character;
		}
	}
...
/*
	...
	Flags: Linked, Private
*/
private function function_315c8e4(v_magnitude, e_attacker, n_damage = self.health, weapon = level.weaponnone)
{
	self endon(#"death");
	self.var_bfffc79e = 1;
...
function function_ebb2f490()
{
	...
	foreach(var_5d22227d in var_400c259d)
	{
		...
		if(var_5d22227d.var_4d0c0f54 != level.weaponnone)
		{
			if(!isdefined(var_dc69b88b))
			{
				var_dc69b88b = [];
			...
			var_dc69b88b[var_dc69b88b.size] = zm_weapons::function_93cd8e76(var_5d22227d.var_4d0c0f54);
		}
	}
	return var_dc69b88b;
}
...
function function_28ee38f4(weapon, var_3a36e0dc, var_87f6ae5)
{
	...
	if(isinarray(var_dc69b88b, root_weapon) || zm_weapons::function_93cd8e76(self.currentweapon) === root_weapon)
	{
		...
		if(root_weapon.var_4d0c0f54 !== level.weaponnone)
		{
			if(!isdefined(self.var_f6d3c3[var_3a36e0dc]))
			{
				self.var_f6d3c3[var_3a36e0dc] = [];
			...
			self.var_f6d3c3[var_3a36e0dc][self.var_f6d3c3[var_3a36e0dc].size] = root_weapon.var_4d0c0f54;
		}
...
function function_18ce0c8(weapon, var_3a36e0dc)
{
	...
	if(root_weapon.var_4d0c0f54 != level.weaponnone)
	{
		self.var_f6d3c3[var_3a36e0dc] = array::exclude(self.var_f6d3c3[var_3a36e0dc], root_weapon.var_4d0c0f54);
	}
}
...
function function_fdb0368(n_round_number, str_endon)
{
	...
	if(!isdefined(level.round_number) || level.round_number < n_round_number)
	{
		while(true)
		{
			...
			var_be17187b = level waittill(#"start_of_round");
			if(var_be17187b.n_round_number >= n_round_number)
			{
				return;
			}
		}
...
/*
	...
	Flags: Linked
*/
function function_9ad5aeb1(var_a8d0b313 = 1, var_82ea43f2 = 1, var_68578e19 = 0, var_b0e62e21 = 1, var_814b69d3 = 1, var_87c98387 = "white")
{
	var_4b9821e4 = 0;
	...
	else
	{
		...
		var_413948c0 = var_b0e62e21[1];
		var_7012f1e9 = var_b0e62e21[2];
		n_alpha = array(0.8, 1)[var_814b69d3];
		level thread lui::screen_flash(var_72487f42, var_413948c0, var_7012f1e9, n_alpha, var_87c98387);
	}
	foreach(ai in getaiteamarray(level.zombie_team))
	{
		if(isalive(ai) && (!(isdefined(ai.var_d45ca662) && ai.var_d45ca662)) && (!(isdefined(ai.marked_for_death) && ai.marked_for_death)))
		{
			if(var_a8d0b313)
			{
				ai namespace_57ff8cbb::function_23621259(0);
			}
			if(var_82ea43f2 || (ai.var_6f84b820 !== #"basic" && ai.var_6f84b820 !== #"popcorn" && ai.var_6f84b820 !== #"enhanced"))
			{
				...
				if(!var_68578e19 && (ai.var_6f84b820 === #"basic" || ai.var_6f84b820 === #"enhanced") && var_4b9821e4 < 6)
				{
					var_4b9821e4++;
...
/*
	...
	Flags: Linked
*/
function function_b6208d7f(weapon, var_b69165c7 = 0)
{
...
function function_4a25b584(v_start_pos, var_487ba56d, n_radius = 512, b_randomize = 1, var_79ced64 = 0.2, n_half_height = 4, var_21aae2c6 = undefined)
{
	...
	{
		var_7d81025 = function_ce46d95e(v_start_pos, 0, 0, 1);
		...
		if(isdefined(var_bf08dccd[i]))
		{
			...
			n_move_time = var_7d81025 fake_physicslaunch(var_bf08dccd[i] + vectorscale((0, 0, 1), 35), var_96bdce8a);
		}
		else
		{
			n_move_time = var_7d81025 fake_physicslaunch(v_start_pos + vectorscale((0, 0, 1), 35), n_radius / 3.5);
		}
		if(isdefined(level.var_b4ff4ec))
		{
			var_7d81025 thread [[level.var_b4ff4ec]](n_move_time);
		}
		wait(var_79ced64);
	}
	if(is_standard())
...
/*
	...
	Flags: Linked
*/
function function_25e3484e(v_pos, var_5ee385ac = 400, var_3e807a14)
{
...
/*
	...
	Flags: Linked
*/
function function_ce46d95e(v_origin, var_3be61dc3 = 1, var_4ecce348 = 1, var_9a5654a5)
{
	if(var_4ecce348)
	{
	...
	{
		var_7d81025 = zm_powerups::specific_powerup_drop("bonus_points_player", v_origin, undefined, var_9a5654a5, undefined, b_permanent, 1);
		if(isdefined(var_7d81025))
		{
			if(isdefined(level.var_48e2ab90))
			{
				var_7d81025 setscale(level.var_48e2ab90);
			}
			if(isdefined(level.var_6463d67c))
			{
				var_7d81025.var_258c5fbc = level.var_6463d67c;
			}
		}
	}
	return var_7d81025;
