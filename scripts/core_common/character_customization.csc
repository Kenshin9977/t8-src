...
/*
	...
	Flags: Linked, Private
*/
private function function_91cd5499(var_ea8d5ac8, var_87606b20, var_584905de)
{
...
function function_7ea1db75(params)
{
	...
	{
		var_cebd9c7e = [[ self ]]->function_d5e754c6();
	...
	{
		var_cebd9c7e = [[ self ]]->function_b06080fb();
	...
	if(isdefined(params.var_c76f3e47) && params.var_c76f3e47 && !self.var_c31e86ed && !self.var_ff2bed36 isstreamed(params.var_5bd51249, params.var_13fb1841))
	{
		if(isdefined(params.var_401d9a1) && params.var_401d9a1)
		{
			...
			{
				function_bcffa9f0(model, var_a9916921, 0);
			}
			do
			{
				waitframe(1);
	...
	if(self.var_b627749c)
	{
		...
		{
			function_91cd5499(util::spawn_model(self.var_f141235b, var_cebd9c7e, self._origin, self.var_7e5e7fa2));
			self.var_45210dc7 = [];
			self.var_bf273e28 = [];
			self.var_5633914d = [];
		}
	...
	if(isdefined(var_2d0192e5))
	{
		...
		{
			setuimodelvalue(var_2d0192e5.var_6ca54849, [[ self ]]->function_ea4ac9f8() && [[ self ]]->is_visible());
		}
	}
...
private function function_2e77aae4(localclientnum, weaponmodel, var_6f2ae9c0, var_49daa2f6)
{
	...
	var_5c040783 = cschashed-2\script_158d50d476435605::function_ae141bf2(camoindex);
	...
	return cschashed-2\script_158d50d476435605::function_374e37a0(localclientnum, weaponmodel, var_3594168e, var_49daa2f6);
}
...
{
	return {#hash_5f383817:self.var_f5c0467b, #hash_665ae20e:self.var_cfe86a3e, #hash_ab6c1fa9:self.var_cf55444c, #hash_e1c69280:self.var_db113baf, #charactertype:self.var_1d73bad9, #charactermode:self.var_ea1ac6a5, #xuid:self.var_61e64cb8};
}
...
function __init__()
{
	...
	level.model_type_bones = [#"hash_6fbc03ba2c7779e6":"", #"hash_75bb30e3db362b72":"", #"hash_624d1a4c293770ca":"", #"outfit_head":"", #"head":""];	if(!isdefined(level.liveccdata))
	{
		level.liveccdata = [];
	}
...
function function_aa5382ed(var_1c843d99, var_671ed2ed, var_f91927a1 = 1)
{
	...
	if(var_1c843d99.var_ab6c1fa9 != var_671ed2ed.outfit)
	{
		return 1;
	}
...
function function_7474681d(local_client_num, session_mode, character_index)
{
	...
	return {#hash_5f383817:var_809a2fb0, #hash_665ae20e:var_17b172ca, #hash_ab6c1fa9:var_7abdc6dd, #hash_e1c69280:getequippedheadindexforhero(local_client_num, session_mode), #charactertype:character_index, #charactermode:session_mode};
}
...
function function_3f5625f1(mode, character_index = 1)
{
	...
	return {#hash_5f383817:var_809a2fb0, #hash_665ae20e:0, #hash_ab6c1fa9:0, #hash_e1c69280:0, #charactertype:character_index, #charactermode:mode};
}
