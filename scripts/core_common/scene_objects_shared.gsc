...
/*
	...
	Flags: Linked
*/
function is_interactive_shot(n_shot)
{
	if(isdefined(n_shot))
	{
...
/*
	...
	Flags: Linked
*/
function play_anim(animation, b_camera_anim = 0, b_interactive_shot = 0, n_start_time = 0)
{
	/#
		if(getdvarint(#"debug_scene", 0) > 0)
		{
	...
	if(self._b_first_frame || b_interactive_shot)
	{
		n_rate = 0;
	}
	else
...
private autoexec function csceneobject()
{
	...
	classes.csceneobject[0].__vtable[384002887] = &csceneobject::is_interactive_shot;
