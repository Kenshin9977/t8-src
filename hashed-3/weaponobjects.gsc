...
#using hashed-2\trophy_system.gsc;
...
function function_6d8aa6a0(player, watcher)
{
	...
	player waittill(#"joined_team", #"joined_spectators", #"disconnect", #"changed_specialist", #"changed_specialist_death");	self [[watcher.var_994b472b]](player);
}
...
/*
	...
	Flags: Linked
*/
function function_127fb8f3(var_983dc34, var_dbd1a594)
{
	if(isdefined(var_983dc34) && isdefined(var_983dc34.var_2d045452))
	{
		var_983dc34.var_2d045452 thread waitanddetonate(var_983dc34, 0.05, var_dbd1a594, getweapon(#"hash_21b346649d376bf3"));
	}
	else
	{
...
/*
	...
	Flags: Linked
*/
function watchusetrigger(trigger, callback, playersoundonuse, npcsoundonuse, var_61dedb9f)
{
